...
class CreateTblNpsAutomationsTrackingLogsTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_nps_automations_tracking_logs', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('tbl_nps_automations_tracking_logs');
	}
