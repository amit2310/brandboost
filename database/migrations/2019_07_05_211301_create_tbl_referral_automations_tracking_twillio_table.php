...
class CreateTblReferralAutomationsTrackingTwillioTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_referral_automations_tracking_twillio', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_referral_automations_tracking_twillio');
	}
