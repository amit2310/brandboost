...
class CreateTblNpsAutomationsTrackingSendgridTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_nps_automations_tracking_sendgrid', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_nps_automations_tracking_sendgrid');
	}
