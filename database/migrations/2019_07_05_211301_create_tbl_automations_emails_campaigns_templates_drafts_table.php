...
class CreateTblAutomationsEmailsCampaignsTemplatesDraftsTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_automations_emails_campaigns_templates_drafts', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_automations_emails_campaigns_templates_drafts');
	}
