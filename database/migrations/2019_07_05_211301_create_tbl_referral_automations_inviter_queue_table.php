...
class CreateTblReferralAutomationsInviterQueueTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_referral_automations_inviter_queue', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_referral_automations_inviter_queue');
	}
