...
class CreateTblReferralRewardsTemplatesTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_referral_rewards_templates', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_referral_rewards_templates');
	}
