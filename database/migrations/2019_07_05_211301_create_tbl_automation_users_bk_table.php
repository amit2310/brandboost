...
class CreateTblAutomationUsersBkTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_automation_users_bk', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_automation_users_bk');
	}
