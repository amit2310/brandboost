...
class CreateTblReferralAutomationsTriggersTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_referral_automations_triggers', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('tbl_referral_automations_triggers');
	}
