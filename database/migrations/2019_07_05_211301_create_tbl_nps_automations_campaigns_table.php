...
class CreateTblNpsAutomationsCampaignsTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_nps_automations_campaigns', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('tbl_nps_automations_campaigns');
	}
