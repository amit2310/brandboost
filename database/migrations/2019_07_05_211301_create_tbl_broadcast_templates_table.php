...
class CreateTblBroadcastTemplatesTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_broadcast_templates', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_broadcast_templates');
	}
