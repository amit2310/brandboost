...
class CreateTblListSubscribersBkTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_list_subscribers_bk', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_list_subscribers_bk');
	}
