...
class CreateTblBroadcastTemplatesDraftsTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_broadcast_templates_drafts', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_broadcast_templates_drafts');
	}
