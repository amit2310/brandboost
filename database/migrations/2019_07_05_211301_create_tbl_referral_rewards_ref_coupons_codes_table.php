...
class CreateTblReferralRewardsRefCouponsCodesTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_referral_rewards_ref_coupons_codes', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tbl_referral_rewards_ref_coupons_codes');
	}
