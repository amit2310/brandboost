...
class CreateTblAutomationsEmailsTriggersTable extends Migration {
	...
	public function up()
	{
		Schema::create('tbl_automations_emails_triggers', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('tbl_automations_emails_triggers');
	}
