...
(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'Paginationwithhashchange3',
        defaults = {
            nextSelector: '.next-video',
            prevSelector: '.prev-video',
            counterSelector: '.counter-video',
            pagingSelector: '.paging-nav-video',
            itemsPerPage: 5,
            initialPage: 1
        };
    ...
    function Paginationwithhashchange3( element, options ) {
    ...
    Paginationwithhashchange3.prototype.init = function () {
    ...
    $.fn[pluginName] = function ( options ) {
        return this.each(function () {
            if (!$.data(this, 'plugin_' + pluginName)) {
                ...
                new Paginationwithhashchange3( this, options ));
            }
        });
    };
