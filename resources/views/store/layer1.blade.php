				...
				<div class="row">
					<div class="brand_side mt-10">
						...
						<div class="col-md-4"  style="float: <?php //echo $position; ?>">
							...
							<div class="panel panel-flat review_ratings <?php echo $brandData->customer_experiance > 0 ? '':'hidden';?>">
								<div class="panel-heading">
									<h6 class="panel-title pl10">Customer Experiance <span class="<?php echo $textClassReview; ?>">(<?php 
										if($avgRatings > 0) {
											echo number_format($avgRatings, 1);
										}
										else {
								...
								<div class="panel-body p0">
									<div class="pt20 pb20 pl30 pr30 bbot">
										...
										?> <sup><i class="fa fa-caret-up"></i> &nbsp; +15%</sup></h1>
										<p class="brand_rating mb0">
											
											<?php for ($i = 1; $i <= 5; $i++): ?>
											<i class="fa fa-star big <?php
												if ($i <= ceil($avgRatings)) {
													echo 'txt_yellow';
													}else{
													echo 'txt_grey';
										...
										<p class="text-muted fsize12 pull-left m0">Based On <?php echo $totalRatingReview; ?> Review over the past year.</p>
									...
									<div class="p30 ratings">
										<div class="row inner">
											...
											<div class="col-xs-6 text-right"><p><?php echo ceil(($fiveRating/$totalRatingReview)*100) > 0 ? ceil(($fiveRating/$totalRatingReview)*100).'%' : '0' ; ?> <span><?php echo $fiveRating; ?></span></p></div>
											<div class="col-xs-12">
												<div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Requests 17">
													<div class="progress-bar progress-bar-info <?php echo $gradientClassReview; ?>" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40" style="width:<?php echo ceil(($fiveRating/$totalRatingReview)*100).'%'?>"></div>
												</div>
											</div>
										</div>
										<div class="row inner">
											...
											<div class="col-xs-6 text-right"><p><?php echo ceil(($fourRating/$totalRatingReview)*100) > 0 ? ceil(($fourRating/$totalRatingReview)*100).'%' : '0' ; ?>  <span><?php echo $fourRating; ?></span></p></div>
											<div class="col-xs-12">
												<div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Requests 17">
													<div class="progress-bar progress-bar-info <?php echo $gradientClassReview; ?>" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="70" style="width:<?php echo ceil(($fourRating/$totalRatingReview)*100).'%'?>"></div>
												</div>
											</div>
										</div>
										<div class="row inner">
											...
											<div class="col-xs-6 text-right"><p><?php echo ceil(($threeRating/$totalRatingReview)*100) > 0 ? ceil(($threeRating/$totalRatingReview)*100).'%' : '0' ; ?>  <span><?php echo $threeRating; ?></span></p></div>
											<div class="col-xs-12">
												<div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Requests 17">
													<div class="progress-bar progress-bar-info <?php echo $gradientClassReview; ?>" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="10" style="width:<?php echo ceil(($threeRating/$totalRatingReview)*100).'%'?>"></div>
												</div>
											</div>
										</div>
										<div class="row inner">
											...
											<div class="col-xs-6 text-right"><p><?php echo ceil(($twoRating/$totalRatingReview)*100) > 0 ? ceil(($twoRating/$totalRatingReview)*100).'%' : '0' ; ?>  <span><?php echo $twoRating; ?></span></p></div>
											<div class="col-xs-12">
												<div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Requests 17">
													<div class="progress-bar progress-bar-info <?php echo $gradientClassReview; ?>" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="10" style="width:<?php echo ceil(($twoRating/$totalRatingReview)*100).'%'?>"></div>
												</div>
											</div>
										</div>
										<div class="row inner mb0">
											...
											<div class="col-xs-6 text-right"><p><?php echo ceil(($oneRating/$totalRatingReview)*100) > 0 ? ceil(($oneRating/$totalRatingReview)*100).'%' : '0' ; ?>  <span><?php echo $oneRating; ?></span></p></div>
											<div class="col-xs-12">
												<div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Requests 17">
													<div class="progress-bar progress-bar-info <?php echo $gradientClassReview; ?>" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="10" style="width:<?php echo ceil(($oneRating/$totalRatingReview)*100).'%'?>"></div>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="panel-footer p20">
									<img src="<?php echo base_url(); ?>assets/images/bb_sm_logo.jpg" alt=""><span class="fsize124 text-muted pl-10 lh24">Powered by BrandBoost</span>
								</div>
							</div>
