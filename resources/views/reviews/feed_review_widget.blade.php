...
<style>
	...
	.bbpw_form_group .bbpw_form_control{padding: 10px; height: 45px; border: 1px solid #ddd; width: 100%;}
	.bbpw_form_group textarea.bbpw_form_control{height:210px;}
	.bbpw_form_group .bbcmtsubmit, .bbpw_form_group .bbcmtreplysubmit{padding: 10px; height: 45px; background:#000; color:#fff; width:100%; border: 1px solid #000;}
	.bbpw_comment_form .bb_overlay, .bbpw_comment_form .bb_overlay_reply{display:none;}
	.bb-hidden{display:none;}
	.bbpw_success_message{padding:5px 0 3px;}
	.bb-success-msg, .bb_success_msg{color:#53aa2e}
	.bb-error-msg, .bb_error_msg{color:#F00}
	a.bbactive {color: #127bfb; font-weight: 500;}
	.bb_img_enlagre{ -webkit-transition: width 1s, height 1s; transition: width 1s, height 1s; }
	.bb_img_enlagre.bb_zoom_image{
...
<div class="bb_rw05">
<span class="reviews visible-xs">Reviews</span>
	<!--<button type="button" class="bb_close">×</button>-->
	...
	<div class="bb_white_box <?php echo $bgClassName; ?>" style="padding:0 30px;">
		<!--========RATING & BUTTONS========-->
		<div class="bbtop_sec">
			<div id="bb_product_rating_area">
				<div class="bb_rating_sec">
					...
					<p class="bb_para">
						<?php for ($i = 0; $i < number_format($avgProductRatings, 0); $i++) { ?>
			...
			<div id="bb_service_rating_area" style="display:none;">
				<div class="bb_rating_sec">
					...
					<p class="bb_para">
						<?php for ($i = 0; $i < number_format($avgServiceRatings, 0); $i++) { ?>
							<i class="fa fa-star bb_txt_yellow bb_custom_rc"></i>
						<?php } ?>
						<?php
							if ($i < 5) {
			...
			<div id="bb_site_rating_area" style="display:none;">
				<div class="bb_rating_sec">
					...
					<p class="bb_para">
						<?php for ($i = 0; $i < number_format($avgSiteRatings, 0); $i++) { ?>
							<i class="fa fa-star bb_txt_yellow bb_custom_rc"></i>
						<?php } ?>
						<?php
							if ($i < 5) {
				...
				<div class="bb_progress_bar_sec">
					...
					<div class="bb_progress_bar_inner">
						...
						<div class="bb_progress">
							<div class="bb_progress_grey">
								<div class="bb_progress_status red width15" style="width:<?php echo $twoStarSiteRatingsPer; ?>%;" title="<?php echo $twoStarSiteRatings; ?>"> </div>
							</div>
						</div>
						<div class="bb_clear"></div>
					</div>
			...
			<div class="bb_button_area">
				<a class="bb_btn" href="<?php echo base_url(); ?>for/<?php echo $companySlug; ?>/<?php echo strtolower(str_replace(" ", "-", $reviewData['brandboost_name'])) . '-' . $campaignID; ?>" style="text-decoration:none;" target="_blank"><img src="<?php echo base_url(); ?>assets/images/green_smiley.png"> &nbsp; Add review</a>
				<a class="bb_btn bb_fright" href="<?php echo base_url(); ?>for/<?php echo $companySlug; ?>/<?php echo strtolower(str_replace(" ", "-", $reviewData['brandboost_name'])) . '-' . $campaignID; ?>" style="text-decoration:none;" target="_blank">? &nbsp;  Ask a Question</a>
			</div>
			<div class="bb_clear"></div>
		</div>
		...
		<div class="bb_tab_box bb_custom_bc">
			<ul>
				<li><a class="active bb_custom_fc bb_product_reviews" href="javascript:void(0);"><span class="hidden-xs">Product</span> Reviews (<?php echo sizeof($aReviews) - sizeof($aSiteReviews) - sizeof($aServiceReviews); ?>)</a></li>
		...
		<div class="bb_comments_area">
			...
			<?php
				...
				?>
				<div class="bb_comment_boc_main bb_custom_bc bbw_main_loop_cantainer bb_type_<?php echo $reviewData['review_type'] == '' ? 'product' : $reviewData['review_type']; ?>" data-product-type="<?php echo $reviewData['review_type'] == '' ? 'product' : $reviewData['review_type']; ?>">
					<div class="bb_comment_header bb_custom_bc">
						<div class="bb_avatar01">
							<i class="fa bb_check_green fa-check-circle"></i>
							<?php echo showUserAvtar($reviewData['user_data']['avatar'], $reviewData['firstname'], $reviewData['lastname']); ?>
						</div>
						<div class="bb_fleft">
						...
						<div class="bb_fleft">
							...
							<p class="bb_para"><span class="bb_dot"><i class="fa fa-circle"></i></span> <span class="bb_thingrey bb_custom_fc"><?php echo dataFormat($reviewData['created']); ?></span></p>
							<?php endif; ?>
								...
								<?php 
									foreach ($brandImgArray as $imageData):
										if ($reviewData['media_url'] != '' && $imageData['media_url'] != '' && $imageData['media_type'] == 'image'):
											echo '<img src="https://s3-us-west-2.amazonaws.com/brandboost.io/campaigns/' . $imageData['media_url'] . '" alt="" class="bb_img_enlagre bb_normal_image">';
										endif;
									endforeach;											
								?>
							</a>
					...
					<div class="bb_comment_area">
						...
						<a href="javascript:void(0);" class-position="<?php echo $count; ?>" class="bbpw_comment_counter bb_custom_fc <?php echo sizeof($reviewData['comment_block']) > 0 ? 'bbactive' : ''; ?>"><i class="fa fa-comment txt_grey bb_custom_fc" style="font-size:16px;"></i> &nbsp;<?php echo sizeof($reviewData['comment_block']); ?>  comments</a> 
						<?php endif; ?>
						<?php if ($bAllowHelpful): ?>
						<a class="bb_review_helpful bb_custom_fc"><?php echo ($reviewData['total_helpful']) ? $reviewData['total_helpful'] : 0; ?> found this helpful</a> 
						<a class="bb_review_like bb_like_dislike bb_txt_green bbpw_helpful_action bb_custom_bc" class-position="<?php echo $count; ?>" action-name="Yes" bb-review-id="<?php echo $reviewData['id']; ?>" href="javascript:void(0);"><i class="fa fa-thumbs-up"></i></a> 
						<a class="bb_review_dislike bb_like_dislike bb_txt_red bbpw_helpful_action bb_custom_bc" class-position="<?php echo $count; ?>" action-name="No" bb-review-id="<?php echo $reviewData['id']; ?>" href="javascript:void(0);"><i class="fa fa-thumbs-down"></i></a> 
						<?php endif; ?>
						...
						<!-- <a href="whatsapp://send?text=<?php echo $reviewData['comment_text']; ?> - http://pleasereviewmehere.com/campaign/<?php echo strtolower(str_replace(" ", "-", $reviewData['brandboost_name'])) . '-' . $campaignID; ?>">Whatsapp</a> -->
					...
					?>
						<div class="bb_inner_reply">
							<div class="bb_comment_header_small">
								...
								<div class="bb_fleft">
									<p class="bb_para"><span class="bb_dot"><i class="fa fa-circle"></i></span> <span class="bb_thingrey bb_custom_fc"><?php echo timeAgo(date('F d, Y', strtotime($aComment['created']))); ?></span></p>
								</div>
								<div class="bb_clear"></div>
							</div>
						...
						?>
							<div class="bb_inner_reply" style="margin-left:40px;">
								<div class="bb_comment_header_small">
									...
									<div class="bb_fleft">
										<p class="bb_para"><span class="bb_dot"><i class="fa fa-circle"></i></span> <span class="bb_thingrey bb_custom_fc"><?php echo timeAgo(date('F d, Y', strtotime($cComment['created']))); ?></span></p>
									</div>
									<div class="bb_clear"></div>
								</div>
								<div class="text_section_reply">
								...
								<div class="bb_comment_area_reply">
									<span class="bb_custom_fc bbpw_comment_like_<?php echo $cComment['id']; ?>"><?php echo $oCommentLike['like']; ?></span>&nbsp;
									...
									<span class="bb_custom_fc bbpw_comment_dislike_<?php echo $cComment['id']; ?>"><?php echo $oCommentLike['dislike']; ?></span>&nbsp;
					...
					<?php endif; ?>
						...
						<div class="bb_comment_row" style="border:none; padding-top: 15px; display: inline-block;">
							<p>
								...
								<span><a style="text-decoration:none;" class-position="<?php echo $count; ?>" class="bb_custom_fc bbactive bbpw_show_all_comment" href="javascript:void(0);"><i class="fa fa-comment txt_grey bb_custom_fc" style="font-size:16px;"></i>&nbsp; View all comments</a></span>
								<?php endif; ?>
							</p>
						</div>
					</div>
