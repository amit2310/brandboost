...
<style>
	...
	<?php } ?>
	<?php if($widgetPosition == 'bottom-right'){ ?>
...
<div class="bb_rw04_1 <?php echo $mainWigetClassName; ?> bbpwPossition" id="bb_vpw_section">
	<button type="button" class="bbcpw_close_btn bb_close bb_custom_fc <?php echo $bgClassName; ?>">x</button>
	<button style="border-radius: 100px; margin-top: -65px; top:50%" type="button" scroll-type="top" click-data="0" class="bb_widget_scroll bb_close bb_custom_fc <?php echo $bgClassName; ?>"><i class="fa fa-angle-up"></i></button>
	<button style="border-radius: 100px; margin-top: 0px; top:50%" type="button" scroll-type="bottom" click-data="0" class="bb_widget_scroll bb_close bb_custom_fc <?php echo $bgClassName; ?>"><i class="fa fa-angle-down"></i></button>
	...
	<div class="bb_white_box <?php if($alternativeDesign == 1){ echo $bgClassName; } ?>">
		...
		<div class="bb_pad20">
			<div class="bb_rating_sec">
				...
				<h4 class="bb_custom_fc">Based on <?php echo $totalReviews; ?> reviews</h4>
			</div>
		</div>
		<div class="bb_clear"></div>
	</div>
				...
				<div class="bb_comments_area">
					<div class="bb_pad20">
						...
						<div class="bb_comment_area">
							...
							<a class="bb_like_dislike bb_txt_green bbpw_helpful_action bb_review_like bb_custom_bc" href="javascript:void(0);" class-position="<?php echo $count; ?>" action-name="Yes" bb-review-id="<?php echo $reviewData['id']; ?>"><i class="fa fa-thumbs-up" style="padding-top: 5px;"></i></a> 
							<a class="bb_like_dislike bb_txt_red bbpw_helpful_action bb_review_dislike bb_custom_bc" href="javascript:void(0);" class-position="<?php echo $count; ?>" action-name="No" bb-review-id="<?php echo $reviewData['id']; ?>"><i class="fa fa-thumbs-down" style="padding-top: 5px;"></i></a> 
							<?php endif; ?>
						</div>
	...
	<a class="bb_submit_button_white <?php echo $bgClassName; ?>" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/widget/bb_icon_transparent.png" style="padding-top:14px;"></a>
	<?php }else if($iconType == 'light'){ ?>
	<a class="bb_submit_button_white" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/widget/bb_icons_2.png" style="padding-top:14px;"></a>
	<?php }else if($iconType == 'dark'){ ?>
	<a class="bb_submit_button_blue" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/widget/bb_icon_transparent.png" style="padding-top:14px;"></a>
	<?php } ?>
	</div>
