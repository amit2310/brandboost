...
<style>
	...
	<?php } ?>
	.bb_rw01 .bb_submit_button_white, .bb_rw04_1 .bb_submit_button_blue{float:right; margin-top:10px;}
	...
	.bb_rw01 .bb_main_comments_section{height:410px!important;}
	
	@media only screen and (max-width:480px){
   .bb_rw01 .bb_main_comments_section{height:360px!important;}
	}
	.bb_rw01 .bb_close { position: absolute; cursor: pointer; width: 40px; height: 40px; border-radius: 6px; border: none; background-color: #fff; top: 0; left: -55px; color: #b4c4dc; font-size: 18px;  box-shadow: 0 1px 1px 0 rgba(1, 21, 64, 0.08); font-weight: 600 !important; }
	<?php if($alternativeDesign != 1){ ?>
		.bbpw_inner_comment_box{border-radius:0px!important; margin-bottom:0px!important; border-bottom:1px solid <?php echo $borderColor == '' ? '#f4f6fa' : $borderColor; ?>}
	<?php } ?>
	<?php if($widgetPosition == 'bottom-left'){ ?>
		.bb_rw01.bbpwPossition{left:20px; right:initial!important;}
		.bb_rw01.bbpwPossition .bb_submit_button_white, .bb_rw04_1.bbpwPossition .bb_submit_button_blue{left:55px; right:initial!important; border-radius:100px 0px 100px 100px!important; float:left!important;}
		.bb_rw01.bbpwPossition .bb_widget_scroll{left:initial!important; right:-55px!important;}
	<?php } ?>
</style>
<div class="bb-loaded">&nbsp;</div>
<div class="bb_rw01 <?php echo $mainWigetClassName; ?> bbpwPossition" id="bb_bpw_section">
	<div id="bbpwButtonWidget" style="display: inline-block;">
	...
	<div class="bb_white_box bb_pr_header01 bb_pad15 <?php echo $bgClassName; ?>">
		<div class="bb_fleft">
			<img class="bb_br5" width="75" src="https://s3-us-west-2.amazonaws.com/brandboost.io/campaigns/<?php echo $oCampaign->logo_img; ?>" onerror="this.src='<?php echo base_url('assets/images/default_table_img2.png'); ?>'"/>
		</div>
		<div class="">
			<h3 class="bb_custom_fc"><?php echo $oCampaign->brand_title; ?> <span><?php echo $oCampaign->brand_desc; ?></span></h3>
			<hr class="bb_hr">
			<p class="bb_para">
				<?php for ($i = 0; $i < number_format($avgRatings, 0); $i++) { ?><i class="fa fa-star bb_txt_yellow bb_custom_rc"></i><?php } ?><?php if ($i < 5) { for ($j = $i; $j < 5; $j++) { ?><i class="fa fa-star bb_txt_grey"></i><?php } } ?>
				<span class="bb_custom_fc"><?php echo number_format($avgRatings, 2); ?><span class="bb_custom_fc">/5</span></span>
			</p>
		</div>
		<div class="bb_clear"></div>
	</div>
	<div class="<?php if($alternativeDesign != 1){ echo $bgClassName; } ?>" style="<?php if($alternativeDesign != 1){ echo 'border-radius:6px;'; } ?>">
		<div class="bb_main_comments_section" id="bb_main_comments_section">
			<?php
				...
				?>
				<div class="bb_white_box bbpw_inner_comment_box <?php if($alternativeDesign == 1){ echo $bgClassName; } ?>">
					...
					<div class="bb_comments_area">
						<div class="bb_pad20">
							<div class="bb_comment_header bb_custom_bc">
								...
								<div class="bb_custom_fc" style="margin-left:52px; font-weight:bold;"><?php echo $productData->product_name == '' ? $bbData->brand_title : $productData->product_name; ?></div>
								<?php endif; ?>
							</div>
							...
							<div class="text_section">
								<p class="bb_para heading_txt bb_custom_fc" style="margin-top:12px!important;"><?php echo $reviewData['review_title']; ?></p>
								<?php echo $videoURL; ?>
							...
							<div class="bb_comment_area" style="margin-top:10px;">
								...
								<a class="bb_like_dislike bb_txt_green bbpw_helpful_action bb_review_like bb_custom_bc" href="javascript:void(0);" class-position="<?php echo $count; ?>" action-name="Yes" bb-review-id="<?php echo $reviewData['id']; ?>"><i class="fa fa-thumbs-up" style="margin-top:4px;"></i></a> 
								<a class="bb_like_dislike bb_txt_red bbpw_helpful_action bb_review_dislike bb_custom_bc" href="javascript:void(0);" class-position="<?php echo $count; ?>" action-name="No" bb-review-id="<?php echo $reviewData['id']; ?>"><i class="fa fa-thumbs-down" style="margin-top:4px;"></i></a> 
								<?php endif; ?>
							</div>
	...
	<?php if($iconType == 'default'){ ?>
		<a class="bb_submit_button_white <?php echo $bgClassName; ?> bbpw_bw_review_btn" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/widget/bb_icon_transparent.png" style="padding-top:14px;"></a>
		<?php }else if($iconType == 'light'){ ?>
		<a class="bb_submit_button_white bbpw_bw_review_btn" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/widget/bb_icons_2.png" style="padding-top:14px;"></a>
		<?php }else if($iconType == 'dark'){ ?>
		<a class="bb_submit_button_blue bbpw_bw_review_btn" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/widget/bb_icon_transparent.png" style="padding-top:14px;"></a>
	<?php } ?>
	<?php if ($bAllowBranding && false): ?>
