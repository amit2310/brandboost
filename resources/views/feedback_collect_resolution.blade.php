        ...
        <form method="post" id="resolutionFrm" name="resolutionFrm" class="form-horizontal" action="javascript:void();">
            <div class="review_main_box_new">
                <div class="review_top_icon"><img width="74"
                                                  src="{{ base_url("assets/images/review/review_smiley_icon.png") }}"/>
                </div>
                ...
                <div class="review_feedback text-left mt30">
                    ...
                    <input type="text" name="resolutionText" id="resolutionText" class="form-control"
                           placeholder="Give title to your feedback" required="required"/>
                </div>

                <div class="review_feedback text-left mt30">
                    <p class="txt_dark mb10 fw500">Your feedback</p>
                    <textarea name="resolutionText" id="resolutionText" class="form-control"
                              placeholder="Tell you what you thought of their service…" required="required"></textarea>
                </div>
                <div class="review_button mt30 text-left">
                    ...
                    @endif
                    <button type="submit" class="btn dark_btn bkg_blue_light h52 mr10 sh_no">Send feedback <i
                            class="icon-paperplane"></i></button>
                    <a href="{{ base_url('feedback/thankyou/?'.$getParam) }}"
                       class="btn light_btn bkg_grey_light h52 ml10 txt_dark sh_no pt20" data-dismiss="modal">Skip <i
...
<script>
    $(document).ready(function () {
        ...
        $("#resolutionFrm").submit(function () {
            ...
            @endif
            $.ajax({
                url: "{{ base_url('feedback/saveResolution') }}",
                type: "POST",
