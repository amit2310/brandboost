    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (!empty($membership_data->free_trial_days)): ?>
                        ...
                        <div class="col-md-7">
                            <div class="checkout_left">
                                ...
                                <div id="newCreditCardForm">
                                    <div class="alert-danger" style="margin-bottom:10px;"><?php echo validation_errors(); ?></div>
                                    <form action="<?php echo base_url('/payment/chargedecline'); ?>"  method="post" id="frmSubmit">
                                        <input type="hidden" name="plan_id" class="plan_id" value="<?php echo $planID; ?>" />
                                        <input type="hidden" name="contact_id" value="<?php echo $this->session->userdata('customer_user_id'); ?>" />
                                        <div class="row">
                                            <?php if (empty($cbContactID)): ?>
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input_box">
                                                        ...
                                                        <input type="text" name="postal_code" class="txtboxToFilter"  value="<?php echo $zip; ?>" placeholder="10001" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input_box">
                                                        ...
                                                        <input type="text" name="phone_number" value="<?php echo $phone; ?>" class="txtboxToFilter" placeholder="(212) 692-93-92" required/>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
