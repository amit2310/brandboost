                        ...
                        <div class="col-md-12">
                            <div class="review_main_box_new">
                                ...
                                <div class="review_button mt30">
                                    <button class="btn dark_btn bkg_blue_light h52 mr10 sh_no" id="yesfeed"><img width="12" src="<?php echo base_url("assets/images/rating5.png"); ?>"/>&nbsp;  I'm happy</button>
                                    <button class="btn light_btn bkg_grey_light h52 ml10 txt_dark sh_no" id="nothappy"><img src="<?php echo base_url("assets/images/icons/rating2.svg"); ?>"/> &nbsp;  Unhappy</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="review_main_box_new">
                                ...
                                <div class="review_button mt30">
                                    <button class="btn dark_btn bkg_blue_light h52 sh_no" id="continueStarRatings">Submit review <i class="icon-arrow-right13"></i></button>
                                </div>
        ...
        <div id="addFeedback" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" id="addFeedbackFrm" name="addFeedbackFrm" class="form-horizontal" action="javascript:void();">
                        ...
                        <div class="modal-body" style="margin-top:-20px;">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea name="feedback" id="feedback" class="form-control" placeholder="Please leave feedback here..." required style="width: 100%; height: 100px; padding-top: 10px;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
