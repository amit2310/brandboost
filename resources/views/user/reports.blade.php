                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="tdropdown ml0"><a style="margin:0!important;"
                                                          ...
                                                          data-toggle="dropdown" aria-expanded="false"> Sort by date <i
                ...
                <div class="panel-heading">
                    ...
                    <div class="heading-elements">
                        <div style="display: inline-block; margin: 0;"
                            ...
                            <input class="form-control input-sm cus_search" tableId="allContact"
                        ...
                        <tr>
                            <td>
                                <div style="vertical-align: top!important;" class="media-left media-middle">
                                    <a href="#">
                                        <img src="http://brandboost.io/admin_new/images/userp.png"
                                             class="img-circle img-xs" alt="">
                                    </a>
                                </div>
                                <div class="media-left">
                                    <a href="javascript:void()"
                                       class="text-default text-semibold">{{ $data->firstname }} {{ $data->lastname }}</a>
                                    <div class="text-muted text-size-small">{{ $data->email }}</div>
                                    <div
                                        class="text-muted text-size-small">{{ $data->phone == '' ? '<span style="color:#999999">Phone Unavailable</span>' : $data->phone }}</div>
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="media-left">
                                    <a href="javascript:void()"
                                       class="text-default text-semibold">{{ $data->aff_firstname }} {{ $data->aff_lastname }}</a>
                                    <div class="text-muted text-size-small">{{ $data->aff_email }}</div>
                                    <div
                                        class="text-muted text-size-small">{{ $data->aff_mobile == '' ? '<span style="color:#999999">Phone Unavailable</span>' : $data->aff_mobile }}</div>
                                </div>
                            </td>
