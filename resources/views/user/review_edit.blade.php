            ...
            <div class="col-md-12">
                <div class="white_box profile_sec mb20">
                    <div style="top: 35px;" class="backbtn">
                        <a href="{{ base_url() }}user/review"><img
                                src="{{ base_url() }}assets/profile_images/back_40.png"></a>
                    </div>
                    <div style="top: 35px;" class="review_edit">
                        <a style="cursor: pointer;"><img src="{{ base_url() }}assets/profile_images/edit_40.png"></a>
                    </div>
                        ...
                        <form method="post" id="updateReview" action="javascript:void();">
                            ...
                            <div class="form-group">
                                ...
                                <div class="step_star" style="padding: 5px 0;">
                                    <ul id='stars'>
                                        @php
                                            foreach($starRating as $key => $sRate) {
                                            $selected = '';
                                            if($key <= $myReview->ratings) {
                                                $selected = 'selected';
                                            }
                                        @endphp
                                        <li class='star {{ $selected }}' title='{{ $sRate }}' data-value='{{ $key }}'>
                                ...
                                <input type="hidden" value="{{ $myReview->ratings }}" id="ratingValue"
                                       name="ratingValue">
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var myDropzone_ = new Dropzone(
                ...
                {
                    url: '{{ base_url("webchat/dropzone/edit_review_image") }}',
