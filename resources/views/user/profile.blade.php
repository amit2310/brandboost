    ...
    <div class="content_area">
        <div class="row">
            <div class="col-md-12">
                <div class="white_box text-center profile_sec mb25">
                    <div class="review_edit">
                        <a href="{{ base_url() }}user/setting"><img
                                src="{{ base_url() }}assets/profile_images/settings_40.png"></a>
                    </div>
                    <div class="p25 bbot">
                        <div class="profile_avatar">
                            <div style="cursor:pointer;" class="media-left media-middle pr10 uploadAvatar">
                                {!! showUserAvtar($aUInfo->avatar, $aUInfo->firstname, $aUInfo->lastname, '80', '80', '25') !!}
                            </div>
                            <div class="input-group dropzone hidden" id="myDropzone_avatar">
                                <span class="input-group-addon"><i class="icon-upload7"></i></span>
                                <div class=""></div>
                            </div>
                            <h3>Hello, {{ $aUInfo->firstname.' '.$aUInfo->lastname }}!</h3>
                            <p>{{ $aUInfo->email }}</p>
                        </div>
                        ...
                        <div class="p40 text-center profile_user_data">
                            <div class="row">
                                <div class="col-md-4">
                                    <p><strong class="txt_dark">{{ number_format(count($oReviews)) }}</strong><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="white_box user_sections">
                        <div class="media-left"><img src="{{ base_url() }}assets/profile_images/user_review_icon.png"/>
                        </div>
                        <div class="media-left">
                            <h3>My reviews</h3>
                            <p>On BrandBoost, you can write reviews about companies, product or services you used and
                                purchased . </p>
                            <a href="{{ base_url() }}user/review">View all reviews <i
                                    class="icon-arrow-right13"></i></a></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="white_box user_sections">
                        <div class="media-left"><img src="{{ base_url() }}assets/profile_images/user_profile_icon.png"/>
                        </div>
                        <div class="media-left">
                            <h3>Profile</h3>
                            <p>On BrandBoost, you can write reviews about companies, product or services you used and
                                purchased . </p>
                            <a href="{{ base_url() }}user/setting">Account settings <i
                                    class="icon-arrow-right13"></i></a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="white_box user_sections">
                        <div class="media-left"><img src="{{ base_url() }}assets/profile_images/user_pw_icon.png"/>
                        </div>
                        <div class="media-left">
                ...
                <div class="col-md-6">
                    <div class="white_box user_sections">
                        <div class="media-left"><img
                                src="{{ base_url() }}assets/profile_images/user_discover_icon.png"/></div>
                        <div class="media-left">
