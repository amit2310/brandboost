        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white_box profile_sec mb20">
                    <div class="backbtn">
                        <a href="{{ base_url() }}user/profile"><img
                                src="{{ base_url() }}assets/profile_images/back_40.png"></a>
                    </div>
                    ...
                    <div class="p20">
                        ...
                        <!-- <div class="col-xs-6">
          		            <a class="pull-right txt_grey fsize12" style="cursor: pointer;"><i><img style="vertical-align: top; margin-top: 4px" src="{{ base_url() }}assets/profile_images/edit_icon.png" width="12"></i> &nbsp; Edit</a>
          	            </div> -->
                        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="nps_feedback">
                                    <li>
                                        <div class="pull-left">
                                            <div class="media-left"><img class="mt5"
                                                                         src="{{ base_url() }}assets/profile_images/{{ $sImage }}"/>
                                            </div>
                                            <div class="media-left"><p><strong>{{ $value->score }}</strong></p>
                                                <p>{{ $sStatus }}</p></div>
                                        </div>

                                        <div class="pull-right">
                                            <div class="media-left text-right pr40"><p>
                                                    <strong>{{ $value->title != ''?$value->title:'N/A' }}</strong></p>
                                                <p> {{ $value->feedback != ''?$value->feedback:'N/A' }} </p></div>
                                            <div class="media-left text-right pr30"><p>
                                                    <strong>{{ $created_at }}</strong></p>
                                                <p>{{ $created_time }}</p></div>
                                            <div class="media-left p0">
                                                <div class="tdropdown mt5"><a class="table_more dropdown-toggle"
                                                    ...
                                                    <ul style="right: 0;"
                                                        ...
                                                        <li><a href="{{ base_url() }}user/nps/reports/{{ $value->id }}"><i
