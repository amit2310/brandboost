...
<div class="content">
    ...
    <div class="page_header">
        <div class="row">
            <!--=============Headings & Tabs menu==============-->
            <div class="col-md-7">
                <h3><img style="width:17px;" src="/assets/images/menu_icons/Chat_Light.svg">&nbsp; Chat Shortcuts</h3>
        ...
        <button type="button" class="btn dark_btn ml10" data-toggle="modal" data-target="#addChatShortcutListN"><i class="icon-plus3"></i><span> &nbsp;  Add Shortcut</span> </button>
                        ...
                        <div class = "panel-heading"> <span class = "pull-left">
                            ...
                            <div class="heading-elements">
                                <div style="display: inline-block; margin: 0;" class="form-group has-feedback has-feedback-left">
                                    <input class="form-control input-sm cus_search" tableID="chatShortcut" placeholder="Search by name" type="text">
                                ...
                                <div class="table_action_tool">
                                    ...
                                    <a href="javascript:void();" style="display: none;" id="deleteChatShortcut" class="custom_action_box"><i class="icon-trash position-left"></i></a>
                                </div>
                            ...
                            <table class="table datatable-basic-new" id="chatShortcut">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class=""><img src="<?php echo base_url(); ?>assets/images/icon_click_10.png"></i>Name</th>
                                        <th><i class=""><img src="<?php echo base_url(); ?>assets/images/icon_star_10.png"></i>Conversatation</th>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($getChatShortcut)) {
                                        ...
                                        foreach ($getChatShortcut as $cShortcut) {
                                            ...
                                            ?>
                                            <tr>
                                                <td style="display: none;"><?php echo date('m/d/Y', strtotime($cShortcut->created)); ?></td>
                                                <td style="display: none;"><?php echo $cShortcut->id; ?></td>
                                                <td style="width: 40px!important; display: none;" class="editAction"><label class="custmo_checkbox pull-left"><input type="checkbox" name="checkRows[]" class="checkRows" id="chk<?php echo $cShortcut->id; ?>" value="<?php echo $cShortcut->id; ?>" ><span class="custmo_checkmark"></span></label></td>

                                                <td><div class="media-left">
              <div><a href="javascript:void(0);" class="text-default text-semibold"><?php echo $cShortcut->name;?></a></div>
            </div></td>
                                                <td> <div class="text-muted"><?php echo setStringLimit($cShortcut->conversatation, 111);?></div></td>
                                                

                                                <td>
         <div class="media-left">
          <div class="pt-5"><a href="#" class="text-muted"><?php echo dataFormat($cShortcut->created).' '.date('h:iA', strtotime($cShortcut->created)); ?></a></div>
        </div>
    </td>
    ...
    <td class="text-right">
        <div class="media-left pt-5 pull-right">
          <div class="tdropdown ml10"> <a class="table_more dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url(); ?>assets/images/more.svg"></a>
            <ul style="right: 0;" class="dropdown-menu dropdown-menu-right status">
              ...
              <?php
                if ($canWrite) {
                    echo '<li><a href="javascript:void(0);" class="editChatShortcut" shortcutid="' . $cShortcut->id . '"><i class="icon-pencil"></i> Edit</a></li>';
                    echo '<li><a href="javascript:void(0);" class="deleteChatShortcut" shortcutid="' . $cShortcut->id . '" ><i class="icon-trash"></i> Delete</a></li>';
                }
              ?>
            </ul>
          </div>
        ...
        <div class="media-left pull-right">
            <div class="pt-5"><a href="javascript:void(0);" class="text-semibold txt_dark"><?php
                                                            if ($cShortcut->status == 0) {
                                                                echo 'Inactive';
                                                            } else if ($cShortcut->status == 2) {
                                                                echo 'Pending';
                                                            } else {
                                                                echo 'Active';
                                                            } ?> &nbsp;<i class="fa fa-circle txt_green" style="font-size: 7px;"></i></a></div>
        </div>
    </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div style="margin: 20px 0px 0;" class="text-center">
                                                    <h5 class="mb-20 mt40">
                                                        Looks Like You Don’t Have Any Chat Shortcut Yet <img src="<?php echo site_url('assets/images/smiley.png'); ?>"> <br>
                                                        Lets Create Your First Chat Shortcut.
                                                    </h5>

                                                    <?php if ($canWrite): ?>
                                                        <button <?php if ($bActiveSubsription == false) { ?> title="No Active Subscription" class="btn bl_cust_btn btn-default dark_btn ml20 pDisplayNoActiveSubscription mb40" <?php } else { ?> id="addChatshortcut" class="btn bl_cust_btn btn-default dark_btn ml20 mb40" <?php } ?> type="button" ><i class="icon-plus3"></i> Add Shortcut</button>
                                                    <?php endif; ?>
    ...
    <div class="modal-content">
      <form method="post" class="form-horizontal" id="frmShortListModalN">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="">
                  <input placeholder="!shortname" name="shortname" id="shortname" class="form-control h52" type="text" required>
                </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb0">
                ...
                <div class="">
                  <textarea class="form-control p20" name="conversatation" style="resize: none; min-height: 130px;" id="conversatation" required></textarea>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer">
          ...
          <button data-dismiss="modal" class="close" data-dismiss="modal" class="close btn btn-link fsize14 txt_blue h52">Cancel</button>
        </div>
      </form>
    </div>
  </div>
    ...
    <div class="modal-content">
      <form method="post" class="form-horizontal" id="frmUpdateShortListModal">
        ...
        <div class="modal-header">
          ...
          <p class="fsize12 txt_grey mt10 mb10" style="max-width: 370px;">Update shortcut. Give it a ! symbol, and write a message for this shortcut. Then, use conversations to quickly answer 
            to visitors using the shortcut ! symbol. </p>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label class="control-label">Shortcut</label>
                <div class="">
                  <input placeholder="!shortname" name="edit_shortname" id="edit_shortname" class="form-control h52" type="text">
                </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb0">
                <label class="control-label">Conversatation</label>
                <div class="">
                  <textarea class="form-control p20" name="edit_conversatation" style="resize: none; min-height: 130px;" id="edit_conversatation"></textarea>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn dark_btn bkg_sblue fsize14 h52"><i class="icon-plus3"></i> &nbsp;  Update Shortcut</button>
          <button type="button" class="close" data-dismiss="modal" class="btn btn-link fsize14 txt_blue h52">Cancel</button>
        </div>
      </form>
    </div>
  </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#deleteChatShortcut', function () {
            ...
            if (val.length === 0) {
                ...
                function() {
                    ...
                    $('.overlaynew').show();
                    $.ajax({
                        url: "<?php echo base_url('admin/chatshortcut/deleteMultipalChatShortcut'); ?>",
                        type: "POST",
        ...
        $("#frmUpdateShortListModal").submit(function () {
            ...
            $.ajax({
                url: '<?php echo base_url('admin/chatshortcut/updateShortCut'); ?>',
                type: "POST",
                data: formdata,
                dataType: "json",
                success: function (data) {
        ...
        $(document).on('click', '.editChatShortcut', function () {
            ...
            $.ajax({
                url: '<?php echo base_url('admin/chatshortcut/getChatShortcutById'); ?>',
                type: "POST",
        ...
        $(document).on('click', '.deleteChatShortcut', function () {
            ...
            function() {   
                ...
                $('.overlaynew').show();
                $.ajax({
                    url: "<?php echo base_url('admin/chatshortcut/deleteChatShortcut'); ?>",
                    type: "POST",
                    data: {shortcutId: shortcutId,_token: '{{csrf_token()}}'},
                    dataType: "json",
                    success: function (data) {
