        ...
        <td>
            <div class="white_box template_preview sms">
                <label class="custmo_checkbox">
                    <input type="radio" class="continueChooseSMSTemplateButton" template_id="{{ $oTemplate->id }}"
                ...
                <label for="templateID_{{ $oTemplate->id }}" class="m0">
                        ...
                        <div class="temp_more_opt"><a class="table_more dropdown-toggle" data-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu dropdown-menu-right more_act"
                                ...
                                <li><a href="javascript:void(0);" template_id="{{ $oTemplate->id }}"
                                       class="cloneTemplate"
                                       template_type="sms"><i class="icon-copy"></i> Clone</a></li>
                                <li><a href="javascript:void(0);" template_id="{{ $oTemplate->id }}"
                                       class="previewSMSTemplate" source="{{ $source }}"><i
                    ...
                    <a class="sms_preview_button previewSMSTemplate small" href="javascript:void(0);"
