        ...
        <div class="col-md-2" style="max-width: 187px!important;">
            <div class="white_box p25 mb20 pt-15 pb-15">
                <ul class="select_template">
                    ...
                    <li><a class="displaySMSTemplates" selected_template="" action="my" href="javascript:void(0);">My
                            Templates</a></li>
                    <hr>
                        ...
                        @foreach ($oCategories as $oCategory)
                            @if ($oCategory->status == '2')
                                ...
                                @if ($moduleName == 'brandboost' && $brandboostData->review_type == 'onsite' && $oCategory->module_name == 'onsite')
                                    <li><a class="displaySMSTemplates" selected_template="" action="category"
                                        ...
                                        <div class="white_box template_preview sms">
                                            <label class="custmo_checkbox">
                                                <input type="radio" class="continueChooseSMSTemplateButton"
                                                       template_id="{{ $oTemplate->id }}" source="{{ $source }}"
                                                       name="selectedTemplate" value="{{ $oTemplate->id }}"
                                            ...
                                            <label for="templateID_{{ $oTemplate->id }}" class="m0">
                                                ...
                                                <div
                                                    ...
                                                    @if (!empty($oTemplate->thumbnail))
                                                        <img style="height:auto!important;min-height:155px!important;"
                                                ...
                                                <a class="sms_preview_button previewSMSTemplate small"
                                                   ...
                                                   template_id="{{ $oTemplate->id }}" source="{{ $source }}"><i
                                                        class="icon-eye8"></i></a>
