...
<div class="content">
    ...
    <div class="page_header">
        <div class="row">
            ...
            <div class="col-md-9 text-right btn_area">
                <a href="{{ base_url() }}admin/templates/{{ $templateType }}" class="btn dark_btn ml10" style="padding-top:10px!important;"><i class="icon-indent-decrease2"></i><span> &nbsp;  All Template</span> </a>  
                <button type="button" class="btn dark_btn dropdown-toggle ml10 saveUserTemplate" template-type="{{ $templateType }}"><i class="icon-plus3"></i><span> &nbsp;  Save Template</span> </button>
            </div>
        </div>
    </div>
    <!--&&&&&&&&&&&& PAGE HEADER END &&&&&&&&&&-->
    ...
    @if ($templateType == 'email')
        <div class="tab-content">
            ...
            <iframe src="{{ base_url() }}admin/templates/loadEmailTemplate/{{ $templateID }}" id="userTemplateEditArea" width="100%" height="1800" scrolling="no" style="border:none !important;overflow:hidden;display:none;"></iframe>
    ...
    @if ($templateType == 'sms')
        <div class="tab-content"> 
            ...
            <iframe src="{{ base_url() }}admin/templates/loadSMSTemplate/{{ $templateID }}" id="userTemplateEditArea" width="100%" height="1800" scrolling="no" style="border:none !important;overflow:hidden;display:none;"></iframe>
        </div>
    @endif
</div>
...
<div id="wfSendTestEmail" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h5 class="modal-title"><img src="{{ base_url() }}assets/css/menu_icons/Email_Color.svg"/> &nbsp;Send Test Email <i class="icon-info22 fsize12 txt_grey"></i></h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
<div id="wfSendTestSMS" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h5 class="modal-title"><img src="{{ base_url() }}assets/css/menu_icons/Sms_Color.svg"/> &nbsp;Send Test SMS <i class="icon-info22 fsize12 txt_grey"></i></h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="wfTextPopupSendTestSMS" placeholder="Phone Number" type="text" value="{{ $oUser->mobile }}" required>							
                        </div>
                    </div>
                </div>
            </div>
...
<div id="emaileditorinfo" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h5 class="modal-title"><img src="{{ base_url() }}assets/css/menu_icons/Email_Color.svg"/> &nbsp;How to use this editor <i class="icon-info22 fsize12 txt_grey"></i></h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
<div id="smseditorinfo" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h5 class="modal-title"><img src="{{ base_url() }}assets/css/menu_icons/Sms_Color.svg"/> &nbsp;How to use this sms editor <i class="icon-info22 fsize12 txt_grey"></i></h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 'success') {
                        displayMessagePopup('success', 'Success', 'Test email sent successfully');
