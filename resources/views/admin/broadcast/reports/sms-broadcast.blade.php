...
@section('contents')
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p0 pb10 min_h270">
                                <div class="semi_circle_smiley"><img
                                        src="{{ base_url() }}assets/images/icon_sms_44.png"/></div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p0 pb10 min_h270">
                                <div class="semi_circle_smiley"><img
                                        src="{{ base_url() }}assets/images/click_green.png"/></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a class="icons br5" href="#"><img
                                                        src="{{ base_url() }}assets/images/icon_sms_24.png"
                                                        class="img-circle img-xs br5" alt=""></a>
                                            </div>
                                        ...
                                        <td class="text-center"><span
                                                class="{{ ($oCampaignStats['variationData']->id == $sentWinner && $sendingMethod == 'split') ? 'txt_green' : 'txt_dgrey' }}">{{ $totalSent }}</span>
                                        </td>
                                        <td class=" text-center"><span
                                                class="{{ ($oCampaignStats['variationData']->id == $deliverWinner && $sendingMethod == 'split') ? 'txt_green' : 'txt_dgrey' }}">{{ $totalDelivered }}</span>
                                        </td>
                                        <td class=" text-center"><span
                                                class="txt_dgrey">{{ $totalQueue }}</span></td>
                                        <td class="text-center"><span class="txt_dgrey">{{ $totalUnDelivered }}</span>
                                        </td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var title2 = {
                text: '{{ $grandDelivered }} <br> <span style="border: none;" class="label bkg_green ml0 ">{{ $grandDeliveredRate }}%</span>',
                align: 'center',
                verticalAlign: 'middle',
                y: 50
            };
            ...
            var title3 = {
                text: '{{ $grandQueued }} <br> <span style="border: none;" class="label bkg_green ml0 ">{{ $grandQueuedRate }}%</span>',
                align: 'center',
                verticalAlign: 'middle',
                y: 50
            };
            ...
            var title4 = {
                text: '{{ $grandUndelivered }} <br> <span style="border: none;" class="label bkg_green ml0 ">{{ $grandUndeliveredRate }}%</span>',
                align: 'center',
                verticalAlign: 'middle',
                y: 50
            };
            ...
            var series2 = [{
                ...
                innerSize: '85%',
                data: [
                    ['Delivered', {{ $grandDeliveredRate }}],
                    ['Not Delivered', {{ (100 - ($grandDeliveredRate)) }}],
            ...
            var series3 = [{
                ...
                innerSize: '85%',
                data: [
                    ['{series.name}', {{ $grandQueuedRate }}],
                    ['Not Queued', {{ (100 - ($grandQueuedRate)) }}],
            ...
            var series4 = [{
                ...
                innerSize: '85%',
                data: [
                    ['Undelivered', {{ $grandUndeliveredRate }}],
                    ['Non Undelivered', {{ (100 - ($grandUndeliveredRate)) }}],
