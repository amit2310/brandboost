...
@section('contents')
        ...
        <div class="page_header">
            <div class="row">
                ...
                <div class="col-md-7 mt20">
                    <h3><img style="width: 16px;" src="{{ base_url() }}assets/images/analysis_icon.png"> Broadcast
                        Report</h3>
                </div>
                ...
                <div class="col-md-5 text-right btn_area">
                    <div class="btn-group">
                        <button type="button" class="btn light_btn btn-icon dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-calendar2"></i>&nbsp; &nbsp; Filter reports &nbsp; &nbsp; <span
                                class="caret"></span>
                        </button>
        ...
        @php
            if (!empty($aBroadcastStats)) {
                ...
                foreach ($aBroadcastStats as $oCampaignStats) {
                    ...
                    if ($open > $iOpenMax) {
                        $iOpenMax = $open;
                        $openWinner = isset($oCampaignStats['variationData']) ? $oCampaignStats['variationData']->id : '';
                    }

                    if ($click > $iClickMax) {
                        $iClickMax = $click;
                        $clickWinner = isset($oCampaignStats['variationData']) ? $oCampaignStats['variationData']->id : '';
                    }

                    if ($delivered > $iDeliveredMax) {
                        $iDeliveredMax = $delivered;
                        $deliverWinner = isset($oCampaignStats['variationData']) ? $oCampaignStats['variationData']->id : '';
                    }
            ...
            <div class="tab-pane active" id="right-icon-tab0">
                <div class="row">
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p0 pb10 min_h270">
                                <div class="semi_circle_smiley"><img src="{{ base_url() }}assets/images/msg_icon.png"/>
                                </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p0 pb10 min_h270">
                                <div class="semi_circle_smiley"><img src="{{ base_url() }}assets/images/curser.png"/>
                                </div>
                                <div id="semi_circle_chart2" class="br5 bkg_gradient"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p0 pb10 min_h270">
                                ...
                                <div id="semi_circle_chart3" class="br5 bkg_gradient"
                                     style="width: 100%; height: 240px;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p0 pb10 min_h270">
                                ...
                                <div id="semi_circle_chart4" class="br5 bkg_gradient"
                                     style="width: 100%; height: 240px;"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h6 class="panel-title">{{ ($sendingMethod == 'split') ? 'All Variations' : 'Detailed Report' }}</h6>
                            ...
                            <div class="panel-body p0">
                                <table class="table datatable-basic">
                                    ...
                                    <tr>
                                        <th>
                                            <i class="icon-calendar"></i>{{ ($sendingMethod == 'split') ? 'Campaign/Variation Name' : 'Campaign Name' }}
                                        </th>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="media-left">
                                                <div class="pt-5"><a href="#"
                                                                     class="text-default txt_dgrey text-semibold">
                                                        @if ($sendingMethod == 'split')
                                                            {{ ($oCampaignStats['variationData']->variation_name) ? $oCampaignStats['variationData']->variation_name : 'Variation ' . $aSequence[$i] }}
                                                        @else
                                                            {{ ($oBroadcast->title) ? $oBroadcast->title : 'Unnamed Campaign' }}
                                                        @endif
                                        ...
                                        @if ($sendingMethod == 'split')
                                            <td class="text-center"><span class="txt_dgrey">{{ $oCampaignStats['variationData']->split_load }}%</span>
                                            </td>
                                        @endif
                                        <td class="text-center"><span class="txt_dgrey">{{ $totalSent }}</span></td>
                                        <td class="text-center"><span
                                                class="{{ @($oCampaignStats['variationData']->id == $deliverWinner && $sendingMethod == 'split') ? 'txt_green' : 'txt_dgrey' }}">{{ $totalDelivered }}</span>
                                        </td>
                                        <td class="text-center"><span
                                                class="{{ @($oCampaignStats['variationData']->id == $openWinner && $sendingMethod == 'split') ? 'txt_green' : 'txt_dgrey' }}">{{ $totalOpen }}</span>
                                        </td>
                                        <td class="text-center"><span
                                                class="{{ @($oCampaignStats['variationData']->id == $clickWinner && $sendingMethod == 'split') ? 'txt_green' : 'txt_dgrey' }}">{{ $totalClick }}</span>
                                        </td>


                                        <td class="text-center"><span class="txt_dgrey">{{ $totalBounce }}</span></td>
                                        <td class="text-center"><span class="txt_dgrey">{{ $totalFailed }}</span></td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var title = {
                text: '{{ $grandSent }} <br> <span style="border: none;" class="label bkg_green ml0 ">100%</span>',
                align: 'center',
            ...
            var title2 = {
                text: '{{ $grandDelivered }} <br> <span style="border: none;" class="label bkg_green ml0 ">{{ $grandDeliveryRate }}%</span>',
                align: 'center',
                verticalAlign: 'middle',
                y: 50
            };
            ...
            var title3 = {
                text: '{{ $grandOpen }} <br> <span style="border: none;" class="label bkg_green ml0 ">{{ $grandOpenRate }}%</span>',
                align: 'center',
                verticalAlign: 'middle',
                y: 50
            };
            ...
            var title4 = {
                text: '{{ $grandClick }} <br> <span style="border: none;" class="label bkg_green ml0 ">{{ $grandClickRate }}%</span>',
                align: 'center',
                verticalAlign: 'middle',
                y: 50
            };
            ...
            var series2 = [{
                ...
                innerSize: '85%',
                data: [
                    ['Delivered', {{ $grandDeliveryRate }}],
                    ['Not Delivered', {{ (100 - ($grandDeliveryRate)) }}],
            ...
            var series3 = [{
                ...
                innerSize: '85%',
                data: [
                    ['Opened', {{ $grandOpenRate }}],
                    ['Not Opened', {{ (100 - ($grandOpenRate)) }}],
            ...
            var series4 = [{
                ...
                innerSize: '85%',
                data: [
                    ['Clicked', {{ $grandClickRate }}],
                    ['Not Clicked', {{ (100 - ($grandClickRate)) }}],
