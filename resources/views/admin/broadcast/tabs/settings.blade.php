...
<style>
    ...
    .interactions ul li small {
        color: #09204f;
    }

    .email_sec.small .form-group {
        margin-bottom: 28px;
    }

    .pickadate.bkg_white {
        background: url({{ base_url() }}assets/images/icon_calender3_blue.png) 95% 16px no-repeat #fff !important
    }
    ...
    .picker__month, .picker__year {
        ...
        color: #425784 !important;
        font-weight: 400 !important;
    }

    .picker__holder {
        border-radius: 4px !important;
        box-shadow: 0 3px 5px 0 rgba(1, 21, 64, 0.04), 0 10px 20px 0 rgba(1, 21, 64, 0.02) !important;
        border: solid 1px #ebeff6 !important;
        padding-top: 0px;
    }
...
<script src="{{ base_url() }}assets/js/plugins/pickers/anytime.min.js"></script>
<style>
    ul {
...
<div id="broadcastConfiguration" class="broadcastTab"
        ...
        <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb0">
                                    ...
                                    <input class="form-control h52 updatesettings" type="text" id="edit_campaign_name"
                                           name="title" value="{{ $oBroadcast->title }}" placeholder="Test broadcast"
                                           required="required">
                                </div>
                            </div>
                        </div>
                            ...
                            @if (strtolower($oBroadcast->campaign_type) != 'sms')
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Subject</label>
                                        <input class="form-control h52 updatesettings" type="text"
                                               value="{{ $oBroadcast->subject }}" name="subject" id="email_subject"
                                               placeholder="Email Broadcast Subject">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control h52 updatesettings" type="text"
                                               value="{{ $oBroadcast->from_name == '' ? $userData->firstname . ' ' . $userData->lastname : $oBroadcast->from_name }}"
                                               name="from_name" id="from_name" placeholder="Mr Anderson">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control h52 updatesettings" type="text"
                                               value="{{ $oBroadcast->from_email == '' ? $userData->email : $oBroadcast->from_email }}"
                                               name="from_email" id="from_email" placeholder="umair@nethues.com">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb0">
                                        ...
                                        <input class="form-control h52 updatesettings" type="text"
                                               value="{{ $oBroadcast->reply_to == '' ? $userData->email : $oBroadcast->reply_to }}"
                                               name="reply_to" id="reply_to_email" placeholder="umair@nethues.com">
                                    </div>
                                </div>
                            ...
                            @else
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control h52 updatesettings" type="text" readonly="readonly"
                                               value="{{ $twillioData->contact_no }}" name="from_number"
                                               id="from_number" placeholder="Broadcast From Number">
                                    </div>
                                </div>
                            @endif
                        </div>
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body p0 bkg_white">
                    ...
                    <div class="bbot p30" id="spt_container"
                         @if ($oBroadcast->sending_method == 'normal')
                         style="display:none;"
                        @endif>
                        <div class="row">
                            <div class="form-group">
                                <label>Test Name</label>
                                <input class="form-control h52 updateSplitTest" st_id="{{ $oVariations[0]->splitID }}"
                                       type="text" value="{{ $oVariations[0]->test_name }}" name="test_name"
                                       placeholder="Split test demo">
                            </div>
                        </div>
                        ...
                        <div class="interactions configurations">
                            <ul>
                                @if (strtolower($oBroadcast->campaign_type) == 'email')
                                    <li><small class="wauto">Generate a text version of the email</small>
                                        <label class="custom-form-switch pull-right">
                                            <input class="field checkedBoxValue updatesettings"
                                                   value="{{ $broadcastSettings->text_version_email != '0' ? '1' : '0' }}"
                                                   {{ $broadcastSettings->text_version_email != '0' ? 'checked' : '' }} name="text_version_email"
                                                   id="textVersionEmail" type="checkbox">
                                            <span class="toggle {{ $colorClass }}"></span>
                                        </label>
                                    </li>
                                    <li><small class="wauto">Enable Mobile Responsiveness</small>
                                        <label class="custom-form-switch pull-right">
                                            <input class="field checkedBoxValue updatesettings"
                                                   value="{{ $broadcastSettings->enable_mobile_responsiveness != '0' ? '1' : '0' }}"
                                                   {{ $broadcastSettings->enable_mobile_responsiveness != '0' ? 'checked' : '' }} id="enableMobileResponsiveness"
                                                   name="enable_mobile_responsiveness" type="checkbox">
                                            <span class="toggle {{ $colorClass }}"></span>
                                        </label>
                                    </li>
                                    ...
                                    <li><small class="wauto">Open/Read Tracking</small>
                                        <label class="custom-form-switch pull-right">
                                            <input class="field checkedBoxValue updatesettings"
                                                   value="{{ $broadcastSettings->read_tracking != '0' ? '1' : '0' }}"
                                                   {{ $broadcastSettings->read_tracking != '0' ? 'checked' : '' }} name="read_tracking"
                                                   id="readTracking" type="checkbox">
                                            <span class="toggle {{ $colorClass }}"></span>
                                        </label>
                                    </li>
                                @endif
                                <li><small class="wauto">Link Tracking</small>
                                    <label class="custom-form-switch pull-right">
                                        <input class="field checkedBoxValue updatesettings"
                                               value="{{ $broadcastSettings->link_tracking != '0' ? '1' : '0' }}"
                                               {{ $broadcastSettings->link_tracking != '0' ? 'checked' : '' }} name="link_tracking"
                                               id="linkTracking" type="checkbox">
                                        <span class="toggle {{ $colorClass }}"></span>
                                    </label>
                                </li>
                                @if (strtolower($oBroadcast->campaign_type) == 'email')
                                    <li><small class="wauto">Reply Tracking</small>
                                        <label class="custom-form-switch pull-right">
                                            <input class="field checkedBoxValue updatesettings"
                                                   value="{{ $broadcastSettings->reply_tracking != '0' ? '1' : '0' }}"
                                                   {{ $broadcastSettings->reply_tracking != '0' ? 'checked' : '' }} name="reply_tracking"
                                                   id="replyTracking" type="checkbox" disabled="disabled">
                                            <span class="toggle {{ $colorClass }}"></span>
                                        </label>
                                    </li>
                                @endif
                                <li><small class="wauto">Google Analytics</small>
                                    <label class="custom-form-switch pull-right">
                                        <input class="field checkedBoxValue updatesettings"
                                               value="{{ $broadcastSettings->google_analytics != '0' ? '1' : '0' }}"
                                               {{ $broadcastSettings->google_analytics != '0' ? 'checked' : '' }} name="google_analytics"
                                               id="googleAnalytics" type="checkbox" disabled="disabled">
                                        <span class="toggle {{ $colorClass }}"></span>
                                    </label>
                                </li>
                                <li><small class="wauto">Campaign Archives</small>
                                    <label class="custom-form-switch pull-right">
                                        <input class="field checkedBoxValue updatesettings"
                                               value="{{ $broadcastSettings->campaign_archives != '0' ? '1' : '0' }}"
                                               {{ $broadcastSettings->campaign_archives != '0' ? 'checked' : '' }} id="campaignArchives"
                                               name="campaign_archives" type="checkbox" disabled="disabled">
                                        <span class="toggle {{ $colorClass }}"></span>
                                    </label>
                                </li>
                ...
                <div class="panel-body p0 bkg_white">
                    <div class="bbot p20 pl30 pr30">
                        <div class="position-relative">
                            Date: <input type="text" name="delivery_date"
                                         value="{{ (!empty($deliveryDate)) ? $deliveryDate : date("m/d/Y") }}"
                                         class="form-control h52 pickadate bkg_white updateSchedule"
                                         placeholder="Send now"
                                         data-value="{{ (!empty($deliveryDate)) ? $deliveryDate : date("m/d/Y") }}">
                    ...
                    <div class="bbot p20 pl30 pr30">
                        ...
                        <div class="form-group">
                            <label class="custmo_checkbox">
                                <input type="radio" name="chooseTimeBroadcast" class="form-control chooseTimeBroadcast"
                                       value="now">
                        ...
                        <div class="position-relative displayanytimePicker">
                            <input type="text" id="anytime-time" name="delivery_time"
                                   value="{{ (!empty($deliveryTime)) ? $deliveryTime : '9 PM' }}"
                                   class="form-control h52 bkg_white selecttime updateSchedule" placeholder="9 PM">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).on("change", ".updatesettings", function () {
        ...
        $('.overlaynew').show();
        $.ajax({
            url: "{{ base_url('admin/broadcast/updateBroadcastSettingUnit') }}",
            type: "POST",
            data: {
                _token: '{{csrf_token()}}',
                fieldName: fieldName,
                fieldVal: fieldVal,
                'event_id': '{{ $oBroadcast->event_id }}',
                'campaign_id': '{{ $oBroadcast->id }}',
                broadcast_id: '{{ $oBroadcast->broadcast_id }}'
            },
            dataType: "json",
    ...
    $(document).on("click", ".btnDeleteVariation", function () {
        ...
        deleteConfirmationPopup("This variation will deleted immediately.<br>You can't undo this action.",
            () => {
                ...
                $('.overlaynew').show();
                $.ajax({
                    url: "{{ base_url('admin/broadcast/deleteVariation') }}",
                    type: "POST",
    ...
    $(document).on("change", ".updateSplitTest", function () {
        ...
        var fieldVal = $(this).val();
        $.ajax({
            url: "{{ base_url('admin/broadcast/updateSplitTest') }}",
            type: "POST",
    ...
    $(document).on("change", ".updateVariation", function () {
        ...
        $.ajax({
            url: "{{ base_url('admin/broadcast/updateVariation') }}",
            type: "POST",
    ...
    $(document).on("click", "#btnAddMoreVariations", function () {
        ...
        if (bPreviousValidated == true) {
            ...
            var campaign_type = "{{ strtolower($oBroadcast->campaign_type) }}";
            $.ajax({
                url: "{{ base_url('admin/broadcast/addVariation') }}",
                type: "POST",
    ...
    $(document).on("change", ".updateSchedule", function () {
        ...
        $.ajax({
            url: "{{ base_url('admin/broadcast/updateBroadcastSettings') }}",
            type: "POST",
            data: {
                _token: '{{csrf_token()}}',
                'event_id': '{{ $oBroadcast->event_id }}',
