...
@endphp
<div id="broadcastTargetAudience" class="broadcastTab"
     @if ($activeTab != 'Select List')
     style="display:none;"
    @endif>
    <div style="width: 100%; max-width: 1100px; margin: 0 auto;
    @if (!empty($activeTab) || !empty($oBroadcast->audience_type))
        display:none;
    @endif" id="audienceSelectionContainer">
        <div class="row">
                ...
                <label for="temp1" class="m0">
                    <div class="broadcast_select_contact">
                        <label class="custmo_checkbox">
                            <input type="radio" id="temp1" value="lists" class="choose_audience" name="audience_type"
                        ...
                        <div class="img_box">
                            <img src="{{ base_url() }}assets/images/contact_list_act.png"/>
                        </div>
                        <p class="fsize14 txt_dark fw500">Contact List</p>
                        <p class="fsize12 txt_grey fw300">Select one or more of the pre-prepared contact lists. You can
                            create a new list of contacts in the “People” module.</p>
                    </div>
                </label>
            </div>
            <div class="col-md-4 text-center">
                <label for="temp2" class="m0">
                    <div class="broadcast_select_contact">
                        <label class="custmo_checkbox">
                            <input type="radio" id="temp2" value="tags" class="choose_audience" name="audience_type"
                        ...
                        <div class="img_box">
                            <img src="{{ base_url() }}assets/images/tags_grey.png"/>
                        </div>
            ...
            <div class="col-md-4 text-center">
                <label for="temp3" class="m0">
                    <div class="broadcast_select_contact">
                        <label class="custmo_checkbox">
                            <input type="radio" id="temp3" value="contacts" class="choose_audience" name="audience_type"
                                   @if ($oBroadcast->audience_type == 'contacts')
                                   checked="checked"
                                @endif
                            >
                            <span class="custmo_checkmark blue_tr"></span>
                        ...
                        <div class="img_box">
                            <img src="{{ base_url() }}assets/images/contact_list2_inactive.png"/>
                        </div>
                        <p class="fsize14 txt_dark fw500">Contacts</p>
                        <p class="fsize12 txt_grey fw300">Choose from all available contacts. The list of contacts will
                            be created automatically based on this broadcast.</p>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="modal-content">
            <form method="post" id="frmeditlistModel" name="frmeditlistModel">
                ...
                <div class="modal-body" style="padding-bottom:0px;">
                    <p>List Title:</p>
                    <input class="form-control" id="edit_title" name="title" placeholder="Enter List Name" type="text"
                           required><br>
        ...
        <div class="modal-content">
            <form method="post" name="frmaddListModal" id="frmaddListModal" action="javascript:void();">
                ...
                <div class="modal-body">
                    <p>List Name:</p>
                    <input class="form-control" id="title" name="title" placeholder="Enter List Name" type="text"
                           required><br>
        ...
        <div class="modal-content">
            <form method="post" class="form-horizontal" id="addSubscriberData" action="javascript:void();">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="updateButton" class="btn btn-primary"><i class="icon-check"></i> Add
                    </button>
                </div>
            </form>
        </div>
...
<div id="importCSV" class="modal modalpopup fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" class="form-horizontal" action="{{ base_url() }}admin/lists/importListCSV"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".choose_audience").change(function () {
            ...
            $('.overlaynew').show();
            $.ajax({
                url: "{{ base_url('admin/broadcast/updateBroadcastData') }}",
                type: "POST",
                data: {
                    _token: '{{csrf_token()}}',
        ...
        $(document).on('click', '.syncContacts', function () {
            ...
            $('.overlaynew').show();
            $.ajax({
                url: "{{ base_url('admin/broadcast/syncSegment') }}",
                type: "POST",
        ...
        $("#addSubscriberData").submit(function () {
            ...
            $.ajax({
                url: "{{ base_url('admin/lists/addListSusbscriber') }}",
                type: "POST",
                data: formData,
                contentType: false,
                cache: false,
