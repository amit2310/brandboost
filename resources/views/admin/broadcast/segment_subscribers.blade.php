                                ...
                                <tbody>
                                    ...
                                    <tr id="append-{{ $oContact->id }}" class="selectedClass">
                                        ...
                                        <td>
                                            ...
                                            <div class="media-left">
                                                <div class="pt-5"><a href="#" class="text-default text-semibold bbot"><span>@php if(empty($oContact->firstname) && empty($oContact->lastname)){ echo displayNoData();}else{ echo $oContact->firstname . ' '. $oContact->lastname; } @endphp</span>
                                                        <img class="flags" src="{{ base_url() }}assets/images/flags/{{ strtolower($oContact->country_code)}}.png" onerror="this.src='{{ base_url('assets/images/flags/us.png') }}'"/></a></div>
                                        ...
                                        <td class="text-right viewContactSmartPopup" data-modulesubscriberid=" {{ $oContact->globalSubscriberId }}" data-modulename="{{ $moduleName}} "><div class="media-left pull-right">
                                                <div class="pt-5"><a href="#" class="text-default text-semibold dark">{{ $oContact->phone == '' ? displayNoData() : mobileNoFormat($oContact->phone) }}</a></div>
                                                @php echo $oContact->phone == '' ? '' : '<div class="text-muted text-size-small">Chat</div>' @endphp
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <a class="icons social" 
                                               ...
                                               @endif
                                               >
                                               <img src="{{ base_url() }}assets/images/icons/twitter.svg"/>
                                            </a> 
                                            <a class="icons social"  
                                                ...
                                                @endif
                                                >
                                                <img src="{{ base_url() }}assets/images/icons/facebook.svg"/>
                                            </a> 
                                            <a class="icons social" href="{{ $oContact->socialProfile }}"><img src="{{ base_url() }}assets/images/icons/google.svg"/></a> 
                                            <a class="icons social" href="mailto:{{ $oContact->email }}"><img src="{{ base_url() }}assets/images/icons/mail.svg"/></a>
                                            
                                        </td>

                                        <td id="tag_container_{{ $subscriberID }}">
                                            ...
                                            <div class="media-left pr30 brig">
                                                <div class="tdropdown">
                                                    ...
                                                    <ul style="right: 0px!important;" class="dropdown-menu dropdown-menu-right tagss">
                                                        ...
                                                        @endphp
                                                        <button class="btn btn-xs plus_icon ml10 applyInsightTags" data-subscriber-id="{{ $subscriberID }}"><i class="icon-plus3"></i></button>
                                                    </ul>
                                                </div>
                                            </div>
                                        </td>
        ...
        if (val.length === 0) {
            ...
            deleteConfirmationPopup(
                    ...
                    function () {
                        ...
                        $('.overlaynew').show();
                        $.ajax({
                            url: "{{ base_url('admin/broadcast/deleteMultipalSegmentUser') }}",
                            type: "POST",
