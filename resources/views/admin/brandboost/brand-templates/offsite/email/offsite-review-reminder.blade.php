                        ...
                        <tr>
                            <th style="padding:0 80px;"> <table style="margin-top: -60px;">
                                    ...
                                    <center>
                                        ...
                                        <a href="{OFFSITE_REVIEW_URL}&r=1"><img style="margin:0 20px 0 0;" src="<?php echo base_url(); ?>assets/images/emailer/star.png" title="" alt=""> </a>
                                        <a href="{OFFSITE_REVIEW_URL}&r=2"><img style="margin:0 20px 0 0;" src="<?php echo base_url(); ?>assets/images/emailer/star.png" title="" alt=""> </a>
                                        <a href="{OFFSITE_REVIEW_URL}&r=3"><img style="margin:0 20px 0 0;" src="<?php echo base_url(); ?>assets/images/emailer/star.png" title="" alt=""> </a>
                                        <a href="{OFFSITE_REVIEW_URL}&r=4"><img style="margin:0 20px 0 0;" src="<?php echo base_url(); ?>assets/images/emailer/star.png" title="" alt=""> </a> 
                                        <a href="{OFFSITE_REVIEW_URL}&r=5"><img style="margin:0 0 0 0;" src="<?php echo base_url(); ?>assets/images/emailer/star.png" title="" alt=""> </a>
                                    </center> 
                                    <center>
                                        <a href="{OFFSITE_REVIEW_URL}" title="Leave your feedback" style="margin:35px 0 0; text-decoration: none; font-family: 'Open Sans', sans-serif; background-color: #6d41f2; display: inline-block; padding:16px 20px; border-radius: 4px; font-size: 14px; color: #FFFFFF; text-align: center;"><img src="<?php echo base_url(); ?>assets/images/emailer/feedback-icon.png" style="margin-right: 8px; float: left;margin-top: 2px;">
                                            Leave your feedback
                                        </a>
                                    </center>
                            </th>
