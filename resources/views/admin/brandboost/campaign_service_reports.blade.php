			  ...
			  <div class="content">
				  ...
				  <!--&&&&&&&&&&&& PAGE HEADER &&&&&&&&&&-->
					<div class="page_header">
					  ...
					  <!--=============Headings & Tabs menu==============-->
						<div class="col-md-7">
						  <h3><img style="width: 16px;" src="<?php echo base_url(); ?>assets/images/analysis_icon.png"> Analytics Service</h3>
					 ...
					 <div class="tab-content"> 
					  ...
					  <div class="row">
						   ...
						   <div class="col-md-3">
							<div class="panel panel-flat review_ratings ratings_new">
							  ...
							  <div class="pt20 pb20 pl40 pr40 bbot">
							  	<h1><i><img src="<?php echo base_url(); ?>assets/images/smiley_green_26.png"></i> 4.2 <sup><i class="icon-arrow-up5"></i> &nbsp; +15%</sup></h1>
							  </div>
							  <div class="p40 ratings">
								<div class="row inner">
									<div class="col-xs-6">
										 <i><img src="<?php echo base_url(); ?>assets/images/smile_dgreen.png"></i> 
									</div>
								...
								<div class="row inner">
									<div class="col-xs-6">
										<i><img src="<?php echo base_url(); ?>assets/images/smile_dyellow.png"></i> 
									</div>
								...
								<div class="row inner">
									<div class="col-xs-6">
										<i><img src="<?php echo base_url(); ?>assets/images/smile_dpink.png"></i> 
									</div>
						   ...
						   <div class="col-md-3">
									...
									<div class="row">
										<div class="col-xs-12">
										<img class="graph" src="<?php echo base_url(); ?>assets/images/info_graph1.png"/>
										</div>
						  ...
						  <!------------RIGHT------------->
						   <div class="col-md-3">
									...
									<div class="row">
										<div class="col-xs-12">
										<img class="graph" src="<?php echo base_url(); ?>assets/images/info_graph2.png"/>
										</div>
...
<!--================================================-->
<tr>
  <td><div class="media-left media-middle"> <a class="icons" href="#"><img src="<?php echo base_url(); ?>assets/images/cust1.png" class="img-circle img-xs" alt=""></a> </div>
    <div class="media-left">
      <div class="pt-5"><a href="#" class="text-default text-semibold"><span>Dora Weber</span> <img class="flags" src="<?php echo base_url(); ?>assets/images/flags/ao.png"></a></div>
      <div class="text-muted text-size-small">carlo.johnston@yahoo.com</div>
    </div></td>
  <td><div class="media-left media-middle"> <a class="icons" href="#"><img src="<?php echo base_url(); ?>assets/images/smiley_green.png" class="img-circle img-xs" alt=""></a> </div>
    <div class="media-left">
  ...
  <!--================================================-->
<tr>
  <td><div class="media-left media-middle"> <a class="icons" href="#"><img src="<?php echo base_url(); ?>assets/images/cust2.png" class="img-circle img-xs" alt=""></a> </div>
    <div class="media-left">
      <div class="pt-5"><a href="#" class="text-default text-semibold"><span>Della Delgado</span> <img class="flags" src="<?php echo base_url(); ?>assets/images/flags/us.png"></a></div>
  ...
  <td><div class="media-left">
    ...
    <!--================================================-->
<tr>
  <td><div class="media-left media-middle"> <a class="icons" href="#"><img src="<?php echo base_url(); ?>assets/images/cust3.png" class="img-circle img-xs" alt=""></a> </div>
    <div class="media-left">
      <div class="pt-5"><a href="#" class="text-default text-semibold"><span>Ethel Powers</span> <img class="flags" src="<?php echo base_url(); ?>assets/images/flags/us.png"></a></div>
      <div class="text-muted text-size-small">carlo.johnston@yahoo.com</div>
    </div></td>
  <td><div class="media-left media-middle"> <a class="icons" href="#"><img src="<?php echo base_url(); ?>assets/images/smiley_green.png" class="img-circle img-xs" alt=""></a> </div>
    <div class="media-left">
...
<tr>
  ...
  <td><div class="media-left media-middle"> <a class="icons" href="#"><img src="<?php echo base_url(); ?>assets/images/smiley_red.png" class="img-circle img-xs" alt=""></a> </div>
    <div class="media-left">
      <div class="pt-5"><a href="#" class="text-default text-semibold"><span>4.3</span> </a></div>
      <div class="text-muted text-size-small">Positive</div>
    </div></td>
