                                            ...
                                            <tr id="append-{{ $data->id }}" class="selectedClass">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="media-left">
                                                        ...
                                                        <div class="text-muted text-size-small">{{ setStringLimit($data->brand_desc) }}</div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="media-left">
                                                        <div class=""><a href="#" class="text-default text-semibold">{{ date('d M Y', strtotime($data->created)) }}</a>
                                                        </div>
                                                        <div class="text-muted text-size-small">{{ date('h:iA', strtotime($data->created)) }}</div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div data-toggle="tooltip" title="Total Requests {{ $getResCount }}" data-placement="top" class="progress">
                                                        <div class="progress-bar progress-bar-violet" role="progressbar" aria-valuenow="100" aria-valuemin="100" aria-valuemax="100" style="width:{{ $totalGraph }}%"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a style='cursor:pointer;' class="text-default text-semibold">{{ $positiveRating }}</a>
                                                    <div data-toggle="tooltip" title="{{ $positiveRating }} out of {{ $getResCount }} Responses" data-placement="top" class="progress">
                                                        <div class="progress-bar progress-bar-green2" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:{{ $positiveGraph }}%"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a style='cursor:pointer;' class="text-default text-semibold">{{ $neturalRating }}</a>
                                                    <div data-toggle="tooltip" title="{{ $neturalRating }} out of {{ $getResCount }} Response" data-placement="top" class="progress">
                                                        <div class="progress-bar progress-bar-black" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:{{ $neturalGraph }}%"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a style='cursor:pointer;' class="text-default text-semibold">{{ $negativeRating }}</a>
                                                    <div data-toggle="tooltip" title="{{ $negativeRating }} out of {{ $getResCount }} Response" data-placement="top" class="progress">
                                                        <div class="progress-bar progress-bar-red" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:{{ $negativeGraph }}%"></div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                        <div class="media-left media-middle"> <a href="#"><img src="{{ $avatarImage }}" class="img-circle img-xs" alt=""></a> </div>
                                                        <div class="media-left">
...
<div class="row">
    <div class="col-md-12">
        <div style="margin: 200px 0px 0;" class="text-center">
            ...
            <h5 class="mb-20">
                Looks Like You Don’t Have Any Brand Boosts Yet <img src="{{ site_url('assets/images/smiley.png') }}"> <br>
