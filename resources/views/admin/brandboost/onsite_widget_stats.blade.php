    ...
    <div class="tab-content"> 
        ...
        <div class="page_header">
            <div class="row">
                <!--=============Headings & Tabs menu==============-->
                <div class="col-md-7">
                    <h3 class=""><img style="width: 16px;" src="{{ base_url("assets/images/analysis_icon.png") }}"> On Site Widget Statistics</h3>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="{{ base_url('admin/brandboost/onsite_widget_setup/' . $oData->widget_id) }}" widgetID="<?php echo $oData->widget_id; ?>" b_title="<?php echo $oData->bbCTitle; ?>" class="text-default text-semibold">
                                                            <img src="<?php echo $imgSrc; ?>" class="img-circle img-xs br5" alt="Img"></a>
                                                    </div>
                                                    <div class="media-left">
                                                        <div class=""><a href="{{ base_url('admin/brandboost/onsite_widget_setup/' . $oData->id) }}" widgetID="<?php echo $oData->id; ?>" b_title="<?php echo $oData->widget_title; ?>" class="text-default text-semibold"><?php echo $oData->widget_title; ?></a></div>
                                    ...
                                    if (!empty($oStatsYesterday)) {
                                        foreach ($oStatsYesterday as $oData) {
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="{{ base_url('admin/brandboost/onsite_widget_setup/' . $oData->widget_id) }}" widgetID="<?php echo $oData->widget_id; ?>" b_title="<?php echo $oData->widget_title; ?>" class="text-default text-semibold">
                                                            <img src="<?php echo $imgSrc; ?>" class="img-circle img-xs br5" alt="Img"></a>
                                                    </div>
                                                    <div class="media-left">
                                                        <div class=""><a href="{{ base_url('admin/brandboost/onsite_widget_setup/' . $oData->id) }}" widgetID="<?php echo $oData->id; ?>" b_title="<?php echo $oData->widget_title; ?>" class="text-default text-semibold"><?php echo $oData->widget_title; ?></a></div>
