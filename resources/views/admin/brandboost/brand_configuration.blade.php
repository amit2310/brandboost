...
<style type="text/css">
    ...
    #Desktopver{background: url("{{ base_url() }}assets/images/config_bkg_bk2_overlay.png") center top no-repeat; background-size:100% auto; padding-top: 86px;}
...
<div class="content">
    ...
    <div class="page_header">
        <div class="row">
            <!--=============Headings & Tabs menu==============-->
            <div class="col-md-7">
                <h3><img src="{{ base_url() }}/assets/images/brand_icon.png" style="width: 16px;"> Brand Page</h3>
                <ul class="nav nav-tabs nav-tabs-bottom">
                    <li class="{{ $tb0active }}"><a href="#right-icon-tab01" data-toggle="tab">Configuration</a></li>
                    <li class="{{ $tb1active }}"><a href="#right-icon-tab11" data-toggle="tab">Reviews</a></li>
                    <li class="{{ $tb2active }}"><a href="#right-icon-tab21" data-toggle="tab">Media</a></li>
                    <li class="{{ $tb3active }}"><a href="#right-icon-tab31" data-toggle="tab">FAQ</a></li>
                </ul>
            </div>
    ...
    <div class="tab-content"> 
            ...
            <div class="row">
                <div class="col-md-3">
                            ...
                            <div class="tab-content"> 
                                ...
                                <div class="tab-pane active" id="Configurations">
                                    ...
                                    <div class="form-group p20">
                                        <button id="newcampaign" class="btn h52 form-control w100" style="text-align: left; padding: 7px 23px!important;"><span>Horizontal Popup</span> <i class="pull-right txt_grey"><img src="{{ base_url() }}assets/images/icon_grid.png"></i></button>
                                    </div>
                                    ...
                                    <form method="post" name="frmSubmit" id="frmSubmit" action="javascript:void(0);"  enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12"> 
                                                    ...
                                                    <div class="form-group mb10">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="company_description" type="checkbox" name="company_des_switch" id="company_des_switch" {{ ($brandData->company_description == '1' || $brandData->company_description == '') ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-group mb10">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="services" type="checkbox" name="services_switch" id="services_switch" {{ ($brandData->services == '1' || $brandData->services == '') ? 'checked' : '' }}>
                                                            <span class="toggle dred"></span> </label>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb10">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="contact_btn" type="checkbox" name="contact_btn_switch" id="contact_btn_switch" {{ ($brandData->contact_button == '1' || $brandData->contact_button == '') ? 'checked' : '' }}>
                                                            <span class="toggle dred"></span> </label>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb10">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="contact_info" type="checkbox" name="contact_info_switch" id="contact_info_switch" {{ ($brandData->contact_info == '1' || $brandData->contact_info == '') ? 'checked' : '' }}>
                                                            <span class="toggle dred"></span> </label>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb10">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="socials" type="checkbox" name="socials_switch" id="socials_switch" {{ ($brandData->socials == '1' || $brandData->socials == '') ? 'checked' : '' }}>
                                                            <span class="toggle dred"></span> </label>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb0">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="customer_experiance" type="checkbox" name="customer_experiance_switch" id="customer_experiance_switch" {{ ($brandData->customer_experiance == '1' || $brandData->customer_experiance == '') ? 'checked' : '' }}>
                                                            <span class="toggle dred"></span> </label>
                                                        <div class="clearfix"></div>
                                                    </div>
                                            ...
                                            <div class="card_sec p0">
                                                <div class="form-group select_box">
                                                    ...
                                                    <select name="about_company_position" id="about_company_position" class="selectbox_cls form-control changeAction" action-type="about_company">
                                                        <option value="left" {{ ($brandData->about_company_position == 'left' || $brandData->about_company_position == '') ? 'selected' : '' }}>Left</option>
                                                        <option value="right" {{ $brandData->about_company_position == 'right' ? 'selected' : '' }}>Right</option>
                                                    </select>
                                                    <div class="clearfix"></div>
                                                </div>
                                                ...
                                                <div class="form-group select_box">
                                                    ...
                                                    <select name="reviews_list_position" id="reviews_list_position" class="selectbox_cls form-control changeAction" action-type="review_list">
                                                        <option value="left" {{ $brandData->review_list_position == 'left' ? 'selected' : '' }}>Left</option>
                                                        <option value="right" {{ ($brandData->review_list_position == 'right' || $brandData->review_list_position == '') ? 'selected' : '' }}>Right</option>
                                                    </select>
                                                    <div class="clearfix"></div>
                                                </div>
                                                ...
                                                <div class="form-group select_box">
                                                    ...
                                                    <select name="show_rating" id="show_rating" class="selectbox_cls form-control changeAction" action-type="rating">
                                                        ...
                                                        <option value="on" {{ ($brandData->rating == 'on' || $brandData->rating == '') ? 'selected' : '' }}>On</option>
                                                        <option value="off" {{ $brandData->rating == 'off' ? 'selected' : '' }}>Off</option>
                                                    </select>
                                                    <div class="clearfix"></div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12"> 
                                                    <div class="form-group mb10">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="chat_widget" type="checkbox" name="chat_widget_switch" id="chat_widget_switch" {{ ($brandData->chat_widget == '1') ? 'checked' : '' }}>
                                                            <span class="toggle dred"></span> </label>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb10">
                                                        ...
                                                        <label class="custom-form-switch pull-right">
                                                            <input class="field changeAction" action-type="referral_widget" type="checkbox" name="referral_widgets_switch" id="referral_widgets_switch" {{ ($brandData->referral_widget == '1') ? 'checked' : '' }}>
                                                            <span class="toggle dred"></span> </label>
                                                        <div class="clearfix"></div>
                                                    </div>
                                        ...
                                        <div class="p20 btop">
                                            <input type="hidden" name="brandboost_id" id="brandboost_id" value="{{ Request::segment(4) }}">
                                ...
                                <div class="tab-pane" id="Design">
                                    <form method="post" name="frmDesignSubmit" id="frmDesignSubmit" action="javascript:void(0);"  enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="area_type" id="area_type" value="{{ ($brandData->area_type == "") ? 1 : $brandData->area_type }} ">
                                        <input type="hidden" value="{{ $brandData->color_orientation_full }}" id="color_orientation_full_value" name="color_orientation_full_value">
                                        <input type="hidden" value="{{ $brandData->color_orientation_top }}" id="color_orientation_top_value" name="color_orientation_top_value">
                                        ...
                                        <div class="p20">
                                            <div class="barand_avatar mb20 hidden">
                                                <img width="64" height="65" class="rounded" src=""/>
                                                <img width="65" height="65" class="rounded" src="{{ ($company_logo1 == '') ? base_url('assets/images/default_table_img2.png') : 'https://s3-us-west-2.amazonaws.com/brandboost.io/' . $company_logo }}"/>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="hidden" name="company_header_logo" id="company_header_logo" value="{{ $brandData->company_header_logo }}">
                                            ...
                                            <div class="mb0">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    ...
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" {{ ($brandData->company_info > 0 || empty($brandData)) ? 'checked' : '' }} name="company_info_switch" id="company_info_switch">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="import_box p0">
                                                    <div id="default_company_info_box" {!! ($brandData->company_info > 0 || empty($brandData)) ? 'style="display:block;"' : 'style="display:none;"' !!}>
                                                        <div class="p20 bbot">
                                                    ...
                                                    <div id="custom_company_info_box" {!! ($brandData->company_info > 0 || empty($brandData)) ? 'style="display:none;"' : 'style="display:block;"' !!}>
                                                        <div class="p10 bbot">
                                                            <p class="mb0">
                                                                <strong>
                                                                    <input name="custom_company_name" id="custom_company_name" class="form-control" placeholder="Company Name" type="text" style="border:none; background:#FBFBFD; padding-left:10px;" value="{{ $brandData->company_info_name == '' ? '' : $brandData->company_info_name }}">
                                                                </strong>
                                                            </p>
                                                        </div>
                                                        <div class="p10">
                                                            <textarea name="custom_company_description" style="border:none; background:#FBFBFD; padding-left:10px; padding-top:10px; height:190px;" id="custom_company_description" class="form-control">{{ $brandData->company_info_description == '' ? '' : $brandData->company_info_description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group p20">
                                            ...
                                            <select class="form-control h52" name="brand_themes" id="brand_themes">
                                                ...
                                                @foreach ($brandThemeData as $TConfigdata)
                                                    <option @if ($TConfigdata->id == '8') selected="selected" @endif value="{{ $TConfigdata->id }}">{{ $TConfigdata->brand_theme_title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!--=======Top Area=====-->
                                        <div class="profile_headings txt_upper fsize11 fw600">Dual Pane Design <a class="pull-right plus_icon" href="javascript:void(0)"><label class="custom-form-switch pull-right">
                                                    <input class="field" @if ($brandData->area_type == '1') checked @endif type="checkbox" name="topPlaneSecSwitch" id="topPlaneSecSwitch">
                                                    <span class="toggle green"></span> </label></a></div>
                                        <div class="p20" id="TopArea" @if ($brandData->area_type == '1') style="display:block" @else style="display:none" @endif>
                                            ...
                                            <div class="mb20">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    ...
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" @if ($brandData->area_type == '1')  {{ ($brandData->header_color_solid < 1) ? '' : 'checked' }}  @endif name="solid_color_switch" id="solid_color_switch">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                @php
                                                if ($brandData->area_type == '1') {
                                                    if ($brandData->header_color_solid < 1) {
                                                        $printStr2 =  "display:none";
                                                    } else {
                                                        $printStr2 = "display:block";
                                                    }
                                                } else {
                                                    $printStr2 = "display:none";
                                                }
                                                @endphp
                                                <div class="row solid_color_switch_div" style="{{ $printStr2 }}">
                                                    <div class="position-relative mt-5 col-md-12">
                                                        <input name="solid_color" class="form-control" id="solid_color" placeholder="#FF0000" type="text" value="{{ ($brandData->header_solid_color == '') ? '#FF0000' : $brandData->header_solid_color }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="solidcolorpicker colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!! ($brandData->header_solid_color == '') ? 'style="color:#FF0000"' : 'style="color:' . $brandData->header_solid_color . '"' !!}></i></a>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="color_box main_color_switch_div" style="{{ $printStr3 }}">
                                                    ...
                                                    <div class="color_cube dred selectMainColor {{  $brandData->header_color == 'red' ? 'active' : '' }}" color-data='red' color-class="red_preview_1"></div>
                                                    <div class="color_cube yellow selectMainColor {{  $brandData->header_color == 'yellow' ? 'active' : '' }}" color-data='yellow' color-class="yellow_preview_1"></div>
                                                    <div class="color_cube red selectMainColor {{  $brandData->header_color == 'orange' ? 'active' : '' }}" color-data='orange' color-class="orange_preview_1"></div>
                                                    <div class="color_cube green selectMainColor {{  ($brandData->header_color == '' || $brandData->header_color == 'green') ? 'active' : '' }}" color-data='green' color-class="green_preview_1"></div>
                                                    <div class="color_cube blue selectMainColor {{  $brandData->header_color == 'blue' ? 'active' : '' }}" color-data='blue' color-class="blue_preview_1"></div>
                                                    <div class="color_cube black selectMainColor {{  $brandData->header_color == 'purple' ? 'active' : '' }}" color-data='purple' color-class="purple_preview_1"></div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                ...
                                                if ($brandData->area_type == '1') {
                                                    if ($brandData->header_color_fix < 1) {
                                                        $printStr4 =  "display:none";
                                                    } else {
                                                        $printStr4 = "display:block";
                                                    }
                                                } else {
                                                   $printStr4 = "display:none";
                                                }
                                                @endphp
                                                <div class="row orientation_top_fix" style="{{ $printStr4 }}">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul class="choose_orientation">
                                                            <li class="torighttop"><a class="{{  $brandData->color_orientation_top == 'to right top' ? 'active' : '' }}" color-orientation="to right top" href="javascript:void(0);"><i class="fa fa-arrow-right degtop" aria-hidden="true"></i></a></li>
                                                            <li class="toright"><a class="{{  $brandData->color_orientation_top == 'to right' ? 'active' : '' }}" color-orientation="to right"  href="javascript:void(0);"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></li>
                                                            <li class="torightbottom"><a class="{{  $brandData->color_orientation_top == 'to right bottom' ? 'active' : '' }}" color-orientation="to right bottom" href="javascript:void(0);"><i class="fa fa-arrow-right degbot" aria-hidden="true"></i></a></li>
                                                            <li class="tobottom"><a class="{{  $brandData->color_orientation_top == 'to bottom' ? 'active' : '' }}" color-orientation="to bottom" href="javascript:void(0);"><i class="fa fa-arrow-down" aria-hidden="true"></i></a></li>
                                                            <li class="toleftbottom"><a class="{{  $brandData->color_orientation_top == 'to left bottom' ? 'active' : '' }}" color-orientation="to left bottom" href="javascript:void(0);"><i class="fa fa-arrow-left degtop" aria-hidden="true"></i></a></li>
                                                            <li class="toleft"><a class="{{  $brandData->color_orientation_top == 'to left' ? 'active' : '' }}" color-orientation="to left" href="javascript:void(0);"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></li>
                                                            <li class="tolefttop"><a class="{{  $brandData->color_orientation_top == 'to left top' ? 'active' : '' }}" color-orientation="to left top" href="javascript:void(0);"><i class="fa fa-arrow-left degbot" aria-hidden="true"></i></a></li>
                                                            <li class="totop"><a class="{{  $brandData->color_orientation_top == 'to top' ? 'active' : '' }}" color-orientation="to top" href="javascript:void(0);"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></li>
                                                            <li class="circle"><a class="{{  $brandData->color_orientation_top == 'circle' ? 'active' : '' }}" color-orientation="circle" href="javascript:void(0);"><i class="fa fa-undo" aria-hidden="true"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <!--==========Choose orientation fix  ==========-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    ...
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" {{ ($brandData->area_type == '1') ? (($brandData->header_color_custom < 1) ? '' : 'checked') : '' }} name="custom_color_switch" id="custom_color_switch">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                @php
                                                if ($brandData->area_type == '1') {
                                                    if ($brandData->header_color_custom < 1) {
                                                        $printStr5 = "display:none";
                                                    } else {
                                                        $printStr5 = "display:block";
                                                    }
                                                } else {
                                                    $printStr5 = "display:none";
                                                }
                                                @endphp
                                                <div class="row custom_color_switch_div" style="{{ $printStr5 }}">
                                                    <div class="position-relative mt-5 col-md-6">
                                                        <input name="custom_colors1" class="form-control" id="custom_colors1" placeholder="#000000" type="text" value="{{  $brandData->header_custom_color1 == '' ? '#000000' : $brandData->header_custom_color1 }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="colorpicker1 colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!!  $brandData->header_custom_color1 == '' ? 'style="color:#000000"' : 'style="color:' . $brandData->header_custom_color1 . '"' !!}></i></a>
                                                    </div>

                                                    <div class="position-relative mt-5 col-md-6">
                                                        <input name="custom_colors2" class="form-control" id="custom_colors2" placeholder="#FF0000" type="text" value="{{  $brandData->header_custom_color2 == '' ? '#FF0000' : $brandData->header_custom_color2 }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="colorpicker2 colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!!  $brandData->header_custom_color2 == '' ? 'style="color:#FF0000"' : 'style="color:' . $brandData->header_custom_color2 . '"' !!}></i></a>
                                                    </div>
                                                </div>
                                        ...
                                        <div style="display:none" class="p20" id="BottomArea">
                                            ...
                                            <div class="mb20">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    <p class="pull-left mb0 fsize11 fw500 text-muted mr-5">Solid color</p>
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" {{  $brandData->header_color_solid < 1 ? '' : 'checked' }} name="solid_color_switch_bottom" id="solid_color_switch_bottom">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="row">
                                                    <div class="position-relative mt-5 col-md-12">
                                                        <input name="solid_color_bottom" class="form-control" id="solid_color_bottom" placeholder="#FF0000" type="text" value="{{  $brandData->header_solid_color == '' ? '#FF0000' : $brandData->header_solid_color }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="solidcolorpicker colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!!  $brandData->header_solid_color == '' ? 'style="color:#FF0000"' : 'style="color:' . $brandData->header_solid_color . '"' !!}></i></a>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    <p class="pull-left mb0 fsize11 fw500 text-muted mr-5">Gradient</p>
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" {{  ($brandData->header_color_fix > 0 || empty($brandData)) ? 'checked' : '' }} name="main_color_switch_bottom" id="main_color_switch_bottom">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="color_box">
                                                    <input type="hidden" name="main_colors_bottom" id="main_colors_bottom" value="{{  $brandData->header_color == '' ? 'green' : $brandData->header_color }}">
                                                    <div class="color_cube dred selectBottomMainColor {{ $brandData->header_color == 'red' ? 'active' : '' }}" color-data='red' color-class="red_preview_1"></div>
                                                    <div class="color_cube yellow selectBottomMainColor {{ $brandData->header_color == 'yellow' ? 'active' : '' }}" color-data='yellow' color-class="yellow_preview_1"></div>
                                                    <div class="color_cube red selectBottomMainColor {{ $brandData->header_color == 'orange' ? 'active' : '' }}" color-data='orange' color-class="orange_preview_1"></div>
                                                    <div class="color_cube green selectBottomMainColor {{ ($brandData->header_color == '' || $brandData->header_color == 'green') ? 'active' : '' }}" color-data='green' color-class="green_preview_1"></div>
                                                    <div class="color_cube blue selectBottomMainColor {{ $brandData->header_color == 'blue' ? 'active' : '' }}" color-data='blue' color-class="blue_preview_1"></div>
                                                    <div class="color_cube black selectBottomMainColor {{ $brandData->header_color == 'purple' ? 'active' : '' }}" color-data='purple' color-class="purple_preview_1"></div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    <p class="pull-left mb0 fsize11 fw500 text-muted mr-5">Custom Gradient color</p>
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" {{  $brandData->header_color_custom < 1 ? '' : 'checked' }} name="custom_color_switch_bottom" id="custom_color_switch_bottom">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="row">
                                                    <div class="position-relative mt-5 col-md-6">
                                                        <input name="custom_colors1_bottom" class="form-control" id="custom_colors1_bottom" placeholder="#000000" type="text" value="{{  $brandData->header_custom_color1 == '' ? '#000000' : $brandData->header_custom_color1 }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="colorpicker1 colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!!  $brandData->header_custom_color1 == '' ? 'style="color:#000000"' : 'style="color:' . $brandData->header_custom_color1 . '"' !!}></i></a>
                                                    </div>

                                                    <div class="position-relative mt-5 col-md-6">
                                                        <input name="custom_colors2_bottom" class="form-control" id="custom_colors2_bottom" placeholder="#FF0000" type="text" value="{{  $brandData->header_custom_color2 == '' ? '#FF0000' : $brandData->header_custom_color2 }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="colorpicker2 colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!!  $brandData->header_custom_color2 == '' ? 'style="color:#FF0000"' : 'style="color:' . $brandData->header_custom_color2 . '"' !!}></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="profile_headings txt_upper fsize11 fw600" style="margin-top:25px">Single Pane Design <a class="pull-right plus_icon" href="javascript:void(0)"><label class="custom-form-switch pull-right">
                                            <input class="field" @if ($brandData->area_type == '2') checked @endif type="checkbox" name="FullPlaneSecSwitch" id="FullPlaneSecSwitch">
                                            <span class="toggle green"></span> </label></a></div>
                                            <div class="p20" id="FullArea" @if ($brandData->area_type == '2') style="display:block" @else style="display:none" @endif>
                                            ...
                                            <div class="mb20">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    <p class="pull-left mb0 fsize11 fw500 text-muted mr-5">Solid color</p>
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" {{ ($brandData->area_type == '2') ? (($brandData->header_color_solid < 1) ? '' : 'checked') : '' }} name="solid_color_switch_full" id="solid_color_switch_full">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                @php
                                                if ($brandData->area_type == '2') {
                                                    if ($brandData->header_color_solid < 1) {
                                                        $printStr7 = "display:none";
                                                    } else {
                                                        $printStr7 = "display:block";
                                                    }
                                                } else {
                                                    $printStr7 = "display:none";
                                                }
                                                @endphp
                                                <div class="row solid_color_switch_full_div" style="{{ $printStr7 }}">
                                                    <div class="position-relative mt-5 col-md-12">
                                                        <input name="solid_color_full" class="form-control" id="solid_color_full" placeholder="#FF0000" type="text" value="{{  $brandData->header_solid_color == '' ? '#FF0000' : $brandData->header_solid_color }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="solidcolorpicker colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!!  $brandData->header_solid_color == '' ? 'style="color:#FF0000"' : 'style="color:' . $brandData->header_solid_color . '"' !!}></i></a>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    <p class="pull-left mb0 fsize11 fw500 text-muted mr-5">Gradient</p>
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" @php if ($brandData->area_type == '2') {
                                                    echo ($brandData->header_color_fix > 0 || empty($brandData)) ? 'checked' : '';
                                                } @endphp name="main_color_switch_full" id="main_color_switch_full">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                @php
                                                if ($brandData->area_type == '2') {
                                                    if ($brandData->header_color_fix < 1) {
                                                        $printStr8 = "display:none";
                                                    } else {
                                                        $printStr8 = "display:block";
                                                    }
                                                } else {
                                                    $printStr8 = "display:none";
                                                }
                                                @endphp
                                                <div class="color_box main_color_switch_full_div" style="{{ $printStr8 }}">
                                                    <input type="hidden" name="main_colors_full" id="main_colors_full" value="{{  $brandData->header_color == '' ? 'green' : $brandData->header_color }}">
                                                    <div class="color_cube white selectFullMainColor {{  $brandData->header_color == 'white' ? 'active' : '' }}" color-data='white' color-class="white_preview_1"></div>
                                                    <div class="color_cube dred selectFullMainColor {{  $brandData->header_color == 'red' ? 'active' : '' }}" color-data='red' color-class="red_preview_1"></div>
                                                    <div class="color_cube yellow selectFullMainColor {{  $brandData->header_color == 'yellow' ? 'active' : '' }}" color-data='yellow' color-class="yellow_preview_1"></div>
                                                    <div class="color_cube red selectFullMainColor {{  $brandData->header_color == 'orange' ? 'active' : '' }}" color-data='orange' color-class="orange_preview_1"></div>
                                                    <div class="color_cube green selectFullMainColor {{  ($brandData->header_color == '' || $brandData->header_color == 'green') ? 'active' : '' }}" color-data='green' color-class="green_preview_1"></div>
                                                    <div class="color_cube blue selectFullMainColor {{  $brandData->header_color == 'blue' ? 'active' : '' }}" color-data='blue' color-class="blue_preview_1"></div>
                                                    <div class="color_cube black selectFullMainColor {{  $brandData->header_color == 'purple' ? 'active' : '' }}" color-data='purple' color-class="purple_preview_1"></div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                ...
                                                if ($brandData->area_type == '2') {
                                                    if ($brandData->header_color_fix < 1) {
                                                        $printStr9 = "display:none";
                                                    } else {
                                                        $printStr9 = "display:block";
                                                    }
                                                } else {
                                                    $printStr9 = "display:none";
                                                }
                                                @endphp
                                                <div class="row orientation_fix" style="{{ $printStr9 }}">
                                                    <div class="col-md-12">
                                                        <div style="margin: 25px 0 15px!important;" class="profile_headings txt_upper fsize11 fw600">Choose orientation</div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <ul class="choose_orientation">
                                                            <li class="torighttop"><a class="{{ $brandData->color_orientation_full == 'to right top' ? 'active' : '' }}" color-orientation="to right top" href="javascript:void(0);"><i class="fa fa-arrow-right degtop" aria-hidden="true"></i></a></li>
                                                            <li class="toright"><a class="{{ $brandData->color_orientation_full == 'to right' ? 'active' : '' }}" color-orientation="to right"  href="javascript:void(0);"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></li>
                                                            <li class="torightbottom"><a class="{{ $brandData->color_orientation_full == 'to right bottom' ? 'active' : '' }}" color-orientation="to right bottom" href="javascript:void(0);"><i class="fa fa-arrow-right degbot" aria-hidden="true"></i></a></li>
                                                            <li class="tobottom"><a class="{{ $brandData->color_orientation_full == 'to bottom' ? 'active' : '' }}" color-orientation="to bottom" href="javascript:void(0);"><i class="fa fa-arrow-down" aria-hidden="true"></i></a></li>
                                                            <li class="toleftbottom"><a class="{{ $brandData->color_orientation_full == 'to left bottom' ? 'active' : '' }}" color-orientation="to left bottom" href="javascript:void(0);"><i class="fa fa-arrow-left degtop" aria-hidden="true"></i></a></li>
                                                            <li class="toleft"><a class="{{ $brandData->color_orientation_full == 'to left' ? 'active' : '' }}" color-orientation="to left" href="javascript:void(0);"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></li>
                                                            <li class="tolefttop"><a class="{{ $brandData->color_orientation_full == 'to left top' ? 'active' : '' }}" color-orientation="to left top" href="javascript:void(0);"><i class="fa fa-arrow-left degbot" aria-hidden="true"></i></a></li>
                                                            <li class="totop"><a class="{{ $brandData->color_orientation_full == 'to top' ? 'active' : '' }}" color-orientation="to top" href="javascript:void(0);"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></li>
                                                            <li class="circle"><a class="{{ $brandData->color_orientation_full == 'circle' ? 'active' : '' }}" color-orientation="circle" href="javascript:void(0);"><i class="fa fa-undo" aria-hidden="true"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <!--==========Choose orientation full fix ==========-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group pull-right mb0">
                                                    ...
                                                    <label class="custom-form-switch pull-right">
                                                        <input class="field" type="checkbox" @php if ($brandData->area_type == '2') {
                                                    echo $brandData->header_color_custom < 1 ? '' : 'checked';
                                                } @endphp name="custom_color_switch_full" id="custom_color_switch_full">
                                                        <span class="toggle dred"></span> </label>
                                                    <div class="clearfix"></div>
                                                </div>
                                                @php
                                                ...
                                                <div class="row custom_color_switch_full_div" style="{{ $printStr10 }}">
                                                    ...
                                                    <div class="position-relative mt-5 col-md-6">
                                                        <input name="custom_colors2_full" class="form-control" id="custom_colors2_full" placeholder="#FF0000" type="text" value="{{  $brandData->header_custom_color2 == '' ? '#FF0000' : $brandData->header_custom_color2 }}">
                                                        <a style="position: absolute; top: 10px; right: 20px;" class="colorpicker2 colorpicker-show-input" href="javascript:void(0);"><i class="fa fa-circle fsize18" {!!  $brandData->header_custom_color2 == '' ? 'style="color:#FF0000"' : 'style="color:' . $brandData->header_custom_color2 . '"' !!}></i></a>
                                                    </div>
                                                </div>
                    ...
                    <div class="panel panel-flat review_ratings">
                        ...
                        <div class="panel-body  p40 info_card text-center">
                            <div class="img_icon mb20"><img src="{{ base_url() }}assets/images/company_info.png" width="36"></div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-heading">
                            <h6 class="panel-title">Statistic &nbsp; &nbsp; <a style="color: #962e6c ; font-weight: 500!important" href="{{ base_url() }}for/{{  str_replace(' ', '-', strtolower($userData->company_name)) }} target="_blank">Live Preview</</a></h6>
        ...
        <!--===========TAB 1======Reviews=====-->
        <div class="tab-pane {{  $tb1active }}" id="right-icon-tab11">
            @include("admin.brandboost.campaign-tabs.onsite.onsite-reviews", ['aReviews' => $aReviews, 'brandboostData' => ''])
        </div>
        <!--===========TAB 2=====Media======-->
        <div class="tab-pane {{  $tb2active }}" id="right-icon-tab21">
            @include("admin.brandboost.campaign-tabs.onsite.onsite-media", ['aReviews' => $aReviews])
        </div>
        <!--===========TAB 3=====FAQ======-->
        <div class="tab-pane {{  $tb3active }} FaQSection" id="right-icon-tab31">
            @include("admin.brandboost.campaign-tabs.onsite.onsite-faqs", ['faQData' => $faQData])
        </div>
...
$(document).ready(function () {
    ...
    $('.template_select').click(function () {
        ...
        $.ajax({
            url: "{{ base_url() }}/admin/brandboost/switchTemplate",
            method: "POST",
    ...
    var myDropzoneLogoImg = new Dropzone(
            ...
            {
                url: '{{  base_url("webchat/dropzone/upload_s3_attachment") }}/{{  $userData->id }}/onsite',
    ...
    $('#addQuestionFrm').on('submit', function (e) {
        ...
        $('.overlaynew').show();
        $.ajax({
            url: "{{ base_url() }}/admin/brandboost/addFaqData",
            method: "POST",
    ...
    $(document).on('click', '.FaQSection .chg_status', function () {
        ...
        $.ajax({
            url: '{{ base_url() }}/admin/brandboost/update_faq_status',
            type: "POST",
    ...
    $(document).on('click', '.deleteFaq', function () {
        ...
        deleteConfirmationPopup(
                ...
                function () {
                    $('.overlaynew').show();
                    $.ajax({
                        url: '{{ base_url() }}/admin/brandboost/delete_faq',
                        type: "POST",
                        data: {'faq_id': faq_id},
                        dataType: "json",
                        success: function (data) {
    ...
    $('#frmSubmitCampaign').on('submit', function (e) {
        ...
        $('.overlaynew').show();
        $.ajax({
            url: "{{ base_url() }}/admin/brandboost/addBrandCampaign",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#frmSubmit').on('submit', function (e) {
        ...
        $('.overlaynew').show();
        $.ajax({
            url: "{{ base_url() }}/admin/brandboost/addBrandConfigurationData",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#brand_themes').on('change', function () {
        ...
        $.ajax({
            url: "{{ base_url() }}/admin/brandboost/getBrandThemeData",
            method: "POST",
    ...
    $('#frmDesignSubmit').on('submit', function (e) {
        ...
        $.ajax({
            url: "{{ base_url() }}/admin/brandboost/updateBrandConfigurationData",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
