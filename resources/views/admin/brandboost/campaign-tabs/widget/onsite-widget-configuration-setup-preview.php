                ...
                <div class="tablet_box_bkg">
                    <div class="bb_rw04 previewWidgetBox vpw <?php echo $alternative_design == 1 ? 'bbAlternetWidget' : ''; ?> <?php echo $widgetData->widget_position == 'bottom-right' ? 'bb_right_position' : ''; ?> <?php echo $widgetData->widget_type == 'vpw' ? '' : 'hidden'; ?>">
                        ...
                        <div class="bb_widget_main_container <?php echo ($widgetData->header_color_fix == '1' && $alternative_design != 1) ? $widgetData->header_color . '_preview_1' : ''; ?>">
                            <button type="button" class="bb_close bb_custom_txt_color <?php echo $widgetData->header_color_fix == '1' ? $widgetData->header_color . '_preview_1' : ''; ?>" style="<?php echo $widgetData->header_color_solid == '1' ? 'background:' . $widgetData->header_solid_color : ''; ?> <?php
                            if ($colorOrientation == 'circle') {
                                echo $widgetData->header_color_custom == '1' ? 'background-image:radial-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                            } else {
                                echo $widgetData->header_color_custom == '1' ? 'background-image:linear-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                            ...
                            <a class="bb_submit_button_white bb_widget_open_btn bbDefaultButton <?php echo $widgetData->header_color_fix == '1' ? $widgetData->header_color . '_preview_1' : ''; ?>" style="<?php echo ($widgetData->icon_type == 'default' || $widgetData->icon_type == '') ? '' : 'display:none;'; ?> <?php echo $widgetData->header_color_solid == '1' ? 'background:' . $widgetData->header_solid_color : ''; ?> <?php
                            if ($colorOrientation == 'circle') {
                                echo $widgetData->header_color_custom == '1' ? 'background-image:radial-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                            } else {
                                echo $widgetData->header_color_custom == '1' ? 'background-image:linear-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                            }
                            ?>" href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/widget/bb_icons_2.png"></a>
                    ...
                    <div class="bb_rw05 previewWidgetBox rfw <?php echo $widgetData->widget_type == 'rfw' ? '' : 'hidden'; ?>">
                        ...
                        <div class="bb_feed_widget_rb bb_white_box bb_custom_bg <?php echo $widgetData->header_color_fix == '1' ? $widgetData->header_color . '_preview_1' : ''; ?>" style="<?php echo $widgetData->header_color_solid == '1' ? 'background:' . $widgetData->header_solid_color : ''; ?> <?php
                        if ($colorOrientation == 'circle') {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:radial-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                        } else {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:linear-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                    ...
                    <div class="bb_rw01 previewWidgetBox bww bwwMain <?php echo ($widgetData->widget_type == 'bww' && $alternative_design != 1) ? '' : 'hidden'; ?> <?php echo $widgetData->widget_position == 'bottom-left' ? 'bb_left_position_bw' : ''; ?>">
                        <div class="bb_white_box bb_pr_header01 bb_pad15 bb_widget_main_container_bw <?php echo $widgetData->header_color_fix == '1' ? $widgetData->header_color . '_preview_1' : ''; ?>" style="<?php echo $widgetData->header_color_solid == '1' ? 'background:' . $widgetData->header_solid_color : ''; ?> <?php
                        if ($colorOrientation == 'circle') {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:radial-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                        } else {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:linear-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                        ...
                        <div class="bb_white_box review_main_box bb_widget_main_container_bw <?php echo $widgetData->header_color_fix == '1' ? $widgetData->header_color . '_preview_1' : ''; ?>" style="<?php echo $widgetData->header_color_solid == '1' ? 'background:' . $widgetData->header_solid_color : ''; ?> <?php
                        if ($colorOrientation == 'circle') {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:radial-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                        } else {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:linear-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                        ...
                        <a class="bb_submit_button_blue bb_fright bbDefaultButton <?php echo $widgetData->header_color_fix == '1' ? $widgetData->header_color . '_preview_1' : ''; ?>" style="<?php echo ($widgetData->icon_type == 'default' || $widgetData->icon_type == '') ? '' : 'display:none;'; ?> <?php echo $widgetData->header_color_solid == '1' ? 'background:' . $widgetData->header_solid_color : ''; ?> <?php
                        if ($colorOrientation == 'circle') {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:radial-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
                        } else {
                            echo $widgetData->header_color_custom == '1' ? 'background-image:linear-gradient(' . $colorOrientation . ', ' . $widgetData->header_custom_color1 . ' 1%, ' . $widgetData->header_custom_color2 . ')' : '';
