...
<div class="row">
     ...
     <div class="panel panel-flat">
			  ...
			  <div class="row">
			  	...
			  	<div class="row">
			  		...
			  		<div class="col-xs-6">
			  		<h1 class="m0 lh25"><?php echo $positiveGraph; ?></h1>
      ...
      <div class="panel panel-flat review_ratings">
        ...
        <div class="panel-body p0">
          <div class="pt30 pb30 pl40 pr40 bbot">
            <h1><i style="color: #7f62df !important;" class="icon-star-full2 txt_purple"></i> <?php echo number_format($startRating, 1, '.', ''); ?> <sup><i class="icon-arrow-up5"></i> &nbsp; +15%</sup></h1>
          </div>
          <div class="p40 ratings">
            ...
            <div class="row inner">
              ...
              <div class="col-xs-6 text-right">
                <p><?php echo $postivePercentage; ?>% <span><?php echo $positiveGraph; ?></span></p>
              </div>
              <div class="col-xs-12">
                <div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Percentage <?php echo $postivePercentage; ?>">
                  <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="<?php echo $postivePercentage; ?>" aria-valuemin="0" aria-valuemax="<?php echo $postivePercentage; ?>" style="width:<?php echo $postivePercentage; ?>%"></div>
                </div>
              </div>
            </div>
            ...
            <div class="row inner">
              ...
              <div class="col-xs-6 text-right">
                <p><?php echo $neturalPercentage; ?>% <span><?php echo $neturalGraph; ?></span></p>
              </div>
              <div class="col-xs-12">
                <div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Percentage <?php echo $neturalPercentage; ?>">
                  <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="<?php echo $neturalPercentage; ?>" aria-valuemin="0" aria-valuemax="<?php echo $neturalPercentage; ?>" style="width:<?php echo $neturalPercentage; ?>%"></div>
                </div>
              </div>
            </div>
            ...
            <div class="row inner mb0">
              ...
              <div class="col-xs-6 text-right">
                <p><?php echo $negativePercentage; ?>% <span><?php echo $negativeGraph; ?></span></p>
              </div>
              <div class="col-xs-12">
                <div data-toggle="tooltip" title="" data-placement="top" class="progress" data-original-title="Total Percentage <?php echo $negativePercentage; ?>">
                  <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="<?php echo $negativePercentage; ?>" aria-valuemin="0" aria-valuemax="<?php echo $negativePercentage; ?>" style="width:<?php echo $negativePercentage; ?>%"></div>
                </div>
              </div>
            </div>
     ...
     <div class="panel panel-flat">
		  ...
		  <div class="row">
		  	...
		  	<div class="row">
		  		...
		  		<div class="col-xs-7">
		  		<h1 class="m0 lh25"><?php echo $negativeGraph; ?></h1>
  ...
  <script>	
	...
	var config2 = {
		type: 'line',
		data: {
			labels: [<?php echo "'".$seMonth."'"; ?>],
			datasets: [{
				label: '',
				backgroundColor: window.chartColors.purple,
				borderColor: window.chartColors.purple,
				data: [<?php echo $emailM; ?>],
				fill: false,
			},
