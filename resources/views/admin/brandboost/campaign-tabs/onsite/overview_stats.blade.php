            ...
            <div class="panel-body p0 bkg_white">
                <div class="p20 bbot">
                    ...
                    @if (!empty($monthlyReview)) 
                        {{ number_format(array_sum($monthlyReview)) }}
                    @else
                        {{ '0' }}
                    @endif
                        </strong></p>
                ...
                <div class="row">
                    <div class="col-md-4 pr50 pl30 brig">
                        <ul class="onsite_list">
                            <li class="bnone"><span class="txt_dark"><img width="12" src="{{ base_url() }}assets/images/purple_user.png"> Requests Sent</span><strong>{{ number_format($bbEmailSend + $bbSmsSend) }}</strong></li>
                            <li><span><img width="14" src="{{ base_url() }}assets/images/purple_env.png"> Email Sent</span><strong>{{ number_format($bbEmailSend) }}</strong></li>
                            <li><span><img width="14" src="{{ base_url() }}assets/images/purple_phone.png"> SMS Sent</span><strong>{{ number_format($bbSmsSend) }}</strong></li>
                        </ul>
                    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body p20 bkg_white pb-5" style="padding-bottom: 5px!important;">
                ...
                <ul class="onsite_list">
                    <li><span class="txt_dark"><img width="12" src="{{ base_url() }}assets/images/smiley_icon_green.png"> Positive</span><strong>{{ number_format($totalPositive) }}</strong></li>
                    <li><span><img width="12" src="{{ base_url() }}assets/images/smiley_icon_yellow.png"> Neutral</span><strong>{{ number_format($totalNeutral) }}</strong></li>
                    <li><span><img width="12" src="{{ base_url() }}assets/images/smiley_icon_red.png"> Negative</span><strong>{{ number_format($totalNegative) }}</strong></li>
                </ul>
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body p20 db_stats bkg_white">
                <div class="row">
                    ...
                    <div class="col-xs-6"><h1>{{ number_format($allContact) }}</h1><p><strong class="txt_green"><i class=""><img src="/assets/images/green_arrow.png"/></i>&nbsp; 33,87%</strong> &nbsp; <span class="txt_dgrey">last week</span></p></div>
...
// top navigation fixed on scroll and side bar collasped
    ...
    var reviewList = {{ json_encode($monthlyReview) ?>;// don't use quotes
    ...
    var emailsendList = {{ json_encode($monthlyEmailSend) ?>;// don't use quotes
