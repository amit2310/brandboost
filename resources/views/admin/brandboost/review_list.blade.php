...
<div class="content">
    ...
    <div class="page_header">
        <div class="row">
            <!--=============Headings & Tabs menu==============-->
            <div class="col-md-7">
                <h3><img style="width: 18px;" src="{{ base_url() }}assets/images/review_icon2.png"/> Reviews</h3>
                                ...
                                <table class="table datatable-basic-new" id="onsitereviewQuestion">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($aReviews as $oReview) {
                                            ...
                                            @endphp
                                            <!--=======================-->
                                            <tr id="append-{{ $oReview->reviewid }}" class="selectedClass">
                                                <td style="display: none;">{{ date('m/d/Y', strtotime($oReview->review_created)) }}</td>
                                                ...
                                                <td class="viewSmartPopup" reviewid="{{ $oReview->reviewid }}"><div class="media-left media-middle"> {!! showUserAvtar($oReview->avatar, $oReview->firstname, $oReview->lastname) !!}</div>
                                                    <div class="media-left">
                                                        <div class="pt-5"><a href="javascript:void();" class="text-default text-semibold bbot">{{ $oReview->firstname . ' ' . $oReview->lastname }}</a><img class="flags" src="{{ base_url() }}assets/images/flags/{{ strtolower($oReview->userCountry) }}.png" onerror="this.src='{{ base_url('assets/images/flags/us.png') }}'"/> </div>
                                                        <div class="text-muted text-size-small">{{ $oReview->email }}</div>
                                                    </div></td>
                                                <td class="viewSmartPopup" reviewid="{{ $oReview->reviewid }}">{!! $smilyImage !!}</td>
                                                <td><a href="{{ base_url('admin/brandboost/reviewdetails/' . $oReview->reviewid) }}" class="txt_dblack"><div class="text-semibold">{{ setStringLimit($oReview->review_title, '23') }}</div>
                                                        <div class="text-size-small text-muted">{{ setStringLimit($oReview->comment_text, '31') }}</div></a></td>
                                                <td class="viewSmartPopup" reviewid="{{ $oReview->reviewid }}"><div class="media-left">
                                                        <div class=""><span class="text-default text-semibold">{{ dataFormat($oReview->review_created) }}</span> </div>
                                                        <div class="text-muted text-size-small">{{ date('h:iA', strtotime($oReview->review_created)) }}</div>
                                                    </div>
                                                </td>

                                                <td id="review_tag_{{ $oReview->reviewid }}">
                                                    <div class="media-left pl30 blef">
                                                        <div class=""><a href="javascript:void(0);" class="text-default text-semibold bbot">{{ count($reviewTags) }} Tags</a> </div>
                                                    </div>
                                                        ...
                                                        <div class="tdropdown">
                                                            ...
                                                            <ul style="right: 0px!important;" class="dropdown-menu dropdown-menu-right tagss">
                                                                @if (count($reviewTags) > 0) 
                                                                    ...
                                                                    @endforeach    
                                                                @endif
                                                                <button class="btn btn-xs plus_icon ml10 applyInsightTagsReviews" reviewid="{{ base64_url_encode($oReview->reviewid) }}" action_name="review-tag"><i class="icon-plus3"></i></button>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="tdropdown ml10"> 
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right more_act">
                                                            ...
                                                            <li>
                                                                <a target="_blank" href="{{ base_url('admin/brandboost/reviewdetails/' . $oReview->reviewid) }}"><i class="icon-file-locked"></i> View Review</a>
                                                            </li>
                                                            @if ($canWrite) 
                                                                @if ($oReview->review_type == 'text') 
                                                                    <li>
                                                                        <a href="javascript:void(0);" class="editReview" reviewid="{{ $oReview->reviewid }}"><i class="icon-gear"></i> Edit</a>
                                                                    </li>
                                                                @else
                                                                    <li>
                                                                        <a href="javascript:void(0);" class="editVideoReview" reviewid="{{ $oReview->reviewid }}"><i class="icon-pencil"></i> Edit</a>
                                                                    </li>
                                                                @endif
                                                                <li>
                                                                    <a href="javascript:void(0);" class="deleteReview" reviewid="{{ $oReview->reviewid }}" ><i class="icon-trash"></i> Delete</a>
                                                                </li>
                                                            @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div style="margin: 20px 0px 0;" class="text-center">
                                                    <h5 class="mb-20 mt40">
                                                        Looks Like You Don’t Have Any On Site Review Yet <img src="{{ site_url('assets/images/smiley.png') }}"> <br>
