...
<div class="page_header">
  ...
  <!--=============Headings & Tabs menu==============-->
	<div class="col-md-7">
	  <h3><img src="<?php echo base_url('assets/images/media.png'); ?>"/>On site Media</h3>
									...
									if(!empty($mediaUrl)) {
										foreach ($mediaUrl as $value) {
											...
											<tr id="append-<?php echo $review->id.$incDel; ?>" class="selectedClass">
												...
												<td>
													<?php 
													    ...
													    <div class="small_media_icon" style="position: relative; width: 60px;">
													        <img class="media br5" src="<?php echo $imageUrl; ?>" alt="">
												...
												<td>
													<div class="media-left media-middle"> <a class="icons" href="<?php echo base_url('admin/brandboost/onsite_setup/'.$review->campaign_id.'?type=media'); ?>"><img src="<?php echo $smilyImage; ?>" class="img-circle img-xs" alt=""></a> </div>
													<div class="media-left">
														<div class="pt-5"><a href="<?php echo base_url('admin/brandboost/onsite_setup/'.$review->campaign_id.'?type=media'); ?>" class="text-default text-semibold editBrandboost"><span><?php echo $review->brand_title; ?></span></a> </div>
														<div class="text-muted text-size-small"><a href="<?php echo base_url('admin/brandboost/onsite_setup/'.$review->campaign_id.'?type=media'); ?>" style="color:#7a8dae!important"  ><?php echo setStringLimit($review->brand_desc); ?></a></div>
													</div>
												</td>
												<td>
