            ...
            <div class="row">
                 <div class="col-md-3">
                    <div style="padding:15px 15px 5px;  margin:20px 0;">
                            <img src="{{ base_url() }}/assets/images/default_user_img.png" style="width:100%" />
                    </div>
                </div>
...
<div class="tab-content">
            ...
            @if ($reviewCommentCount > 0)
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h6 class="panel-title">Latest Comments {{ $reviewCommentCount > 0 ? '(' . $reviewCommentCount . ')' : '' }}</h6>
    ...
    <div class="tab-pane @if ($selectedTab == 'notes') active @endif" id="smartNotesTab">
        ...
        <form method="post" class="form-horizontal" id="frmSmartSaveNote1">
            @csrf
            <div class="smartStickyFooter">
                <div class="box_heading bbot ">
            ...
            <div class="box_footer_btn">
                ...
                <button type="submit" class="btn dark_btn mr20 bkg_purple" id="saveReviewNotes2">Save Note </button>
                <a href="mailto:{{ $reviewData->email }}" class="btn dark_btn mr20 bkg_purple">Send Email</a>
                @if(!empty($oSubscriber->phone))
                    <button type="button" class="btn dark_btn mr20 bkg_purple open-smart-sms-chat" @if ($subscriberID > 0) smart-subs-id="{{ $subscriberID }}" @endif>Send SMS</button>
                @endif
...
<script>
    ...
    $(document).ready(function () {
        ...
        // $("#frmSmartSaveNote12").submit(function (e) {
        //     e.preventDefault();
        $(document).on("click", "#saveReviewNotes2", function (e) {
            e.preventDefault();
            var formdata = $("#frmSmartSaveNote1").serialize();
            $('.overlaynew').show();
            $.ajax({
