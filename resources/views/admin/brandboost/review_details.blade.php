...
<div class="content">
    ...
    <div class="page_header">
        <div class="row">
            ...
            <div class="col-md-5 text-right btn_area">
                <button type="button" class="btn light_btn deleteReview" reviewid="{{ $reviewData->id }}"><i class="icon-bin"></i><span> &nbsp;  Delete</span> </button>
    ...
    <div class="row">
                ...
                <div class="panel-body p0" >
                    <div class="image_video">
                        ...
                        if (!empty($mediaArray)) {
                                ...
                                if ($media['media_type'] == 'image') {
                                    ...
                                    <div class="p25 bbot">
                                        ...
                                        <div class="media-left">
                                            ...
                                            <div class="text-muted text-size-small" style="word-break: break-all;"></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="media-left media-middle pr40"> 
                                            <a class="videoReview" style="cursor: pointer;" filepath="{{ $videoImage }}" fileext="{{ $ext }}">
                                                ...
                                                <video class="media br5" height="50px" width="60px">
                                                    <source src="{{ $videoImage }}" type="video/{{ $ext }}">
                                                </video>
                                            </a>
                                        </div>
                                        <div class="media-left media-middle pr10"> 
                           ...
                           @endphp<div class="p25 bbot text-center"><span>No Image Found</span></div>@php
                        }
                        @endphp
                ...
                <div class="panel-body p0" >
                    <div class="profile_sec">
                        <div class="p25">
                            ...
                            @endif
                            <button class="btn btn-xs plus_icon applyInsightTags" reviewid="{{ base64_url_encode($reviewData->id) }}" action_name="review-tag"><i class="icon-plus3"></i></button>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title">{{ $productName }} Review</h6>
                    <div class="heading-elements">
                        <div class="table_action_tool">
                            <a href="#"><img src="{{ base_url() }}assets/images/more.svg"></a>
                        </div>
                ...
                <div class="panel-body p30 br0">
                    <p class="fsize16 mb10">{{ $reviewData->review_title }}</p>
                    <p class="fsize13 mb20 lh25 txt_grey2">{{ $reviewData->comment_text != '' ? $reviewData->comment_text : 'N/A' }}</p>


                    <div class="media-left media-middle pr10"> <span class="icons">{!! showUserAvtar($reviewData->avatar, $reviewData->firstname, $reviewData->lastname) !!}</span> </div>
                    <div class="media-left">
                        <div class="text-muted">by {{ $reviewData->firstname . " " . $reviewData->lastname }}   <span class="ml20"><i class="icon-checkmark3 fsize12 txt_green"></i>&nbsp; Verified Purchase</span></div>
                    </div>
                ...
                <div class="panel-body p0" >
                    <div class="interactions p25">
                        <ul>
                            ...
                            <li><small>Name</small> <strong>{{ $reviewData->firstname . ' ' . $reviewData->lastname }}</strong></li>
                            <li><small>Email</small> <strong>{{ $reviewData->email }}</strong></li>
                            <li><small>Phone</small> <strong>{{ $reviewData->mobile == '' ? 'N/A' : $reviewData->mobile }}</strong></li>
                    ...
                    @if (!empty($reviewNotesData))
                        ...
                        @endforeach
                    @else
                        <div class="p25 bbot text-center">No Note Found</div>
                    @endif
...
<script>
    ...
    deleteConfirmationPopup(
            ...
            url: "{{ base_url('admin/reviews/deleteReview') }}",
                    ...
                    success: function (data) {
                    if (data.status == 'success') {
                    window.location.href = "{{ base_url() }}admin/brandboost/reviews/";
                    } else {
    ...
    var noteId = $(this).attr('noteid');
    $.ajax({
    url: "{{ base_url('admin/reviews/deleteReviewNote') }}",
            type: "POST",
            data: {noteid: noteId, _token: '{{csrf_token()}}'},
            dataType: "json",
            success: function (data) {
    ...
    $.ajax({
    url: "{{ base_url('admin/reviews/update_note') }}",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
    ...
    $.ajax({
    url: "{{ base_url("admin / reviewdetail / loadComment") }}",
            type: "POST",
