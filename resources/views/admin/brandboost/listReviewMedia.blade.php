<!-- *** online image *** -->
	<style type="text/css">
		.loading {
		  background: transparent url('<?php echo base_url(); ?>assets/images/widget_load.gif') center no-repeat;
			...
			<div style="margin: 0;" class="panel panel-flat">
				<div class="panel-heading"> 
					<span class="pull-left">
						<h6 class="panel-title"><?php //echo count($aReviews); ?> Images & Video</h6>
					</span>
										...
										if(!empty($mediaUrl)) {
											foreach ($mediaUrl as $value) {
												...
												<tr id="append-<?php echo $review->id.$incDel; ?>" class="selectedClass">
													<td style="display: none;"><?php echo date('m/d/Y', strtotime($review->created)); ?></td>
													<td style="display: none;"><?php echo $review->id; ?></td>
													<td style="display: none;" class="editAction"><label class="custmo_checkbox pull-left"><input type="checkbox" name="checkRows[]" class="checkRows" value="<?php echo $review->id; ?>" id="chk<?php echo $review->id; ?>"  mediaName="<?php echo $value['media_url']; ?>" delattr="<?php echo $incDel; ?>"><span class="custmo_checkmark"></span></label></td>
													<td>
														...
														<?php 
															...
															?>
														        ...
														        <img class="media br5 loading" src="<?php echo $imageUrl; ?>" alt="">
														        <div class="caption-overflow smallovfl">
														            <a href="<?php echo $imageUrl; ?>" data-popup="lightbox"><i class="icon-eye"></i></a>
														        </div>
															...
															?>
														        <video class="media br5 " height="100%" width="100%">
																  <source class="loading" src="<?php echo $filePath; ?>" type="video/<?php echo $fileExt; ?>">
																</video>

																<div class="caption-overflow smallovfl">
														            <a class="videoReview" style="cursor: pointer;" filepath="<?php echo $imageUrl; ?>" fileext="<?php echo $fileExt; ?>"><i class="icon-eye"></i></a>
														        </div>
													...
													<td>
														<div class="media-left media-middle"> <a class="icons" style="cursor: text;"><img src="<?php echo $smilyImage; ?>" class="img-circle img-xs" alt=""></a> </div>
														<div class="media-left">
															<div class="pt-5"><a style="cursor: text;" class="text-default text-semibold editBrandboost"><span><?php echo $review->brand_title; ?></span></a> </div>
															<div class="text-muted text-size-small"><?php //echo setStringLimit($review->brand_desc); ?></div>
														</div>
													</td>
													<td>
														<div class="media-left media-middle"> <a style="cursor: text;"><?php echo showUserAvtar($review->avatar, $review->firstname, $review->lastname); ?></a> </div>
														<div class="media-left">
															<div class="pt-5"><a style="cursor: text;" class="text-default text-semibold bbot"><?php echo $review->firstname; ?> <?php echo $review->lastname; ?></a>
															<img class="flags" src="<?php echo base_url(); ?>assets/images/flags/<?php echo strtolower($review->country); ?>.png" onerror="this.src='<?php echo base_url('assets/images/flags/us.png'); ?>'"/></div>
															<div class="text-muted text-size-small"><?php echo $review->email; ?></div>
													...
													<td>
														<div class="media-left">
															...
															<div class="text-muted text-size-small"><?php echo date('h:i A', strtotime($review->created)); ?></div>
														</div>
													</td>
													<td><div class="media-left media-middle"> <a class="icons" href="javascript:void(0);"><img src="<?php echo $extFileImage; ?>" class="img-xs file" alt=""></a> </div>
												        <div class="media-left">
												          <div class="pt-5"><a href="javascript:void(0);" class="text-default text-semibold"><?php echo $getFileSize; ?></a> </div>
												          <div class="text-muted text-size-small"><?php echo strtoupper($fileExt); ?></div>
												        </div>
												    </td>
					  ...
					  <td>
					  	<div class="imagetab">
							...
							if($incMediaImg > 1) {
								...
								?><div class="text-center"> Image not found.</div><?php 
							}
							?>
							</div>
					    </div>
							...
							<div class="imagetab videotabs">
								...
								if(!empty($mediaUrl)) {
															...
															<video height="220px" width="100%">
															  <source src="<?php echo $filePath; ?>" type="video/<?php echo $fileExt; ?>">
																...
																<span class="video_icon">
																	<a href="<?php echo $filePath; ?>" data-popup="lightbox" class="btn white_btn fancybox fancybox.iframe"><i class="icon-menu txt_purple"></i></a>
																</span>
																<span class="video_icon_bot">
																	<a href="<?php echo $filePath; ?>" data-popup="lightbox" class="btn player_btn fancybox fancybox.iframe"><i class="icon-play4 txt_white"></i></a>
																</span>
																<div class="caption-overflow">
																<span>
																	<a class="videoReview btn white_btn" style="cursor: pointer;" filepath="<?php echo $filePath; ?>" fileext="<?php echo $fileExt; ?>"><i class="icon-eye txt_purple"></i></a>
																	<a href="<?php echo $filePath; ?>" class="btn white_btn ml-5"><i class="icon-download4 txt_red"></i></a>
									...
									if($incmediaVideo > 1) {
										...
										?><div class="text-center">Video not found.</div><?php 
									}?>
												...
												<tr id="append-<?php echo $review->id.$incDel; ?>" class="selectedClass">
													...
													<td>
														<?php 
															...
															{
															?>
															<img src="<?php echo $imageUrl; ?>" class="media br5" alt="">
															<?php
															}
															else
															{
