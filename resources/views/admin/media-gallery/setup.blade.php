...
<style>
	...
	.media_sec p{font-size: 14px;}
	
	.gallery_slider_widget { width: 950px; margin: 0px auto; font-family: 'Inter UI'; font-style: normal; font-weight: 400;	position: absolute;	bottom: 35px; box-sizing: border-box; left: 50%; transform: translate(-50%, 0) }
	...
	.gallery_slider_widget .arrow {position: relative;top: 102px;right: 0;left: 0;width: 100%;z-index:9;}
	.gallery_slider_widget .middle .box_1 {max-width: 235px; width: 100%;float: left; padding: 5px; box-sizing: border-box; border-radius: 0px; background: #ffffff; margin: 0 1px; max-height: 235px; position:relative;}
	
	.img_overlay{position:absolute; width:100%; height:100%; text-align:center; line-height:100%; top:0px; left:0px; background:rgba(0, 0, 0, 0.5); color:#FFF; font-size:15px; padding-top:48%; box-sizing:border-box; display:none; cursor:pointer;font-weight: 500;}
	...
	.gallery_slider_widget .footer_div .left img{float: left; margin: 4px 4px 0;}
	...
	@media only screen and (max-width:1550px){
		.gallery_slider_widget {max-width: 695px;left: 50%; margin-left: -350px}
		.box_1.hide_under_1500{display: none;}
	}

	.imgpopup.modal .close:hover,.close:focus {color: #000;text-decoration: none;cursor: pointer;}
	.imgpopup.modal .box_inner{display: inline-block; width: 100%;}
	.imgpopup.modal .left_box{width: 50%;box-sizing: border-box; float: left; padding-right: 40px;}
	.imgpopup.modal .left_box img{width: 100%; border-radius: 5px;}
	.imgpopup.modal .right_box{width: 50%;box-sizing: border-box; float: right; padding-right: 0px;}
	.imgpopup.modal .box_2 {width: 100%;float: left;padding: 5px 0px 18px 0px;/*border-bottom: 1px solid #e7edf8;*/box-sizing: border-box;}
	.imgpopup.modal .box_2 .top_div {padding: 17px 0;border-bottom: 1px solid #e7edf8;border-top: 1px solid #e7edf8;}
	.imgpopup.modal .box_2 .top_div .left {position: relative;width: 45px;display: inline-block;margin-right: 12px; float: left; margin-top: 5px;}
	.imgpopup.modal .box_2 .top_div .left a.icons{	width: 40px !important;	height: 40px !important;}
	.imgpopup.modal .box_2 .top_div .left .img-xs {	width: 40px !important;	height: 40px !important;}
	.imgpopup.modal .box_2 .top_div .left .circle {position: absolute;width: 10px;height: 10px;background: #69d641;border-radius: 100%;right: 0;border: 2px solid #fff;top: 4px;right: 2px;}
	.imgpopup.modal .box_2 .top_div .right {display: inline-block; padding-right: 35px;}
	.imgpopup.modal .box_2 .bottom_div {padding: 0; margin: 15px 0}
	.imgpopup.modal .heading_pop{ font-size: 18px;  font-weight: 500; color: #0c0c2c; margin-top: 0px;}
	.imgpopup.modal .heading_pop2{font-size: 12px;color: #525378; line-height: 1.67;font-weight: normal;}
	.imgpopup.modal .box_2 .top_div .right .client_review span {color: #526b9b;font-size: 12px;margin-left: 10px;}
	.imgpopup.modal .box_2 .top_div .right p {color: #364d79;font-size: 14px;font-weight: 500;margin: 0 0 2px 0;padding: 0;}
	.imgpopup.modal .box_2 .top_div .right .client_review span {color: #526b9b;font-size: 12px;margin-left: 10px;}
	.imgpopup.modal .footer_div2 .comment_div p {    color: #768fbf;    font-size: 12px !important;    font-weight: 500;}
	.imgpopup.modal .footer_div2 {padding: 0px;box-sizing: border-box;}
	.imgpopup.modal .footer_div2 .comment_div {display: inline-block;}
	.imgpopup.modal .footer_div2 .liked_icon {display: inline-block;position: relative;top: 3px;}
	.imgpopup.modal .footer_div2 .comment_div p img {margin-right: 10px;float: left;margin-top: 2px;}
	.imgpopup.modal .footer_div2 .comment_div p span {margin-left: 14px;padding-left: 14px;border-left: 1px solid;margin-right: 14px;}
	.imgpopup.modal .footer_div2 .liked_icon img {background: #fff;padding: 4px;box-shadow: 0 1px 1px 0 rgba(0, 36, 128, 0.11), 0 0 1px 0 rgba(0, 0, 0, 0.05);border-radius: 5px;}
	.imgpopup.modal .box_2 .bottom_div p {color: #22375e;font-size: 14px;font-weight: 500;line-height: 1.69;margin-bottom: 10px;}
	.imgpopup.modal .arrow{top: 170px;}
	.imgpopup.modal .arrow .left_arrow{left: -30px;}
	.imgpopup.modal .arrow .right_arrow{right: -32px;}
	...
	.review_section_user .top_div {padding: 7px 0 7px 55px;border-bottom: 1px solid #e7edf8;border-top: 1px solid #e7edf8;}
	.review_section_user .top_div .left {position: relative;width: 35px;display: inline-block;margin-right: 4px; float: left; margin-top: 3px;}
	.review_section_user .top_div .left a.icons{	width: 30px !important;	height: 30px !important;}
	.review_section_user .top_div .left .img-xs {	width: 30px !important;	height: 30px !important;}
	.review_section_user .top_div .left a.icons span.icons.fl_letters{	width: 30px !important;	height: 30px !important; line-height: 30px; font-size: 10px!important;}
	.review_section_user .top_div .left .circle {position: absolute;width: 10px;height: 10px;background: #69d641;border-radius: 100%;right: 0;border: 2px solid #fff;top: 4px;right: 2px;}
	img.review_productimg{width:40px; height:40px; border-radius:5px;}
	@media (max-width: 1367px) {
		.review_section_user .top_div .left{display: none;}
		.media-left.pr-15{padding-right:5px!important}
		.review_section_user .top_div {	padding: 7px 0 7px 35px;}
		.showReviewPopup{width: calc(100% - 35px)!important;}
		img.review_productimg{width:30px; height:30px; border-radius:5px;}
	
	}
	.review_section_user .top_div .right {display: inline-block; padding-right: 0px; line-height: 15px;}
	.review_section_user .top_div .right p {color: #364d79;font-size: 12px;font-weight: 500;margin: 0 0 2px 0;padding: 0;}
	.review_section_user .top_div .right .client_review span {color: #526b9b;font-size: 10px;margin-left: 2px;}
	.review_section_user .top_div .right .client_review img{width: 9px; height: 9px;}
...
<style type="text/css">
    ...
    .toRightTop .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to right top, #f9d84a, #f9814a)!important;}
    .toRightTop .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to right top, #ef9d39, #d92a3f)!important;}
    .toRightTop .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to right top, #93cf48, #076768)!important;}
    .toRightTop .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to right top, #4194f7 3%, #1b1f97 99%)!important;}
    .toRightTop .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to right top, #4d4d7c 1%, #1e1e40)!important;}
	
	.toRight .previewWidgetBox .bbw_white_color{background-image: linear-gradient(to right, #ffffff, #ffffff 98%)!important;}
    .toRight .previewWidgetBox .bbw_red_color{background-image: linear-gradient(to right, #e93474, #541069 98%)!important;}
    .toRight .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to right, #f9d84a, #f9814a)!important;}
    .toRight .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to right, #ef9d39, #d92a3f)!important;}
    .toRight .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to right, #93cf48, #076768)!important;}
    .toRight .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to right, #4194f7 3%, #1b1f97 99%)!important;}
    .toRight .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to right, #4d4d7c 1%, #1e1e40)!important;}
	
	.toRightBottom .previewWidgetBox .bbw_white_color{background-image: linear-gradient(to right bottom, #ffffff, #ffffff 98%)!important;}
    .toRightBottom .previewWidgetBox .bbw_red_color{background-image: linear-gradient(to right bottom, #e93474, #541069 98%)!important;}
    .toRightBottom .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to right bottom, #f9d84a, #f9814a)!important;}
    .toRightBottom .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to right bottom, #ef9d39, #d92a3f)!important;}
    .toRightBottom .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to right bottom, #93cf48, #076768)!important;}
    .toRightBottom .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to right bottom, #4194f7 3%, #1b1f97 99%)!important;}
    .toRightBottom .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to right bottom, #4d4d7c 1%, #1e1e40)!important;}
	
	.toBottom .previewWidgetBox .bbw_white_color{background-image: linear-gradient(to bottom, #ffffff, #ffffff 98%)!important;}
    .toBottom .previewWidgetBox .bbw_red_color{background-image: linear-gradient(to bottom, #e93474, #541069 98%)!important;}
    .toBottom .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to bottom, #f9d84a, #f9814a)!important;}
    .toBottom .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to bottom, #ef9d39, #d92a3f)!important;}
    .toBottom .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to bottom, #93cf48, #076768)!important;}
    .toBottom .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to bottom, #4194f7 3%, #1b1f97 99%)!important;}
    .toBottom .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to bottom, #4d4d7c 1%, #1e1e40)!important;}
	
	.toLeftBottom .previewWidgetBox .bbw_white_color{background-image: linear-gradient(to left bottom, #ffffff, #ffffff 98%)!important;}
    .toLeftBottom .previewWidgetBox .bbw_red_color{background-image: linear-gradient(to left bottom, #e93474, #541069 98%)!important;}
    .toLeftBottom .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to left bottom, #f9d84a, #f9814a)!important;}
    .toLeftBottom .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to left bottom, #ef9d39, #d92a3f)!important;}
    .toLeftBottom .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to left bottom, #93cf48, #076768)!important;}
    .toLeftBottom .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to left bottom, #4194f7 3%, #1b1f97 99%)!important;}
    .toLeftBottom .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to left bottom, #4d4d7c 1%, #1e1e40)!important;}
	
	.toLeft .previewWidgetBox .bbw_white_color{background-image: linear-gradient(to left, #ffffff, #ffffff 98%)!important;}
    .toLeft .previewWidgetBox .bbw_red_color{background-image: linear-gradient(to left, #e93474, #541069 98%)!important;}
    .toLeft .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to left, #f9d84a, #f9814a)!important;}
    .toLeft .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to left, #ef9d39, #d92a3f)!important;}
    .toLeft .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to left, #93cf48, #076768)!important;}
    .toLeft .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to left, #4194f7 3%, #1b1f97 99%)!important;}
    .toLeft .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to left, #4d4d7c 1%, #1e1e40)!important;}
	
	.toLeftTop .previewWidgetBox .bbw_white_color{background-image: linear-gradient(to left top, #ffffff, #ffffff 98%)!important;}
    .toLeftTop .previewWidgetBox .bbw_red_color{background-image: linear-gradient(to left top, #e93474, #541069 98%)!important;}
    .toLeftTop .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to left top, #f9d84a, #f9814a)!important;}
    .toLeftTop .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to left top, #ef9d39, #d92a3f)!important;}
    .toLeftTop .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to left top, #93cf48, #076768)!important;}
    .toLeftTop .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to left top, #4194f7 3%, #1b1f97 99%)!important;}
    .toLeftTop .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to left top, #4d4d7c 1%, #1e1e40)!important;}
	
	.toTop .previewWidgetBox .bbw_white_color{background-image: linear-gradient(to top, #ffffff, #ffffff 98%)!important;}
    .toTop .previewWidgetBox .bbw_red_color{background-image: linear-gradient(to top, #e93474, #541069 98%)!important;}
    .toTop .previewWidgetBox .bbw_yellow_color{background-image: linear-gradient(to top, #f9d84a, #f9814a)!important;}
    .toTop .previewWidgetBox .bbw_orange_color{background-image: linear-gradient(to top, #ef9d39, #d92a3f)!important;}
    .toTop .previewWidgetBox .bbw_green_color{background-image: linear-gradient(to top, #93cf48, #076768)!important;}
    .toTop .previewWidgetBox .bbw_blue_color{background-image: linear-gradient(to top, #4194f7 3%, #1b1f97 99%)!important;}
    .toTop .previewWidgetBox .bbw_purple_color{background-image: linear-gradient(to top, #4d4d7c 1%, #1e1e40)!important;}
	
	.orientationCircle .previewWidgetBox .bbw_white_color{background-image: radial-gradient(circle, #ffffff, #ffffff 98%)!important;}
    .orientationCircle .previewWidgetBox .bbw_red_color{background-image: radial-gradient(circle, #e93474, #541069 98%)!important;}
    .orientationCircle .previewWidgetBox .bbw_yellow_color{background-image: radial-gradient(circle, #f9d84a, #f9814a)!important;}
    .orientationCircle .previewWidgetBox .bbw_orange_color{background-image: radial-gradient(circle, #ef9d39, #d92a3f)!important;}
    .orientationCircle .previewWidgetBox .bbw_green_color{background-image: radial-gradient(circle, #93cf48, #076768)!important;}
    .orientationCircle .previewWidgetBox .bbw_blue_color{background-image: radial-gradient(circle, #4194f7 3%, #1b1f97 99%)!important;}
	.orientationCircle .previewWidgetBox .bbw_purple_color{background-image: radial-gradient(circle, #4d4d7c 1%, #1e1e40)!important;}
	
	
	.gallery_slider_widget.galleryType2{width: 476px!important;}
	.gallery_slider_widget.galleryType3{width: 714px!important;}
	.gallery_slider_widget.slides3{width: 708px;}
	.gallery_slider_widget.slides4{width: 947px;}
	.gallery_slider_widget.slides5{width: 1184px;}
	.gallery_slider_widget.slides6{width: 1421px;}
	.gallery_slider_widget.slides7{width: 1660px;}
	
	.gallery_slider_widget.galleryType2.imgSizeSmall{width: 356px!important;}
	
	.gallery_slider_widget.galleryType3.imgSizeSmall{width: 534px!important;}
	
	.gallery_slider_widget.slides3.imgSizeSmall{width: 529px;}
	.gallery_slider_widget.slides3.imgSizeSmall .middle .box_1 {max-width: 175px; max-height: 175px;}
	
	.gallery_slider_widget.slides4.imgSizeSmall{width: 708px;}
	.gallery_slider_widget.slides4.imgSizeSmall .middle .box_1 {max-width: 175px; max-height: 175px;}
	
	.gallery_slider_widget.slides5.imgSizeSmall{width: 884px;}
	.gallery_slider_widget.slides5.imgSizeSmall .middle .box_1 {max-width: 175px; max-height: 175px;}
	
	.gallery_slider_widget.slides6.imgSizeSmall{width: 1060px;}
	.gallery_slider_widget.slides6.imgSizeSmall .middle .box_1 {max-width: 175px; max-height: 175px;}
	
	.gallery_slider_widget.slides7.imgSizeSmall{width: 1238px;}
	.gallery_slider_widget.slides7.imgSizeSmall .middle .box_1 {max-width: 175px; max-height: 175px;}
	
	
	.gallery_slider_widget.galleryType2.imgSizeLarge{width: 586px!important;}
	
	.gallery_slider_widget.galleryType3.imgSizeLarge{width: 887px!important;}
	
	.gallery_slider_widget.slides3.imgSizeLarge{width: 874px;}
	.gallery_slider_widget.slides3.imgSizeLarge .middle .box_1 {max-width: 290px; max-height: 290px;}
	
	.gallery_slider_widget.slides4.imgSizeLarge{width: 1166px;}
	.gallery_slider_widget.slides4.imgSizeLarge .middle .box_1 {max-width: 290px; max-height: 290px;}
	
	.gallery_slider_widget.slides5.imgSizeLarge{width: 1458px;}
	.gallery_slider_widget.slides5.imgSizeLarge .middle .box_1 {max-width: 290px; max-height: 290px;}
	
	.gallery_slider_widget.slides6.imgSizeLarge{width: 1750px;}
	.gallery_slider_widget.slides6.imgSizeLarge .middle .box_1 {max-width: 290px; max-height: 290px;}
	
	.gallery_slider_widget.slides7.imgSizeLarge{width: 2045px;}
	.gallery_slider_widget.slides7.imgSizeLarge .middle .box_1 {max-width: 290px; max-height: 290px;}
	
	.gallery_slider_widget.imgSizeSmall .arrow {top: 68px;}
	.gallery_slider_widget.imgSizeLarge .arrow {top: 128px;}
	
	.gallery_slider_widget.imgSizeSmall .middle .box_1 img{height:175px;}
	.gallery_slider_widget.imgSizeMedium .middle .box_1 img{height:235px;}
	.gallery_slider_widget.imgSizeLarge .middle .box_1 img{height:290px;}
	
	.borderBoxShadow{box-shadow:2px 1px 6px 1px #666666!important;}
	
	span.icons.fl_letters { width: 40px; height: 40px; line-height: 40px; }
	.previewWidgetBox .clearfix{height:1px;}
	.cropper-container.cropper-bg{width:105%!important;}
			...
			<div class="col-md-3">
			  ...
			  <div class="panel-body p0 bkg_white">
				  ...
				  <div class="tab-pane active" id="Configurations">
				   ...
				   <div class="profile_headings">COMPONENTS <a class="pull-right plus_icon" href="#"><i class="icon-arrow-down12 txt_grey fsize15"></i></a></div>
				  <div class="p20">
					<div class="row">
					  <div class="col-md-12"> 
				 ...
				 <div class="profile_headings">Details <a class="pull-right plus_icon" href="#"><i class="icon-arrow-down12 txt_grey fsize15"></i></a></div>
					<div class="p20">
					<div class="form-group">
					<p>Gallery Name</p>
				  ...
				  <div class="p20" style="display:none;">
					...
					<div class="form-group">
						  ...
						  <label class="display-block">
								<input type="hidden" name="logo_img" id="logo_img" class="autoSaveDesign" value="">
				  ...
				  <div class="profile_headings">Branding <a class="pull-right plus_icon" href="#"><i class="icon-arrow-down12 txt_grey fsize15"></i></a></div>
				  <div class="p20">
						...
						<div class="form-group" style="border-bottom: 1px solid #f4f6fa; margin-bottom:0px; padding-bottom:10px;">
