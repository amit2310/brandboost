                ...
                <div class="col-md-7">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="active all"><a style="javascript:void();" id="activeCampaign" class="filterByColumn"
                                                  fil="Publish">All</a></li>
                        <li><a style="javascript:void();" class="filterByColumn" fil="Archive">Archive</a></li>
                    </ul>
                </div>
                <!--=============Button Area Right Side==============-->
                <div class="col-md-5 text-right btn_area">
                    <button type="button" class="btn dark_btn ml10" data-toggle="modal" data-target="#addGallery"><i
                            class="icon-plus3 "></i><span> &nbsp;  Add Gallery</span></button>
                </div>
            </div>
        </div>
        <!--&&&&&&&&&&&& PAGE HEADER END&&&&&&&&&&-->
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="heading-elements">
                                <div style="display: inline-block; margin: 0;"
                                    ...
                                    <input class="form-control input-sm cus_search" tableid="mediaGalleryDataList"
                                ...
                                <div class="table_action_tool">
                                    ...
                                    <a href="javascript:void(0)" id="deleteMediaWidget" class="custom_action_box"
                                       style="display:none;">
                                        <i class="icon-trash position-left"></i>
                                    </a>
                                    <a href="javascript:void(0)" id="archiveButtonMediaWidget" class="custom_action_box"
                                       style="display:none;"><i class="icon-gear position-left"></i></a>
                                ...
                                <tr>
                                    ...
                                    <th style="display: none;" class="nosort editAction"><label
                                            class="custmo_checkbox pull-left"><input type="checkbox" name="checkAll[]"
                                                                                     class="" id="checkAll"><span
                                                class="custmo_checkmark"></span></label></th>
                                    <th><i class=""><img src="{{ base_url() }}assets/images/icon_name.png"></i>Name</th>
                                    <th><i class=""><img src="{{ base_url() }}assets/images/icon_device.png"></i>Media
                                    </th>
                                    <th><i class=""><img src="{{ base_url() }}assets/images/icon_clock.png"></i>Type
                                    </th>
                                    <th><i class=""><img src="{{ base_url() }}assets/images/icon_id.png"></i>Created
                                    </th>
                                    <th><i class=""><img src="{{ base_url() }}assets/images/icon_id.png"></i>Created By
                                    </th>
                                    <th><i class=""><img src="{{ base_url() }}assets/images/icon_action.png"></i>Action
                                    </th>
                                    <th>&nbsp;</th>
                                    <th style="display: none;"></th>
                                </tr>
                                ...
                                <tr id="append-{{ $galleryData->id }}" class="selectedClass">
                                    ...
                                    <td style="display: none;" class="editAction"><label
                                            class="custmo_checkbox pull-left"><input type="checkbox" name="checkRows[]"
                                                                                     class="checkRows"
                                                                                     id="chk{{ $galleryData->id }}"
                                                                                     value="{{ $galleryData->id }}"><span
                                                class="custmo_checkmark"></span></label></td>
                                    <td>
                                        <div class="media-left media-middle"><a class="icons"
                                                                                href="{{ base_url() }}admin/mediagallery/setup/{{ $galleryData->id }}"><img
                                                    ...
                                                    class="img-circle br5 img-xs" alt=""></a></div>
                                        <div class="media-left">
                                            <div class=""><a
                                                    href="{{ base_url() }}admin/mediagallery/setup/{{ $galleryData->id }}"
                                                    class="text-default text-semibold">{{ $galleryData->name }}</a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td><a href="javascript:void(0);" class="getGalleryImage text-muted"
                                           gallery-type="{{ $galleryData->gallery_type }}"
                                           gallery-id="{{ $galleryData->id }}">{{ $galleryData->gallery_type < 3 ? 'Grid' : $galleryData->gallery_type. ' Images' }}</a>
                                    </td>
                                    <td>
                                        <div class="media-left">
                                            <div class="pt-5">
                                            ...
                                            <div
                                                class="text-muted text-size-small">{{ date('h:i A', strtotime($galleryData->created)) }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <div
                                            class="media-left media-middle"> {!! showUserAvtar($createdByData->avatar, $createdByData->firstname, $createdByData->lastname) !!}</div>
                                        <div class="media-left">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right status" style="right: 0;">
                                                @if ($galleryData->status == '1')
                                                    <li><a href="javascript:void(0);" class="updateStatus"
                                                           gallery-id="{{ $galleryData->id }}" data-status="0"><i
                                                ...
                                                <li><a href="javascript:void(0);" class="updateStatus"
                                                       gallery-id="{{ $galleryData->id }}" data-status="0"><i
                                                            class="icon-primitive-dot txt_red"></i> Inactive</a></li>
                                                @else
                                                    <li><a href="javascript:void(0);" class="updateStatus"
                                                           gallery-id="{{ $galleryData->id }}" data-status="1"><i
                                    ...
                                    <td>
                                        <div class="media-left pull-right text-right">
                                            <div class="tdropdown ml10">
                                                <a class="table_more dropdown-toggle" data-toggle="dropdown"><img
                                                ...
                                                <ul style="right: 0;" class="dropdown-menu dropdown-menu-right status">
                                                    ...
                                                    <li><a href="javascript:void(0);" class="editGallery"
                                                           gallery-id="{{ $galleryData->id }}"
                                                           gallery-name="{{ $galleryData->name }}"><i
                                                                class="icon-pencil"></i> Edit</a></li>
                                                    <li><a class="deleteGallery" gallery-id="{{ $galleryData->id }}"
            ...
            <div class="modal-content">
                <form method="post" id="frmUpdateGallery" name="frmUpdateGallery">
                    ...
                    <div class="modal-body" style="padding-bottom:0px;">
                        <p>List Name:</p>
                        <input class="form-control h52" id="editGalleryName" name="editGalleryName"
                               placeholder="Enter Gallery Name" type="text" required>
                    </div>
                    <div class="modal-footer">
                ...
                <form method="post" name="frmAddGallery" id="frmAddGallery" action="javascript:void();">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><img src="{{ base_url() }}assets/css/menu_icons/Email_Color.svg"/>
                            Create Gallery &nbsp; <i class="icon-info22 fsize12 txt_grey"></i></h5>
                    </div>
            ...
            <div class="modal-content">
                <form method="post" name="frmSelectReviews" id="frmSelectReviews" action="javascript:void();">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">×</button>
                        <h5 class="modal-title"><img src="{{ base_url() }}assets/css/menu_icons/Email_Color.svg"/>
                            Select Media &nbsp; <i class="icon-info22 fsize12 txt_grey"></i></h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
