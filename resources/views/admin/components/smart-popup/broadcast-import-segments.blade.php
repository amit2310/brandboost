...
<div class="col-md-12"> <a style="left: 30px; top: 15px;" class="reviews smart-broadcast-import-back slide-toggle bkg_grey_light" ><i class=""><img src="{{ base_url() }}assets/images/icon_arrow_right.png"/></i></a>
    <h5 style="padding-left: 60px;" class="panel-title">Add from segments <span id="totalSegmentCount"> {{ count($aSelectedSegments) }} </span></h5>
            ...
            <table class="table" id="listSmartContacts">
                <thead>
                    <tr>
                        ...
                        <th style="display: none;"></th>
                        <th><i class=""><img src="{{ base_url() }}assets/images/icon_list_small.png"></i>Segment Name</th>
                ...
                <tbody>
                    ...
                    foreach ($oSegments as $oSegment):
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="media-left brig pr10">
                                    <label class="custmo_checkbox ">
                                        <input type="checkbox" class="addSegmentToCampaign" name="checkRows[]" value="{{ $oSegment->id }}" 
										@if (in_array($oSegment->id, $aSelectedSegments)) checked="checked" @endif>
                                ...
                                <div class="media-left">
                                    <div class=""><a href="javascript:void(0);" class="text-default text-semibold">{{ $oSegment->segment_name }}</a> </div>
                                </div>
                            </td>
                            <td class="text-right">
                            ...
                            <td class="text-right">
                                <div class="media-left text-right pull-right">
                                    <div class=""><a href="#" class="txt_grey">{{ dataFormat($oSegment->created) }} <span class="txt_grey">{{ date('h:i A', strtotime($oSegment->created)) }}</span></a> </div>
                                </div>
                            </td>
                            <td class="text-right">
                                <div class="media-left pull-right">
                                    <div class="tdropdown ml10"> <a class="table_more dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><img src="{{ base_url() }}assets/images/more.svg"></a>
                                        <ul class="dropdown-menu dropdown-menu-right more_act">
                                            ...
                                            <li><a href="javascript:void(0);" segment_id="{{ $oSegment->id }}" class="syncContacts"><i class="icon-arrow-down16"></i> Sync Lastest Contacts</a> </li>
                                            <li><a href="javascript:void(0);" segment_id="{{ $oSegment->id }}" class="deleteSegment"><i class="icon-bin"></i> Delete</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
