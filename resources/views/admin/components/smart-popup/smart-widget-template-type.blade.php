									...
									<span class="custmo_checkbox checkboxs">
										<input type="radio"
											@if($brandData->template_style==1)
												checked="checked"
											@endif
											class="template_select" value="1" name="template_type" id="active_soruce1">
										<span class="custmo_checkmark red_tr "></span> 
									</span>
									<figure><img src="/assets/images/brand_page1_icon.png"></figure>
                                    <a class="bot_txt active" href="#">Info & Media</a>
								</div>
                            </label>
                        </div>
                        ...
                        <div class="col-md-2 review_source_new bfwCWBox">
                            <label for="active_soruce2">
                                <div class="inner"> 
									<span class="custmo_checkbox checkboxs">
										<input type="radio"
											   @if($brandData->template_style==2)
											   checked="checked"
											   @endif
											   class="template_select" value="2" name="template_type" id="active_soruce2">
										<span class="custmo_checkmark red_tr "></span> 
									</span>
                                    <figure><img src="/assets/images/brand_page2_icon.png"></figure>
                                    <a class="bot_txt" href="#">Info & Reviews</a>
								</div>
                            </label>
                        </div>
                        ...
                        <div class="col-md-2 review_source_new vpwCWBox">
                            <label for="active_soruce3">
                                <div class="inner"> 
									<span class="custmo_checkbox checkboxs">
										<input type="radio"
											   @if($brandData->template_style==3)
											   checked="checked"
											   @endif
											   class="template_select" value="3" name="template_type" id="active_soruce3">
										<span class="custmo_checkmark red_tr "></span> 
									</span>
                                    <figure><img src="/assets/images/brand_page3_icon.png"></figure>
                                    <a class="bot_txt" href="#">Info & Media 2</a>
								</div>
                            </label>
                        </div>
                    </div>
