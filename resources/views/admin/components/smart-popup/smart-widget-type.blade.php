            ...
            <div class="row" style="height: 100%;">
							...
							<label for="radiocheck_sp_1">
								<div class="inner <?php echo $widgetType == 'bww' ? 'active' : ''; ?>">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_1" type="radio" name="widgetList1" class="selectwidget1" widget-id="bww" <?php echo $widgetType == 'bww' ? 'checked="checked"' : ''; ?>>
									...
									<div class="text_sec">
										...
										<p class="txt_grey"><i class="mr-5"><img src="<?php echo base_url(); ?>assets/images/icon_download_small2.png"/></i>1,395</p>
						...
						<div class="col-md-2 review_source_new bfwCWBox">
							<label for="radiocheck_sp_2">
								<div class="inner <?php echo $widgetType == 'bfw' ? 'active' : ''; ?>">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_2" type="radio" name="widgetList1" class="selectwidget1" widget-id="bfw" <?php echo $widgetType == 'bfw' ? 'checked="checked"' : ''; ?>>
										<span class="custmo_checkmark purple"></span>
									</span>
						...
						<div class="col-md-2 review_source_new cpwCWBox">
							<label for="radiocheck_sp_3">
								<div class="inner <?php echo $widgetType == 'cpw' ? 'active' : ''; ?>">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_3" type="radio" name="widgetList1" class="selectwidget1" widget-id="cpw" <?php echo $widgetType == 'cpw' ? 'checked="checked"' : ''; ?>>
										<span class="custmo_checkmark purple"></span>
									</span>
						...
						<div class="col-md-2 review_source_new vpwCWBox">
							<label for="radiocheck_sp_4">
								<div class="inner <?php echo $widgetType == 'vpw' ? 'active' : ''; ?>">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_4" type="radio" name="widgetList1" class="selectwidget1" widget-id="vpw" <?php echo $widgetType == 'vpw' ? 'checked="checked"' : ''; ?>>
										<span class="custmo_checkmark purple"></span>
									</span>
						...
						<div class="col-md-2 review_source_new rfwCWBox">
							<label for="radiocheck_sp_5">
								<div class="inner <?php echo $widgetType == 'rfw' ? 'active' : ''; ?>">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_5" type="radio" name="widgetList1" class="selectwidget1" widget-id="rfw" <?php echo $widgetType == 'rfw' ? 'checked="checked"' : ''; ?>>
										<span class="custmo_checkmark purple"></span>
									</span>
				...
				<div class="col-md-12">
                	...
                	<div class="btop pb20 pt20">
                		<button type="button" class="btn dark_btn h52 bkg_purple mr20 chooseWidget">Choose Widget</button>
