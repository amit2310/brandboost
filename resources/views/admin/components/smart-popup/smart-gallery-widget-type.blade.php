    ...
    <div style="width: 680px;overflow: hidden; height: 100%;">
        <div style="height: 100%; overflow-y:auto; overflow-x: hidden;">
            ...
            <div class="row" style="height: 100%;">
                <div class="col-md-12">
                    <a style="left: 35px; top: 15px;" class="reviews smart-widget-type slide-toggle bkg_grey_light" ><i class=""><img src="{{ base_url() }}assets/images/icon_arrow_left.png"/></i></a>
					...
					<div class="row p30">
						<div class="col-md-2 review_source_new onerowCWBox" current-class="onerow">
							<label for="radiocheck_sp_1">
								<div class="inner {{ $widgetType == 'onerow' ? 'active' : '' }}">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_1" type="radio" name="widgetDesignType" class="selectwidget1" widget-id="onerow" {{ $widgetType == 'onerow' ? 'checked="checked"' : '' }}>
										<span class="custmo_checkmark purple"></span>
									</span>
									<figure><img src="{{ base_url() }}assets/images/media_inline_4.png"/></figure>
									<div class="text_sec">
						...
						<div class="col-md-2 review_source_new squareCWBox" current-class="square">
							<label for="radiocheck_sp_2">
								<div class="inner {{ $widgetType == 'square' ? 'active' : '' }}">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_2" type="radio" name="widgetDesignType" class="selectwidget1" widget-id="square" {{ $widgetType == 'square' ? 'checked="checked"' : '' }}>
										<span class="custmo_checkmark purple"></span>
									</span>
									<figure><img src="{{ base_url() }}assets/images/media_square_4.png"/></figure>
									<div class="text_sec">
						...
						<div class="col-md-2 review_source_new horizontalCWBox" current-class="horizontal">
							<label for="radiocheck_sp_3">
								<div class="inner {{ $widgetType == 'horizontal' ? 'active' : '' }}">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_3" type="radio" name="widgetDesignType" class="selectwidget1" widget-id="horizontal" {{ $widgetType == 'horizontal' ? 'checked="checked"' : '' }}>
										<span class="custmo_checkmark purple"></span>
									</span>
									<figure><img src="{{ base_url() }}assets/images/media_square_6.png"/></figure>
									<div class="text_sec">
						...
						<div class="col-md-2 review_source_new verticalCWBox" current-class="vertical">
							<label for="radiocheck_sp_4">
								<div class="inner {{ $widgetType == 'vertical' ? 'active' : '' }}">
									<span class="custmo_checkbox checkboxs">
										<input id="radiocheck_sp_4" type="radio" name="widgetDesignType" class="selectwidget1" widget-id="vertical" {{ $widgetType == 'vertical' ? 'checked="checked"' : '' }}>
										<span class="custmo_checkmark purple"></span>
									</span>

									<figure><img src="{{ base_url() }}assets/images/media_square_6_vert.png"/></figure>
									<div class="text_sec">
