...
<div class="col-md-12"> <a style="left: 30px; top: 15px;" class="reviews smart-broadcast-import-back slide-toggle bkg_grey_light" ><i class=""><img src="{{ base_url() }}assets/images/icon_arrow_right.png"/></i></a>
    <h5 style="padding-left: 60px;" class="panel-title">Add from Contacts <span id="totalContactCount">{{ count($aSelectedContacts) }}</span></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-left brig pr10">
                                            <label class="custmo_checkbox ">
                                                <input type="checkbox" name="checkRows[]" class="addToCampaign" value="{{ $oContact->subscriber_id }}" @if (in_array($oContact->subscriber_id, $aSelectedContacts)) checked="checked" @endif>
                                    ...
                                    <td class="text-right">
                                        <div class="media-left text-right pull-right">
                                            <div class=""><a href="#" class="txt_grey">{{ $oContact->phone == '' ? '<span style="color:#999999">Phone Unavailable</span>' : mobileNoFormat($oContact->phone) }}</a> </div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div class="media-left text-right pull-right">
                                            <div class=""><a href="#" class="txt_grey">{{ dataFormat($oContact->created) }} <span class="txt_grey">{{ date('h:i A', strtotime($oContact->created)) }}</span></a> </div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div class="media-left pull-right">
                                            <div class="tdropdown ml10"> <a class="table_more dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><img src="{{ base_url() }}assets/images/more.svg"></a>
                                                <ul class="dropdown-menu dropdown-menu-right more_act">
                                                    ...
                                                    @endif
                                                    <li><a href="{{ base_url() }}admin/contacts/profile/{{ $oContact->subscriber_id }}"><i class="icon-eye"></i> View Details</a></li>
                                                    <li><a href="javascript:void(0);" class="editModuleSubscriber" data-modulesubscriberid="{{ $oContact->id }}" data-modulename="{{ $moduleName }}" data-moduleaccountid="{{ $moduleUnitID }}" data-redirect="admin/lists/getListContacts?list_id={{ $list_id }}"><i class="icon-pencil"></i> Edit</a></li>
