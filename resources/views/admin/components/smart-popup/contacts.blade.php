...
@php
    ...
    $address ="";
    $city = isset($aUInfo->cityName) ? $aUInfo->cityName : '';
    $state = isset($aUInfo->stateName) ? $aUInfo->stateName : '';
    $country = isset($aUInfo->country_code) ? $aUInfo->country_code : '';
    if (empty($country)) {
        $country = 'us';
    }
    $email = $aUInfo->email;
    $mobile = isset($aUInfo->phone) ? $aUInfo->phone : '';
    $gender = isset($aUInfo->gender) ? $aUInfo->gender : '';
...
<div class="smartpopup-container">
    <div class="col-md-5 pr0 brig" style="height: 100%;">
        <div class="p0" style="min-height: 500px;">
            <div class="profile_sec">
                ...
                <div class="profile_headings">Info <a href="javascript:void(0);" class="pull-right"><i
                ...
                <div class="profile_headings">Lists <a href="javascript:void(0);" class="pull-right"><i
                            class="fa fsize15 txt_grey fa-angle-down"></i></a></div>
                ...
                <div class="p20">
                    @if (!empty($getMyLists))
                        ...
                        @endforeach
                        <button style="margin: 0 10px 15px 0!important;" class="btn btn-xs plus_icon mt0"
                                data-toggle="modal" data-target="#chooselistModal"><i class="icon-plus3"></i></button>
                    @else
                        {!! displayNoData() !!}
                    @endif
                </div>

                <div class="profile_headings">Tags <a href="javascript:void(0);" class="pull-right"><i
                            class="fa fsize15 txt_grey fa-angle-down"></i></a></div>
                ...
                <div class="p20">
                    @if (!empty($oTags))
                        ...
                        <button style="margin: 0 10px 15px 0!important;"
                                class="btn btn-xs plus_icon mt0 applyInsightTags" data-subscriber-id="{{$contactId}}"><i
                ...
                <div class="brig">
                    @php
                        ...
                        if (!empty($oOnsite)) {
                    @endphp
                    <div class="profile_headings">On Site Review Campaigns <a href="javascript:void(0);"
                                                                              class="pull-right"><i
                                class="fa fsize15 txt_grey fa-angle-down"></i></a></div>
                    ...
                    @php
                        ...
                        if (!empty($oOffsite)) {
                    @endphp
                    <div class="profile_headings">Off Site Review Campaigns <a href="javascript:void(0);"
                                                                               class="pull-right"><i
                                class="fa fsize15 txt_grey fa-angle-down"></i></a></div>
                    ...
                    @endphp
                    <div class="profile_headings">NPS Campaigns <a href="javascript:void(0);" class="pull-right"><i
                                class="fa fsize15 txt_grey fa-angle-down"></i></a></div>
                    ...
                    @endphp
                    <div class="profile_headings">Referral Campaigns <a href="javascript:void(0);" class="pull-right"><i
                                class="fa fsize15 txt_grey fa-angle-down"></i></a></div>
    ...
    <div class="col-md-7 pl0" style="height: 100%;">
        <div class="bbot">
            ...
            <textarea style="height: 100px;" class="form-control addnote p20" id="notes2"
                      placeholder="Start typing to leave a note..."></textarea>
            <div class="p20 btop pl30">
                <button class="btn dark_btn bkg_blue mr20 addNoteButton2" style="color:#5d7df3!important;">Add Note
                </button>
                <a href="javascript:void(0);">
                    <i class=""><img width="10" src="{{ base_url() }}assets/images/icon_hash.png"/></i>
                </a>
                &nbsp; &nbsp; <a href="javascript:void(0);">
                    <i class=""><img width="10" src="{{ base_url() }}assets/images/icon_atrate.png"/></i>
                </a>
            </div>
        </div>
                ...
                <div class="pt0 p10" style="min-height:500px;">
                            ...
                            <tr class="activityShow" style="{!! $display !!}">
                                <td>
                                    <div class="media-left media-middle">
                                        <a class="icons s28" style="cursor: pointer;">{!! $icon !!}</a>
                                    </div>
                                    <div class="media-left">
                                        <div class="pt-5">
                                            <a href="#"
                                               class="text-default text-semibold">{{ $value->activity_message }}</a>
                                        </div>
                    ...
                    @if(!empty($userActivities))
                        @if (count($userActivities) > 10)
                            <div class="loadMoreRecord loadMoreRecordActivity text-center">
                                <a style="cursor: pointer;" class="loadMoreActivity">
                                    Load more
                                </a>
                                <img class="loaderImage hidden" src="{{ base_url() }}assets/images/widget_load.gif"
            ...
            <div class="tab-pane" id="Email">
                <div class="pt0 p10" style="min-height:500px;">
                    ...
                    @if (!empty($result))
                        <table class="table new">
                            ...
                            <tr class="emailsShow" style="{!! $display !!}">
                                <td>
                                    ...
                                    <div class="media-left">
                                        <div class="pt-5">
                                            <span class="text-default text-semibold">{{ $value['title'] . ' - ' . $value['name'] . '' }}</span>
                                        </div>
                        ...
                        @if ($emailInc > 10)
                            <div class="loadMoreRecord loadMoreRecordEmail">
                                <a style="cursor: pointer;" class="loadMoreEmail">Load more</a>
                                <img class="loaderImage hidden" src="{{ base_url() }}assets/images/widget_load.gif"
                                     width="20px" height="20px">
                            </div>
                        @endif
            ...
            <div class="tab-pane" id="SMS">
                <div class="pt0 p10" style="min-height:500px;">
                    ...
                    @if (!empty($result))
                        <table class="table new">
                            ...
                            <tr class="smsShow" style="{!! $display !!}">
                                <td>
                                    ...
                                    <div class="media-left">
                                        <div class="pt-5"><span
                                                class="text-default text-semibold">{{ $value['title'] . ' - ' . $value['name'] . '' }}</span>
                                        </div>
                        ...
                        @if ($smsInc > 10)
                            <div class="loadMoreRecord loadMoreRecordSms">
                                <a style="cursor: pointer;" class="loadMoreSms">Load more</a>
                                <img class="loaderImage hidden" src="{{ base_url() }}assets/images/widget_load.gif"
                                     width="20px" height="20px">
                            </div>
                        @endif
