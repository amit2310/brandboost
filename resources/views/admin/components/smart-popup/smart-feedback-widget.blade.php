    ...
    <div style="width: 680px;overflow: hidden; height: 100%;">
        <div style="height: 100%; overflow-y:auto; overflow-x: hidden;">
            <div class="row" style="height: 100%;">
                <div class="col-md-12">
                    <a style="left: 35px; top: 15px;" class="reviews smart-feedback slide-toggle bkg_grey_light">
...
<a style="position: fixed; top: 50%; right: 12px; display:none;" class="reviews smart-feedback slide-toggle visible {{ @$bgClass }}">
