...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/dropzone-master/dist/dropzone.js"></script>
	  ...
	  <!--&&&&&&&&&&&& PAGE HEADER &&&&&&&&&&-->
		<div class="page_header">
		  ...
		  <!--=============Headings & Tabs menu==============-->
			<div class="col-md-5">
			  <h3 class="mt30"><img width="18" src="<?php echo base_url(); ?>assets/images/plus_icon_purple.png"/> Add Question</h3>
			</div>
	  ...
	  <!--&&&&&&&&&&&& PAGE HEADER END&&&&&&&&&&-->
		...
		<div class="row">
			<div class="col-md-6">
				...
				<input type="hidden" name="fullname" class="display_name" value="<?php echo $aUser->firstname.' '.$aUser->lastname; ?>">
				<input type="hidden" name="emailid" class="display_email" value="<?php echo $aUser->email; ?>">
				<input type="hidden" name="phone" class="change_phone" value="<?php echo $aUser->mobile; ?>">
				...
				<div class="panel panel-flat">
				  ...
				  <div class="form-group">
				 	...
				 	<?php 
				 	 ...
				 	 ?><select class="h52 form-control changeCampaign"><?php
...
<script>
    ...
    $(document).ready(function() {
		...
		$("#frmQuestionSubmit").submit(function () {
			...
			$('.overlaynew').show();
			$.ajax({
				url: "<?php echo base_url('/admin/questions/saveManualQuestion'); ?>",
				type: "POST",
				data: formdata,
				contentType: false,
				cache: false,
