...
<div class="content">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title"><?php echo 'Question : ' . $question->question; ?></h6>
                    <div class="heading-elements">
                        <span class="label bg-success heading-text"><?php echo count($result); ?> Answers</span>
                        ...
                        <tbody>
                            ...
                            foreach ($result as $data) {
                                ...
                                <tr id="append-<?php echo $data->id; ?>" class="selectedClass">
                                    ...
                                    <td><?php echo base64_decode($data->answer); ?></td>
    ...
    <?php
    if ($data->status == 1) {
        echo "<li><a style='cursor:pointer' answer_id='" . $data->id . "' change_status = '0' title='Disapproved this answer.' class='chg_status'><i class='icon-gear'></i>Disapproved</a></li>";
    } else if ($data->status == 2) {
        echo "<li><a style='cursor:pointer' answer_id='" . $data->id . "' change_status = '1' title='Approved this answer.' class='chg_status'><i class='icon-gear'></i>Approved</a>&nbsp; / &nbsp;";
        echo "<li><a style='cursor:pointer' answer_id='" . $data->id . "' change_status = '0' title='Disapproved this answer.' class='chg_status'><i class='icon-gear'></i>Disapproved</a></li>";
    } else {
        echo "<li><a style='cursor:pointer' answer_id='" . $data->id . "' change_status = '1' title='Approved this answer.' class='chg_status'><i class='icon-gear'></i>Approved</a></li>";
    }
    ?>

                                                    <li><a href="javascript:void(0);" class="answerEdit" quesID="<?php echo $question->id; ?>" ansID="<?php echo $data->id; ?>" ><i class="icon-gear"></i> Edit</a></li>

                                                    <li><a href="javascript:void(0);" class="answerDelete" quesID="<?php echo $question->id; ?>" ansID="<?php echo $data->id; ?>" ><i class="icon-trash"></i> Delete</a></li>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
                    ...
                    closeOnCancel: true
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                $('.overlaynew').show();
                                $.ajax({
                                    url: '<?php echo base_url('admin/questions/deleteAnswers'); ?>',
                                    type: "POST",
        ...
        $(document).on('click', '.answerEdit', function () {
            ...
            $.ajax({
                url: '<?php echo base_url('admin/questions/get_answer_by_Id'); ?>',
                type: "POST",
        ...
        $("#updateAnswerTemplate").submit(function () {
            ...
            $.ajax({
                url: '<?php echo base_url('admin/questions/update_answer'); ?>',
                type: "POST",
