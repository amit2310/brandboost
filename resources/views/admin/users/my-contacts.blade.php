    ...
    <div class="page_header">
        <div class="row">
            ...
            <div class="col-md-9 text-right btn_area">
                ...
                <button type="button" class="btn dark_btn ml20" data-toggle="modal" data-target="#addContact"><i class="icon-plus3"></i><span> &nbsp;  Add Contact</span> </button>
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            ...
                            <div class="heading-elements">
                                ...
                                <button id="deleteContactsBtn" class="btn btn-xs custom_action_box"><i class="icon-trash position-left m0"></i></button>
                                <button id="archiveContactsBtn" class="btn btn-xs custom_action_box"><i class="icon-gear position-left m0"></i></button>
                            </div>
                        </div>
        ...
        <div class="tab-pane" id="right-icon-tab1">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h6 class="panel-title"><?php echo count($archiveContacts); ?> Contacts</h6>
                            <div class="heading-elements">
                                <div style="display: inline-block; margin: 0;" class="form-group has-feedback has-feedback-left">
                                    <input class="form-control input-sm cus_search" placeholder="Search by name" type="text">
                                    <div class="form-control-feedback">
                                ...
                                <button id="deleteArchiveContacts" class="btn btn-danger btn-xs lgrey custom_action_box_archive">Delete</button>
                            </div>
                        </div>
                            ...
                            <table class="table datatable-basic datatable-sorting">
                                <thead>
                                    ...
                                    <tr>
                                        <th style="display: none;"></th>
                                        <th style="display: none;"></th>
                                        <th style="display: none;" class="nosort editArchiveAction"><label class="custmo_checkbox pull-left"><input type="checkbox" name="checkAll[]" class="" id="checkAllArchive" ><span class="custmo_checkmark"></span></label></th>
                                        <th><i class="icon-user"></i>Name</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($archiveContacts as $oContact) {
                                        ...
                                        <tr id="append-<?php echo $oContact->id; ?>" class="selectedClass">
                                            <td style="display: none;"><?php echo date('m/d/Y', strtotime($oContact->created)); ?></td>
                                            <td style="display: none;"><?php echo $oContact->id; ?></td>
                                            <td style="display: none;" class="editArchiveAction"><label class="custmo_checkbox pull-left"><input type="checkbox" name="checkRows[]" class="checkRowsArchive" value="<?php echo $oContact->id; ?>" id="chk<?php echo $oContact->id; ?>"><span class="custmo_checkmark"></span></label></td>
                                            <td>
                                                <div class="media-left media-middle"> <a href="#"><img src="http://brandboost.io/admin_new/images/userp.png" class="img-circle img-xs" alt=""></a> </div>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-xs btn_white_table pr10"><?php echo $oContact->status == 1 ? '<i class="icon-primitive-dot txt_green"></i> Active' : '<i class="icon-primitive-dot txt_red"></i> Archive'; ?></button>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="tdropdown">
                                                    <button type="button" class="btn btn-xs btn_white_table ml20 dropdown-toggle" data-toggle="dropdown"><i class="icon-more2 txt_blue"></i></button>
                                                    <ul class="dropdown-menu dropdown-menu-right width-200">
														<li><a  subscriberId='<?php echo $oContact->id; ?>' change_status = '1' class='chg_status'><i class='icon-file-locked'></i> Move To Active Contact</a></li>
                                                        <li><a href="javascript:void(0);" class="editSubscriber" subscriberid="<?php echo $oContact->id; ?>"><i class="icon-pencil"></i> Edit</a></li>
...
<script>
    ...
    $(document).ready(function () {
            ...
            if (val.length === 0) {
				...
				function (isConfirm) {
					if (isConfirm) {
						$('.overlaynew').show();
						$.ajax({
							url: '<?php echo base_url('admin/contacts/deleteBulkContacts'); ?>',
							type: "POST",
            ...
            if (val.length === 0) {
				...
				function (isConfirm) {
					if (isConfirm) {
						$('.overlaynew').show();
						$.ajax({
							url: '<?php echo base_url('admin/contacts/archiveBulkContacts'); ?>',
							type: "POST",
							data: {multipal_record_id: val},
							dataType: "json",
							success: function (data) {
            ...
            swal({
                ...
                closeOnCancel: true
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                url: '<?php echo base_url('admin/contacts/delete_contact'); ?>',
                                type: "POST",
        ...
        $(document).on('click', '.chg_status', function () {
            ...
            $.ajax({
                url: '<?php echo base_url('admin/contacts/update_status'); ?>',
                type: "POST",
        ...
        $(document).on('click', '.editSubscriber', function () {
            var contactID = $(this).attr('subscriberid');
            $.ajax({
                url: '<?php echo base_url('admin/contacts/get_contact_info'); ?>',
                type: "POST",
        ...
        $("#updateSubscriberDataForm").submit(function (e) {
            ...
            var formData = new FormData($(this)[0]);
            $.ajax({
                url: '<?php echo base_url('admin/contacts/update_contact_info'); ?>',
                type: "POST",
                data: formData,
                contentType: false,
                cache: false,
