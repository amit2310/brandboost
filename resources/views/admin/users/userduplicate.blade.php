...
<div class="content">
	...
	<div class="row mb20">
		<div class="col-lg-12 text-right">
			...
			<button data-toggle="modal" data-target="#userLevelAdd" type="button" class="btn btn-default"><i class="icon-make-group position-left"></i> ADD USER </button>
			...
			<div class="panel panel-flat">
				...
				<div class="table-responsive">
					<table class="table text-nowrap dataTable">
						<thead>
							<tr>
								<th class="col-md-3 sorting sortingAction" sort_type_element="DESC" sort_by_element="firstname">NAME</th>
								<th class="col-md-3 sorting sortingAction" sort_type_element="ASC" sort_by_element="email">EMAIL</th>
								<th class="col-md-2 text-center sorting sortingAction" sort_type_element="ASC" sort_by_element="created">DATE CREATED</th>
								<th class="col-md-2 text-center sorting sortingAction" sort_type_element="ASC" sort_by_element="status">CURRENT STATUS</th>
