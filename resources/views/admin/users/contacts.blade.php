                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        ...
                        <div class="heading-elements">
                            <span class="label bg-success lgraybtn heading-text">{{ count($usersdata) }} users</span>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table text-nowrap datatable-sorting" id="allContact">
                            ...
                            <tr>
                                ...
                                <th style="display: none;"></th>
                                <th style="width: 40px!important;" class="nosort"><input type="checkbox"
                                                                                         name="checkAll[]" class=""
                                                                                         id="checkAll"></th>
                            ...
                            <tr id="append-{{ $data->id }}" class="selectedClass">
                                ...
                                <td style="width: 40px!important;"><input type="checkbox" name="checkRows[]"
                                                                          class="checkRows" value="{{ $data->id }}">
                                </td>
                                <td>
                                    ...
                                    <div class="media-left">
                                        ...
                                        <div
                                            class="text-muted text-size-small">{{ $data->mobile == '' ? '<span style="color:#999999">Phone Unavailable</span>' : $data->mobile }}</div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div style="padding-right: 10px!important;" class="media-left media-middle">
                                        ...
                                        <img src="{{ base_url() }}/assets/images/email_icon2.png"
                                             class="img-circle img-xs" alt="">
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a style="cursor: pointer;" class="deleteContact"
                                                       delId="{{ $data->id }}"><i class="icon-gear"></i> Delete</a></li>
                ...
                <form method="post" class="form-horizontal" id="updateUsers" action="javascript:void();">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Last Name</label>
                            <div class="col-lg-9">
                                <input name="lastname" id="e_lastname" class="form-control" value="" type="text"
                                       required>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-link" data-dismiss="modal"><i class="icon-cross"></i> Close</button>
                        <button type="submit" id="updateButton" class="btn btn-primary"><i class="icon-check"></i>
                            Update
                        </button>
                    </div>
                </form>
