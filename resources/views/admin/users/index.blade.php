    ...
    <div class="content">
        ...
        <div class="row mb20">
            <div class="col-lg-12 text-right">
                ...
                <button data-toggle="modal" data-target="#userLevelAdd" type="button"
                        class="btn bl_cust_btn btn-default"><i class="icon-make-group position-left"></i> ADD USER
                </button>
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                $('.overlaynew').show();
                                $.ajax({
                                    url: "{{ base_url('admin/users/deleteUsers') }}",
                                    type: "POST",
