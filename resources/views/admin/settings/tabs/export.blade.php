<div class="tab-pane @if($seletedTab=='export') active @endif" id="right-icon-tab6">
    <div class="row"> 
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><a href="{{ base_url() }}admin/tags/exportTags"><img src="{{ base_url() }}assets/images/icon_tab.png" width="27"></a></div>
                                <p class="mb0">Export Tags</p>
                            </div>
                        </div>
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><a href="{{ base_url() }}admin/brandboost/exportMedia"><img src="{{ base_url() }}assets/images/icon_media.png" width="27"></a></div>
                        ...
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><a href="{{ base_url() }}admin/subscriber/exportSubscriberCSV?module_name=people&module_account_id={{ $oUser->id }}"><img src="{{ base_url() }}assets/images/contact_icon.png" width="27"></a></div>
                                <p class="mb0">Export Contacts</p>
                            </div>
                        </div>
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><a href="{{ base_url() }}admin/brandboost/exportReviews"><img src="{{ base_url() }}assets/images/icon_star.png" width="27"></a></div>
            ...
            <div class="panel panel-flat review_ratings">
                ...
                <div class="panel-body p0">
                    <table class="table datatable-basic-new">
                        <tbody>
                            @if(!empty($oExportHistory)) 
								@foreach($oExportHistory as $oHistory)
									<tr>
										<td><div class="media-left media-middle"> <a class="icons br5" href="#"><i class="icon-arrow-up16 txt_purple"></i></a> </div>
											<div class="media-left">
												<div class="pt-5"><a href="#" class="text-default text-semibold">Export {{ $oHistory->export_name }}</a></div>
											</div></td>
											<td class="text-right"><span class="text-muted">{{ date("d M Y", strtotime($oHistory->created)) }} &nbsp;&nbsp;{{ date("h:iA", strtotime($oHistory->created)) }}</span></td>
