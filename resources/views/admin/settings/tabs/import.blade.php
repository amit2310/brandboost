<div class="tab-pane <?php if($seletedTab=='import'):?>active<?php endif;?>" id="right-icon-tab5">
    <div class="row"> 
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><a href="javascript:void(0);"><img class="importModuleContact" data-modulename="people" data-moduleaccountid="<?php echo $oUser->id;?>" data-redirect="<?php echo base_url();?>admin/settings" src="<?php echo base_url(); ?>assets/images/contact_icon.png" width="27"></a></div>
                                <p class="mb0">Import Contacts</p>
                            </div>
                        </div>
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><img src="<?php echo base_url(); ?>assets/images/icon_star.png" width="27"></div>
                                <p class="mb0">Import Reviews</p>
                            </div>
                        </div>
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><img src="<?php echo base_url(); ?>assets/images/icon_tab.png" width="27"></div>
                                <p class="mb0">Import Tags</p>
                            </div>
                        </div>
                        <div class="col-md-3 text-center">
                            <div class="import_box">
                                <div class="img_icon mb20"><img src="<?php echo base_url(); ?>assets/images/icon_media.png" width="27"></div>
                ...
                <div class="panel-body p0">
                    <table class="table datatable-basic-new">
                        <tbody>
                            ...
                            <?php if(!empty($oImportHistory)): foreach($oImportHistory as $oHistory):?>
                            
                            <tr>
                                <td><div class="media-left media-middle"> <a class="icons br5" href="#"><i class="icon-arrow-down16 txt_purple"></i></a> </div>
                                    <div class="media-left">
                                        <div class="pt-5"><a href="#" class="text-default text-semibold">Import <?php echo $oHistory->import_name;?></a></div>
                                    </div></td>
                                <td class="text-right"><span class="text-muted"><?php echo date("d M Y  h:iA", strtotime($oHistory->created));?></span></td>
