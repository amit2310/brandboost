        ...
        <div class="col-md-3">
            <div class="panel panel-flat review_ratings">
                ...
                <div class="panel-body min_h405 p40 pt60 info_card text-center">
                    <div class="img_icon mb20"><img src="{{ base_url() }}assets/images/icon_credit.png" width="35"></div>
            ...
            <div class="modal-body">
                ...
                <table class="table table-hover table-striped table-bordered text-left mb-20">
                    ...
                    <tr>
                        <td>Current Plan :</td>
                        <td>
							{{ !empty($oCurrentTopupMembership->level_name) ? $oCurrentTopupMembership->level_name : 'No topup plan subscribed yet' }}
                        </td>
                    </tr>
                    <tr>
                        <td>Upgrade to :</td>
    ...
    $(document).ready(function () {
        ...
        $("#confirmTopupLevelUpdate").click(function () {
            ...
            if ($('#topuplvltermsCondition').is(":checked") == true) {
                $.ajax({
                    url: "{{ base_url('payment/upgradeTopupMembership') }}",
                    type: "POST",
                    data: {
