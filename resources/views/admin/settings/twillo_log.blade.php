			...
			<div class="panel panel-flat">
				...
				@endphp
						<tr>
							...
							<td style="display:none;">{{ $detail->user_id }}</td>
							<td>{{ $detail->firstname.' '.$detail->lastname }}</td>
							<td>{{ $detail->email }}</td>
							<td>{{ $detail->contact_no }}</td>
							<td>{{ '$'.number_format($getUsage,2) }}</td>
							<td>
								<div class="tdropdown"> 
									...
									<li><a href="{{ base_url('admin/settings/team_accounts/' . $detail->user_id) }}" user_id="35" class="systemNotiSmartPopup"><i class="icon-arrow-down16"></i>View Team Member Accounts</a> </li>
									<li><a href="{{ base_url('admin/settings/list_client_details/' . $detail->user_id) }}" user_id="35" class="systemNotiSmartPopup"><i class="icon-arrow-down16"></i>View Nmumber Details</a> </li>
									</ul>
								</div>
							</td>
						</tr>
