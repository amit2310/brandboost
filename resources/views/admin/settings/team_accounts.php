                              ...
                              <div class="panel-heading"> 
                                ...
                                ?>
                               	<tr>
                               		...
                               		<td><?php echo $detail->bb_number; ?></td>
                               		<td><?php echo '$'.$getUsage; ?></td>
                                ...
                                <li><a href="<?php echo base_url('admin/settings/list_details/' . $detail->id); ?>" user_id="35" class="systemNotiSmartPopup"><i class="icon-arrow-down16"></i>View Nmumber Details</a> </li>
