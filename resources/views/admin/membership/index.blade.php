    ...
    <div class="content">
        <div class="row mb20">
            <div class="col-lg-12 text-right">
                <a style="margin-left: 20px;" data-toggle="modal" data-target="#membershipLevel"
                   class="btn bl_cust_btn btn-default" href="#"><i class="icon-make-group position-left"></i> ADD
                    MEMBERSHIP LEVEL</a>
            </div>
        </div>
                    ...
                    <div class="panel-body">
                        <div class="tabbable">
                            <ul class="nav nav-tabs nav-tabs-bottom">
                                <li class="active"><a href="#right-icon-tab0" data-toggle="tab">Membership Levels <i
                                            class="icon-file-text position-right"></i></a></li>
                                <li><a href="#right-icon-tab1" data-toggle="tab">Topup Membership <i
                                            class="icon-menu7 position-right"></i></a></li>
                                <li><a href="#right-icon-tab2" data-toggle="tab">Topup <i
                                            class="icon-menu7 position-right"></i></a></li>
                            </ul>
                                                                    ...
                                                                    <li class="dropdown">
                                                                        <a href="#" class="dropdown-toggle"
                                                                           data-toggle="dropdown"><i
                                                                                class="icon-menu7"></i> <span
                                                                                class="caret"></span></a>
                                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                                            <li><a href="#"><i class="icon-sync"></i>
                                                                                    Update data</a></li>
                                                                            <li><a href="#"><i
                                                ...
                                                <div class="table-responsive">
                                                    <div class="custom_action_box">
                                                        <button id="deleteMembershipBtn"
                                                                class="btn btn-danger btn-xs lgrey">Delete
                                                        </button>
                                                    </div>
                                                    <input name="min" id="min" type="hidden">
                                                    <input name="max" id="max" type="hidden">
                                                    <table
                                                        class="table text-nowrap datatable-sorting blef0 brig0 membershipTable"
                                                        id="membershipLevelN">
                                                        <thead>
                                                        <tr>
                                                            <th style="display: none;"></th>
                                                            <th style="display: none;"></th>
                                                            <th style="width: 40px!important;" class="nosort"><input
                                                                    type="checkbox" name="checkAll[]" class=""
                                                                    id="checkAll"></th>
                                                            <th>Level Name</th>
                                                            <th>Price</th>
                                                            <th>Credits</th>
                                                        ...
                                                        @foreach ($membership_data as $data)
                                                            @if ($data->type == 'membership')
                                                                <tr id="append-{{ $data->id }}" class="selectedClass">
                                                                    ...
                                                                    <td style="width: 40px!important;"><input
                                                                            type="checkbox" name="checkRows[]"
                                                                            class="checkRows" id="chk{{ $data->id }}"
                                                                            value="{{ $data->id }}"></td>
                                                                    <td>{{ $data->level_name }}</td>
                                                                    <td>
                                                                        ${{ number_format($data->price, 2) }}/@if
                                                                    ...
                                                                    <td>
                                                                        <h6 class="text-semibold">
                                                                            ...
                                                                            <div class="text-muted text-size-small">
                                                                                {{ date('h:i A', strtotime($data->created)) }}
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        @else
                                                                            <span
                                                                                class="label bg-danger">Inactive</span>
                                                                        @endif
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <ul class="icons-list">
                                                        ...
                                                        @foreach ($membership_data as $data)
                                                            @if ($data->type == 'topup-membership')
                                                                <tr id="append-{{ $data->id }}" class="selectedClass">
                                                                    ...
                                                                    <td>{{ number_format($data->contact_limit) }}</td>
                                                                    <td>
                                                                        <h6 class="text-semibold">{{ date('M d, Y', strtotime($data->created)) }}
                                                                            <div
                                                                                class="text-muted text-size-small">{{ date('h:i A', strtotime($data->created)) . ' (' . timeAgo($data->created) . ')' }}</div>
                                                                        </h6>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        @if ($data->status == 1)
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table
                                                        ...
                                                        @foreach ($membership_data as $data)
                                                            @if ($data->type == 'topup')
                                                                <tr>
                                                                <tr id="append-topup-{{ $data->id }}"
                                                                    class="selectedClass">
                                                                    <td style="display: none;">{{ date('m/d/Y', strtotime($data->created)) }}</td>
                                                                    <td style="display: none;">{{ $data->id }}</td>
                                                                    <td style="width: 40px!important;"><input
                                                                            type="checkbox" name="checkRows[]"
                                                                            class="checkRows-topup"
                                                                            id="chk{{ $data->id }}"
                                                                            value="{{ $data->id }}"></td>
                                                                    <td>{{ $data->level_name }}</td>
            ...
            <div class="modal-content">
                <form method="post" class="form-horizontal" id="addTopup" action="javascript:void();">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                ...
                                <input class="form-control" name="level_name" id="level_name" value=""
                                       placeholder="Basic" type="text" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="topup_price" id="topup_price" value=""
                                       placeholder="$29" type="text" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="credits" placeholder="Enter number of credits"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="addButtonTop" class="btn btn-primary"><i class="icon-check"></i> Save
                        </button>
                    </div>
                </form>
            </div>
                ...
                <form method="post" class="form-horizontal" id="addMembership" action="javascript:void();">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="level_name" placeholder="Enter Plan Name" type="text"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="invoice_name" placeholder="Enter Plan Name"
                                       type="text" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="contact_limit" placeholder="Enter contact limit"
                                       type="number" required>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-link" data-dismiss="modal"><i class="icon-cross"></i> Close</button>
                        <button type="submit" id="addButtonMem" class="btn btn-primary"><i class="icon-check"></i> Save
                        </button>
                    </div>
                </form>
            </div>
                ...
                <form method="post" class="form-horizontal" id="updateMembership" action="javascript:void();">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Plan Name</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="level_name" value="" id="e_level_name"
                                       placeholder="Basic" type="text" required>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Invoice Name</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="invoice_name" id="e_invoice_name"
                                       placeholder="Enter Invoice Name" type="text" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Price($)</label>
                            <div class="col-lg-7">
                                <input class="form-control" name="price" value="" id="mem_price"
                                       placeholder="Enter the price" type="text" required>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Credits</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="credits" value="" id="mem_credits"
                                       placeholder="Enter number of credits" type="number" required>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Contact Limit</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="contact_limit" value="" id="mem_contact_limit"
                                       placeholder="Enter contact limit" type="number" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-link" data-dismiss="modal"><i class="icon-cross"></i> Close</button>
                        <button type="submit" id="updateButtonMem" class="btn btn-primary"><i class="icon-check"></i>
                            Update
                        </button>
                    </div>
                </form>
                ...
                <form method="post" class="form-horizontal" id="updateTopup" action="javascript:void();">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input name="type" value="topup" type="hidden">
                                <input class="form-control" name="level_name" id="t_level_name" value=""
                                       placeholder="Basic" type="text" required>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Price</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="topup_price" id="t_topup_price" value=""
                                       placeholder="$29" type="text" required>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-link" data-dismiss="modal"><i class="icon-cross"></i> Close</button>
                        <button type="submit" id="updateButtonTop" class="btn btn-primary"><i class="icon-check"></i>
                            Update
                        </button>
                    </div>
                </form>
