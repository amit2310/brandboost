        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    @endphp"><a href="{{ url('/admin/dashboard') }}"><strong class="nav_icon icon_dashboard"></strong> <span>Dashboard</span></a></li>
                    <li class="@php
                    if ($pageName == 'live') {
                        echo 'active';
                    }
                    @endphp"><a href="{{ url('/admin/live') }}"><strong class="nav_icon icon_live"></strong> <span>Live</span></a></li>
                    <li class="@php
                    if ($pageName == 'contacts') {
                        echo 'active';
                    }
                    @endphp"> <a href="{{ url('/admin/contacts/mycontacts') }}"><strong class="nav_icon icon_people"></strong> <span>Contacts</span></a>
                    ...
                    <li id="menu-templates"><a href="#"><strong class="nav_icon icon_brand"></strong> <span>Templates</span></a>
                        <ul id="menu-templates-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/templates/email') }}"><i class="icon-menu6"></i> Emails</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/templates/sms') }}"><i class="fa fa-circle"></i> SMS</a></li>
                    ...
                    <li id="menu-analytics"><a href="#"><strong class="nav_icon icon_analytics"></strong> <span>Analytics</span></a>
                        <ul id="menu-analytics-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/reports') }}"><i class="icon-menu6"></i> Reports</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/responseperformance') }}"><i class="fa fa-circle"></i> Response Report</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/servicereports') }}"><i class="fa fa-circle"></i> Service Profile</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/reportsOptOut') }}"><i class="fa fa-circle"></i>Opt Out</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/insightTags') }}"><i class="fa fa-circle"></i> Insight Tags Report</a></li>
                    ...
                    <li class="navigation-header servises-1"><span class="">Communication</span> <i class="icon-menu" title="" data-original-title="Appearance"></i></li>
                     ...
                     <li id="chat-onsite" class="listt0"><a href="javascript:void(0)"><strong class="nav_icon icon_chat"></strong> <span>Chat</span></a>
                        <ul id="chat-websms" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/smschat') }}"><i class="fa fa-circle"></i>Sms Chat</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/webchat') }}"><i class="fa fa-circle"></i>Web Chat</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/chat/overview') }}"><i class="fa fa-circle"></i>Web Chat Overview</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/chatshortcut') }}"><i class="fa fa-circle"></i>Chat Shortcut</a></li>
                    ...
                    <li id="menu-site-boost" class="listt"><a href="#"><strong class="nav_icon icon_offsite"></strong> <span>On Site Reviews</span> @if(!empty($onBrandBoostCount))<span class="label bg-blue-400 menubadge">{{ $onBrandBoostCount }}</span>@endif</a>
                        <ul id="menu-site-boost-submenu" class="hidden-ul">
                         <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/onsite_overview') }}"><i class="fa fa-circle"></i> Overview</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/onsite') }}"><i class="fa fa-circle"></i> Campaigns</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/reviews/') }}"><i class="fa fa-circle"></i> Reviews</a></li>
                    ...
                    <li id="menu-offsite-boost" class="listt"><a href="#"><strong class="nav_icon icon_onsite"></strong> <span>Off Site Reviews</span> @if(!empty($offBrandBoostCount))<span class="label bg-blue-400 menubadge">{{ $offBrandBoostCount }}</span>@endif </a>
                        <ul id="menu-offsite-boost-submenu" class="hidden-ul">
                         ...
                         <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/offsite_overview') }}"><i class="fa fa-circle"></i> Overview</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/offsite') }}"><i class="fa fa-circle"></i> Campaigns</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/feedback/listall/') }}"><i class="fa fa-circle"></i>Negative Feedback</a>
                            </li>
                    ...
                    <li id="menu-email" class="listt"><a href="#"><strong class="nav_icon icon_email"></strong> <span>Email</span> </a>
                        <ul id="menu-email-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/modules/emails/overview') }}"><i class="fa fa-circle"></i> Overview</a>
                            </li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/modules/emails') }}"><i class="fa fa-circle"></i> Automation</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/broadcast/email') }}"><i class="fa fa-circle"></i> Broadcast</a></li>
                            <li class="@php
                    ...
                    <li id="menu-sms" class="listt"><a href="#"><strong class="nav_icon icon_sms"></strong> <span>SMS</span> <span class="label bg-blue-400 menubadge"></span></a>
                        <ul id="menu-sms-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/broadcast/smsoverview') }}"><i class="fa fa-circle"></i> Overview</a>
                            </li>
                            ...
                            @endphp"><a href="{{ url('admin/modules/emails/sms') }}"><i class="fa fa-circle"></i> Automation</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/broadcast/sms') }}"><i class="fa fa-circle"></i> Broadcast</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/lists/smslists') }}"><i class="fa fa-circle"></i> Lists</a></li>

                        </ul>
                    </li>
                    
                    <li class="@if ($pageSeName == 'mysegments') active @endif"> <a href="{{ url('admin/broadcast/mysegments') }}"><strong class="nav_icon icon_segment"></strong> <span>Segments</span></a>
                    ...
                    <li id="menu-brand" class="listt"><a href="#"><strong class="nav_icon icon_brand"></strong> <span>Brand Page</span> <span class="label bg-blue-400 menubadge"></span></a>
                        <ul id="menu-brand-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/settings') }}"><i class="fa fa-circle"></i> Brand Setting</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/brand_configuration') }}"><i class="fa fa-circle"></i> Universal Brand Page</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/campaign_specific') }}"><i class="fa fa-circle"></i> Campaign Specific</a></li>
                    ...
                    <li id="menu-widgets" class="listt"><a href="#"><strong class="nav_icon icon_widget"></strong> <span>Widgets</span> </a>
                        <ul id="menu-widgets-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/widget_overview') }}"><i class="fa fa-circle"></i> <span>Overview</span> </a></li>
                            ...
                            @endphp"><a href="{{ url('admin/brandboost/widgets') }}"><i class="fa fa-circle"></i> <span>Onsite Widgets</span> @if(!empty($widgetCount))<span class="label bg-blue-400 menubadge">{{ $widgetCount }}</span>@endif</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/modules/chat/') }}"><i class="fa fa-circle"></i> <span>Chat Widgets </span> @if(!empty($chatCount))<span class="label bg-blue-400 menubadge">{{ $chatCount }}</span>@endif</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/modules/nps/widgets') }}"><i class="fa fa-circle"></i> <span>NPS Widgets </span> @if(!empty($npsWidgetCount))<span class="label bg-blue-400 menubadge">{{ $npsWidgetCount }}</span>@endif</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/modules/referral/widgets') }}"><i class="fa fa-circle"></i> <span>Referral Widgets </span> @if(!empty($referralWidgetCount))<span class="label bg-blue-400 menubadge">{{ $referralWidgetCount }}</span>@endif</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/mediagallery') }}"><i class="fa fa-circle"></i> <span>Media Widgets </span><span class="label bg-blue-400 menubadge">1</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li id="menu-referral" class="listt"><a href="#"><strong class="nav_icon icon_referral"></strong> <span>Referral</span> </a>
                        <ul id="menu-referral-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/modules/referral/overview') }}"><i class="fa fa-circle"></i> <span>Overview</span> </a></li>
                            ...
                            @endphp"><a href="{{ url('admin/modules/referral/') }}"><i class="fa fa-circle"></i> <span>Referral App</span> </a></li>
                            ...
                            @endphp"><a href="{{ url('admin/modules/referral/advocates/') }}"><i class="fa fa-circle"></i> <span>Advocates</span> </a></li>
                    ...
                    <li id="menu-nps" class="listt1"><a href="javascript:void(0);"><strong class="nav_icon icon_nps"></strong> <span>NPS Survey</span></a>
                        <ul id="menu-nps-submenu" class="hidden-ul">
                         <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/modules/nps/overview') }}"><i class="fa fa-circle"></i> Overview</a></li>
                            ...
                            @endphp"><a href="{{ url('admin/modules/nps') }}"><i class="fa fa-circle"></i> Campaigns</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/modules/nps/score') }}"><i class="fa fa-circle"></i> Scores / Feedbacks</a></li>
                        </ul>
                    </li>
                    ...
                    <li id="menu-team" class="listt2"><a href="#"><strong class="nav_icon icon_people"></strong> <span>Team</span></a>
                        <ul id="menu-team-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/team/dashboard') }}"><i class="fa fa-circle"></i>Dashboard</a>
                            </li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/team/rolelist') }}"><i class="fa fa-circle"></i>Roles</a>
                            </li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/team/memberlist') }}"><i class="fa fa-circle"></i> Team Members</a></li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/team/activitylist') }}"><i class="fa fa-circle"></i> Member Activities</a>    
                            </li>
                        </ul>
                    </li>
                    ...
                    <li id="menu-tags" class="listt2"><a href="#"><strong class="nav_icon icon_tags"></strong> <span>Insight Tags</span></a>
                        <ul id="menu-tags-submenu" class="hidden-ul">
                            ...
                            @endphp"><a href="{{ url('admin/tags/') }}"><i class="fa fa-circle"></i> Tag Management</a>
                            </li>
                            <li class="@php
                            ...
                            @endphp"><a href="{{ url('admin/tags/tagsreview') }}"><i class="fa fa-circle"></i> Tag Reviews</a>
                            </li>
                            <li class="@php
                    ...
                    <li class="listt2 @if ($pageName == 'settings') active @endif"><a href="{{ url('admin/settings') }}"><strong class="nav_icon icon_settings"></strong> <span>Settings</span></a></li>
