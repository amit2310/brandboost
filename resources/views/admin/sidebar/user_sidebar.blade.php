        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                ...
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    ?>"><a href="<?php echo base_url('/admin/reviews/'); ?>"><i class="icon-stack2"></i> <span>Reviews</span></a></li>

                    <li class="<?php
                    if ($pageName == 'feedback') {
                        echo 'active';
                    }
                    ?>"><a href="<?php echo base_url('/admin/feedback/my'); ?>"><i class="icon-stack2"></i> <span>Feedbacks</span></a></li>
                    
                    <li class="<?php
                    if ($pageName == 'comments') {
                        echo 'active';
                    }
                    ?>"><a href="<?php echo base_url(); ?>admin/comments/"><i class="icon-stack2"></i> <span>Comments</span></a></li>
                    
                    <li class="<?php
                    if ($pageName == 'notifications') {
                        echo 'active';
                    }
                    ?>"><a href="<?php echo base_url(); ?>admin/notifications/"><i class="icon-stack2"></i> <span>Notifications</span></a></li>
