                ...
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li class="<?php if(($pageName == 'brandboost') || ($pageName == 'brandboost' && $pageSeName == 'feedbackreports') || ($pageName == 'report' && $pageSeName == 'brandboost' && $pageThName == "responseperformance") || ($pageSeName == 'brandboost' && $pageThName == "repResTimeTrends") || ($pageName == 'brandboost' && $pageSeName == 'servicereports') || ($pageSeName == 'brandboost' && $pageThName == "reportsOptOut") || ($pageSeName == 'brandboost' && $pageThName == "insightTags")){ echo 'active'; } ?>">
                    	...
                    	<ul>
                            ...
                            <li class="<?php if($pageSeName == 'brandboost' && $pageThName == "responseperformance"){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>admin/brandboost/responseperformance"><i class="icon-list3"></i> Response Report</a></li>
                            <li class="<?php if($pageName == 'report' && $pageSeName == 'brandboost' && $pageThName == "repResTimeTrends"){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>admin/brandboost/repResTimeTrends"><i class="icon-alarm-check"></i> Response Time Trends</a></li>
                            ...
                            <li class="<?php if($pageName == 'report' && $pageSeName == 'brandboost' && $pageThName == "reportsOptOut"){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>admin/brandboost/reportsOptOut"><i class="icon-move-up"></i>Opt Out</a></li>
                            <li class="<?php if($pageName == 'report' && $pageSeName == 'brandboost' && $pageThName == "insightTags"){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>admin/brandboost/insightTags"><i class="icon-price-tag3"></i> Reports Insight Tags</a></li>
                        </ul>
                    </li>
