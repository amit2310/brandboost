<style>
    ...
    .addSubscriberNotes a#Addnotes {
        color: #f39c4c !important
    }

    .addSubscriberNotes button#notes_but {
        background: #f9b550 !important;
        color: #fff !important;
        border-color: #f9b550 !important
    }
    ...
    #livesearch ul {
        margin: 0;
        padding: 10px;
        box-shadow: 0 3px 5px 0 rgba(1, 21, 64, 0.6);
        border-radius: 5px;
        position: relative;
    ...
    .chat-list .media .media-annotation.user_icon {
        left: -42px;
    }
    ...
    .chat-list .media.reversed .media-annotation.user_icon {
        right: -38px;
    }
...
<div class="col-md-6 pl6 pr6">
    <div class="panel panel-flat mb0">
        <div class="panel-heading">
            ...
            <!--New Search-->
            <div style="width: 250px;float: left;margin: 5px 20px 0 0;display:none"
                 class="chat_search_icon addtionalSearchDiv">
                <input style="width: calc(100% - 22px);"
                       id="livesearchVal" onkeyup="showResult(this.value)" type="text" name="livesearchVal" value=""
                       placeholder="Search">
            ...
            <h6 class="panel-title hIdelater pull-left mr20"><a class="heading-elements-toggle"><i
                        class="icon-more"></i></a> &nbsp; &nbsp; <a style="cursor:pointer;"><img
                        src="/assets/images/phone_green.png" class="" alt="" style="margin-top: 5px;" width=""
                        height=""> SMS:</a> &nbsp; <span class="Dnumber">{{ mobileNoFormat($defaultNumber) }} </span>
            </h6>
            ...
            <div class="heading-elements" class="hIdelater">
                ...
                <div class="tdropdown">
                    <a style="margin:0!important;" class="dropdown-toggle fsize13" data-toggle="dropdown"
                       aria-expanded="false"><img width="16" src="/assets/images/user_img_blank.png"/> Unassigned <i
                    ...
                    <ul style="right: 0px!important;" class="dropdown-menu dropdown-menu-right chat_dropdown">
                        ...
                        <li><strong><a class="active" href="#"><img src="/assets/images/user_img_blank.png"/> Unassigned</a></strong>
                        </li>
                        <li><strong><a href="#"><img src="/assets/images/user-06-a.png"/> Me</a></strong></li>
                        <li><strong><a href="#"><img src="/assets/images/user-05-a.png"/> Nia Gutkowski</a></strong>
                        </li>
                        <li><strong><a href="#"><img src="/assets/images/user-06-a.png"/> Jade Mohr</a></strong></li>
                        <li><strong><a href="#"><img src="/assets/images/v_user.jpg"/> Alexanne Stanton</a></strong>
                        </li>
                        ...
                        <li><strong><a href="#"><img src="/assets/images/v_user.jpg"/> Rosamond Mueller</a></strong>
                        </li>
                ...
                <div class="tdropdown ml10 mr10 open">
                    <a style="margin:0!important;" class="dropdown-toggle fsize13" data-toggle="dropdown"
                       aria-expanded="true"><img src="/assets/images/icon_clock_dark.png" width="14"> <i
                            class="icon-arrow-down22"></i></a>
                    <ul style="right: 0px!important; display: none;"
                        class="dropdown-menu dropdown-menu-right chat_dropdown">
                ...
                <a href="javascript:void(0)" class="icons s20" style="background: #e6f7ef"><i
                        class="fa fa-check txt_green"></i></a>
            </div>
            ...
            <div class="tab-pane active" id="massage_tab">
                ...
                <div class="panel-body p0 bkg_white minh_880 SecondDiv">
                    ...
                    <div class="p20 pr0 pt0 mainchatsvroll2" id="SmsContainer">
                        ...
                        <ul tWR="" class="media-list chat-list content-group messageThreadsBox smsChatTextarea "
                            id="smsSearcharea"
                            style="display:block; padding-top:10px; height: 620px!important; max-height: 620px!important;">
                    ...
                    <div class="panel-footer p0 bkg_white no_shadow smschat_footer">
                        ...
                        <div style="display: none;" class="chat_shortcuts bigsms_chat_shortcut">
                            <div class="p10 pl20 pr20 bbot">
                                <div class="short_search_icon pull-left"><input class="Search_shortcut"
                                                                                id="Search_shortcut" type="text" name=""
                                                                                value="" placeholder="Search shortcut">
                                    <button type="submit"><img src="/assets/images/chat_search_icon.png"></button>
                                </div>

                                <div class="pull-right"><a style="cursor: pointer"
                                                           class="txt_blue fsize13 bigsms_chat_create">Create &nbsp;
                                        <img width="14" height="14" src="/assets/images/chat_plus_icon.png"></a>&nbsp;
                                    <a href="javascript:void(0)" class="short_icon"><img width="14" height="14"
                                                                                         src="/assets/images/close_red_20.png"></a>
                                </div>
                        ...
                        <div class="p20">
                            ...
                            <textarea id="messageContentBox" class="form-control addnote mb0 messageContent"
                        ...
                        <div class="p20 btop " style="padding: 12px 20px!important">
                            ...
                            <div class="pull-right">
                                <a id="" class="mr-15 short_icon bigsms_chat" href="javascript:void();"><img
                                        src="/assets/images/chat_list_icon.png"/> </a>
                                ...
                                <a class="mr-15 smilieSmsIconMessage" href="javascript:void(0)"><img
                                        src="/assets/images/chat_grey_smiley.png"/> </a>
                                <a class="mr-15" href="javascript:void(0)"><img
                                        src="/assets/images/chat_grey_image.png"/> </a>
                                <a class="mr-15 smsFileAttechment" href="javascript:void(0)"><img
                                        src="/assets/images/chat_grey_attach.png"/> </a>
                                <a class="mr-15" href="javascript:void(0)"><img
                                        src="/assets/images/chat_gray_calendar.png"/> </a>

                                <button id="sms_but" class="btn dark_btn btn-xs send_btn sendMsg">Send <img class="ml10"
        ...
        <div class="panel-body p0 bkg_white minh_880">
            <div class="profile_sec pb10" style="min-height:785px;">
                ...
                <div class="p40 text-center">
                    ...
                    <h3 class="subs_name">{{ $userData->firstname }} {{ $userData->lastname }}</h3>
                    <p class="text-size-small text-muted mb0"><span class="city">San-Franciso</span>, <span
                            class="code">USA</span></p>
                </div>


                <div class="profile_headings">Info
                    <!--<a href="#" class="pull-right"><i class="fa fsize15 txt_grey fa-angle-down"></i></a>--> <a
                        href="javascript:void(0);" class="editModuleSubscriber_sms pull-right"
                        data-modulesubscriberid="241" data-modulename="people" data-moduleaccountid="241"
                        data-redirect="admin/lists/getListContacts?list_id="><i
                            class="icon-pencil fsize10 txt_grey "></i></a></div>
                ...
                <div class="interactions xss p20">
                    <ul>
                        <li><i class="fa fa-envelope"></i><strong class="em usremail">{{ $userData->email }}</strong>
                        </li>
                        <li><i class="fa fa-phone"></i><strong class="ep">{{ $userData->phone }}</strong></li>
                ...
                <div class="profile_headings">Lists <a href="#" class="pull-right"><i
                ...
                <div class="p20 pt15 pb0">
                    ...
                    <div class="tdropdown">
                        <button style="margin:0 10px 15px 0!important;"
                                class="btn btn-xs plus_icon dropdown-toggle ml10" data-toggle="dropdown"
                                aria-expanded="true"><i class="icon-plus3"></i></button>
                ...
                <div class="profile_headings">Segments <a href="#" class="pull-right"><i
                            class="fa fsize15 txt_grey fa-angle-down"></i></a></div>
                <div class="p20 pt15 pb0">
