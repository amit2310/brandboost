                            ...
                            <form action="{{ url('/admin/login') }}" method="post">
                                ...
                                <div class="pt30 pb20 bbot">
                                    <div class="text-center">
                                        <img width="72" src="{{ URL::asset('assets/images/bb_icon.png') }}"
                                             class="br100 br_s mb-5">
                                        <h5 class="content-group-lg fsize20 fw500">Sign in to your account <small
                                                class="display-block fsize14">Welcome, back!</small></h5>
                                    </div>
                                    ...
                                    @if ($errors->any())
                                        <div class="alert-danger text-center"
                                             style="margin-bottom:10px;">{{ session('error_message') }}
                                    ...
                                    <div class="form_m">
                                        <div class="form-group has-feedback has-feedback-left mb0">
                                            <input type="text" class="form-control input-lg h52"
                                                   placeholder="login@example.com" name="email" id="email" required="">
                                            <div class="form-control-feedback h52">
                                                <i class="fa fa-envelope-o text-muted"></i>Email
                                            </div>
                                        </div>
                                        <div class="form-group has-feedback has-feedback-left ">
                                            <input type="password" class="form-control input-lg h52"
                                    ...
                                    <div class="form-group mb30">
                                        <button type="submit"
                                                class="btn dark_btn btn_skyblue btn-block h52 fsize14 fw500 btn_pruple2">
                                            Signin
                                        </button>
                                    </div>
                                    ...
                                    <div class="form-group login-options mb30">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 text-center forget_pass">
                                                <a class="text-size-small btn-link fsize13 fw500"
                                                   href="{{ url('/admin/forgot_password') }}">Forgot password?</a>
                                            </div>
                                        </div>
                                    </div>

                                </div>
                                <div class="login_footer text-center text-muted text-size-small pt30 fsize13 fw500 ">
                                    Don’t have an account? <a class="btn-link fw600" href="#">Sign Up!</a></div>
                            </form>
                        </div>
                    </div>
                    <div class="login_slider2">
                        <div class="row">
                            <div class="col-md-12 carousel_main">
                                <div id="DemoCarousel" class="carousel slide width_500 text-center slider_c"
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item tutorials loginslide active">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <img src="{{ URL::asset('assets/images/icon-125.png') }}"
                                                         class="mt-10">
                                                    <p><strong class="fsize22 fw500 mb30">Email marketing
                                                            toolkit </strong></p>
                                                </div>

                                                <div class="col-xs-12">
                                                    <div class="box_main pt40">
                                                        <div class="box_1 txt_grey pt20 pb20 pl30 pr30"><i><img
                                                                    src="{{ URL::asset('assets/images/icon_blue.png') }}"
                                                                    class="mb10"></i>
                                                            <p>Create unique campaigns</p></div>
                                                        <div class="box_1 txt_grey pt20 pb20 pl30 pr30"><i><img
                                                                    src="{{ URL::asset('assets/images/icon_blue.png') }}"
                                                                    class="mb10"></i>
                                                            <p>Connect your favorite tools</p></div>
                                                        <div class="box_1 b_r txt_grey pb20 pt20 pl30 pr30"><i><img
                                                                    src="{{ URL::asset('assets/images/icon_blue.png') }}"
                                                                    class="mb10"></i>
                                                            <p>Automate your busy work</p></div>
                                        ...
                                        <div class="item tutorials loginslide">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <img src="{{ URL::asset('assets/images/icon-125.png') }}"
                                                         class="mt-10">
                                                    <p><strong class="fsize22 fw500 mb30">Build email
                                                            marketing </strong></p>
                                                    <p class="mt-5 fsize14">Create branded and personalized emails with
                                                        pixel perfect accuracy. Start from a gorgeous template or design
                                                        your own. Unleash your creativity. </p>
                                                </div>
