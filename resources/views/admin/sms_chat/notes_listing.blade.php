<div class="panel-body p0 bkg_white minh_880">
    ...
    <div class="p20 pr0 pt0 mainchatsvroll2">
        ...
        <ul class="media-list chat-list content-group NotesThreadsBox"
            style="display:block; margin-top:10px; height: 505px!important; max-height: 505px!important;">
...
<script>
    $(document).ready(function () {
        ...
        $('body').on('click', '.notes_but', function () {
            ...
            if ($.trim(NotesContent) == '') {
                ...
                $.ajax({
                    url: "{{ base_url('/admin/smschat/addSmsNotes') }}",
                    type: "POST",
    ...
    function showNoteslisting(NotesTo) {
        $.ajax({
            url: "{{ base_url('admin/smschat/listingSmsNotes') }}",
            type: "POST",
