                        ...
                        @if(!empty($tagData))
                            <table class="table datatable-basic datatable-sorting">
                                ...
                                <tr id="append-{{ $data->id }}" class="selectedClass">
                                    ...
                                    <td>
                                        <a href="{{ base_url('admin/tags/review/' . $data->id) }}" target="_blank"
                                           class="text-default text-semibold">
                                            {{ count($tData) }}
                                        </a>
                                        <div data-toggle="tooltip" title="" data-placement="top" class="progress"
                                             data-original-title="Total {{ count($tData) }} Feedbacks">
                                            <div class="progress-bar progress-bar-info" role="progressbar"
                                                 aria-valuenow="{{ count($tData) }}" aria-valuemin="0"
                                                 aria-valuemax="{{ count($tData) }}" style="width:100%"></div>
                                        </div>
                                    </td>
                                                        ...
                                                        @if($canWrite)
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                   class="deleteTagGroupEntity" tagid="{{ $data->id  }}"
