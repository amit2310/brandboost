    ...
    <div class="page_header">
        <div class="row">
            ...
            <div class="col-md-7 text-right btn_area">
                ...
                <button type="button" class="btn dark_btn ml20" id="addTagGroup" data-toggle="modal"><i class="icon-plus3"></i><span> &nbsp;  New Tag Group</span> </button>
			</div>
		</div>
	</div>
    <!--&&&&&&&&&&&& PAGE HEADER END &&&&&&&&&&-->
					...
					<div style="margin: 0;" class="panel panel-flat">
						<div class="panel-heading">
							...
							<div class="heading-elements">
								...
								<button id="deleteTagsGroupBtn" class="btn btn-xs custom_action_box"><i class="icon-trash position-left"></i> Delete</button>
								<button id="archiveTagsGroupBtn" class="btn btn-xs custom_action_box"><i class="icon-gear position-left"></i> Archive</button>
							</div>
						</div>
					...
					<div style="margin: 0;" class="panel panel-flat">
						<div class="panel-heading">
							...
							<div class="heading-elements">
								...
								<button id="deleteArchiveTagsGroupBtn" class="btn btn-xs custom_action_box_archive"><i class="icon-trash position-left"></i> Delete</button>
							</div>
						</div>
						<div class="panel-body p0">
							...
							<table class="table datatable-basic datatable-sorting tags">
								<thead>
									<tr>
										<th style="display: none;"></th>
										<th style="display: none;"></th>
										<th style="display: none;" class="nosort editArchiveAction" style="width:30px;"><label class="custmo_checkbox pull-left"><input type="checkbox" name="checkAll[]" class="control-primary" id="checkAllArchive" ><span class="custmo_checkmark"></span></label></th>
										<th class="width-320"><i class="icon-user"></i>Name</th>
										<th><i class="icon-price-tag2"></i>Tags</th>
									</tr>
								</thead>
	...
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content">
			...
			<div class="modal-body p30">
				<div class="row">
					<div class="col-md-12">
						<button class="btn btn-xs btn_white_table pr10 mr10 mb20"><i class="icon-primitive-dot txt_blue"></i> Email</button>
			...
			<div class="modal-footer">
				<button class="btn btn-link text-muted" data-dismiss="modal"><i class="icon-pencil4"></i> &nbsp;  Edit group </button>
				<button data-toggle="modal" id="nextpopup" type="button" class="btn dark_btn bkg_blue"><i class="icon-plus3"></i> Add new tag</button>
			</div>
		</div>
        ...
        <div class="modal-content">
            <form method="post" name="frmaddTagGroupModal" id="frmaddTagGroupModal" action="javascript:void();">
                ...
                <div class="modal-body">
                    <p>Group Name</p>
                    <input class="form-control" id="txtGroupName" name="txtGroupName" placeholder="Enter Group Name" type="text" required>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" name="frmaddTagGroupEntityModal" id="frmaddTagGroupEntityModal" action="javascript:void();">
                ...
                <div class="modal-body">
                    <p>Tag Name</p>
                    <input class="form-control" id="txtTagName" name="txtTagName" placeholder="Enter Tag Name" type="text" required>
        ...
        <div class="modal-content">
            <form method="post" name="frmeditTagGroupModal" id="frmeditTagGroupModal" action="javascript:void();">
                ...
                <div class="modal-body" style="margin-bottom: 50px;">
                    ...
                    <div class="col-md-11"><input class="form-control" id="txtEditGroupName" name="txtEditGroupName" placeholder="Enter Group Name" type="text" required></div>
                    <div class="col-md-1"><button type="button" class="btn red deleteTagGroup"  groupID=""><i class="fa fa-trash"></i></button></div>
...
<div id="editTagGroupEntityModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" name="frmeditTagGroupEntityModal" id="frmeditTagGroupEntityModal" action="javascript:void();">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-body">
                    <p>Tag Name</p>
                    <div class="row">
                        <div class="col-md-11"><input class="form-control" id="txtEditTagName" name="txtEditTagName" placeholder="Enter Tag Name" type="text" required></div>
                        <div class="col-md-1"><button type="button" class="btn red deleteTagGroupEntity"  tagid="" groupid=""><i class="fa fa-trash"></i></button></div>
					</div>
