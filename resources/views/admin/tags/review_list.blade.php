		  ...
		  <div class="col-md-12">
			<div style="margin: 0;" class="panel panel-flat">
			  <div class="panel-heading"> <span class="pull-left">
				  <h6 class="panel-title"><?php if(!empty($aReviews)) { echo count($aReviews); } ?> Reviews</h6>
				  </span>
...
<tr id="append-<?php echo $oReview->id; ?>" class="selectedClass">
  ...
  <td><div class="media-left media-middle"> <a class="icons" href="#"><img src="<?php echo base_url('profile_images/').$avatarImage; ?>" class="img-circle img-xs" alt=""></a> </div>
    <div class="media-left">
      <div class="pt-5"><a href="#" class="text-default text-semibold"><span><?php echo $oReview->firstname.' '.$oReview->lastname; ?></span> <img class="flags" src="<?php echo base_url(); ?>assets/images/flags/ao.png"></a> </div>
      <div class="text-muted text-size-small"><?php echo $oReview->email; ?></div>
    </div></td>
  <td><?php echo $smilyImage; ?></td>
  <td><div class="text-semibold"><?php echo setStringLimit($oReview->review_title, '25'); ?></div>
    <div class="text-size-small text-muted"><?php echo setStringLimit($oReview->comment_text, '61'); ?><!-- Being the savage's bowsman, that is, the person who pulled th. --></div></td>
  <td><div class="media-left">
      <div class=""><a href="#" class="text-default text-semibold"><?php echo date('d M Y', strtotime($oReview->created)); ?></a> </div>
      <div class="text-muted text-size-small"><?php echo date('h:iA', strtotime($oReview->created)); ?></div>
    </div></td>
  <td><div>
  	 <?php
        if ($getComm > 0) {
            echo '<a style="cursor: pointer; color: #333333;" onclick="showCommentsPopup(' . $oReview->id . ')">' . $getComm . '</a>';
        } else {
            echo '0';
        }
        ?>
  </div>
    <div><span class="txt_green text-size-small"><?php echo $approved; ?></span> <span class="pl0 pr0 text-size-small text-muted">/</span> <span class="txt_red text-size-small"><?php echo $disApproved; ?></span> </div></td>
   <td style="display: none;"><?php echo $getComm; ?></td>
