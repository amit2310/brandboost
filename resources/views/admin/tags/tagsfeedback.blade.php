                                ...
                                <tr id="append-{{ $data->id }}" class="selectedClass">
                                    ...
                                    <td>
                                        ...
                                        <div class="media-left">
                                            <div><a href="#"
                                                    class="text-default text-semibold">{{ $data->group_name }}</a></div>
                                        </div>
                                    </td>
                                    <td>
                                        <button class="btn btn-xs btn_white_table pr10"><i
                                                class="icon-primitive-dot txt_green"></i> {{ $data->tag_name }}</button>
                                    </td>

                                    <td>
                                        <div class="media-left">
                                            <div class="pt-5"><a href="#"
                                                                 class="text-default text-semibold">{{ date('d M Y', strtotime($data->tag_created)) }}</a>
                                            </div>
                                            <div
                                                class="text-muted text-size-small">{{ date('h:i A', strtotime($data->tag_created)) }}</div>
                                        </div>
                                    </td>

                                    <td>
                                        <a href="{{ base_url('admin/tags/feedback/' . $data->id) }}" target="_blank"
                                           class="text-default text-semibold">{{ count($tagData) }}</a>
                                        <div data-toggle="tooltip" title="" data-placement="top" class="progress"
                                             data-original-title="Total {{ count($tagData) }} Feedbacks">
                                            <div class="progress-bar progress-bar-info" role="progressbar"
                                                 aria-valuenow="{{ count($tagData) }}" aria-valuemin="0"
                                                 aria-valuemax="{{ count($tagData) }}" style="width:100%"></div>
                                        </div>
                                    </td>
