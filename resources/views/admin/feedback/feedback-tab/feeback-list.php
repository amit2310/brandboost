...
<div class="tab-pane <?php echo $allTab; ?>" id="right-icon-tab1">
    <!-- Dashboard content -->
    <div class="row">
        <div class="col-lg-12">
            <!-- Marketing campaigns -->
        ...
        <?php endif; ?>			
                                        ...
                                        <td id="feedback_tag_<?php echo $data->id; ?>">
                                            <div class="tdropdown">
                                                <button type="button" class="btn btn-xs btn_white_table bluee dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <?php echo count($feedbackTags); ?> tags <span class="caret"></span> </button>

                                                <ul class="dropdown-menu dropdown-menu-right tagss">
                                                    <?php if (count($feedbackTags) > 0) {
                                                        foreach ($feedbackTags as $tagsData) {
                                                            ?>
                                                            <button class="btn btn-xs btn_white_table pr10"> <?php echo $tagsData->tag_name; ?></button>
            <?php } ?>

        <?php } ?>
        <?php if ($canWrite): ?>
                                                        <button class="btn btn-xs plus_icon applyInsightTags" feedback_id="<?php echo base64_url_encode($data->id); ?>" action_name="feedback-tag"><i class="icon-plus3"></i></button>
        <?php endif; ?>
                                                </ul>
