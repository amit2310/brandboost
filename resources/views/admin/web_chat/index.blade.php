...
@section('contents')
    ...
    <style>
        .chat_user_list { /*height:730px;*/
            height: 635px;
            overflow: auto;
        }

        .mainContainer .minh_880 {
            height: 1200px !important
        }

        .mainContainer .chat_user_list {
            height: 1130px !important;
            overflow: hidden;
        }

        .mainContainer .chat_user_list:hover {
            overflow: auto;
        }

        .mainContainer .slimScrollDiv, .mainContainer .messageThreadsBox {
        ...
        #CustomDiv2 .media-content .previewImage img {
            width: 150px !important;
            height: auto !important;
            margin: 0px !important;
        }
        ...
        .chat_user_list span.icons.fl_letters {
        ...
        .conversation_list li a.active {
            color: #09204f;
            font-weight: 500;
        }

        #webparentsearch .media_file {
            width: 250px;
        }
            ...
            <div class="col-md-3 pr6 firstDiv">
                <div class="panel panel-flat mb10">
                    <div class="panel-heading">
                        <h6 class="panel-title">Conversations<a class="heading-elements-toggle"><i
                                    class="icon-more"></i></a></h6>

                        <div class="heading-elements">
                            <a style="background: #e4eefd;" href="javascript:void(0)"
                               class="icons s20 ConversationsIcon"><i style="color: #9fc3f8!important"
                    ...
                    <div class="panel-body p0 bkg_white">
                        <div class="p20 pt-15 pb-15">
                            ...
                            <div class="tdropdown ml0">
                                <a style="margin:0!important;" class="dropdown-toggle fsize12 txt_grey"
                                   data-toggle="dropdown" aria-expanded="false"><span style=""
                                                                                      class="t_web_main allChatShow"
                                                                                      id="toogleDivName">All</span><i
                                        class="icon-arrow-down22"></i></a>
                                <ul style="right: 0px!important; margin-top: 25px; left: -20px;"
                                    class="dropdown-menu dropdown-menu-left chat_dropdown">
                                    <li><strong><a class="active" href="javascript:void(0)"><img class="small"
                                                                                                 src="/assets/images/cd_icon1.png"/>
                                                <b class="smallbr allChatShow">All ({{ $activeOnlyweb->count() }})</b>
                                            </a></strong></li>
                                    <li><strong><a href="javascript:void(0)"><img class="small"
                                                                                  src="/assets/images/cd_icon2.png"/><b
                                                    class="unTab unassigned_show">Unassigned
                                                    ({{ $unassignChat->count() }}) </b></a></strong></li>
                                    <li><strong><a href="javascript:void(0)"><img class="small"
                                                                                  src="/assets/images/cd_icon2.png"/><b
                                                    class="YouTab assigned_show_{{ $loggedYou }}">You
                                                    ({{ $assignChat->count() }}) </b></a></strong></li>

                                    <li style="display: block;"><strong><a href="javascript:void(0)"><img class="small"
                                                                                                          src="/assets/images/cd_icon2.png"/><b
                                                    class="FavTab {{ $loggedYou }}">Favorites
                                                    ({{ $Favorites_list->count() }}) </b></a></strong></li>
                            ...
                            <div class="tdropdown ml0 pull-right">
                                <a style="margin:0!important;" class="dropdown-toggle fsize12 txt_grey"
                                   data-toggle="dropdown" aria-expanded="false"><span class="f_web_main"
                                                                                      id="filterTitle">Newest</span> <i
                                        class="icon-arrow-down22"></i></a>
                                <ul style="margin-top: 25px; right: -20px;"
                                    class="dropdown-menu dropdown-menu-left chat_dropdown width_170">
                                    <li class="f_new chatAction"><strong><a class="active" href="javascript:void(0)">Newest </a></strong>
                                    </li>
                                    <li class="f_old chatAction"><strong><a
                                                href="javascript:void(0)">Oldest </a></strong></li>
                        ...
                        <div class="p20 btop bbot pt-15 pb-15">
                            <div style=" width:100%;" class="chat_search_icon">
                                <input style="width: calc(100% - 22px);"
                                       id="MainsearchChatMsg" class="MainsearchChatMsg" type="text" name="adSearch"
                        ...
                        <!-- <p><span class="unassigned_show">Unassigned ({{ $unassignedChat }}) </span> &nbsp;&nbsp;&nbsp;&nbsp;
							<span class="assigned_show_{{ $loggedYou }}">You ({{ $assignedChat }})</span></p> -->


                            <ul class="conversation_list">
                                <li><a href="javascript:void(0)" class="showList smallbr allChatShow active">All
                                        ({{ $activeOnlyweb->count() }})</a></li>
                                <li><a href="javascript:void(0)" class="showList unTab unassigned_show">Unassigned
                                        ({{ $unassignChat->count() }}) </a></li>
                                <li><a href="javascript:void(0)" class="showList YouTab assigned_show_{{ $loggedYou }}">
                                        You ({{ $assignChat->count() }}) </a></li>
                            </ul>


                            <input type="hidden" name="allChatC" class="allChatC"
                                   value="{{ $activeOnlyweb->count() }}"/>
                            <input type="hidden" name="unassigned" class="unassigned_chat"
                                   value="{{ $unassignChat->count() }}">
                            <input type="hidden" name="assigned" class="assigned_chat"
                                   id="assigned_chat_{{ $loggedYou }}" value="{{ $assignChat->count() }}">
                ...
                <div id="AjaxSearchWeb"
                     style="height:635px; overflow: auto; display:none;background-color:#fff!important">
                </div>

                <div id="InitalWeb">
                    <div id="activeSearchlisting" class="panel-body p0 br5 mb10 chat_user_list activeChatlisting a_list"
                    ...
                    <!--++++++++++++ oldest chat list +++++++++++++++-->
                    <div class="panel-body p0 br5 mb10 chat_user_list o_list"
                    ...
                    <!--++++++++++++ wait chat list +++++++++++++++-->
                    <div class="panel-body p0 br5 mb10 chat_user_list w_list"
                         style="background-image:none; display:none">
                    ...
                    <div class="panel-body p0 br5 mb10 chat_user_list un_list"
                         style="background-image:none; display:none">
                    ...
                    <!--++++++++++++ You chat list +++++++++++++++-->
                    <div class="panel-body p0 br5 mb10 chat_user_list you_list"
                         style="background-image:none; display:none">
                        @php
                            //$this->load->view('admin/webchat/Youchat_list', array('Youchatlist' => $assignedChatData)) }}
                        @endphp
                    </div>
                    <!--++++++++++++ You chat list +++++++++++++++-->
                    ...
                    <!--++++++++++++ favourite chat list +++++++++++++++-->
                    <div class="panel-body p0 br5 mb10 chat_user_list f_list"
                         style="background-image:none; display:none">
                        @include('admin/web_chat/favourite_list', array('favchatlist' => $Favorites_list))
                    </div>
                    <!--++++++++++++ favourite chat list +++++++++++++++-->

                    <a href="javascript:void(0)" class="loadMoreActivity loadMoreRecordActivity blue_plus_increase"
                       style="bottom:-6px; display: none;"><i class="icon-plus3 fsize11 txt_white"></i></a>
                    <!-- chat list -->
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#Webonly .c_link').html('Contacts({{ $contactCount }})');
        ...
        $(document).ready(function () {
            ...
            socket.on('chat message main', function (data) {
                ...
                if (data.avatar == '' || data.avatar === undefined) {
                    ...
                    profileImg = `<span class="icons s32"><img src="${data.avatar}" onerror="this.src='{{ base_url() }}assets/images/default_avt.jpeg'" class="img-circle" alt="" width="24" height="24"></span>`;
                }
                ...
                if (msg.trim().length != 0) {
                    ...
                    if (currentUser == data.currentUser) {
                        ...
                        if ($('#WebChatTextarea_' + chatbox).hasClass('typing_messsage')) {
                            ...
                            $('#WebChatTextarea_' + chatbox).append(`<li class="media loading_message_big_li_${chatbox}" style="height: 43px;padding-top: 10px;"><img  src="{{ base_url() }}assets/images/messageloading.gif" style="height: 25px;"></li>`);
		...
		<div class="media-content">${nl2br(msg)}</div>
            ...
            $(document).on('click', '.getChatDetails', function (event) {
                ...
                setTimeout(function () {
                    searchMainSmsPrevMsg('', $('.MainsearchChatMsg').val());
                }, 2000);
            ...
            function updatReadStatus(RwebId) {
                $.ajax({
                    url: "{{ base_url('admin/Chat/setWebReadstatus') }}",
                    type: "POST",
                    data: {'RwebId': RwebId},
                    dataType: "html",
            ...
            loadMessageChat('{{ $popupId }}', '{{ $popupToken  }}');
            showNoteslisting('{{ $popupId }}', '{{ $popupToken  }}');
            ...
            function loadMessageChat(userId, token, clickvalue = null) {
                ...
                var currentUser = "{{ $loginMember }}";

                var userID = userId;
                var currentUserName = "{{ $aUInfo->firstname . ' ' . $aUInfo->lastname }}";
                ...
                socket.emit('subscribe', newToken);
                $.ajax({
                    url: "{{ base_url('admin/webchat/getUserinfo') }}",
                    type: "POST",
...
//  ######### Load Chat message ############ //
                        ...
                        success: function (data) {
                            if (data.status == 'ok') {
                                ...
                                if (data.hasAssign > 0) {
                                    ...
                                    socket.emit('unassign_chat_count', {
                                        room: newToken,
                                        unAssCount: "Unassigned (" + unAssCount + ")",
                                        countUnassign: unAssCount
                                    });
                                }


                                socket.emit('team_post_data', {
                                    room: newToken,
                                    chatTo: chatTo,
                                    currentUser: currentUser,
                                    teamName: data.isLoggedInTeam,
                                    msg: msg
                                });
            ...
            $(document).on('keyup', '#Webonly .messageContent', function (e) {
                ...
                socket.emit('wait_message_widget', {
                    room: newToken,
                    chatTo: chatTo,
                    currentUser: currentUser,
                    wait: wait
            ...
            $(document).on('click', '.favouriteUser', function (e) {
                ...
                $.ajax({
                    url: "{{ base_url('admin/webchat/favouriteUser') }}",
                    type: "POST",
            ...
            $(document).on('change blur', '.uAddText', function (e) {
                ...
                $.ajax({
                    url: "{{ base_url('admin/webchat/updateSupportuser') }}",
                    type: "POST",
            ...
            $(document).on('click', '.rmtag', function () {
                ...
                $.ajax({
                    url: "{{ base_url('admin/webchat/deleteTagFromWeb') }}",
                    type: "POST",
                ...
                if ($smileyGrid.children().length == 0) {
                    ...
                    for (var i in smiliesMapSMSChat) {
                        ...
                        var smileyCol = $("<div>").addClass("col-md-2"),
                            smileyImg = $("<img>").attr({
                                "src": "{{ base_url() }}assets/img-smile/" + smiliesMapSMSChat[i] + ".gif",
                                "title": i.toString(),
                                "smiley": i.toString(),
                                "data-toggle": "tooltip",
                                "data-placement": "top"
            ...
            function showResult(str) {
                ...
                xmlhttp.open("GET", "{{ base_url('admin/smschat/livesearchWeb') }}?q=" + str, true);
                xmlhttp.send();
            }
            ...
            $(document).on('click', '#Webonly .smallbr', function () {
                ...
                $('#Webonly .t_web_main').html('All {{ $activeOnlyweb->count() }}');
            ...
            $(document).on('click', '#Webonly .FavTab', function () {
                ...
                $('#Webonly .you_list').hide();
                $('#Webonly .f_list').show();
                $('#Webonly .t_web_main').html('Favorites {{ $Favorites_list->count() }}');
            ...
            $(document).on('click', '#Webonly .unTab', function () {
                ...
                $.ajax({
                    url: "{{ base_url('admin/webchat/showUntabAjax') }}",
                    data: {_token: '{{csrf_token()}}'},
                    type: "POST",
                    success: function (data) {
                        $('.un_list').html(data);
                ...
                $('#Webonly .t_web_main').html('Unassigned ({{ $unassignChat->count() }})');
            ...
            $(document).on('click', '#Webonly .YouTab', function () {
                $.ajax({
                    url: "{{ base_url('admin/webchat/showYoutabAjax') }}",
                    data: {_token: '{{csrf_token()}}'},
                    type: "POST",
                    success: function (data) {
                        $('.you_list').html(data);
                ...
                $('#Webonly .t_web_main').html('You ({{ $assignChat->count() }})');
            ...
            $('body').on('click', '#Webonly .favouriteSMSUser', function () {
                ...
                var currentUser = "{{ $loginUserData->id }}";
                $.ajax({
                    url: "{{ base_url('admin/smschat/addSMSFavourite') }}",
                    type: "POST",
            ...
            function ShowfavouritAjax() {
                $.ajax({
                    url: "{{ base_url('admin/smschat/showfavouriteAjax') }}",
                    type: "POST",
                    success: function (data) {
                        $('.f_list').html(data);
                    }
        ...
        $(document).ready(function () {
            $(document).on("keyup", ".MainsearchChatMsg", function () {
                $.ajax({
                    url: "{{ base_url('admin/webchat/bigwfilter') }}",
                    type: "POST",
