...
foreach ($activechatlist as $key => $value) {
    ...
    $created = usaDate($chatMessageRes->created);
...
<div class="activityShow <?php echo $count; ?> media chatbox_new bkg_white <?php if ($count == 1) {
	...
	<a href="javascript:void(0);" class="media-link <?php if ($count != 1) {
		...
		<div class="media-right" style="width:100px;"><span class="date_time txt_grey fsize11">
        <time class="autoTimeUpdate autoTime_<?php echo $userid; ?>" datetime="<?php echo $created; ?>"></time> <?php //echo str_replace('1 day','Y\'day',chatTimeAgo($created)); ?>
