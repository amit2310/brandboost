                    ...
                    <div class="price_plan">
                        ...
                        <div class="p30 pt20 pb20">
                            <ul class="mb20">
                                ...
                                <li><i class="icon-checkmark-circle"></i> Reviews App</li>
                                <li><i class="icon-checkmark-circle"></i> Chat App</li>
                                <li @if ($oMembership->level_name != 'Pro Yearly' && $oMembership->level_name != 'Business Yearly') class="disabled" @endif ><i class="@if ($oMembership->level_name != 'Pro Yearly' && $oMembership->level_name != 'Business Yearly')
									icon-cancel-circle2 @else icon-checkmark-circle @endif "></i> On Site widgets</li>
