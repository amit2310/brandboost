    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Upgrade to {{ $oSuggestedPlan->level_name }}</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center mt-20"><img class="img-responsive" src="{{ base_url() }}assets/images/upgrade1.jpg"/> </div>
                    <div class="col-md-6 mt-20">
                        <div class="content-group">
                            <dl>
                                ...
                                <dd>
                                    Save upto {{ $oSuggestedPlan->contact_limit }} contacts
                                </dd>
            ...
            <div class="modal-footer pt-20">
                <div class="row">
                    <div class="col-md-9 text-left">
                        <h1 style="margin: 0;">For an additional <strong>${{ $additionalPriceToPay }}</strong> every month,</h1>
                    ...
                    <div class="col-md-3 pt-20 text-center">
                        <button type="button" class="btn dark_btn mb-10" id="btnLevelUpgrade" plan_name="{{ $oSuggestedPlan->level_name }}" plan_id="{{ $oSuggestedPlan->plan_id }}" data-toggle="modal" data-target="#confirm_level_upgrade">Confirm Upgrade</button>
