<div id="editSmartComment" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" class="form-horizontal" id="updateSmartComment" action="javascript:void();">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control"  placeholder="Leave Comment" name="edit_content" id="edit_smart_content" required ></textarea>
                        </div>
                    </div>

                </div>
                <div class="modal-footer">
                    <input type="hidden" name="edit_commentid" id="edit_smart_commentid" value="">
