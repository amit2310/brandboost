        ...
        <div style="height: 100%; overflow-y:auto; overflow-x: hidden;">
            ...
            <div class="row" style="height: 100%;">
                ...
                <div class="col-md-5 pr0 brig">
                    <a style="left: 35px; top: 15px;" class="reviews emailNotifictionBack slide-toggle bkg_grey_light" ><i class=""><img src="{{ base_url() }}assets/images/icon_arrow_left.png"/></i></a> 
                            ...
                            <div class="">
                                    ...
                                    <select class="form-control h52 eventEmailTag" name="template_tag">
                                        @if (!empty($oEmailTemplates)) 
                                            @foreach ($oEmailTemplates as $oTemplate) 
                                                <option value="{{ $oTemplate->template_tag }}">{{ $oTemplate->title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <a class="fsize14 open_editor oEditor" href="javascript:void();"><i class=""><img src="{{ base_url() }}assets/images/open_editor.png"> </i> &nbsp; Open editor</a>
                                        <a class="fsize14 open_editor view_editor" href="javascript:void();" style="display: none;"><i class=""><img src="{{ base_url() }}assets/images/open_editor.png"> </i>  &nbsp; View</a>
        ...
        <div style="height: 100%; overflow-y:auto; overflow-x: hidden;">
            ...
            <div class="row" style="height: 100%;">
                ...
                <div class="col-md-12 pr0 brig">
                    <a style="left: 35px; top: 15px;" class="reviews smsNotifictionBack slide-toggle bkg_grey_light" ><i class=""><img src="{{ base_url() }}assets/images/icon_arrow_left.png"/></i></a> 
...
<a style="position: fixed; top: 50%; right: 12px; display: none;" class="reviewsNoti slide-toggle visible emailNotiSmartPopup"  type="admin" template_id="
    @if (!empty($oEmailTemplates)) 
