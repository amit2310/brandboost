...
.iti-flag {
  ...
  background-image: url("<?php echo base_url(); ?>assets/images/flags.png");
  background-repeat: no-repeat;
  background-color: #DBDBDB;
  background-position: 20px 0; }
  @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2 / 1), only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx) {
    .iti-flag {
      background-image: url("<?php echo base_url(); ?>assets/images/flags@2x.png"); } }
...
<section style="padding-bottom: 30px;" class="top_text review_page">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="mbot20">Please Click The Following Links Below And Leave Us A Review & Collect Your Price!</h3>
            </div>
            ...
            <form method="post" name="frmSubmit" id="frmSubmit" action="#"  enctype="multipart/form-data"> 
                ...
                <div class="col-md-5 col-md-offset-1 text-left">
                    ...
                    <input type="text" name="mobile" id="mobile" placeholder="Mobile No." >
					          <input type="text" name="review_title" id="review_title" placeholder="Title" style="margin-top:15px;" required>
                </div>
                <div class="col-md-5 text-left">

                    <div class="dropzone" id="myDropzone"></div>
                    <input type="hidden" name="image_name" id="image_name" value="">
                    <textarea placeholder="Leave Review" name="content" rows='4' required></textarea>
                </div>

                <div class="col-md-5 col-md-offset-1 text-left">
                 <?php if($oCampaign->pro_cons == 1){ ?>
    ...
    $(document).ready(function () {
       ...
       Dropzone.options.myDropzone= {
        ...
        $("#frmSubmit").submit(function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url('/reviews/saveReviewText'); ?>",
                type: "POST",
                data: formdata,
                contentType: false,
                cache: false,
