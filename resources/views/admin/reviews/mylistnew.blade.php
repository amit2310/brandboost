							...
							if (!empty($oMyReviews)):
                                foreach ($oMyReviews as $oReview):
                                    ...
                                    <tr id="append-{{ $oReview->reviewid }}" class="selectedClass">
                                        <td>
                                            <div class="media-left media-middle"> <a href="javascript:void(0);"><img src="{{ base_url('assets/images/smiley_green.png') }}" class="img-circle img-xs" alt=""></a> </div>
                                            <div class="media-left">
                                                <div class=""><a href="javascript:void(0);" class="text-default text-semibold">{{ $brandboostTitle }}</a></div>
                                                <div class="text-muted text-size-small">Public</div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="media-left">
                                                <div class="pt-5"><a href="#" class="text-default text-semibold">{{ date('d M Y', strtotime($oReview->review_created)) }}</a></div>
                                                <div class="text-muted text-size-small">{{ date('h:i A', strtotime($oReview->review_created)) }}</div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            ...
                                            <span class="text-muted reviewnum">({{ $oReview->ratings }} out of 5 Stars)</span>
                                        </td>

                                        <td>
                                            <div class="media-left">
                                                <a target="_blank" href="{{ site_url('admin/brandboost/reviewdetails/' . $oReview->reviewid) }}"><span class="text-default text-semibold">{{ setStringLimit($oReview->review_title) }}</span></a>
                                                    ...
                                                    @endif
														...
														<ul class="dropdown-menu dropdown-menu-right width-200">
															@if ($oReview->review_type == 'text')
																<li><a href="javascript:void(0);" class="editReview" reviewid="{{ $oReview->reviewid }}"><i class="icon-gear"></i> Edit</a></li>
															@else
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.deleteReview', function () {
            ...
            if (conf == true) {
                ...
                $.ajax({
                    url: "{{ echo base_url('admin/reviews/deleteReview') }}",
                    type: "POST",
