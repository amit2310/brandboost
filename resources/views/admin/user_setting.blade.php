                ...
                <div class="col-md-12">
                    <div class="panel panel-flat review_ratings">
                        <div class="panel-heading">
                            <h6 class="panel-title">{{ count($oMembers) }} Users</h6>
                                    ...
                                    foreach ($oMembers as $subData) {
                                        ...
                                        <div class="col-xs-3">
                                            <div class="user_area">
                                                ...
                                                <p class="fsize13">{{ $subData->firstname . ' ' . $subData->lastname }}</p>
                                                <p class="text-muted fsize12"><span>{{ $subData->email }}</span></p>
                                                <div class="text-left">
                                                    @php
                                                    $inc = 1;
                                                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="media-left">
                                                        <div class="pt-5"><a href="#" class="text-default text-semibold"><span>{{ $subData->firstname . ' ' . $subData->lastname }}</span></a></div>
        ...
        <div class="tab-pane" id="right-icon-tab1">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-flat review_ratings">
                        <div class="panel-heading">
                            <h6 class="panel-title">{{ count($oRoles) }} Teams</h6>
                            <div class="heading-elements">
                                        ...
                                        foreach ($oRoles as $role) {
                                            ...
                                            <tr>
                                                <td><div class="media-left media-middle"> <a class="icons bkg_dark" href="#"><i class="icon-user txt_white"></i></a> </div>
                                                    <div class="media-left">
                                                        <div class="pt-5"><a href="#" class="text-default text-semibold"><span>{{ $role->role_name }}</span></a></div>
        ...
        <div class="tab-pane" id="right-icon-tab2">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-flat review_ratings">
                        <div class="panel-heading">
                            <h6 class="panel-title">{{ $oRoles->count() }} Roles</h6>
                            <div class="heading-elements">
                                <div style="display: inline-block; margin: 0;" class="form-group has-feedback has-feedback-left">
                                    <input class="form-control input-sm" placeholder="Search by name" type="text">
                                    <div class="form-control-feedback"> <i class="icon-search4"></i> </div>
