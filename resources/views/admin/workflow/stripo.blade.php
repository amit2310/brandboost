            ...
            $(document).ready(function () {
                ...
                $(document).on("click", "#saveStripoChanges, #saveStripoChangesSilent", function () {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: {moduleName: moduleName, subject: subject, preheader:preheader, stripo_compiled_html: compliledHtml, campaignId: campaignId, moduleUnitID: moduleUnitID},
                        dataType: "json",
                ...
                $(document).on("click", "#saveToMyTemplates", function () {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: {moduleName: moduleName, subject: subject, stripo_compiled_html: compliledHtml, campaignId: campaignId, template_source: template_source},
                        dataType: "json",
                        success: function (data) {
                            if (data.status == 'success') {
                                window.parent.$('.overlaynew').hide();
