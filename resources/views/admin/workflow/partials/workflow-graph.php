...
<div class="col-md-3">
  ...
  <!--<img src="assets/images/email_graph5.png">-->
            ...
            <div class="semi_circle_smiley"><img src="<?php echo base_url("assets/images/blue_envalope.png"); ?>"/></div>
            ...
            <div class="p20 pb0 topchart_value" style="max-width:575px !important;">
                <div class="row">
                    <div class="col-xs-4 brig">
                        <h1 class="m0"><?php echo $iTotalSent; ?></h1>
                        <p>Sent <span class="label ">100%</span></p>
                    </div>
                    <div class="col-xs-4 brig">
                        <h1 class="m0"><?php echo $iOpen; ?></h1>
                        <p>Opened <span class="label "><?php echo $iOpenRate; ?>%</span></p>
                    </div>
                    <div class="col-xs-4">
                        <h1 class="m0"><?php echo $iClick; ?></h1>
                        <p>Clicked <span class="label "><?php echo $iClickRate; ?>%</span></p>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        var titleOpen = {
            text: '<?php echo $iOpenRate; ?>% <br> <span style="border: none;" class="label">Last 24 Hours: <?php echo $iOpenRate24Hours; ?>%</span>',
            align: 'center',
        ...
        var seriesOpen = [{
                ...
                innerSize: '90%',
                data: [
                    ['Opened Rate', <?php echo $iOpenRate; ?>],
                    ['Not Opened Rate', <?php echo $iNotOpenedRate; ?>],
        ...
        var titleClick = {
            text: '<?php echo $iClickRate; ?>% <br> <span style="border: none;" class="label">Last 24 Hours: <?php echo $iClickRate24Hours; ?>%</span>',
            align: 'center',
            verticalAlign: 'middle',
            y: 65
        };
        ...
        var seriesClick = [{
                ...
                innerSize: '90%',
                data: [
                    ['Clicked Rate', <?php echo $iClickRate; ?>],
                    ['Not Clicked Rate', <?php echo $iNotClickedRate; ?>],
