...
<div class="panel panel-flat" id="wfEmailMenu" style="display:none;">
    ...
    <div class="panel-body p20 pt0 bkg_white">
        ...
        <div class="form-group">
            ...
            <select class="form-control h52" name="wfEmailMenuCampaign" disabled="disabled">
        ...
        <div class="pt20 pb20">
            ...
            <p><a href="javascript:void(0);" id="wf_email_preview" class="wf_previewEditCampaign" campaignType="email"><i class=""><img src="<?php echo base_url(); ?>assets/images/list_icon_grey.png"/></i> &nbsp;  Preview Email</a></p>
            ...
            <div class="form-group hidden" id="wfPreviewTestCtr">
                ...
                <button type="button" id="wfPreviewTestCtr_send_email" class="btn dark_btn h40 bkg_bl_gr mt10">Send</button>
                <a href="javascript:void(0);" id="wfPreviewTestCtrCancel" class="btn btn-link fsize14">Cancel</a>
            </div>
            </p>
