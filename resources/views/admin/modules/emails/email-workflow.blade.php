...
<style>
    ...
    .grey{color: #888888;}
    .temp_left_option.right .productsec{background: url({{ site_url('assets/images/cover3.jpg') }}) center center no-repeat; min-height:auto; text-align: center; background-size: cover; padding-bottom: 20px;}
    ...
    .mobile_sms_bkg{background: url({{ site_url('assets/images/iphone.png') }}) center top no-repeat; width: 357px; height: 716px; margin: 0 auto; padding: 70px 40px;}
...
<!--########################TAB 0 ##########################-->
<div class="tab-pane {{ $emailWorkflow }}" id="right-icon-tab3" style="background:#fff;">
    @php
    ...
    <div class="panel panel-flat edge_panel">
        ...
        <div class="panel-body"> <img class="img-responsive" src="{{ site_url() }}admin_new/images/chart.png"/> 
    ...
    <div class="timeline timeline-center">
        <div class="timeline-container"> 
            ...
            <div class="timeline-date text-muted">
                <button class="btn trigger_btn btn-success mb-20 chooselist">Tag: New Customer 
                    @php
                ...
                <button class="btn trigger_btn bl_cust_btn btn-success chooseTrigger"><i style="font-size: 12px;" class="icon-plus3"></i>  Add New Trigger 
                    @if (!empty($oMainEvent))
                    <br>({{ $oMainEvent->event_type }})
                    @endif</button>
            ...
            <div class="timeline-row post-full">
                <div class="timeline-icon start"> <a previous_event_id="{{ $previousID }}" current_event_id="{{ $currentID }}" event_type="main" class="circle_plus {{ ($bAnyEventExist == false || $bListAdded == false) ? 'validatecustlist' : 'addnewaction' }}" href="javascript:void(0);"><i class="icon-plus3"></i></a> </div>
            </div>
            @endif
            <div class="connected-sortable droppable-area">
                ...
                <div class="draggable-item" event_id="{{ $oEvent->automation_event_id }}" item_order="{{ $eventNo }}">
                    <div class="timeline-date text-muted">
                        <button class="btn bl_cust_btn btn-success waitTime" id="waitTime_{{ $oEvent->automation_event_id }}" event_id="{{ $oEvent->automation_event_id }}" delay_value="{{ $aFollowupTriggerData->delay_value == '' ? '10' : $aFollowupTriggerData->delay_value }}" delay_unit="{{ $aFollowupTriggerData->delay_unit == '' ? 'minute' : $aFollowupTriggerData->delay_unit }}" delay_time="{{!(empty($aFollowupTriggerData->delay_time)) ? $aFollowupTriggerData->delay_time : '9 PM' }}"><i class="fa fa-clock-o"></i> &nbsp; <span class="text-semibold">Wait for {{ $aFollowupTriggerData->delay_value == '' ? '10' : $aFollowupTriggerData->delay_value }} {{ $aFollowupTriggerData->delay_unit == '' ? 'minute' : $aFollowupTriggerData->delay_unit }}(s)</span></button>
                    </div>
                    <div class="timeline-row post-even">
                        <div class="timeline-icon"> <img src="{{ site_url('assets/images/email_icon2.png') }}" alt=""> </div>
                        <div class="timeline-time"> <a href="#" target="_blank">{{ $oUser->firstname . ' ' . $oUser->lastname }}</a> added a new email campaign <span class="text-muted">{{ timeAgo($oEvent->created) }}</span> </div>
                        <div class="timeline-content">
                            <div class="panel border-left-lg gery_bkg border-left-primary" style="{!! $oEvent->event_status == 'draft' ? 'background:#f2bfbf' : '' !!}">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <h6 class="no-margin-top"><a href="#"><span class="itemOrder itemOrder_{{ $eventNo }}">{{ $eventNo }}</span>. {{ $oEvent->subject }}</a></h6>

                                        </div>
                                        <div class="col-md-5 text-right">
                                            <a campaign_id="{{ $oEvent->campaign_id }}" class="btn bl_cust_btn  editcampaign" style="cursor: pointer;" ><i class="fa fa-edit"></i> </a>
                                            <a campaign_id="{{ $oEvent->campaign_id }}" class="btn green_cust_btn previewCampaign" ><i class="fa fa-eye"></i> </a>
                                            @if ($canWriteAna)
                                            <button class="btn viewstats" campaign_id="{{ $oEvent->automation_event_id }}"><i class="fa fa-pie-chart"></i></button>
                                            @endif
                                            <button class="btn red" onclick="javascript:delete_email_automation_event('{{ $oEvent->automation_event_id }}');"><i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel green_bkg border-left-lg border-left-danger" id="statsDetaild_{{ $oEvent->automation_event_id }}">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list task-details">
                                                <li><strong><i class="fa fa-circle"></i> Sent:</strong> <a href="#">{{ $processed }}</a></li>
                                                <li><strong><i class="fa fa-circle"></i> Delivered:</strong> <a href="#">{{ $delivered }}</a></li>
                                                <li><strong><i class="fa fa-circle"></i> Open:</strong> <a href="#">{{ $open }}</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list task-details">
                                                <li><strong><i class="fa fa-circle"></i> Click:</strong> <a href="#">{{ $click }}</a></li>
                                                <li><strong><i class="fa fa-circle"></i> Bounce:</strong> <a href="#">{{ $bounce }}</a></li>
                                                <li><strong><i class="fa fa-circle"></i> Dropped:</strong> <a href="#">{{ $dropped }}</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list task-details">
                                                <li><strong><i class="fa fa-circle"></i> Unsubscribe:</strong> <a href="#">{{ $unsubscribe }}</a></li>
                                                <li><strong><i class="fa fa-circle"></i> Spam Report:</strong> <a href="#">{{ $spamReport }}</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-footer panel-footer-condensed">
                                    <div class="heading-elements"> <span class="heading-text">Created: <span class="text-semibold">{{ date("M d, Y h:i A", strtotime($oEvent->created)) }} ({{ timeAgo($oEvent->created) }})</span></span>
                    ...
                    <div class="timeline-row post-full">
                        <div class="timeline-icon"> <a previous_event_id="{{ $previousID }}" current_event_id="{{ $currentID }}" event_type="followup" class="circle_plus {{ ($bAnyEventExist == false || $bListAdded == false) ? 'validatecustlist' : 'addnewaction' }}" href="javascript:void(0);"><i class="icon-plus3 "></i></a> </div>
                    </div>
                </div>
                <!-- /task -->
                ...
                <div class="draggable-item" event_id="{{ $oEvent->automation_event_id }}" item_order="{{ $eventNo }}">
                    ...
                    <div class="timeline-row post-odd">
                        <div class="timeline-icon"> <img src="{{ site_url('assets/images/smsicon.png') }}" alt=""> </div>
                        <div class="timeline-time"> <a href="#">{{ $oUser->firstname . ' ' . $oUser->lastname }}</a> added a new sms campaign <span class="text-muted">{{ timeAgo($oEvent->created) }}</span> </div>
                        <div class="timeline-content">
                            <div class="panel gery_bkg border-right-lg border-right-primary" style="{{ $oEvent->event_status == 'draft' ? 'background:#f2bfbf' : '' }}">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <h6 class="no-margin-top"><a href="#"><span class="itemOrder itemOrder_{{ $eventNo }}">{{ $eventNo }}</span>. {{ $oEvent->name }}</a></h6>

                                        </div>


                                        <div class="col-md-5 text-right">
                                            <a campaign_id="{{ $oEvent->campaign_id }}" class="btn bl_cust_btn  edit_email_template editSmsCampaign" style="cursor: pointer;" ><i class="fa fa-edit"></i> </a> 
                                            <a campaign_id="{{ $oEvent->campaign_id }}" data-toggle="modal" data-target="#sms_preview_modal" class="btn green_cust_btn previewSMSCampaign" ><i class="fa fa-eye"></i> </a>
                                            @if ($canWriteAna)
                                            <button class="btn viewstats" campaign_id="{{ $oEvent->automation_event_id }}"><i class="fa fa-pie-chart"></i></button>
                                            @endif
                                            <button class="btn red" onclick="javascript:delete_email_automation_event('{{ $oEvent->automation_event_id }}');"><i class="fa fa-trash"></i></button>
                            ...
                            <div class="panel green_bkg border-right-lg border-right-danger" id="statsDetaild_{{ $oEvent->automation_event_id }}">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list task-details">
                                                <li><strong><i class="fa fa-circle"></i> Sent:</strong> <a href="#">{{ $sentSms }}</a></li>
                                                <li><strong><i class="fa fa-circle"></i> Delivered:</strong> <a href="#">{{ $deliveredSms }}</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list task-details">
                                                <li><strong><i class="fa fa-circle"></i> Failed:</strong> <a href="#">{{ $failedSms }}</a></li>
                                                <li><strong><i class="fa fa-circle"></i> Queued:</strong> <a href="#">{{ $queuedSms }}</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list task-details">
                                                <li><strong><i class="fa fa-circle"></i> Accepted:</strong> <a href="#">{{ $acceptedSms }}</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            @if ($bAnyEventExist == false)         
            <div class="timeline-row post-full end">
                <div class="timeline-icon"> <a previous_event_id="{{ $previousID }}" current_event_id="{{ $currentID }}" event_type="main" class="circle_plus {{ ($bAnyEventExist == false || $bListAdded == false) ? 'validatecustlist' : 'addnewaction' }}" href="javascript:void(0);"><i class="icon-plus3"></i></a> </div>
            </div>
            @endif          
            <!--            <div class="timeline-row post-full">
                                <div class="timeline-icon"> <a href="#"><img src="{{ $profileImg }}" alt=""></a> </div>
                        </div>-->
            <div class="timeline-date text-muted">
...
<div class="col-md-12 text-right">
    <a href="javascript:void(0);" class="btn bl_cust_btn publishAutoEvent" automation_id="{{ $oEvents[0]->automation_id }}">
        Publish
...
@include(admin.modals.modules.email.workflow)
...
<script>
                                                            ...
                                                            $.ajax({
                                                            url: "{{ base_url('admin/modules/emails/updateAutomationTrigger') }}",
                                                                    type: "POST",
                                                                    data: formdata,
                                                                    dataType: "json",
                                                                    success: function (data) {
                                                            ...
                                                            $.ajax({
                                                            url: "{{ base_url('admin/modules/emails/addAutomationFollowup') }}",
                                                                    type: "POST",
                                                            ...
                                                            $.ajax({
                                                            url: "{{ base_url('admin/modules/emails/updateEmailAutomationEvent') }}",
                                                                    type: "POST",
                                                            ...
                                                            $.ajax({
                                                            url: "{{ base_url('admin/modules/emails/updateEmailAutomationCampaign') }}",
                                                                    type: "POST",
                                                            ...
                                                            $.ajax({
                                                            url: "{{ base_url('admin/modules/emails/getEmailAutmationCampaign') }}",
                                                                    type: "POST",
                                                            ...
                                                            title: "Are you sure? You want to delete this campaign!",
                                                                    ...
                                                                    if (isConfirm) {
                                                                    $.ajax({
                                                                    url: "{{ base_url('admin/modules/emails/delete_event') }}",
                                                                            type: "POST",
                                                            ...
                                                            $.ajax({
                                                            url: "{{ base_url('admin/modules/emails/updateEventOrder') }}",
                                                                    type: "POST",
