                                        ...
                                        foreach ($oAutomations as $oAutomation):
                                            ...
                                            if (1) {
                                                ...
                                                <tr id="append-<?php echo $oAutomation->id; ?>" class="selectedClass">
                                                    ...
                                                    <td>
                                                        <div class="media-left">
                                                            <div class="pt-5"><a href="#" class="text-default text-semibold"><?php //echo date('d M Y', strtotime($oAutomation->created));           ?><?php echo dataFormat($oAutomation->created); ?></a></div>
