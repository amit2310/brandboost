			...
			<div class="row">
				...
				<div class="panel panel-flat">
				  ...
				  <div class="p20">
				  	...
				  	<h1 class="txt_dark fsize28 fw700">{{ $totalEmailSent }}</h1>
			...
			<div class="row">
				...
				<div class="panel panel-flat">
				  ...
				  <div class="p20">
				  	...
				  	<h1 class="txt_dark fsize28 fw700">{{ (count($oRefVisits)) ? count($oRefVisits) : 0 }}</h1>
			  ...
			  <div class="col-md-3">
				<div class="panel panel-flat">
				  ...
				  <div class="p20">
				  	<img width="44" class="br100 mb10" src="{{ base_url() }}assets/images/ro_icon3.png"/>
				  	<h1 class="txt_dark fsize28 fw700">{{ (count($oUntrackedPurchased)) ? count($oUntrackedPurchased) : 0 }}</h1>
				...
				<div class="panel panel-flat">
                        ...
                        <thead>
                            <tr>
                            	...
                            	<th style="display: none;"></th>
                                <th><i class=""><img src="{{ base_url() }}assets/images/icon_name.png"></i> Referred Friend</th>
                                <th><i class=""><img src="{{ base_url() }}assets/images/icon_name.png"></i> Referrer</th>
                                <th><i class=""><img src="{{ base_url() }}assets/images/icon_status.png"></i>Amount</th>
                                <th><i class=""><img src="{{ base_url() }}assets/images/icon_status.png"></i>Invoice ID</th>
                                <th><i class=""><img src="{{ base_url() }}assets/images/icon_clock.png"></i>Date</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
                            ...
                            foreach ($oRefPurchased as $data) {
                                ...
                                <tr>
                                    ...
                                    <td>											
                                        <div class="media-left media-middle"> {!! showUserAvtar('', $data->firstname, $data->lastname) !!} </div>
                                        <div class="media-left">
                                            <div class="pt-5"><a href="javascript:void(0);" class="text-default text-semibold bbot">{{ $data->firstname }} {{ $data->lastname }}</a> <img class="flags" src="{{ base_url() }}assets/images/flags/{{ strtolower($data->country_code) }}.png" onerror="this.src='{{ base_url('assets/images/flags/us.png') }}'"/></div>
                                    ...
                                    <td>											
                                        <div class="media-left media-middle"> {!! showUserAvtar('', $data->aff_firstname, $data->aff_lastname) !!} </div>
                                        <div class="media-left">
                                            <div class="pt-5"><a href="javascript:void(0);" class="text-default text-semibold bbot">{{ $data->aff_firstname }} {{ $data->aff_lastname }}</a> <img class="flags" src="{{ base_url() }}assets/images/flags/{{ strtolower($data->country_code) }}.png" onerror="this.src='{{ base_url('assets/images/flags/us.png') }}'"/></div>
                                            <div class="text-muted text-size-small">{{ $data->aff_email }}</div>
                                        </div>
                                    </td>

                                    <td>{{ $data->currency }} {{ $data->amount }}</td>
                                    <td><h6 class="text-semibold">{{ $data->invoice_id }}</h6></td>
                                    <td><h6 class="text-semibold">{{ date('M d, Y', strtotime($data->created)) }}<div class="text-muted text-size-small">{{ date('h:i A', strtotime($data->created)) }}</div></h6></td>
