        ...
        <div class="col-md-12">
            <div class="white_box broadcast_menu nps">
                <ul>
                    ...
                    <li><a class="active" href="javascript:void(0);"><img src="{{ base_url() }}assets/images/email_br_icon4_act.png">Configuration</a></li>
                        ...
                        <div class="panel-body p0">
                            ...
                            <div class="bbot p20">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input name="referral_title" id="referral_title" class="form-control autoSave" value="{{ $oReferral->title != '' ? $oReferral->title : '' }}" type="text" placeholder="Referral Title">
                                    </div>
                                </div>
                            ...
                            <div class="bbot p20">
                                ...
                                <input type="hidden" name="refid" id="refid" value="{{ $programID }}" />
                                <div class="form-group">
                                    <label>Store Name {{ $defalutTab }}</label>
                                    <div class="">
                                        <input type="text" class="form-control autoSave" name="storeName" value="@php if(!empty($oAccountSettings)){ echo $oAccountSettings->store_name != '' ? $oAccountSettings->store_name : ''; } @endphp" placeholder="Your store name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Store URL</label>
                                    <div class="">
                                        <input type="text" class="form-control autoSave" name="storeURL" value="@php if(!empty($oAccountSettings)){ echo ($oAccountSettings->store_url) ? ($oAccountSettings->store_url) : ''; } @endphp" placeholder="Your store url e.g. http://mystorename.com">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Email Address</label>
                                    <div class="">
                                        <input type="text" class="form-control autoSave" name="storeEmail" value="@php if(!empty($oAccountSettings)){ echo ($oAccountSettings->store_email) ? ($oAccountSettings->store_email) : ''; } @endphp" placeholder="Your store email address">
                                    </div>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="">
                                                                <input name="facebook_title" id="facebook_title" class="form-control autoSave" type="text" placeholder="Apple iPhone XR" value="@php if(!empty($oAccountSettings)){ echo ($oAccountSettings->facebook_title) ? ($oAccountSettings->facebook_title) : ''; } @endphp">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <textarea name="facebook_desc" id="facebook_desc" rows="4" class="form-control autoSave" placeholder="The iPhone XR display has rounded corners that follow a beautiful curved design, and these corners are within a standard rectangle. When measured as a standard rectangular shape, the screen is 5.85 inches diagonally (actual viewable area is less).">@php if(!empty($oAccountSettings)){ echo ($oAccountSettings->facebook_desc) ? ($oAccountSettings->facebook_desc) : ''; } @endphp</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="">
                                                                <input name="twitter_title" id="twitter_title" class="form-control autoSave" type="text" placeholder="Apple iPhone XR" value="@php if(!empty($oAccountSettings)){ echo ($oAccountSettings->twitter_title) ? ($oAccountSettings->twitter_title) : ''; } @endphp">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <textarea rows="4" name="twitter_desc" id="twitter_desc" class="form-control autoSave" placeholder="The iPhone XR display has rounded corners that follow a beautiful curved design, and these corners are within a standard rectangle. When measured as a standard rectangular shape, the screen is 5.85 inches diagonally (actual viewable area is less).">@php if(!empty($oAccountSettings)){ echo ($oAccountSettings->twitter_desc) ? ($oAccountSettings->twitter_desc) : ''; } @endphp</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="">
                                                                <input name="site_link" id="site_link" class="form-control autoSave" type="text" placeholder="" value="@php if(!empty($oAccountSettings)){ echo ($oAccountSettings->site_link) ? ($oAccountSettings->site_link) : ''; } @endphp">
                                                            </div>
                                                        </div>
...
<script>
    $(document).ready(function () {
        $(document).on("click", ".continueSummary", function () {
            $('.overlaynew').show();
            var refId = $("#refId").val();
            window.location.href = "{{ base_url('/admin/modules/referral/integrations/') }}" + refId;
        });
        ...
        $("#frmSettings").submit(function () {
            ...
            $.ajax({
                url: "{{ base_url('admin/modules/referral/saveSettings') }}",
                type: "POST",
                data: formData,
                contentType: false,
                cache: false,
