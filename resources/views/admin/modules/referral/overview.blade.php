    ...
    <div class="content">
        ...
        <div class="page_header">
            <div class="row">
                <!--=============Headings & Tabs menu==============-->
                <div class="col-md-7">
                    <h3 class="mt20"><img style="width: 18px;" src="{{ base_url() }}assets/images/refferal_icon.png">
            ...
            <div class="tab-pane active">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p20 min_h300 bkg_white">
                                <div class="row">
                                    <div class="col-xs-6"><h1 class="m0 fsize20 fw700"><img
                                                src="{{ base_url() }}assets/images/green_dollar_icon.png"/> &nbsp; $0
                                        </h1></div>
                                    <div class="col-xs-6 text-right"><p class="fsize12"><span class="txt_green"><i
                                                    class="fa fa-arrow-up"></i> 33,87%</span>&nbsp; &nbsp; <span
                                                class="txt_grey">from last month</span></p></div>
                                </div>
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h6 class="panel-title">Referrals<a class="heading-elements-toggle"><i
                            ...
                            <div class="panel-body min_h300 p0 bkg_white text-center">
                                <div class="p20">
                                    <img class="mt20" src="{{ base_url() }}assets/images/referal_rate_icon.png"
                                         width="96">
                                </div>
                                <div class="p20">

                                    <h1 class="txt_dark fsize28 mt0 mb10 fw700">{{ count($oPrograms) }}</h1>
                                    <p class="fsize14 txt_dgrey mb0">Rate <span class="txt_green fsize12"><i
                                                class="fa fa-arrow-up"></i> 33,87%</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h6 class="panel-title">Info Card<a class="heading-elements-toggle"><i
                                            class="icon-more"></i></a></h6>
                                <div class="heading-elements"><a href="#"><i class="icon-more2"></i></a></div>
                            </div>
                            <div class="panel-body min_h300 p30 info_card text-center bkg_white">
                                <div class="mb20"><img src="{{ base_url() }}assets/images/refferal_icon_big.png"
                                                       width="62"></div>
                                <p class="mb10"><strong>Ideas to improve your referral rate</strong></p>
                                <p class="mb20"><span>Check out our epic list of 74 referral<br> program examples for businesses<br> of all types</span>
                                </p>
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            <div class="panel-body p20 pb0 br5 bkg_white text-center ref_stats_sec">
                                <div class="p20">
                                    <img width="44" class="br100 mb10"
                                         src="{{ base_url() }}assets/images/ro_icon1.png"/>
                                    <h1 class="txt_dark fsize28 fw700">{{ count($oEmail) }}</h1>
                                    <p class="fsize14 txt_dgrey mb0">Emails</p>
                                </div>
                                <div class="btop p20">
                                    <p class="fsize12 m0"><span class="txt_green"><i class="fa fa-arrow-up"></i> 33,87%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            <div class="panel-body p20 pb0 br5 bkg_white text-center ref_stats_sec">
                                <div class="p20">
                                    <img width="44" class="br100 mb10"
                                         src="{{ base_url() }}assets/images/ro_icon2.png"/>
                                    <h1 class="txt_dark fsize28 fw700">{{ count($oClick) }}</h1>
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            <div class="panel-body p20 pb0 br5 bkg_white text-center ref_stats_sec">
                                <div class="p20">
                                    <img width="44" class="br100 mb10"
                                         src="{{ base_url() }}assets/images/ro_icon3.png"/>
                                    <h1 class="txt_dark fsize28 fw700">{{ count($oVisite) }}</h1>
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-flat">
                            <div class="panel-body p20 pb0 br5 bkg_white text-center ref_stats_sec">
                                <div class="p20">
                                    <img width="44" class="br100 mb10"
                                         src="{{ base_url() }}assets/images/ro_icon4.png"/>
                            ...
                            <div class="panel-heading">
                                ...
                                <div class="heading-elements">
                                    <div style="display: inline-block; margin: 0;"
                                        ...
                                        <input class="form-control input-sm cus_search" tableId="referralList"
                            ...
                            <div class="panel-body p0">
                                <table class="table datatable-basic-new" id="referralList">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class=""><img src="{{ base_url() }}assets/images/icon_date.png"/></i>
                                            Programs
                                        </th>
                                        <th><i class=""><img src="{{ base_url() }}assets/images/icon_people.png"/></i>
                                            Advocated
                                        </th>
                                        <th><i class=""><img src="{{ base_url() }}assets/images/icon_click.png"/></i>
                                        </th>
                                        <th><i class=""><img src="{{ base_url() }}assets/images/icon_display.png"/></i>
                                        </th>
                                        <th><i class=""><img src="{{ base_url() }}assets/images/icon_refresh2.png"/></i>
                                        </th>
                                        ...
                                        <th class="text-center nosort sorting_disabled"><i
                                                class="fa fa-dot-circle-o"></i>Action
                                        </th>
                                        <th style="display: none;"></th>
                                    </tr>
                                    </thead>
                                    ...
                                    <td>
                                        <div class="media-left media-middle"><img width="24"
                                                                                  src="{{ base_url() }}assets/images/referal_ov_icon.png"/>
                                        </div>
                                        <div class="media-left">
                                            <div class=""><a
                                                    href="{{ base_url() }}admin/modules/referral/setup/{{ $oProgram->id }}"
                                                    class="text-default text-semibold bbot">{{ $oProgram->title }}</a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div style="width: 117px;" class="media-left text-right pr40 brig"><a
                                                href="{{ base_url() }}admin/modules/referral/advocates/{{ $oProgram->id }}"
                                                class="text-default text-semibold">{{ count($oContacts) > 0 ? count($oContacts) : 0 }}</a>
                                        </div>
                                    </td>
                                    <td>
                                        @php
                                        ...
                                        <div class="media-left">
                                            <div
                                                class="progress-circle {{ $addPC }} teal cp{{ $positiveGraph }} @if ($positiveGraph > 0) createSegment @endif"
                                                segment-type="total-sent" campaign-id="{{ $oProgram->id; ?>" campaign-type="email" title="click to create segment">
										...
										<div class="media-left">
											<div data-toggle="tooltip" title="{{ $positiveRating }} email send"
                                                data-placement="top">
                                                @if ($positiveRating > 0)
                                    ...
                                    <td>
                                        ...
                                        <div class="media-left">
                                            <div
                                                class="progress-circle {{ $addPC }} dark_green cp{{ $positiveGraph }} @if ($positiveGraph > 0) createSegment @endif"
                                                segment-type="total-open" campaign-id="{{ $oProgram->id }}"
                                        ...
                                        <div class="media-left">
                                            <div data-toggle="tooltip" title="{{ $positiveRating }} email open"
                                                 data-placement="top">
                                                @if ($positiveRating > 0)
                                                    <a href="javascript:void(0);"
                                                       class="text-default text-semibold">{{ $positiveRating }}</a>
                                    ...
                                    <td>
                                        ...
                                        <div class="media-left">
                                            <div
                                                class="progress-circle {{ $addPC }} green cp{{ $totPerClick }} @if ($totPerClick > 0) createSegment @endif"
                                                segment-type="total-click" campaign-id="{{ $oProgram->id }}"
                                                campaign-type="email" title="click to create segment">
                                                <div class="left-half-clipper">
                                                    <div class="first50-bar"></div>
                                                    <div class="value-bar"></div>
                                        ...
                                        <div class="media-left">
                                            <div data-toggle="tooltip" title="{{ $totalClicked }} email clicked"
                                                 data-placement="top">
                                                @if ($totalClicked > 0)
                                                    <a href="javascript:void(0);"
                                                       class="text-default text-semibold">{{ $totalClicked }}</a>
                                                @else
                                                    <a href="javascript:void(0);"
                                                       class="text-default text-semibold">{{ $totalClicked }}</a>
                                                @endif
                                    ...
                                    <td>
                                        <div class="media-left">
                                            <div class=""><span
                                                    class="text-default text-semibold">{{ dataFormat($oProgram->created) }}</span>
                                            </div>
                                            <div
                                    ...
                                    <td class="text-center">
                                        <div class="tdropdown ml10"><a class="table_more dropdown-toggle"
                                            ...
                                            <ul style="right: 0;" class="dropdown-menu dropdown-menu-right status">
                                                ...
                                                <li><a target="_blank"
                                                       href="{{ base_url('admin/modules/referral/stats/' . $oProgram->id) }}"><i
                                                            class="icon-file-stats"></i>Stats</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td style="display: none;">
