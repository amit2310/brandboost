...
#canvas3{height: 230px !important;}
  ...
  <!--&&&&&&&&&&&& PAGE HEADER &&&&&&&&&&-->
	<div class="page_header">
	  ...
	  <!--=============Headings & Tabs menu==============-->
		<div class="col-md-7">
		  <h3 class="mt20"><img style="width: 18px;" src="{{ base_url() }}assets/images/refferal_icon.png"> Referral Overview</h3>
		</div>
	  </div>
	</div>
  <!--&&&&&&&&&&&& PAGE HEADER END&&&&&&&&&&-->
	  ...
	  <div class="tab-pane active">
		...
		<div class="col-md-6">
			  ...
			  <div class="panel-body p20 min_h300 bkg_white">
				<div class="row">
				<div class="col-xs-6"><h1 class="m0 fsize20 fw700"><img src="{{ base_url() }}assets/images/green_dollar_icon.png"/> &nbsp; $0</h1></div>
		...
		<div class="col-md-3">
			<div class="panel panel-flat">
			  ...
			  <div class="p20">
				<img class="mt20" src="{{ base_url() }}assets/images/referal_rate_icon.png" width="96">
			  </div>
			  <div class="p20">
		...
		<div class="panel panel-flat">
		  ...
		  <div class="panel-body min_h300 p30 info_card text-center bkg_white">
			<div class="mb20"><img src="{{ base_url() }}assets/images/refferal_icon_big.png" width="62"></div>
