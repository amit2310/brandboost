		...
		<div class="page_header">
		  ...
		  <!--=============Headings & Tabs menu==============-->
			...
			<!-- <div class="col-md-5 text-right btn_area">
			 <button type="button" class="btn light_btn ml20" ><i class="icon-plus3"></i><span> &nbsp;  Create Campaign</span> </button>
			 <button type="button" class="btn dark_btn ml20" ><i class="icon-plus3"></i><span> &nbsp;  Add Referral</span> </button>
			 </div> -->
		  </div>
		</div>
	  <!--&&&&&&&&&&&& PAGE HEADER END&&&&&&&&&&-->
