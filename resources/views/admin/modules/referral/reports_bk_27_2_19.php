        ...
        <div class="row">
            ...
            <div class="col-md-3">
               ...
               <!--  <ul class="nav nav-tabs nav-tabs-bottom">
                    <li class="<?php echo $emailActive; ?>"><a href="#email_tab" data-toggle="tab"> Email Stats </a></li>
                    <li class="<?php echo $smsActive; ?>"><a href="#sms_tab" data-toggle="tab"> SMS Stats </a></li>
                </ul> -->
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-flat">
                ...
                <div class="tabbable">
 <ul class="nav nav-tabs nav-tabs-bottom">
   <li class="active"><a href="#Trackedtab" data-toggle="tab"><i class="icon-file-text position-left"></i> Tracked Sales </a></li>
   <li><a href="#Untrackedtab" data-toggle="tab"><i class="icon-menu7 position-left"></i> Untracked Sales </a></li>
 </ul>
 <div class="tab-content">
   <!--########################TAB 1 ##########################-->
