...
<div class="content">
    <div class="row mb20">
        ...
        <div class="col-lg-12 text-right">
            ...
            <button type="button" class="btn bl_cust_btn btn-default addModuleContact" data-modulename="<?php echo $moduleName;?>" data-moduleaccountid="<?php echo $oNPS->hashcode; ?>" style="margin-left:12px;"><i class="icon-make-group position-left"></i> INVITE PEOPLE </button>

            <button type="button" class="btn bl_cust_btn btn-default importModuleContact" data-modulename="<?php echo $moduleName;?>" data-moduleaccountid="<?php echo $oNPS->hashcode; ?>" data-redirect="<?php echo base_url();?>admin/modules/nps/setup/<?php echo $oNPS->id; ?>" style="margin-left:12px;"><i class="icon-make-group position-left"></i> IMPORT PEOPLE </button> 

            <a  href="<?php echo base_url() ?>admin/subscriber/exportSubscriberCSV?module_name=<?php echo $moduleName;?>&module_account_id=<?php echo $oNPS->hashcode; ?>" title="Export" class="btn bl_cust_btn btn-default"><i class="icon-make-group position-left"></i> EXPORT PEOPLE </a>
