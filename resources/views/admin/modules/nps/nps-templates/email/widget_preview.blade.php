...
<div id="nps_widget_preview" style="position: absolute;top:10%;width:100%; margin-top:0px; font-family: arial;">
    <div style="text-align: center; padding: 50px; margin-bottom: 0px; width: 100%;border-radius: 5px;background-color: #ffffff;box-shadow: 0 10px 20px 0 rgba(12, 12, 44, 0.05), 0 2px 2px 0 rgba(0, 0, 0, 0.03);position: relative; box-sizing: border-box;">
        ...
        <p  style="font-weight: bold; font-size: 16px; color: {{ $oNPS->web_text_color }}; margin-bottom: 15px; font-family: arial;" class="questionEamilText">{{ $oNPS->question }}</p>
        <p style="font-weight: 400; font-size: 14px; color: {{ $oNPS->web_int_text_color }}; margin: 0; font-family: arial;"><span class="introductionText" @if (!$oNPS->display_intro) style="display:none;" @endif >{{ $oNPS->description }}</span></p>
    </div>
