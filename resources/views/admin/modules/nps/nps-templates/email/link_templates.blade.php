	...
	<body width="100%" height="100%" bgcolor="#f3f3fa" style="margin: 0; mso-line-height-rule: exactly;">
		<center class="wrap" style="width: 100%; text-align:left;">
			<table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin:160px auto 0;" class="email-container table_main_mr">
				<tr>
					<td>
						<table style="background:#fff; box-shadow:0px 0px 8px;">
							<tr>
								<th style="padding:0 80px 40px;" class="pb"> 
									<table width="100%" style="margin-top:-60px;" class="table_mr">
										<tbody>
											<tr>
												<th> 
													<center><img style="margin:5px auto 15px;" src="http://brandboost.io/assets/images/emailer/emailer-3-walker.png" title="" alt="" class="main_img"></center>
													...
													<p style="line-height: 25px; padding:0; margin: 0; font-size: 14px; font-weight: normal; color: #494968; font-family: 'Open Sans', sans-serif; text-align: center;padding: 0 46px;" class="main_txt p15" id="wf_edit_template_introduction">{INTRODUCTION}</p>
													<center><a href="{SURVEYURL}" title="RE-SUBSCRIBE NOW" style="margin: 20px 0 0; text-decoration: none; font-family: 'Open Sans', sans-serif; background-color: #6d41f2; display: inline-block; padding:16px 30px; border-radius: 4px; font-size: 14px; color: #FFFFFF; text-align: center;" class="btn_pd" id="wf_survey_link">Survey</a></center>
												</th>
											</tr>
										</tbody>
									</table>
				...
				<tr>
					<th style="padding:0 80px;" class=""> <table style="margin-top: 20px;">
						<tbody>
							<tr>
								<td height="5px">&nbsp;</td>
							</tr>
							<tr>
								<th> 
									<p style="font-family: 'Open Sans', sans-serif; text-align: center; margin:10px 0 15px; font-size: 10px; color:#8787a5; font-weight: normal; padding: 0 30px; line-height: 16px;" class="p15">You can find answers to common questions here. And you can always reach us at <a href="" style="color: #8787a5; text-decoration: none;">support@brandboost.io</a></p>
									<p style="font-family: 'Open Sans', sans-serif; text-align: center; margin:10px 0 15px; font-size: 10px; color:#8787a5; font-weight: normal; padding: 0 30px; line-height: 16px;" class="p15">BrandBoost Limited is a company registered in England and Wales with registered number 07209813. Our registered office is at 56 Shoreditch High Street, London, E1 6JJ. BrandBoost is an Electronic Money Institution authorised by the Financial Conduct Authority with firm reference 900507.</p>
								</th>
							</tr>
						</tbody>
					</table>
