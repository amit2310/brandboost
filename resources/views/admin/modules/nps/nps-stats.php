									...
									<?php 
										foreach ($oNPSEvents as $oEvent) {
											if($oEvent->event_type == 'invite-email' || $oEvent->event_type == 'reminder-email'){
												...
												$aStats = $this->mNPS->getNPSSendgridStats('event', $oEvent->id, '');
								...
								<?php 
									foreach ($oNPSEvents as $oEvent) {
										if($oEvent->event_type == 'invite-sms' || $oEvent->event_type == 'reminder-sms'){
											$aStats = $this->mNPS->getEmailTwilioStats('event', $oEvent->id);
											$aCategorizedStatsSms = $this->mNPS->getEmailTwilioCategorizedStatsData($aStats);
											//pre($aStats);
