                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="blog-preview">
                                                <h5 class="panel-title">NPS Feedback For <strong>"<?php echo $oScore->npstitle; ?>"</strong> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                                                <h5 class="blog-title mb0 text-semibold"> <?php echo $oScore->title; ?> </h5>
                                                <h4>by <?php echo $oScore->firstname; ?> <?php echo $oScore->lastname; ?> &nbsp; &nbsp; <small class="text-success-400"><i class="fa text-success-400 fa-check"></i> Verified Purchase</small></h4>
                                                <ul class="list-inline list-inline-separate mb-15">
                                                    <li>
                                                        <?php foreach ($oTags as $tagData) { ?>
                                                            <span class="label bg-success animated"><?php echo $tagData->tag_name; ?> <i class="removetxt" tag_id="<?php echo $tagData->id; ?>" score_id="<?php echo $tagData->score_id; ?>">&nbsp; (x)</i></span> 
                                                        <?php } ?>
                                                        <span class="label bg-success addtag applyInsightTags" action_name="nps-tag" scoreid="<?php echo $scoreID; ?>">+ Add Tag</span>
                                                    </li>

                                                </ul>
                                                <p><?php echo $oScore->feedback; ?></p>
                                    ...
                                    <div class="cust_details mb30">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 inner">
                                                ...
                                                <p><strong><i class="fa fa-angle-double-right"></i> &nbsp; Ref: </strong> <span>N/A</span></p>
                                                <p><strong><i class="fa fa-angle-double-right"></i> &nbsp; Name: </strong> <span><?php echo $oScore->firstname; ?> <?php echo $oScore->lastname; ?></span></p>
                                                <p><strong><i class="fa fa-angle-double-right"></i> &nbsp; Email: </strong> <span><?php echo $oScore->email; ?></span></p>
                                                <p><strong><i class="fa fa-angle-double-right"></i> &nbsp; Mobile: </strong> <span><?php echo $oScore->phone == '' ? 'N/A' : $oScore->phone; ?></span></p>
                                            </div>

                                            <div class="col-md-12 inner mt-15">
                                                <h3><i class="fa fa-tags"></i>&nbsp; NPS Notes</h3>
                                            </div>
                ...
                <div class="row">
                    ...
                    <form method="post" class="form-horizontal" id="frmSaveNote" action="javascript:void();">
                        ...
                        <div class="col-md-12 text-right ">
                            ...
                            <button data-toggle="modal" data-target="#addnotes" type="button" id="saveNPSNotes" class="btn bg-blue-600"> Add Notes &nbsp; <i class="fa fa-angle-double-right"></i> </button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on("click", ".removetxt", function () {
            var scoreID = $(this).attr("score_id");
            var tagID = $(this).attr("tag_id");
            var elem = $(this);
            $.ajax({
                url: '<?php echo base_url('admin/modules/nps/removeNPSTag'); ?>',
                type: "POST",
                data: {score_id: scoreID, tag_id: tagID},
                dataType: "json",
