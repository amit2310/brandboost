<div class="tab-pane {{ ($defalutTab == 'widgets') ? 'active' : '' }}" id="right-icon-tab6">
...
id='bbscriptloader' 
data-key='{{ $oNPS->hashcode }}' 
data-widgets='nps' async='' 
src='{{ base_url() }}assets/js/nps_widgets.js' &gt; 
&lt;/script&gt;
</pre>
							<div style="display: none;" class="prettyprintDiv">&lt;script type='text/javascript' id='bbscriptloader' data-key='{{ $oNPS->hashcode }}' data-widgets='nps' async='' src='{{ base_url() }}assets/js/nps_widgets.js' &gt; &lt;/script&gt;</div>
				...
				<div style="margin: 0;" class="panel panel-flat">
					...
					<div class="panel-body min_h270 p0">
						<div class="p20 bbot">
							...
							{{ base_url('/survey/') }}{{ $oNPS->hashcode }}
							</div>
							<div style="display: none;" class="prettyprintURL">{{ base_url('/survey/') }}{{ $oNPS->hashcode }}</div>
