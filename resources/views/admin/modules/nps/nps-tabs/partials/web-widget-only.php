...
/*    .nps_rating_numbers:hover{background: #dfdfdf; color: #636363}*/
...
<div class="widget_sec">
    ...
    <div class="nps_bb_bot_widget" id="nps_bb_bot_widget">
        ...
        <div class="product_icon"  style="top:-45px!important;"><img style="width:50px;" src="<?php echo (!empty($oNPS->brand_logo)) ? 'https://s3-us-west-2.amazonaws.com/brandboost.io/' . $oNPS->brand_logo : base_url() . 'assets/images/apple_icon.png'; ?>" class="logo_img"/></div>
        <h3 class="introductionText" style="color:<?php echo!(empty($oNPS->web_int_text_color)) ? $oNPS->web_int_text_color : '#000'; ?>;"><?php echo (!empty($oNPS->description)) != '' ? $oNPS->description : '{INTRODUCTION}'; ?></h3>
        <h3 class="questionText" style="color:<?php echo!(empty($oNPS->web_text_color)) ? $oNPS->web_text_color : '#000'; ?>;"><?php echo (!empty($oNPS->question)) != '' ? $oNPS->question : '{QUESTION}'; ?></h3>
 
        <div class="nps_bb_footer_box">
            <ul class="nps_bb_rating">
                <li class="nps_rating_lists">Not Likely</li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">1</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">2</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">3</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">4</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">5</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">6</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">7</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">8</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">9</a>
                </li>
                <li class="nps_rating_lists">
                    <a class="nps_rating_numbers buttonStyle" href="javascript:void(0);" style="color:<?php echo!(empty($oNPS->web_button_text_color)) ? $oNPS->web_button_text_color : '#ffffff'; ?>; background:<?php echo (!empty($oNPS->web_button_color)) ? $oNPS->web_button_color : '#636363'; ?>;">10</a>
                </li>
        ...
        <div class="nps_bb_form_box">
            <form id="nps_widget_form" name="">
                <input class="bb_nps_input bb_display_name"  style="display:<?php echo!(empty($oNPS->display_name)) ? 'block' : 'none'; ?>" type="text" name="" value="" placeholder="Name (Optional) :" />
                <input class="bb_nps_input bb_display_email" style="display:<?php echo!(empty($oNPS->display_email)) ? 'block' : 'none'; ?>" type="text" name="" value="" placeholder="Email (Optional) :" />
    ...
    <div class="bb_nps_success_box" id="bb_nps_success_box">
        ...
        <p class="mt20">Powered by: <a target="_blank" href="http://brandboost.io/admin/">Brandboost.io</a></p>
    </div>
...
<script>
//    var x = document.getElementsByClassName("nps_rating_numbers");
//    x[0].addEventListener('click', function (e) {
//        e.preventDefault();
//        document.querySelector(".nps_bb_form_box").style.display = "block";
//    });
