  ...
  <div class="col-md-12">
    <div style="margin: 0;" class="panel panel-flat">
      ...
      <span class="pull-left">
        <h6 class="panel-title">Chat Contacts</h6>
        </span>
      </div>
 ...
 <table class="table datatable-basic">
    <thead>
        <tr>
            ...
            <th><i class="icon-history"></i>Last Contact</th>
        ...
        <!-- <tr>
            <td>
                ...
                <div class="media-left">
                    <div class="pt-5"><a href="#" class="text-default text-semibold"><span>Dora Weber</span> <img class="flags" src="/assets/images/flags/ao.png"/></a></div>
                    <div class="text-muted text-size-small">carlo.johnston@yahoo.com</div>
                </div>
            </td>
            <td>
                <div class="media-left">
                    <div class="pt-5"><a href="#" class="text-default text-semibold">891-099-5244</a></div>
                    <div class="text-muted text-size-small">Chat</div>
                </div>
            </td>
            <td>
                <div class="media-left">
                    <div class="pt-5"><a href="#" class="text-default text-semibold">24 Sep 2018</a></div>
            ...
            <td width="180">
                <button class="btn btn-xs btn_white_table"><i class="icon-twitter txt_lblue"></i></button>
                <button class="btn btn-xs btn_white_table"><i class="icon-facebook txt_dblue"></i></button>
                <button class="btn btn-xs btn_white_table"><i class="icon-phone2 txt_green"></i></button>
                <button class="btn btn-xs btn_white_table"><i class="icon-envelop txt_blue"></i></button>
            </td>
            ...
            <td>
                <div class="tdropdown">
                    <button type="button" class="btn btn-xs btn_white_table dropdown-toggle " data-toggle="dropdown"> 4 Tags &nbsp; <span class="caret"></span></button>
                ...
                <button class="btn btn-xs btn_white_table pr10"><i class="icon-primitive-dot txt_green"></i> Active</button>
