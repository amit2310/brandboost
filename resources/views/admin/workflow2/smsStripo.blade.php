...
<html lang="en">
    ...
    <style>
        ...
        #saveStripoChanges, #saveStripoDraft, #saveToMyTemplates{float: right;margin-left: 10px;margin-top:20px;}
                ...
                <div class="col-md-4 pr0">
                    <div class="email_editor_left" style="">
                        ...
                        <div class="p20 pt0" id="wfSMSActiveCtrEdit">
                            ...
                            <button type="button" id="updateWorkflowSmsCampaign" class="btn dark_btn bkg_sblue fsize14">Save</button>
                        ...
                        <div class="p20 pt0" id="wfSMSTestCtrEdit" style="display:none;">
                            ...
                            <button type="button" id="wf_preview_edit_sms_template_send_sms_Edit" class="btn dark_btn bkg_sblue fsize14">Send</button>
                    ...
                    <div class="email_editor_right preview" style="max-height:1000px;overflow:hidden;">
                        <div class="p10 bbot position-relative pull-right" style="width:100%;">
                            <div class="gjs-pn-buttons pull-right">
                                ...
                                <span title="" data-tooltip-pos="bottom" class="gjs-pn-btn fa fa-save" id="saveStripoChanges2" data-tooltip="Save Template"></span>
