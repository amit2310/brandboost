...
<div class="timeline-zoomable">
    <div class="timeline-row post-full">
        ...
        <div class="timeline-date button">
            ...
            <button type="button" class="btn white_btn chooseContact" data-modulename="{{ $moduleName }}"
                    data-moduleaccountid="{{ $moduleUnitID }}"><span class="txt_grey"></span> New Contact

            </button>
            <a class="icons iconsab blue br8 t30 chooseContact" data-modulename="{{ $moduleName }}"
               data-moduleaccountid="{{ $moduleUnitID }}" href="javascript:void(0);"><img
                    src="{{ base_url() }}assets/images/menu_icons/People_Light.svg"></a>
        </div>
        ...
        <div class="timeline-date button mt20 mb40">
            <button class="btn btn-xs btn_white_table smallbtn rounded dropdown-toggle" data-toggle="dropdown"><i
        ...
        @if ($bBranchDrawn == false)
            <div class="timeline-date button">
                <button type="button" class="btn white_btn wf_timer" id="wf_waitTime_{{ $oEvent->id }}"
                        event_id="{{ $oEvent->id }}"
                ...
                <a class="icons iconsab br8 dark t30 wf_timer" id="wf_waitTime_{{ $oEvent->id }}"
                   event_id="{{ $oEvent->id }}"
                   delay_value="{{ $aEventData->delay_value == '' ? '10' : $aEventData->delay_value }}"
                   delay_unit="{{ $aEventData->delay_unit == '' ? 'minute' : $aEventData->delay_unit }}"
                   delay_time="{{!empty($aEventData->delay_time) ? $aEventData->delay_time : '9 PM' }}"
                   href="javascript:void(0)"><img src="{{ base_url() }}assets/images/clock_white14.png"></a>
            </div>
        ...
        @if ($bMulitpleBranches == false)
            <div class="timeline-date button mt20 mb40">
                <button class="btn btn-xs btn_white_table smallbtn rounded dropdown-toggle" data-toggle="dropdown"
                        previous_event_id="{{ $previousID }}" current_event_id="{{ $currentID }}"
                        event_type="{{ $nextEventType }}" data-node-type="followup"><i class="icon-plus3"></i></button>
