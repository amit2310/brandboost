...
<head>
    ...
    <link rel="stylesheet" href="{{ base_url() }}assets/grapes/style/material.css">
    <link rel="stylesheet" href="{{ base_url() }}assets/grapes/style/tooltip.css">
    <link rel="stylesheet" href="{{ base_url() }}assets/grapes/style/toastr.min.css">
    ...
    <script type="text/javascript" src="{{ base_url() }}assets/js/core/libraries/bootstrap.min.js?t=num"></script>
    <script src="//unpkg.com/grapesjs@0.10.7/dist/grapes.min.js"></script>
    <script src="{{ base_url() }}assets/grapes/dist/grapesjs-preset-newsletter.min.js"></script>
    ...
    <div class="row">
        <div class="col-md-12">
            <div style="display:block;width:100%;float:right;margin-right: 20px;margin-top:-5px;">
                ...
                <button id="saveStripoChangesSilent" notification-mod="silent" class="control-button"
                        style="display:none;">Save Email
                </button>
                @if ($moduleName == 'automation' || $moduleName == 'broadcast')
                    ...
                    <input type="hidden" id="draft_id" name="draft_id" value="{{ !empty($draftID) ? $draftID : '' }}"/>
                @endif
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group" style="width: calc(100% - 160px); float: left;">
                <label>Subject: </label>
                <input class="form-control" id="wf_campaign_subject" name="wf_campaign_subject"
                       placeholder="Email Subject" type="text" value="{{ $subject }}">
            </div>
            <button id="preheaderboxshowbtn" type="button" class="btn dark_btn h40 pull-right mr20"
                    style="margin-top:22px;"><i class="icon-plus3"></i> &nbsp; <span>Add Pre Header</span></button>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group" style="width:100%;float: left;">
                ...
                <input class="form-control" id="wf_campaign_pre_header_subject" name="wf_campaign_pre_header_subject"
                       placeholder="Enter Preheader Text" type="text" value="{{ $preheader }}">
            </div>
...
<form id="test-form" class="test-form" method="POST" style="display:none">
    <div class="gjs-sm-property">
        <div class="gjs-field">
                    <span id="gjs-sm-input-holder">
                        <input type="email" name="email" id="wfPreviewTestCtr_text_email" placeholder="Email" required
                               style="color:#000000;">
                    </span>
        </div>
    </div>
    ...
    <button type="button" class="gjs-btn-prim gjs-btn-import" id="wfPreviewTestCtr_send_email" style="width: 100%">
        SEND
    </button>
</form>
...
<div id="success_notice" class="hide">
    <div class="flag_notifications">
        ...
        <div class="row">
            <div class="col-xs-2"><img width="40" src="{{ base_url() }}assets/images/notification_green.png"/></div>
            <div class="col-xs-10">
...
<div id="error_notice" class="hide">
    <div class="flag_notifications">
        ...
        <div class="row">
            <div class="col-xs-2"><img width="40" src="{{ base_url() }}assets/images/notification_red.png"/></div>
            <div class="col-xs-10">
    ...
    var editor = grapesjs.init({
        ...
        assetManager: {
            ...
            uploadFile: function (e) {
                ...
                $.ajax({
                    url: '{{ base_url() }}dropzone/upload_editor_image',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    crossDomain: true,
