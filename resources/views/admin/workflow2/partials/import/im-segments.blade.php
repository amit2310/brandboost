...
<div class="panel panel-flat wfSwitchMenu" id="wfImportFromSegments" style="display:none;">
    <div class="panel-heading">
        <h6 class="panel-title pull-left"><a style="color: #5e729d!important;" class="backtoImportOptionMenu" href="javascript:void(0);"> <i class=""><img width="20" src="{{ base_url() }}assets/images/back_icon.png"/></i> &nbsp; Back</a></h6>
    ...
    <div class="panel-body pt0 bkg_white" style="padding:0;">
        <div class="col-md-12">
            ...
            <div class="p20 bbot">
                <h3 class="fsize20 fw500 txt_dark m0">Include From Segments <span id="totalSegmentCount">{{ count($aSelectedSegments) }}</span></h3>
