...
<div class="panel panel-flat wfSwitchMenu" id="wfImportFromList" style="display:none;">
    ...
    <div class="panel-body pt0 bkg_white" style="padding:0;">
        <div class="col-md-12">
            ...
            <div class="p20 bbot">
                <h3 class="fsize20 fw500 txt_dark m0">Include From Lists <span id="totalListCount"><?php echo count($aListIDs);?></span></h3>
                            ...
                            <td>
                                <div class="media-left brig pr10">
                                    <label class="custmo_checkbox ">
                                        <input type="checkbox" class="addListToCampaign" name="list_id[]" value="<?php echo $oList->id; ?>" <?php if (in_array($oList->id, $aListIDs)): ?> checked="checked"<?php endif; ?>>
