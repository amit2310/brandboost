...
<div class="panel panel-flat" id="wfEmailMenu" style="display:none;">
    ...
    <div class="panel-body p20 pt0 bkg_white">
        ...
        <div class="pt20 pb20">
            ...
            <p><a href="javascript:void(0);" id="wf_email_menu_edit" class="wf_editCampaign" campaign_id="<?php echo $oCampaign->id; ?>" moduleName="<?php echo $moduleName; ?>" campaignType="email"><i class=""><img src="<?php echo base_url(); ?>assets/images/list_icon_grey.png"/></i> &nbsp;  Edit Email</a></p>
            <?php endif; ?>
