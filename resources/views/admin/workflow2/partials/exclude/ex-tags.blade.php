...
<div class="panel panel-flat wfSwitchMenu" id="wfExcludeFromTags" style="display:none;">
    ...
    <div class="panel-body pt0 bkg_white" style="padding:0;">
        <div class="col-md-12">
            ...
            <div class="p20 bbot">
                <h3 class="fsize20 fw500 txt_dark m0">Exclude From Tags <span
                        id="totalExcludeTagCount">{{ count($aSelectedTags) }} </span></h3>
                        ...
                        <td>
                            <div class="media-left brig pr10">
                                <label class="custmo_checkbox ">
                                    <input type="checkbox" name="checkRows[]" class="addExcludedTagToCampaign"
                                           value="{{ $aTag->tagid }}"
