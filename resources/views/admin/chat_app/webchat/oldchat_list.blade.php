...
<div RwebId="{{ $token }}" token="{{ $token }}" class="sidebar-user-box all_user_chat tk_{{ $token }}"
    ...
    <div class="avatarImage">{!! showUserAvtar($avatar, $first_name, $last_name, 28, 28, 11) !!}</div>
    ...
    <span class="user_status"><time class="autoTimeUpdate" id="autoTime_{{  $userid }}"
                ...
                <div class="p20 pt0 pb10">
                    <div class="interactions p0 pt10 pb10 btop">
                        <ul>
                            ...
                            <li>
                                <span style="width: 62px; float: left;">
                                    <i class="fa fa-envelope"></i> Email:
                                </span>
                                <span class="userAdd">
		<strong class="em">{{ $Usrvalue->email }}</strong>
                                </span>
                                <input type="text" class="uAddText support_email" style="display:none;"
                                       name="support_email">
                            </li>
                            <li>
                                <span style="width: 62px; float: left;"><i class="fa fa-phone"></i> Phone: </span>
                                <span class="userAdd">
		<strong class="em">{{ $Usrvalue->phone }}</strong>
                                </span> <input type="text" class="uAddText support_email" style="display:none;"
                                               name="support_email">
                            </li>
