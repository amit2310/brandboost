...
@section('contents')
    ...
    <style>
        ...
        #myfirstchart {
            background: url(images/graphbkg.png) left top repeat !important;
        }
    ...
    <div class="content">
        ...
        <div class="page_header">
            <div class="row">
                <!--=============Headings & Tabs menu==============-->
                <div class="col-md-5">
                    <h3><img style="width:17px;" src="{{ base_url() }}assets/images/menu_icons/Chat_Light.svg"> Chat
                        Overview</h3>
                ...
                <div class="col-md-7 text-right btn_area">
                    <button type="button" class="btn light_btn ml10"><i class="icon-download4"></i><span> &nbsp;  Import Contacts</span>
                    </button>
                    ...
                    <div class="col-md-8 ">
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p0 bkg_white min_h310">
                                <div class="p20 bbot">
                                    <p class="txt_grey fw300 m0"><i class="fa fa-square txt_blue"></i> &nbsp; New chats
                                        this month &nbsp; &nbsp; <strong class="txt_dark"></strong></p>
                                </div>
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p20 pt50 pb40 bkg_white text-center min_h310">
                                <div class="outer_circle">
                                    <div id="bluecircle"
                                         class="c100 p23 medium"> <span><strong>{{ $todayChat }}</strong> <br>
										CHATS <br>
										TODAY</span>
                                        <div class="slice">
                                            <div class="bar"></div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                                            ...
                                            <div class="col-md-5 pr40 pl20 mt20 brig">
                                                <ul class="onsite_list">
                                                    <li class="bnone"><span class="txt_dark"><img width="12"
                                                                                                  src="{{ base_url() }}assets/images/chat_list_icon.png"> All Chats</span><strong
                                                            class="txt_dark">{{ count($supportChat) }}</strong></li>
                                                    <li><span><img width="14"
                                                                   src="{{ base_url() }}assets/images/chat_desktop_icon.png"> Website Chats</span><strong>{{ count($supportChat) }}</strong>
                                                    </li>
                                                    <li><span><img width="14"
                                                                   src="{{ base_url() }}assets/images/chat_mobile_icon.png"> SMS Chats</span><strong>N/A</strong>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-md-7 pl20">
                                                <div id="linechart_a" style="min-width: 300px; height: 220px;"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h6 class="panel-title">Response Time<a class="heading-elements-toggle"><i
                                    ...
                                    <div class="panel-body p20 db_stats bkg_white">
                                        <div class="row">
                                            <div class="col-xs-2"><img class="pull-left"
                                                                       src="{{ base_url() }}assets/images/clock_44.png">
                                            </div>
                                            <div class="col-xs-10"><h1>{{ $showtime }}</h1>
                                                <p><strong class="txt_green"><i class=""><img
                                                                src="{{ base_url() }}assets/images/green_arrow.png"></i>&nbsp;
                                                        33,87%</strong> &nbsp; <span class="txt_dgrey">last week</span>
                                                </p></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12"><img class="img-responsive mt30"
                                                                        src="{{ base_url() }}assets/images/chat_graph_blue.png">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h6 class="panel-title">Time to close<a class="heading-elements-toggle"><i
                                                    class="icon-more"></i></a></h6>
                                        <div class="heading-elements"><i class="icon-arrow-down12 txt_grey"></i></div>
                                    </div>
                                    <div class="panel-body p20 db_stats bkg_white">
                                        <div class="row">
                                            <div class="col-xs-2"><img class="pull-left"
                                                                       src="{{ base_url() }}assets/images/icon_check_44.png">
                                            </div>
                                            <div class="col-xs-10"><h1>{{ $showCompleteTime }}</h1>
                                                <p><strong class="txt_green"><i class=""><img
                                                                src="{{ base_url() }}assets/images/green_arrow.png"></i>&nbsp;
                                                        33,87%</strong> &nbsp; <span class="txt_dgrey">last week</span>
                                                </p></div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12"><img class="img-responsive mt30"
                                                                        src="{{ base_url() }}assets/images/chat_graph_green.png">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p20 bkg_white min_h310" style="padding-bottom: 5px!important">
                                <div class="p20 text-center">
                                    <!--<img style="height: 250px; margin: 0 auto;" class="img-responsive" src="assets/images/map.png"/>-->
                                ...
                                <ul class="onsite_list">
                                    ...
                                    @endphp
                                    <li><span><img
                                                src="{{ base_url() }}assets/images/flags/{{ strtolower($countryCount->countryCode) }}.png"
                                                width="16"> {{ $countryCount->country }}</span><strong
                                            class="txt_dark">{{ $countryCount->countryTotal }}</strong></li>
                                    @php
                                        $flag++;
                                    }
                                }
                        ...
                        <div style="margin: 0;" class="panel panel-flat">
                            ...
                            <div class="panel-heading">
                                ...
                                <div class="heading_links pull-left">
                                    ...
                                    <button type="button" class="btn btn-xs plus_icon ml20"><i class="icon-plus3"></i>
                                    </button>
                                </div>
