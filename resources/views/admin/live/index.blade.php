...
@section('contents')
	...
	<style>
		...
		.mapael .map{margin-top:0px; height: 230px!important}
...
<div class="content">
	...
	<div class="page_header">
		<div class="row">
			<!--=============Headings & Tabs menu==============-->
			<div class="col-md-5">
				<h3><img style="width: 16px;" src="<?php echo base_url(); ?>assets/images/live_icon2.png"> Live</h3>
						...
						<div class="panel-heading">
							...
							<div class="heading-elements">
								<div style="display: inline-block; margin: 0;" class="form-group has-feedback has-feedback-left">
									<input class="form-control input-sm cus_search"  tableID="liveVisitors" placeholder="Search by name" type="text">
							...
							<table class="table" id="liveVisitors">
								...
								<tbody>
									...
									<tr>
										...
										<td><strong class="text-default text-semibold"><?php $timeVal = timeAgo($data->created); $timeArray = explode(' ', $timeVal); echo (($timeArray[0] <= 30 && ($timeArray[1] == 'minutes' || $timeArray[1] == 'minute')) || ($timeArray[0] <= 60 && ($timeArray[1] == 'seconds' || $timeArray[1] == 'second'))) ? 'Online' : $timeVal; ?></strong></td>
										...
										<td>
											<div class="media-left"><?php echo ($data->user_id > 0 && $userData->id > 0 && $userData->id != $data->user_id) ? '<a href="javascript:void(0);" class="sidebar-user-box text-semibold txt_red bbotr" user_id="'.$data->user_id.'" style="padding:0px;">chat</a>' : '&nbsp; &nbsp; &nbsp; &nbsp;'; ?></div>
											<div class="media-left">
												<div class="tdropdown ml10"> <a class="table_more dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url(); ?>assets/images/more.svg"></a>
													<ul class="dropdown-menu dropdown-menu-right more_act">
														...
														<li><a href="<?php echo base_url(); ?>admin/live/details/<?php echo $data->id; ?>"><i class="icon-eye"></i> Details</a> </li>
													</ul>
												</div>
											</div>
										</td>
