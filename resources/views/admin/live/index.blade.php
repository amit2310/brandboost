    ...
    <div class="content">
        ...
        <div class="page_header">
            <div class="row">
                <!--=============Headings & Tabs menu==============-->
                <div class="col-md-5">
                    <h3><img style="width: 16px;" src="{{ base_url() }}assets/images/live_icon2.png"> Live</h3>
                                    ...
                                    <div class="col-md-5 pr40 pl20 brig">
                                        <ul class="onsite_list">
                                            <li class="bnone"><span class="txt_dark"><img width="12"
                                                                                          src="{{ base_url() }}assets/images/all_icon.png"> All</span><strong>162</strong>
                                            </li>
                                            <li><span><img width="12" src="{{ base_url() }}assets/images/google_12.png"> Google</span><strong>139</strong>
                                            </li>
                                            <li><span><img width="12"
                                                           src="{{ base_url() }}assets/images/facebook_12.png"> Facebook</span><strong>23</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="panel-body p20 db_stats bkg_white">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="media-left pr-15">
                                                    <img class="pull-left"
                                                         src="{{ base_url() }}assets/images/clock_44_red.png">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12"><img style="width: 100%; height: 68px;"
                                                                        ...
                                                                        src="{{ base_url() }}assets/images/graph_live1.png">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body p20 db_stats bkg_white">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="media-left pr-15">
                                                    <img class="pull-left"
                                                         src="{{ base_url() }}assets/images/message_red_44.png">
                                                </div>
                                                <div class="media-left">
                                                    <h1>23m</h1>
                                                    <p><strong class="txt_orange"><i class=""><img
                                                                    src="{{ base_url() }}assets/images/red_down_arrow.png"></i>&nbsp;
                                                            33,87%</strong> &nbsp; <span
                                                            class="txt_dgrey">last week</span></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12"><img style="width: 100%; height: 66px;"
                                                                        class="img-responsive mt30"
                                                                        src="{{ base_url() }}assets/images/graph_live2.png">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 ">
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body p20 bkg_white min_h310"
                                ...
                                <div
                                    class="p20 text-center"><!--<img style="height: 250px; margin: 0 auto;" class="img-responsive" src="{{ base_url() }}assets/images/map.png"/>-->
                                ...
                                <div class="pl10 pr20">
                                    <ul class="onsite_list">
                                        <li><span><img src="{{ base_url() }}assets/images/flags/us.png" width="16"> United States</span><strong
                                                class="txt_dark">117</strong></li>
                                        <li><span><img src="{{ base_url() }}assets/images/flags/ca.png" width="16"> Canada</span><strong
                                                class="txt_dark">32</strong></li>
                                        <li><span><img src="{{ base_url() }}assets/images/flags/gb.png" width="16"> Great Britain</span><strong
                            ...
                            <div class="panel-body p0">
                                <table class="table" id="liveVisitors">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class=""><img src="{{ base_url() }}assets/images/icon_action.png"></i>
                                            Action
                                        </th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong class="text-default text-semibold">
                                                @php
                                                    $timeVal = timeAgo($data->created);
                                                    $timeArray = explode(' ', $timeVal);
                                                    echo (($timeArray[0] <= 30 && ($timeArray[1] == 'minutes' || $timeArray[1] == 'minute')) || ($timeArray[0] <= 60 && ($timeArray[1] == 'seconds' || $timeArray[1] == 'second'))) ? 'Online' : $timeVal
                                                @endphp
                                            </strong>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div
                                                class="media-left">{{ ($data->user_id > 0 && $userData->id > 0 && $userData->id != $data->user_id) ? '<a href="javascript:void(0);" class="sidebar-user-box text-semibold txt_red bbotr" user_id="'.$data->user_id.'" style="padding:0px;">chat</a>' : '&nbsp; &nbsp; &nbsp; &nbsp;' }}</div>
                                            <div class="media-left">
                                                <div class="tdropdown ml10"><a class="table_more dropdown-toggle"
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right more_act">
                                                        ...
                                                        <li>
                                                            <a href="{{ base_url() }}admin/live/details/{{ $data->id }}"><i
