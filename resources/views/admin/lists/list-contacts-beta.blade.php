...
<div class="content">
    ...
    <div class="page_header">
        <div class="row">
            <!--=============Headings & Tabs menu==============-->
            <div class="col-md-3">
                <h3><i class="icon-vcard"></i> &nbsp;List Contacts @php if(!empty($listName)){ echo ' : '.$listName;} @endphp</h3>
            ...
            <div class="col-md-9 text-right btn_area">
                ...
                <button type="button" class="btn light_btn importModuleContact" data-modulename="{{ $moduleName }}" data-moduleaccountid="{{ $moduleUnitID }}" data-redirect="{{ base_url() }}admin/contacts/mycontacts"><i class="icon-arrow-up16"></i><span> &nbsp;  Import Contact</span> </button>
