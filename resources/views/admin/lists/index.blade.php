                        ...
                        <div style="margin: 0;" class="panel panel-flat">
                            ...
                            <div class="panel-body p0">
                                <table class="table" id="automationList">
                                    ...
                                    <!--================================================-->
                                    <tr id="append-{{ $oList->id }}" class="selectedClass">
                                        ...
                                        <td width="22%">
                                            <div class="media-left media-middle"><a class="icons square"
                                                                                    href="{{ $editListPath . $oList->id }} "><i
                                                        class="icon-indent-decrease2 txt_blue"></i></a></div>
                                            <div class="media-left">
                                                <div><a href="{{ $editListPath . $oList->id }} "
                                                        list_id="{{ $oList->id }}"
                                                        class="text-default text-semibold">{{ setStringLimit($oList->list_name, 20)}} </a>
                                                </div>
                                                <div
                                                    class="text-muted text-size-small">{{ setStringLimit($oList->description, 25)}} </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="media-left">
                                                <div class="pt-5"><a href="#"
                                                                     class="text-default text-semibold"> {{ dataFormat($oList->list_created) }}</a>
                                                </div>
                                                <div
                                                    class="text-muted text-size-small">{{ date('h:i A', strtotime($oList->list_created))}} </div>
                                            </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="media-left">
                                                    <div class="pt-5"><a href="#" list_id="{{ $oList->id }}"
                                                            ...
                                                            <img class="flags"
                                                                 src="{{ base_url()}}assets/images/flags/ao.png"></a>
                                                    </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="media-left">
                                                <div data-toggle="tooltip"
                                                     title="{{ $totSMSCount }} have numbers out of {{ $totalContacts }} contacts"
                                                     data-placement="top">
                                                    <a href="javascript:void(0);"
                                            ...
                                            <div class="media-left pull-right">
                                                <div class="tdropdown ml10"><a class="table_more dropdown-toggle"
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right more_act width-200">
                                                        ...
                                                        @if ($oList->status == 'active')
                                                            <li><a href="javascript:void(0);" status="inactive"
                                                                   list_id="{{ $oList->id }} " class="changeStatus"><i
                                                                        class="icon-file-stats"></i> Inactive</a></li>
                                                        @endif
                                                        @if ($oList->status == 'inactive' && $oList->status != 'archive')
                                                            <li><a href="javascript:void(0);" status="active"
                                                                   list_id="{{  $oList->id }}" class="changeStatus"><i
                                                                        class="icon-file-stats"></i> Active</a></li>
                                                        @endif
                                                        @if ($oList->status != 'archive')
                                                            <li><a href="javascript:void(0);" status="archive"
                                                                   list_id="{{ $oList->id }}" class="changeStatus"><i
                                                    ...
                                                    <div class="col-md-12">
                                                        <div style="margin: 20px 0px 0;" class="text-center">
                                                            <h5 class="mb-20 mt40">
                                                                ...
                                                                <img src="{{ base_url('assets/images/smiley.png')}} ">
                                                                <br>
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    class="btn dark_btn ml20 pDisplayNoActiveSubscription mb40"
                                                                    @else
                                                                    id="addListN"
                                                                    @endif
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                $('.overlaynew').show();
                                $.ajax({
                                    url: "{{ base_url('admin/lists/deleteMultipalLists') }}",
                                    type: "POST",
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                $('.overlaynew').show();
                                $.ajax({
                                    url: "{{ base_url('admin/lists/archiveMultipalLists') }}",
                                    type: "POST",
                                    data: {_token: '{{csrf_token()}}', multi_list_id: val},
                                    dataType: "json",
                                    success: function (data) {
            ...
            $(document).on('click', '.viewContact', function () {
                ...
                window.location.href = '{{ base_url("admin/lists/").$scriptFile }}?list_id=' + list_id;
            });
            ...
            $(document).on("click", ".editlist", function () {
                ...
                $.ajax({
                    url: "{{ base_url('admin/lists/getList') }}",
                    type: "POST",
            ...
            $(document).on("click", ".changeStatus", function () {
                ...
                $(".overlaynew").show();
                $.ajax({
                    url: "{{ base_url('admin/lists/changeListStatus') }}",
                    type: "POST",
            ...
            $('#frmeditlistModel').on('submit', function () {
                ...
                $.ajax({
                    url: "{{ base_url('admin/lists/updateList') }}",
                    type: "POST",
                    data: formdata,
                    dataType: "json",
                    success: function (data) {
            ...
            $(document).on('click', '.deletelist', function () {
                ...
                deleteConfirmationPopup(
                    ...
                    function () {
                        ...
                        $.ajax({
                            url: "{{ base_url('admin/lists/deleteLists') }}",
                            type: "POST",
                            data: {_token: '{{ csrf_token() }}', list_id: listID},
                            dataType: "json",
                            success: function (data) {
