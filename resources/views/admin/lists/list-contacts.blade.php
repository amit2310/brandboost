    ...
    <div class="page_header">
        <div class="row">
            ...
            <div class="col-md-9 text-right btn_area">
                ...
                <button type="button" class="btn dark_btn ml20 addModuleContact" data-toggle="modal"
                        data-modulename="list" data-moduleaccountid="{{ $list_id }}"><i class="icon-plus3"></i><span> &nbsp;  Add Contact</span>
                </button>

                <button data-toggle="modal" data-target="#importCSV" type="button"
                        class="btn dark_btn ml20 importModuleContact" data-modulename="list"
                        data-moduleaccountid="{{ $list_id }}"
                        data-redirect="admin/lists/getListContacts?list_id={{ $list_id }}"><i
                        class="icon-make-group position-left"></i> Import Contact
                </button>

                <form method="get" action="{{ base_url() }}admin/subscriber/exportSubscriberCSV"
                      enctype="multipart/form-data" style="float:right;">
                    <input type="hidden" name="module_name" id="module_name" value="list">
                    <input type="hidden" name="module_account_id" value="{{ $list_id }}">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h6 class="panel-title">{{ $oSubscriber[0]->list_name . ' : ' . $iActiveCount }}
                                Subscribers</h6>
                            <div class="heading-elements">
                                ...
                                <button id="deleteButtonListsContacts" class="btn btn-xs custom_action_box"><i
                                        class="icon-trash position-left"></i> Delete
                                </button>
                                <button id="archiveButtonListsContacts" class="btn btn-xs custom_action_box"><i
                            ...
                            <table class="table datatable-basic datatable-sorting" id="allContact">
                                ...
                                <tr id="append-{{ $oContact->id }}" class="selectedClass">
                                    ...
                                    <td>
                                        ...
                                        <div class="media-left">
                                            <div class="pt-5"><a href="javascript:void(0);"
                                                                 class="text-default text-semibold">Email</a></div>
                                    ...
                                    <td>
                                        <div class="tdropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right width-200">
                                                ...
                                                <li><a href="javascript:void(0);"><i class="icon-screen-full"></i>
                                                        Another action</a>
                                                </li>
                                                <li><a href="javascript:void(0);"><i class="icon-mail5"></i> One more
                                                        action</a>
                                                </li>
                                                <li class="divider"></li>
                                                <li><a href="javascript:void(0);"><i class="icon-gear"></i> Separated
                                                        line</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <td class="text-center">
                                        <div class="tdropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right width-200">
                                                <li><a class="moveToArchiveListContact" href="javascript:void(0);"
                                                ...
                                                <li><a href="javascript:void(0);" class="editModuleSubscriber"
                                                       ...
                                                       data-modulename="list" data-moduleaccountid="{{ $list_id }}"
                                                       data-redirect="admin/lists/getListContacts?list_id={{ $list_id }}"><i
        ...
        <div class="tab-pane" id="right-icon-tab1">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h6 class="panel-title">{{ $oSubscriber[0]->list_name . ' : ' . $iArchiveCount }}
                                Subscribers</h6>
                            <div class="heading-elements">
                                <div style="display: inline-block; margin: 0;"
                                     class="form-group has-feedback has-feedback-left">
                                ...
                                <button id="deleteContactsBtn" class="btn btn-danger btn-xs lgrey custom_action_box">
                                    Delete
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="panel-body p0">
                            <table class="table datatable-basic datatable-sorting" id="allContact">
                                ...
                                <tr id="append-{{ $oContact->id }}" class="selectedClass">
                                    <td style="display: none;">{{ date('m/d/Y', strtotime($oContact->created)) }}</td>
                                    <td style="display: none;">{{ $oContact->id }}</td>
                                    <td style="display: none;"><label class="custmo_checkbox pull-left"><input
                                                type="checkbox" name="checkRows[]" class="checkRows"
                                                value="{{ $oContact->id }}"><span
                                                class="custmo_checkmark"></span></label></td>
                                    <td>
                                        <div class="media-left media-middle"><a href="javascript:void(0);"><img
...
<script type="text/javascript">
    $(document).ready(function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('.overlaynew').show();
                            $.ajax({
                                url: "{{ base_url('admin/lists/deleteMultipalListContact') }}",
                                type: "POST",
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('.overlaynew').show();
                            $.ajax({
                                url: "{{ base_url('admin/lists/archiveMultipalListContact') }}",
                                type: "POST",
                                data: {multipalSubscriberId: val},
                                dataType: "json",
                                success: function (data) {
        ...
        $(document).on("click", ".moveToArchiveListContact", function () {
            ...
            $.ajax({
                url: "{{ base_url('admin/lists/moveToArchiveListContact') }}",
                type: "POST",
        ...
        $(document).on('click', '.chg_status', function () {
            ...
            $.ajax({
                url: "{{ base_url('admin/lists/updateContactStatus') }}",
                type: "POST",
        ...
        $(document).on('click', '.deleteSubscriber', function () {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        url: "{{ base_url('admin/lists/deleteListContact') }}",
                        type: "POST",
                        data: {subscriberId: subscriberId},
                        dataType: "json",
                        success: function (data) {
