...
<div class="content">
    ...
    <div class="page_header pt20">
        <div class="row">
            <!--=============Headings & Tabs menu==============-->
            <div class="col-md-12">
                <h3><img style="width: 18px;" src="{{ base_url() }}assets/images/user_settings_icon.png"> Account Settings</h3>
            </div>
        </div>
    </div>
    <!--&&&&&&&&&&&& PAGE HEADER END&&&&&&&&&&-->
...
$(document).ready(function () {
    ...
    $("#frmSubmit").submit(function (e) {
        ...
        $.ajax({
            url: "{{ base_url('admin/account_setting/saveProfileDetail') }}",
            type: "POST",
            data: formdata,
            contentType: false,
            cache: false,
    ...
    $(document).on('click', '.delete_account', function () {
        ...
        deleteConfirmationPopup(
                ...
                function () {
                    ...
                    $.ajax({
                        url: "{{ base_url('admin/account_setting/account_deleted') }} ",
                        type: "POST",
