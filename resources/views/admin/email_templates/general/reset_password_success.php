                            ...
                            <table style="margin-top:-60px;">
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <center><a href="{{ base_url('admin/login') }}" title="RE-SUBSCRIBE NOW"
                                                   style="margin: 20px 0 0; text-decoration: none; font-family: 'Open Sans', sans-serif; background-color: #6d41f2; display: inline-block; padding:16px 30px; border-radius: 4px; font-size: 14px; color: #FFFFFF; text-align: center;">Login</a>
                                        </center>
                                    </th>
                                </tr>
                                </tbody>
