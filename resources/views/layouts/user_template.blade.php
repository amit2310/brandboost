...
<?php 
  ...
  else if (\Request::segment(1) == 'user' && \Request::segment(2) == 'review'&& \Request::segment(3) == '') {
      $reviewActive = 'active';
      $headerStyle = "style='height:257px'";
  }
   else if (\Request::segment(1) == 'user' && \Request::segment(2) == 'review' && \Request::segment(3) == 'edit') {
      $reviewActive = 'active';
      $headerStyle = "style='height:209px'";
  }
  else if (\Request::segment(1) == 'user' && \Request::segment(2) == 'setting') {
      $settingActive = 'active';
      $headerStyle = "style='height:209px'";
  }
  else if (\Request::segment(1) == 'user' && \Request::segment(2) == 'media') {
      $mediaActive = 'active';
      $headerStyle = "style='height:257px'";
  }
  else if (\Request::segment(1) == 'user' && \Request::segment(2) == 'nps') {
      $npsActive = 'active';
      $headerStyle = "style='height:257px'";
  }
  else if (\Request::segment(1) == 'user' && \Request::segment(2) == 'referral') {
