<template>
    <div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 wfSmsPreviewTemplate" v-for="template in templates"
                        ...
                        <div class="col-md-12 text-center wfSmsPreviewTemplate" v-if="!templates.length && loading == false">
                            <div class="col-md-12">
        ...
        <!--Preview Popup-->
        <div class="box wfSmsPreviewTemplatePopup" style="width: 80%; display: none;">
            <div style="width: 80%;overflow: hidden;height: 100%;">
                <div style="height: 100%; overflow: hidden auto;"><a class="cross_icon wfSmsPreviewTemplate"><i><img
                    ...
                    <div class="p40">
                        ...
                        <div class="row bottom-position">
                            ...
                            <div class="col-md-12"><input type="hidden" name="module_name" id="active_module_name"
                                ...
                                <button type="submit"
                                        class="btn btn-lg bkg_blue_300 light_000 pr20 min_w_160 fsize16 fw600 wfSmsPreviewTemplate"
                                ...
                                <a href="javascript:void(0);" class="blue_300 fsize16 fw600 ml20 wfSmsPreviewTemplate">Close</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        $(document).on('click', '.wfSmsPreviewTemplate', function () {
            $(".wfSmsPreviewTemplatePopup").animate({
                width: "toggle"
            });
        });
...
<style scoped>
    ...
    .sms_preview{width: 276px; height: 553px; background: url(/assets/images/iphone.png) center top no-repeat; margin: 50px auto; padding: 100px 30px}
    .sms_preview .inner {	background: #e5e5ea;	padding: 10px;	font-size: 11px;	border-radius: 15px;	margin-bottom: 10px;	float: left; max-width: 100%;	width: 100%;	max-height: 300px;
        overflow-y: auto;	word-wrap: break-word;}
    .sms_preview .inner.reply {	background: #0a86f9;	padding:3px 10px;	font-size: 11px;	border-radius: 15px;	margin-bottom: 10px;	color: #fff;	float: right; max-width: 90%;}
    .sms_preview .date{width: 100%; float: left; text-align: center; color: #ccc; font-size: 9px; margin: 10px 0;}
