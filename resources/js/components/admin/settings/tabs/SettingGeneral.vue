                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="table_filter">
                                <li><a class="active" href="#/settings/general" tyle="cursor:pointer; padding: 5px;">GENERAL</a></li>&nbsp;&nbsp;
                ...
                <div class="row">
                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6 col-md-offset-1">
                                            <div class="form-group mb0">
                                                <div class="input-group">
                                                    ...
                                                    <div class="dropzone" id="myDropzone1" style="min-height: 0px; width: 300px!important;"></div>
                                                    <div style="display: none;" id="uploadedSiteFiles"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" :value="oUser.id" id="settingsUserId" />
                        ...
                        <div class="panel panel-flat review_ratings pt25">
                            <div class="panel-heading" style="padding: 10px;">
                                <h4  class="panel-title">Delete brand account</h4>
                            </div>
        ...
        methods: {
            ...
            saveGeneralInfo: function () {
                ...
                axios.post('/admin/settings/saveGeneralInfo',{
                    ...
                    company_logo:this.oUser.company_logo,
    ...
    function loadJQCode(){
        $(document).ready(function () {
            ...
            var myDropzone = new Dropzone(
                '#myDropzone1', //id of drop zone element 1
                {
