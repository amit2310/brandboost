                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            ...
                            <li  class="active"><a href="#/settings/import" style="cursor:pointer; padding: 5px;">Import&nbsp;</a></li>&nbsp;&nbsp;
                    ...
                    <div class="panel-body p0">
                        ...
                        <div class="bbot p30">
                            ...
                            <div class="row">
                                    ...
                                    <div class="import_box">
                                        <div class="img_icon mb20">
                                            <a href="javascript:void(0);">
                                                <img class="importModuleContact"
                                                    data-modulename="people" :data-moduleaccountid="oUser.id"
                                                    data-redirect="admin#/settings/import" src="assets/images/contact_icon.png" width="27">
                                            </a>
                                        </div>
                                ...
                                <div class="col-md-3 text-center">
                                    <div class="import_box">
                                        <div class="img_icon mb20"><img src="assets/images/icon_star.png" width="27"></div>
                                        <p class="mb0">Import Reviews</p>
                                    </div>
                                </div>
                                <div class="col-md-3 text-center">
                                    <div class="import_box">
                                        <div class="img_icon mb20"><img src="assets/images/icon_tab.png" width="27"></div>
                                        <p class="mb0">Import Tags</p>
                                    </div>
                                </div>
                                <div class="col-md-3 text-center">
                                    <div class="import_box">
                                        <div class="img_icon mb20"><img src="assets/images/icon_media.png" width="27"></div>
                        ...
                        <div class="bbot p30">
                            <div class="row">
                                <table class="table datatable-basic-new">
                                    <tbody>
                                    <tr v-for="oHistory in oImportHistory">
                                        <td>
                                            ...
                                            <div class="media-left">
                                                <div class="pt-3">
                                                    <a href="#" class="text-default text-semibold">Import {{ oHistory.import_name }}</a>
                                                </div>
                                            </div>
                                        </td>
