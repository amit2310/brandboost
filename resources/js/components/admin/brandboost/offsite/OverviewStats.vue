<template>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title">Off Site Boost Report<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title">Positive Reviews<a class="heading-elements-toggle"><i class="icon-more"></i></a><a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                    <div class="heading-elements"><a href="#"><i class="icon-more2"></i></a></div>
                </div>
            ...
            <div class="panel panel-flat review_ratings">
                ...
                <div class="panel-body p0">
                    <div class="pt30 pb30 pl40 pr40 bbot">
                        <h1><i style="color: #7f62df !important;" class="icon-star-full2 txt_purple"></i> 0.0 <sup><i class="icon-arrow-up5"></i> &nbsp; +15%</sup></h1>
                    </div>
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title">Widgets<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                    <div class="heading-elements"><a href="#"><i class="icon-more2"></i></a></div>
                </div>
                <div class="panel-body p0">
                    <div class="row">
