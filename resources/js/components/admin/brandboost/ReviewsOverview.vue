...
<!--                                        <div style="margin-top: -30px" id="widgetreview2">-->
                                        <div style="margin-top: -30px">
                                            <apexchart type=area height=130 :options="chartOptionsWR2" :series="seriesWR2" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                                        <div style="margin-top: -30px" id="widgetreview">-->
                                            <apexchart type=area height=130 :options="chartOptionsWR" :series="seriesWR" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        components: {UserAvatar, Pagination, LatestReviews, LatestCampaigns, apexchart: VueApexCharts,},
        data(){
            return {
                moduleName: '',
                moduleUnitID: '',
