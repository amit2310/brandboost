    ...
    <div class="content">
        ...
        <div class="page_header">
            <div class="row">
                <!--=============Headings & Tabs menu==============-->
                <div class="col-md-7">
                    <h3><img src="/assets/images/media.png"/>On site Media</h3>
                ...
                <div class="col-md-5 text-right btn_area">
                    <div class="btn-group">
                        <button type="button" class="btn light_btn btn-icon dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-calendar2"></i>&nbsp; &nbsp; Filter Media &nbsp; &nbsp; <span
                            class="caret"></span>
                        </button>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6">
                                                        ...
                                                        class="form-control input-sm" type="text" name="" value="10"/>
                                                    </div>
                    ...
                    <button type="button" class="btn dark_btn dropdown-toggle ml10" data-toggle="modal"
                            data-target="#addContact"><i class="icon-plus3"></i><span> &nbsp;  Add Media</span></button>
                </div>
            </div>
        </div>
        <!--&&&&&&&&&&&& PAGE HEADER END&&&&&&&&&&-->
                            ...
                            <span class="pull-left">
                                ...
                                <div class="heading-elements">
                                    <div style="display: inline-block; margin: 0;"
                                        ...
                                        <input class="form-control input-sm cus_search" tableid="brandboostOnsiteMedia"
                                    ...
                                    <div class="table_action_tool">
                                        ...
                                        <a href="javascript:void(0);" style="display: none;" id="deleteContactsBtn"
                            ...
                            <div class="panel-body p0">
                                ...
                                <table class="table" id="brandboostOnsiteMedia">
                                    ...
                                    <template v-for="(review, index) in reviews">
                                        <tr v-for="oFile in review.fileCollection" :id="`append-${review.id+index}`"
                                            class="selectedClass">
                                            <td style="display: none;">{{ review.created }}</td>
                                            ...
                                            <td>
                                                <div v-if="oFile.media_type == 'image'" class="small_media_icon"
                                                     style="position: relative; width: 60px;">
                                                    <img class="media br5"
                                                         :src="`https://s3-us-west-2.amazonaws.com/brandboost.io/${oFile.media_url}`"
                                                         alt="">
                                                    <div class="caption-overflow smallovfl">
                                                        <a :href="`https://s3-us-west-2.amazonaws.com/brandboost.io/${oFile.media_url}`"
                                                           data-popup="lightbox"><i class="icon-eye"></i></a>
                                                    </div>
                                                </div>

                                                <div v-else class="small_media_icon"
                                                     style="position: relative; width: 60px;">
                                                    <video class="media br5" width="100%">
                                                        <source :src="oFile.filePath"
                                                                :type="`video/${oFile.fileExt}`">
                                                    </video>

                                                    <div class="caption-overflow smallovfl">
                                                        <a class="videoReview" style="cursor: pointer;"
                                                           :filepath="`https://s3-us-west-2.amazonaws.com/brandboost.io/${oFile.media_url}`"
                                                           :fileext="oFile.fileExt"><i class="icon-eye"></i></a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="media-left media-middle">
                                                    <a class="icons" :href="`/admin/brandboost/onsite_setup/${review.campaign_id}?type=media`">
                                                        <img :src="oFile.smily" class="img-circle img-xs" alt="">
                                                    </a>
                                                </div>
                                                <div class="media-left">
                                                    <div class="pt-5"><a
                                                        :href="`/admin/brandboost/onsite_setup/${review.campaign_id}?type=media`"
                                                        class="text-default text-semibold editBrandboost"><span>{{ review.brand_title }}</span></a>
                                                    </div>
                                                    <div class="text-muted text-size-small"><a
                                                        :href="`/admin/brandboost/onsite_setup/${review.campaign_id}?type=media`"
                                                        style="color:#7a8dae!important">{{
                                                        setStringLimit(review.brand_desc) }}</a></div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="media-left">
                                                    <div class="pt-5"><a style="cursor: text;"
                                                                         class="text-default text-semibold bbot">{{
                                                        review.firstname }} {{ review.lastname }}</a>
                                                        <img class="flags"
                                                             :src="`/assets/images/flags/${review.country}.png`"
                                                             onerror="this.src='/assets/images/flags/us.png'"/></div>
                                            ...
                                            <td>
                                                <div class="media-left">
                                                    <div class="pt-5"><a href="#" class="text-default text-semibold">{{ review.created }}</a>
                                                    </div>
                                                    <div class="text-muted text-size-small">{{ review.created }}</div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="media-left media-middle"><a class="icons"
                                                                                        href="javascript:void(0);"><img
                                                    :src="oFile.fileExt" class="img-xs file" alt=""></a></div>
                                                <div class="media-left">
                                                    <div class="pt-5"><a href="javascript:void(0);"
                                                                         class="text-default text-semibold">{{oFile.allowfilesize}}</a>
                                                    </div>
                                                    <div class="text-muted text-size-small">{{oFile.fileExt.toUpperCase() }} </div>
                                                </div>
                                            </td>

                                            <td class="text-center">
                                                <div class="tdropdown">
                                                    <a class="table_more dropdown-toggle" data-toggle="dropdown"
                                                       aria-expanded="false"><img src="/assets/images/more.svg"></a>
                                                    <ul class="dropdown-menu dropdown-menu-right more_act">
                                                        <li><a :href="oFile.filePath" data-popup="lightbox"><i
                                                            class="icon-eye txt_purple"></i> View</a></li>
                                                        <li><a :href="oFile.filePath"><i
                                                            class="icon-download4 txt_red"></i> Download</a></li>
                                                        <!-- <li><a href="javascript:void(0);"><i class="icon-redo2 txt_blue"></i> Share</a></li> -->
                                                        <li><a href="javascript:void(0);" class="deleteSingleVideo"
                                                               :reviewId="review.id"
                                                               :mediaName="oFile.media_url"><i
                                                            class="icon-bin txt_grey"></i> Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                ...
                deleteConfirmationPopup(
                    ...
                    function () {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: {reviewid: val, mediaName: mediaName, _token: tkn},
                            dataType: "json",
