            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h3 class="htxt_medium_24 dark_700">Question Details</h3>
                    </div>
        ...
        <div class="content-area">
                        ...
                        <div class="card card_shadow min-h-280">
                            ...
                            <div class="row mb65">
                                <div class="col-md-6 text-right">
                                    <a class="lh_32 htxt_regular_14 dark_200" href="#">
                                        ...
                                        Learn how to view questions details
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row mb65">
                                <div class="col-md-12 text-center">
                                    ...
                                    <h3 class="htxt_bold_18 dark_700 mt30">No question details so far. But you can change it!</h3>
                                    <h3 class="htxt_regular_14 dark_200 mt20 mb25">It’s very easy to add details and answer of a question!</h3>
                                    <button class="btn btn-sm bkg_reviews_000 pr20 reviews_400 slidebox">Answer question</button>
                                </div>
                            </div>
            ...
            <div class="container-fluid" v-else>
                ...
                <div class="table_head_action mt-2">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="htxt_medium_16 dark_400">Question Details</h3>
                        </div>
                        <div class="col-md-6">
