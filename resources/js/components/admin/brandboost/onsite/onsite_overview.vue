<template>
    ...
    <div class="content" id="masterContainer">
                                ...
                                <table class="table datatable-basic">
                                    ...
                                    <tr v-for="oBrandboost in oBrandboosts" :id="`append-${oBrandboost.id}`" class="selectedClass">
                                        ...
                                        <td style="display: none;" class="editAction"><label class="custmo_checkbox pull-left">
                                            ...
                                            <span class="custmo_checkmark"></span></label>
                                        </td>


                                        <td>
                                            <div class="media-left media-middle">
                                                <a :href="`/admin/brandboost/onsite_setup/${oBrandboost.id}`"
                                                   :brandID="`${oBrandboost.id}`"
                                                   :b_title="`${oBrandboost.brand_title}`" class="text-default text-semibold">
                                                        <img src="assets/images/default_table_img2.png" class="img-circle img-xs br5" alt="">
                                                </a>
                                            </div>
                                            <div class="media-left">
                                                <div class="">
                                                    <a :href="`/admin/brandboost/onsite_setup/${oBrandboost.id}`"
                                                                 ...
                                                                 class="text-default text-semibold">{{ oBrandboost.brand_title }}
                                                    </a>
                                                </div>
                                                <div class="text-muted text-size-small">{{ oBrandboost.brand_desc.substring(0,35)+"..." }}</div>
                                            </div>
                                        </td>

                                        <td>
                                            <div v-if="oBrandboost.revRA >= 4" class="media-left media-middle">
                                                <a :href="`/admin/brandboost/reviews/${oBrandboost.id}`" target="_blank"><img src="/assets/images/smiley_green.png" class="img-circle img-xs" alt=""></a>
                                                <div class="media-left">
                                                    <div class=""><a :href="`/admin/brandboost/reviews/${oBrandboost.id}`" target="_blank" class="text-default text-semibold">{{ oBrandboost.revRA }}</a> </div>
                                                    <div class="text-muted text-size-small">Positive</div>
                                                </div>
                                            </div>

                                            <div v-else-if="oBrandboost.revRA > 2 && oBrandboost.revRA < 4" class="media-left media-middle">
                                                <a :href="`/admin/brandboost/reviews/${oBrandboost.id}`" target="_blank"><img src="/assets/images/smiley_grey2.png" class="img-circle img-xs" alt=""></a>
                                                <div class="media-left">
                                                    <div class=""><a :href="`/admin/brandboost/reviews/${oBrandboost.id}`" target="_blank" class="text-default text-semibold">{{ oBrandboost.revRA }}</a> </div>
                                                    <div class="text-muted text-size-small">Neutral</div>
                                                </div>
                                            </div>

                                            <div v-else-if="oBrandboost.revRA >= 1" class="media-left media-middle">
                                                <a :href="`/admin/brandboost/reviews/${oBrandboost.id}`" target="_blank"><img src="/assets/images/smiley_red.png" class="img-circle img-xs" alt=""></a>
                                                <div class="media-left">
                                                    <div class=""><a :href="`/admin/brandboost/reviews/${oBrandboost.id}`" target="_blank" class="text-default text-semibold">{{ oBrandboost.revRA }}</a> </div>
                                                    <div class="text-muted text-size-small">Negative</div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="media-left">
                                                <div class=""><a href="#" class="text-default text-semibold">{{ oBrandboost.created }}</a>
                                                </div>
                                                <div class="text-muted text-size-small">{{ oBrandboost.created }}</div>
                                            </div>
                                        </td>

                                        <td>

                                            <a v-if="oBrandboost.AllSubscribers" :href="`/admin/brandboost/stats/onsite/${oBrandboost.id}?t=contact`" target="_blank" class="text-default text-semibold">{{ oBrandboost.AllSubscribers.length }}</a>
                                            <div v-if="oBrandboost.AllSubscribers" data-toggle="tooltip" :title="`Total contacts ${oBrandboost.AllSubscribers.length}`" data-placement="top" class="progress">
                                            ...
                                            <a v-else :href="`/admin/brandboost/stats/onsite/${oBrandboost.id}?t=contact`" target="_blank" class="text-default text-semibold">{{ oBrandboost.AllSubscribers.length }}</a>
                                            <div v-else data-toggle="tooltip" title="Total contacts 0" data-placement="top" class="progress">
                                                <div style="color:#999999!important; width:100%;" class="progress-bar progress-bar-violet" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>

                                        </td>

                                        <td>
                                            <a style="cursor: pointer;" target="_blank" class="text-default text-semibold">{{ oBrandboost.reviewResponse.length }}</a>
                                            <div data-toggle="tooltip" :title="`Total Requests ${oBrandboost.reviewResponse.length}`" data-placement="top" class="progress">
                                                <div class="progress-bar progress-bar-violet" role="progressbar" aria-valuenow="100" aria-valuemin="100" aria-valuemax="100" :style="`width:((${oBrandboost.reviewResponse.length} * 100 / ${oBrandboost.reviewRequests.length}) > 100 ? 100 : (${oBrandboost.reviewResponse.length} * 100 / ${oBrandboost.reviewRequests.length}))%`"></div>
                                            </div>
                                        </td>
                                        <td>
                                            <a style='cursor:pointer;' class="text-default text-semibold">{{ oBrandboost.statsVal.positiveRating }}</a>
                                            <div data-toggle="tooltip" :title="`${oBrandboost.statsVal.positiveRating} out of ${oBrandboost.reviewResponse.length} Responses`" data-placement="top" class="progress">
                                                <div class="progress-bar progress-bar-green2" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" :style="`width:${oBrandboost.statsVal.positiveGraph}%`"></div>
                                            </div>
                                        </td>
                                        <td>
                                            <a style='cursor:pointer;' class="text-default text-semibold">{{ oBrandboost.statsVal.neturalRating }}</a>
                                            <div data-toggle="tooltip" :title="`${oBrandboost.statsVal.neturalRating } out of ${oBrandboost.reviewResponse.length} Response`" data-placement="top" class="progress">
                                                <div class="progress-bar progress-bar-black" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" :style="`width:${oBrandboost.statsVal.neturalGraph}%`"></div>
                                            </div>
                                        </td>
                                        <td>
                                            <a style='cursor:pointer;' class="text-default text-semibold">{{ oBrandboost.statsVal.negativeRating }}</a>
                                            <div data-toggle="tooltip" :title="`${oBrandboost.statsVal.negativeRating} out of ${oBrandboost.reviewResponse.length} Response`" data-placement="top" class="progress">
                                                <div class="progress-bar progress-bar-red" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" :style="`width:${oBrandboost.statsVal.negativeGraph}%`"></div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="media-left">
                                                <div class=""><a href="#" class="text-default text-semibold"> <i class="fa fa-smile-o"></i></a> </div>
                                        ...
                                        <td class="text-center">
                                            <label class="custom-form-switch">
                                                ...
                                                <input v-if="oBrandboost.status == 1" class="field changeStatus"  :brandID="`${oBrandboost.id}`" status="2" type="checkbox" checked="checked" >

                                                <input v-else class="field changeStatus"  :brandID="`${oBrandboost.id}`" status="1" type="checkbox" >

                                                <span class="toggle"></span>
                                            </label>

                                            <!-- @if ($currentUserId == $user_id || $user_role == 1) -->
                                            <div v-if="oBrandboost.user_role != 2">
                                            <div v-if="oBrandboost.user_role == 1" class="tdropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right width-200">
                                                    ...
                                                    <li v-if="oBrandboost.status == 1"><a href="javascript:void(0);" class="changeStatusCampaign" :brandID="`${oBrandboost.id}`" status="2"><i class="icon-file-stats"></i> Pause</a></li>

                                                    <li v-if="oBrandboost.status == 2"><a href="javascript:void(0);" class="changeStatusCampaign" :brandID="`${oBrandboost.id}`" status="1"><i class="icon-file-stats"></i> Start</a></li>

                                                    <li><a :href="`/admin/brandboost/onsite_setup/${oBrandboost.id}`" :brandID="`${oBrandboost.id}`" :b_title="`${oBrandboost.brand_title}`" class="text-default text-semibold"><i class="icon-pencil"></i>  Edit</a></li>

                                                    <li><a href="javascript:void(0);" class="deleteCampaign" :brandID="`${oBrandboost.id}`"><i class="icon-trash"></i> Delete</a></li>
                                                    <li><a href="javascript:void(0);" class="archiveCampaign" :brandID="`${oBrandboost.id}`"><i class="icon-file-text2"></i> Move to Archive</a></li>

                                                    <li><a href="javascript:void(0);" class="viewECode" :brandID="`${oBrandboost.id}`"><i class="icon-file-locked"></i> Get Embedded Code</a></li>
                                                    <li><a :href="`/admin/brandboost/stats/onsite/${oBrandboost.id}?t=contact`" target="_blank"><i class="icon-gear"></i> Contacts</a></li>
                                                    <li><a :href="`/for/${oBrandboost.company_name}/${oBrandboost.brand_title.replace(' ','-')}-${oBrandboost.id}`" target="_blank"><i class="icon-menu"></i>Campaign Page</a></li>
                                                </ul>
                                            </div>
        ...
        <div v-else class="row">
            <div class="col-md-12">
                <div style="margin: 200px 0px 0;" class="text-center">
                    ...
                    <h5 class="mb-20">
                        Looks Like You Don’t Have Any Brand Boosts Yet <img src="/assets/images/smiley.png"> <br>
        ...
        <div id="addBrandboostModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" name="frmAddOnsiteBrandboost" id="frmAddOnsiteBrandboost" action="javascript:void(0);">
                        <div class="modal-header">
        ...
        mounted() {
            ...
            axios.get('/admin/brandboost/onsite_overview')
                .then(response => {
                    ...
                    this.oOverviews = response.data;
                    this.oBrandboosts = response.data.aBrandbosts;
                    console.log(this.oBrandboosts);
                });
