                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="table_filter">
                                <li :class="[ seletedTab === 1 ? 'active' : '' ]"><a @click="seletedTab=1" data-toggle="tab" style="cursor:pointer; padding: 5px;">Overview&nbsp;</a></li>&nbsp;&nbsp;
                                <li :class="[ seletedTab === 2 ? 'active' : '' ]"><a @click="seletedTab=2" data-toggle="tab" style="cursor:pointer; padding: 5px;">Requests&nbsp;</a></li>&nbsp;&nbsp;
                                <li :class="[ seletedTab === 3 ? 'active' : '' ]"><a @click="seletedTab=3" data-toggle="tab" style="cursor:pointer; padding: 5px;">Reviews </a></li>&nbsp;&nbsp;
                                <li :class="[ seletedTab === 4 ? 'active' : '' ]"><a @click="seletedTab=4" data-toggle="tab" style="cursor:pointer; padding: 5px;">Contacts&nbsp;</a></li>&nbsp;&nbsp;
                                <li :class="[ seletedTab === 5 ? 'active' : '' ]"><a @click="seletedTab=5" data-toggle="tab" style="cursor:pointer; padding: 5px;">Stats&nbsp;</a></li>&nbsp;&nbsp;
                            </ul>
                        </div>
                        <div class="col-md-6">
