                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="email_config_list">
                                            ...
                                            <li><a  href="javascript:void(0);" @click="displayStep(2)"><span class="num_circle"><span class="num">2</span><span
        ...
        methods: {
            displayStep: function(step){
                ...
                if(!step){
                    ...
                    path = '/admin#/widgets/onsite/setup/'+this.$route.params.id+'/'+step;
                }
