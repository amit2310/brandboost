        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <span class="pull-left">
                    <h6 class="panel-title">{{ oTagFeedbacks.length }} Tag Feedbacks</h6>
                </span>
                        <div class="heading-elements">
                            ...
                            <button id="deleteButtonTagFeedback" class="btn btn-danger btn-xs lgrey custom_action_box">
                                Delete
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table v-if="oTagFeedbacks.length" class="table datatable-basic datatable-sorting">
                            <thead>
                            <tr>
                            ...
                            <tbody>
                            <tr v-for="oTagFeedback in oTagFeedbacks" :id="`append-${oTagFeedback.id}`" class="selectedClass">
                                <td style="display: none;">{{ oTagFeedback.tag_created }}</td>
                                <td style="display: none;">{{ oTagFeedback.id }}</td>
                                <td style="display: none;" class="editAction"><label
                                    class="custmo_checkbox pull-left"><input type="checkbox" name="checkRows[]"
                                                                             class="checkRows"
                                                                             :id="`chk${oTagFeedback.id}`"
                                                                             :value="oTagFeedback.id"><span
                                    class="custmo_checkmark"></span></label></td>
                                <td>
                                    <div class="media-left media-middle">
                                        <a class="icons square" href="#"><i
                                            class="icon-indent-decrease2 txt_blue"></i></a>
                                    </div>
                                    <div class="media-left">
                                        <div><a href="#"
                                                class="text-default text-semibold">{{ oTagFeedback.group_name }}</a></div>
                                    </div>
                                </td>
                                <td>
                                    <button class="btn btn-xs btn_white_table pr10"><i
                                        class="icon-primitive-dot txt_green"></i> {{ oTagFeedback.tag_name }}</button>
                                </td>

                                <td>
                                    <div class="media-left">
                                        <div class="pt-5"><a href="#"
                                                             class="text-default text-semibold">{{ oTagFeedback.tag_created }}</a>
                                        </div>
                                        <div
                                            class="text-muted text-size-small">{{ oTagFeedback.tag_created }}</div>
                                    </div>
                                </td>

                                <td>
                                    <a :href="`/admin/tags/feedback/${oTagFeedback.id}`" target="_blank"
                                       class="text-default text-semibold">{{ oTagFeedback.TagDataById }}</a>
                                    <div data-toggle="tooltip" title="" data-placement="top" class="progress"
                                         :data-original-title="`Total {{oTagFeedback.TagDataById}} Feedbacks`">
                                        <div class="progress-bar progress-bar-info" role="progressbar"
                                             :aria-valuenow="oTagFeedback.TagDataById" aria-valuemin="0"
                                             :aria-valuemax="oTagFeedback.TagDataById" style="width:100%">
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="javascript:void(0);" class="deleteTagGroupEntity"
                                                       :tagid="oTagFeedback.id"
                                                       :groupid="oTagFeedback.group_id"><i
                                                    class="icon-file-text2"></i> Delete</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div style="margin: 20px 0px 0;" class="text-center">
                                                <h5 class="mb-20">
                                                    Looks Like You Don’t Have Any Tag Feedbacks <img
...
<script>
    ...
    export default {
        ...
        mounted() {
            //getData
            axios.get('/admin/tags/tagsfeedback')
                .then(response => {
                    //console.log(response.data);

                    this.oTagFeedbacks = response.data;
                    console.log(this.oTagFeedbacks);
                });
