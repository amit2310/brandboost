            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-6">
                        ...
                        <h3 class="htxt_medium_24 dark_700">{{ capitalizeFirstLetter(oTagGroupDetails[0].group_name) }} :: Tags</h3>
                    </div>
                    <div class="col-md-6 col-6 text-right">
                        <button class="circle-icon-40 mr15 back_btn"><img class="back_img_icon" src="assets/images/filter.svg"/></button>
                        <button class="btn btn-md bkg_blue_200 light_000 js-tag-name-slidebox">New Tag<span><img src="assets/images/blue-plus.svg"/></span></button>
                    </div>
                </div>
            </div>
        ...
        <div class="content-area">
            <div class="container-fluid">
                            ...
                            <div class="card card_shadow min-h-280">
                                ...
                                <div class="row mb65">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <button class="btn btn-sm bkg_blue_000 pr20 blue_300 js-tag-name-slidebox">Add New Tag</button>
                                    </div>
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="card p30 h235 animate_top">
                            <div class="dot_dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="javascript:void(0);" @click="deleteTag(oTag.id)"><i class="dripicons-user text-muted mr-2"></i> Delete</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 text-center js-tag-name-slidebox" style="cursor: pointer;">
                        <div class="card p30 bkg_none border_dashed shadow_none h235 animate_top">
                            ...
                            <p class="htxt_regular_16 dark_100 mb15">Create<br>New Tag</p>
                        </div>
                    </div>
        ...
        <div class="box" style="width: 424px;">
            <div style="width: 424px;overflow: hidden; height: 100%;">
                <div style="height: 100%; overflow-y:auto; overflow-x: hidden;">
                    <a class="cross_icon js-tag-name-slidebox"><i class=""><img src="assets/images/cross.svg"/></i></a>
                    <form method="post" @submit.prevent="submitAddTag">
                        <div class="p40">
                        <div class="row">
                            <div class="col-md-12"> <img src="assets/images/tag.svg"/>
                                <h3 class="htxt_medium_24 dark_800 mt20">Create New Tag</h3>
                                <hr>
                            </div>
                            <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control h56" id="fname" placeholder="Enter tag name" name="txtTagName"
                                               v-model="form.txtTagName">
                                    </div>

                                    <div class="form-group">
                                        <label for="desc">Description</label>
                                        <textarea class="form-control min_h_185 p20 pt10" id="desc" placeholder="Tag Description"
                                                  name="description"
...
<script>
    ...
    $(document).ready(function(){
        $(document).on('click', '.js-tag-name-slidebox', function () {
            $(".box").animate({
                width: "toggle"
            });
        });
