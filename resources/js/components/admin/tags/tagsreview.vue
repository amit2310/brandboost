                ...
                <div class="col-md-7 text-right btn_area">
                    <div class="btn-group">
                        <button type="button" class="btn light_btn btn-icon dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-calendar2"></i>&nbsp; &nbsp; Filter Tag Reviews &nbsp; &nbsp; <span
                            class="caret"></span>
                        </button>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-heading">
                        <h6 class="panel-title"> {{ oTagReviews.length }} Tag Reviews</h6>
                        <div class="heading-elements">
                            ...
                            <button type="button" class="btn btn-xs btn-default editDataTagReview"><i
                                class="icon-pencil position-left"></i> Edit
                            </button>

                            <button id="deleteButtonTagReview" class="btn btn-xs custom_action_box"><i
                    ...
                    <div class="panel-body p0">
                        ...
                        <table v-if="oTagReviews.length" class="table datatable-basic datatable-sorting">
                            <thead>
                            <tr>
                                <th style="display: none;"></th>
                                <th style="display: none;"></th>
                                <th style="width: 10px!important; display: none;" class="nosort editAction"><label
                            ...
                            <tbody>
                            <tr v-for="oTagReview in oTagReviews" id="`append-${oTagReview.id}`" class="selectedClass">
                                <td style="display: none;">{{ oTagReview.tag_created }}</td>
                                <td style="display: none;">{{ oTagReview.id }}</td>
                                ...
                                <td>
                                    ...
                                    <div class="media-left">
                                        <div><a href="#"
                                                class="text-default text-semibold">{{ oTagReview.group_name }}</a></div>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="media-left">
                                        <div class="pt-5">
                                            <a href="#" class="text-default text-semibold">
                                                {{ oTagReview.tag_created }}
                                            </a>
                                        </div>
                                        <div
                                            class="text-muted text-size-small">{{ oTagReview.tag_created }}</div>
                                    </div>
                                </td>


                                <td>
                                    <a :href="`/admin/tags/review/${oTagReview.id}`" target="_blank"
                                       class="text-default text-semibold">
                                        {{ oTagReview.TagDataById }}
                                    </a>
                                    <div data-toggle="tooltip" title="" data-placement="top" class="progress"
                                         :data-original-title="`Total {{ oTagReview.TagDataById }} Feedbacks`">
                                        <div class="progress-bar progress-bar-info" role="progressbar"
                                             :aria-valuenow="oTagReview.TagDataById" aria-valuemin="0"
                                             :aria-valuemax="oTagReview.TagDataById" style="width:100%"></div>
                                    </div>
                                </td>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                           class="deleteTagGroupEntity"
                                                           :tagid="oTagReview.id"
                                                           :groupid="oTagReview.group_id"><i
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style="margin: 20px 0px 0;" class="text-center">
                                            <h5 class="mb-20 mt40">
                                                Looks Like You Don’t Have Any Tag Review Yet <img
...
<script>
    ...
    export default {
        ...
        mounted() {
            //getData
            axios.get('/admin/tags/tagsreview')
                .then(response => {
                    //console.log(response.data);

                    this.oTagReviews = response.data;
                    console.log(this.oTagReviews);
                });
