<template>
    <div>
        ...
        <div class="content-area">
            ...
            <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="email_config_list">
                                <li><a class="done" href="javascript:void(0);" @click="displayStep(1)"><span class="num_circle"><span class="num">1</span><span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center d-flex animate_top">
                            <div class="card br8 p0 ">
                                ...
                                <div class="p20 btop">
                                    <a class="fsize14 fw500 email_500" href="javascript:void(0);">Create new email template</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-center d-flex animate_top">
                            <div class="card br8 p0 ">
                                ...
                                <div class="p20 btop">
                                    <a class="fsize14 fw500 email_500" href="javascript:void(0);">Use plain text editor</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div v-show="listTemplateSection">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-4 previewSmsTemplate" v-for="template in templates"
                ...
                <div v-show="editTemplateSection">
                    <div class="row">
                        <iframe id="loadstripotemplate" scrolling="no" :src="stripoEditorSrc" width="100%" height="800"
        ...
        <!--Content Area End-->
        <div class="box previewSmsTemplatePopup" style="width: 80%; display: none;">
            <div style="width: 80%;overflow: hidden;height: 100%;">
                <div style="height: 100%; overflow: hidden auto;"><a class="cross_icon previewSmsTemplate"><i><img
                    ...
                    <div class="p40">
                        ...
                        <div class="row bottom-position">
                            ...
                            <div class="col-md-12"><input type="hidden" name="module_name" id="active_module_name"
                                ...
                                <button type="submit"
                                        class="btn btn-lg bkg_blue_300 light_000 pr20 min_w_160 fsize16 fw600 previewSmsTemplate"
                                        @click="saveSelectedTemplate">Select & Continue
                                </button>
                                <a href="javascript:void(0);" class="blue_300 fsize16 fw600 ml20 previewSmsTemplate">Close</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
            ...
            loadPaginatedData: function () {
                axios.get('/admin/broadcast/setupLoadTemplates/'+this.campaignId+'?page=' + this.current_page)
                    .then(response => {
                        ...
                        this.stripoEditorSrc= '/admin/workflow/loadStripoSMSCampaign/' + this.moduleName + '/' + this.campaign.id + '/' + this.campaign.broadcast_id;
                        this.loading = false;
    ...
    $(document).ready(function () {
        $(document).on('click', '.previewSmsTemplate', function () {
            $(".previewSmsTemplatePopup").animate({
                width: "toggle"
            });
        });
