                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="email_config_list">
                                ...
                                <li><a class="done" href="javascript:void(0)" @click="displayStep(4)"><span class="num_circle"><span class="num">4</span><span class="check_img"><img src="/assets/images/email_check.svg"/></span></span>Review & confirm</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
