    ...
    <div class="content" id="masterContainer">
        ...
        <div class="page_header">
            <div class="row">
                <!--=============Headings & Tabs menu==============-->
                <div class="col-md-3">
                    <h3><img src="/assets/images/email_icon_active.png">
                ...
                <div class="col-md-9 text-right btn_area">
                    ...
                    <button v-if="oData.campaignType === 'Sms'" type="button" class="btn bl_cust_btn new btn-default addBroadcast dark_btn ml20" broadcast_type="SMS"><i class="icon-plus3"></i> &nbsp; SMS Broadcast</button>

                    <button v-else type="button" class="btn bl_cust_btn new btn-default addBroadcast dark_btn ml20" broadcast_type="Email"><i class="icon-plus3"></i> &nbsp; Email Broadcast</button>
        ...
        <div v-if="oBroadcasts.length > 0" class="tab-content">
            <!--===========TAB 1===========-->
                            ...
                            <div class="panel-heading">
                                ...
                                <div class="heading-elements">
                                    ...
                                    <div class="table_action_tool">
                                        <a href="javascript:void(0);" class="brig pr-15">Updated just now &nbsp; <i class=""><img src="/assets/images/icon_refresh.png"></i></a>
                                        <a href="javascript:void(0);"><i class=""><img src="/assets/images/icon_calender.png"></i></a>
                                        <a href="javascript:void(0);"><i class=""><img src="/assets/images/icon_download.png"></i></a>
                                        <a href="javascript:void(0);"><i class=""><img src="/assets/images/icon_upload.png"></i></a>
                                        <a href="javascript:void(0);"><i class="editDataList"><img src="/assets/images/icon_edit.png"></i></a>
                            ...
                            <div class="panel-body p0">
                                <table class="table" id="emailsmsbroadcast">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class=""><img src="/assets/images/icon_star_10.png"/></i>Broadcast Name</th>
                                        <th><i class=""><img src="/assets/images/icon_click_10.png"/></i>Schedule Time</th>
                                        <th><i class=""><img src="/assets/images/icon_minus.png"></i>Sent</th>
                                        <th><i class=""><img src="/assets/images/icon_view.png"></i>Opens</th>
                                        <th><i class=""><img src="/assets/images/icon_click_10.png"></i>Clicked</th>
                                        <th><i class=""><img src="/ assets/images/icon_click_10.png"></i>Sending Method</th>
                                        <th class="text-right"><i><img src="/assets/images/icon_date.png"></i>Created</th>
                                    ...
                                    <tbody>
                                    <tr v-for="broadCastData in oBroadcasts" :id="`append-${broadCastData.broadcast_id}`" class="selectedClass">
                                        <td style="display: none;">{{ broadCastData.created }}</td>
                                        <td style="display: none;">{{ broadCastData.broadcast_id }}</td>
                                        <td style="display: none;" class="editAction">
                                            <label class="custmo_checkbox pull-left">
                                            <input type="checkbox" name="checkRows[]" class="checkRows" :id="`chk ${broadCastData.broadcast_id}`" :value="`${broadCastData.broadcast_id}`" >
                                            <span class="custmo_checkmark"></span>
                                            </label>
                                        </td>
                                        <td>
                                            <div class="media-left media-middle pl-5">
                                                <a class="icons br5" href="#">
                                                <img src="/assets/images/icon_massages.png" class="img-circle img-xs br5" alt="">
                                                </a>
                                            </div>
                                            <div class="media-left">
                                                <div class="">
                                                    <a
                                                        :href="`/admin/broadcast/edit/${broadCastData.broadcast_id}`"
                                                        :broadcast_id="`${broadCastData.broadcast_id}`"
                                                        :broadcast_title="`${broadCastData.title}`"
                                                        :broadcast_des="`${broadCastData.description}`"
                                                        class="text-default text-semibold">
                                                        {{ broadCastData.title.substring(0,20) }}
                                                    </a>
                                                </div>
                                                <div class="text-muted text-size-small">
                                                    {{ broadCastData.description.substring(0,25) }}
                                                </div>
                                            </div>
                                        </td>
                                        <td v-html="JSON.parse(broadCastData.data).delivery_date">
                                            <span class="txt_grey" v-html="JSON.parse(broadCastData.data).delivery_date"></span>
                                        </td>

                                        <td>
                                            <div class="media-left">
                                                <div
                                                    :class="`progress-circle ${broadCastData.addPC} blue3 cp ${broadCastData.totalSentGraph} ${broadCastData.clsCreateSegment}`"
                                                    segment-type="total-sent"
                                                    :campaign-id="`${broadCastData.broadcast_id}`"
                                                    campaign-type="email"
                                                    :sending_method="`${broadCastData.sending_method}`"
                                            ...
                                            <div class="media-left">
                                                <div
                                                    data-toggle="tooltip"
                                                    :title="`${broadCastData.delivered} sent out of ${broadCastData.totalSent} emails`"
                                                    data-placement="top">

                                                    <a v-if="broadCastData.totalSentGraph > 0"
                                                       :href="`/admin/broadcast/records/email/${broadCastData.broadcast_id}?type=delivered`"
                                                       class="text-default text-semibold">{{ broadCastData.delivered }}
                                                    </a>

                                                    <a v-else href="javascript:void(0);" class="text-default text-semibold">{{ broadCastData.delivered }}</a>

                                                    <span v-if="broadCastData.newOpen > 0" style="color:#FF0000;"> ({{ broadCastData.newOpen }} new)</span>
                                        ...
                                        <td>
                                            <div class="media-left">
                                                <div
                                                    :class="`progress-circle ${broadCastData.addPC} blue1 cp${broadCastData.totalOpenGraph} ${broadCastData.clsCreateSegment}`"
                                                    segment-type="total-open"
                                                    :campaign-id="`${broadCastData.broadcast_id}`"
                                                    campaign-type="email"
                                                    :sending_method="`${broadCastData.sending_method}`"
                                                    title="click to create segment">
                                            ...
                                            <div class="media-left">
                                                <div
                                                    data-toggle="tooltip"
                                                    :title="`${broadCastData.open} open out of ${broadCastData.totalSent} emails`"
                                                    data-placement="top">

                                                    <a v-if="broadCastData.open > 0"
                                                       :href="`/admin/broadcast/records/email/${broadCastData.broadcast_id}?type=open`"
                                                       class="text-default text-semibold">
                                                        {{ broadCastData.open }}
                                                    </a>

                                                    <a v-else href="javascript:void(0);" class="text-default text-semibold">{{ broadCastData.open }}</a>
                                        ...
                                        <td>
                                            <div class="media-left">
                                                <div
                                                    :class="`progress-circle ${broadCastData.addPC} blue2 cp${broadCastData.totalClickGraph} ${broadCastData.clsCreateSegment}`"
                                            ...
                                            <div class="media-left">
                                                <div
                                                    data-toggle="tooltip"
                                                    :title="`${broadCastData.click} click out of ${broadCastData.totalSent} emails`"
                                                    data-placement="top">

                                                    <a v-if="broadCastData.click > 0"
                                                       :href="`/admin/broadcast/records/email/${broadCastData.broadcast_id}?type=click`"
                                                       class="text-default text-semibold">
                                                        {{ broadCastData.click }}
                                                    </a>

                                                    <a v-else href="javascript:void(0);" class="text-default text-semibold">{{ broadCastData.click }}</a>

                                                    <span v-if="broadCastData.newClick > 0" style="color:#FF0000;"> ({{ broadCastData.newClick }} new)</span>
                                        ...
                                        <td class="text-center">
                                            <a :href="`/admin/broadcast/report/${broadCastData.broadcast_id}`">
                                                <span v-if="broadCastData.sending_method === 'split'">Split( {{ broadCastData.totalVariations}} Variations)</span>
                                        ...
                                        <td class="text-right">
                                            <div class="media-left text-right pull-right">
                                                <div class="">
                                                    <a href="#" class="text-default text-semibold">{{ broadCastData.created }}
                                                        <span class="txt_grey">{{ broadCastData.created }}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="">
                                            ...
                                            <span v-if="broadCastData.bc_status === 'active'">
                                                <i v-if="broadCastData.bExpired === true" class="icon-primitive-dot txt_grey3 fsize16"></i>
                                            ...
                                            <a class="text-default text-semibold bbot dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                <span v-if="broadCastData.bc_status === 'active'">
                                                    <span v-if="broadCastData.bExpired === true">Expired</span>
                                                    <span v-else>Active</span>
                                                </span>

                                                <span v-if="broadCastData.bc_status === 'draft'">
                                                   Draft
                                                </span>

                                                <span v-else>
                                                   {{ broadCastData.bc_status }}
                                                </span>
                                        ...
                                        <td class="text-center">
                                            <div class="tdropdown ml10">
                                                <a class="table_more dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                                    <img src="/assets/images/more.svg">
                                                </a>
                                                <ul class="dropdown-menu dropdown-menu-right more_act">
                                                    <li><a :href="`/admin/broadcast/edit/${broadCastData.broadcast_id}`"><i class="icon-pencil"></i> Edit</a></li>
                                                    ...
                                                    <li v-if="broadCastData.bc_status !== 'archive'">
                                                        <a href="javascript:void(0);"
                                                           class="moveArchive"
                                                           :broadcast_id="`${broadCastData.broadcast_id}`">
                                                            <i class="icon-file-stats"></i> Move To Archive
                                                        </a>
                                                    </li>
                                        ...
                                        <td style="display:none;">
                                            ...
                                            <span v-if="broadCastData.bc_status === 'archive'">
                                                {{ 'archive' }}
                                            </span>
            ...
            <div class="tab-pane active" id="right-icon-tab0">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h6 class="panel-title">{{ oBroadcasts.iActiveCount }} Brand Boost Broadcast</h6>
                                <div class="heading-elements">
                                    <div style="display: inline-block; margin: 0;" class="form-group has-feedback has-feedback-left">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div style="margin: 20px 0px 0;" class="text-center">
                                                        ...
                                                        <h5 class="mb-20 mt40">
                                                            Looks Like You Don't Have Created Any {{ oBroadcasts.campaignType }} Broadcast Yet <img src="/assets/images/smiley.png"> <br>
                                                            Lets Create {{ oBroadcasts.campaignType }} Broadcast.
                                                        </h5>


                                                        <button type="button"
                                                                class="btn bl_cust_btn new btn-default addBroadcast dark_btn ml20 mb40" :broadcast_type="`${oBroadcasts.campaignType}`"><i class="icon-plus3"></i> &nbsp; {{ oBroadcasts.campaignType }} Broadcast</button>
                ...
                <div class="modal-content">
                    <form method="post" name="addBroadcastSegment" id="addBroadcastSegment" action="javascript:void();">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" :value="`${oBroadcasts.moduleName}`" name="moduleName" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" name="addBroadcastData" id="addBroadcastData" action="javascript:void();">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">×</button>
                            <h5 class="modal-title"><img src="/assets/css/menu_icons/Email_Color.svg"/> Add Brand Boost Broadcast &nbsp; <i class="icon-info22 fsize12 txt_grey"></i></h5>
                        </div>
                        <div class="modal-body">
...
<script>
    ...
    export default {
        ...
        mounted() {
            //getData
            axios.get('/admin/broadcast/email')
                .then(response => {
                    //console.log(response.data);

                    this.oData = response.data;
                    this.oBroadcasts = response.data.oBroadcast;
                    //this.oBroadcastData = this.oBroadcasts.oBroadcastData;
                    //console.log(JSON.parse(this.oBroadcasts[0].data).delivery_date);
                    console.log(this.oBroadcasts);
                });
    ...
    $(document).ready(function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('.overlaynew').show();
                            $.ajax({
                                url: "/admin/modules/emails/multipalDeleteAutomation",
                                type: "POST",
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('.overlaynew').show();
                            $.ajax({
                                url: "/admin/broadcast/multipalArchiveAutomation",
                                type: "POST",
                                data: {_token: '{{csrf_token()}}', multipal_automation_id: val},
                                dataType: "json",
                                success: function (data) {
        ...
        $(document).on('click', '.moveArchive', function () {
            var automationID = $(this).attr('broadcast_id');
            $.ajax({
                url: "/admin/broadcast/moveArchive",
                type: "POST",
                data: {_token: '{{csrf_token()}}', automation_id: automationID},
                dataType: "json",
                success: function (data) {
        ...
        $(document).on('click', '.deleteBroadcastCampaign', function () {
            ...
            deleteConfirmationPopup(
                ...
                function () {
                    ...
                    $.ajax({
                        url: "/admin/modules/emails/deleteAutomation",
                        type: "POST",
                        data: {_token: '{{csrf_token()}}', automation_id: automationID},
                        dataType: "json",
                        success: function (data) {
            ...
            if (campaignName == '') {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.status == 'success') {
                            $('.overlaynew').hide();
                            window.location.href = "/admin/broadcast/edit/" + broadcastId;
                        } else {
                            $('.overlaynew').hide();
        ...
        $('#addBroadcastData').submit(function () {
            ...
            $('.overlaynew').show();
            $.ajax({
                url: "/admin/broadcast/createBroadcast",
                type: "POST",
                ...
                success: function (data) {
                    if (data.status == 'success') {
                        $('.overlaynew').hide();
                        window.location.href = '/admin/broadcast/edit/' + data.broadcastId;
                    } else {
                        $('.overlaynew').hide();
                        alertMessage('Error: Some thing wrong!');
                    }
