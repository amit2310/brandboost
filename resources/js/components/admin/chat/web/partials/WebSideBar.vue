    ...
    <div class="page_sidebar bkg_light_000 absl">
        ...
        <div class="p20 pt0">
            <ul class="nav nav-pills chat_contact_tab" role="tablist">
                ...
                <li class="mr10"><a class="htxt_bold_13" data-toggle="pill" href="#Unassigned">Unassigned ({{unassignedChat.length}})</a></li>
                <li class=""><a class="htxt_bold_13" data-toggle="pill" href="#You">You ({{assignedChat.length}})</a></li>
            </ul>
        </div>
        <div class="tab-content" style="height:600px;overflow-y:auto;overflow-x:hidden;">
            ...
            <div id="All" class="tab-pane active">
                <div class="p20 pt0 pb0 bkg_light_050">
                    <ul class="list_with_icons">
                        <li v-for="contact in allChat" class="d-flex" :userid="contact.user" style="cursor:pointer;" @click="loadChatArea(contact.room, contact.user)">
            ...
            <div id="Unassigned" class="tab-pane fade">
                <div class="p20 pt0 pb0 bkg_light_050">
                    <ul class="list_with_icons">
                        <li v-for="contact in unassignedChat" class="d-flex" :userid="contact.user" style="cursor:pointer;" @click="loadChatArea(contact.room, contact.user)">
                            <div class="media_left">
                                <user-avatar
                                    :avatar="''"
                                    :firstname="getName(contact.user_name).firstName"
            ...
            <div id="You" class="tab-pane fade">
                <div class="p20 pt0 pb0 bkg_light_050">
                    <ul class="list_with_icons">
                        <li class="d-flex" v-for="contact in assignedChat" :userid="contact.user" style="cursor:pointer;" @click="loadChatArea(contact.room, contact.user)">
                            <div class="media_left">
                                <user-avatar
                                    :avatar="''"
                                    :firstname="getName(contact.user_name).firstName"
...
<script>
    ...
    export default {
        props: ['allChat', 'unassignedChat', 'assignedChat'],
