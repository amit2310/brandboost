                    ...
                    <div class="contact_box" style="cursor:pointer;" @click="ShowPanel('contacts')">
                        ...
                        <div class="media-left p0"><p class="txt_dark"><a href="javascript:void(0);"
                            ...
                            <p class="fsize12 fw300 txt_grey m0">Choose from all available contacts. The list of
                                contacts will be created automatically based on this workflow.</p>
                        </div>
                    </div>
...
<script>
    import WorkflowAudienceContacts from './Partials/Import/Im-Contacts';
    import WorkflowAudienceImportLists from './Partials/Import/Im-Lists';
    import WorkflowAudienceImportSegments from './Partials/Import/Im-Segments';
    import WorkflowAudienceImportTags from './Partials/Import/Im-Tags';
