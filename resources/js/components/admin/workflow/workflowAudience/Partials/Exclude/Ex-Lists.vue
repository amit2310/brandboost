    ...
    <div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <h3 class="htxt_medium_24 dark_800 mb-2">Exclude Lists</h3>
                <h3 style="float: right;display:none;">Exclude from Lists <span id="excludedContactList">{{selected_lists.length}}</span></h3>
                <p class="htxt_regular_14 dark_200 m-0">Choose lists do you want to exclude from the campaign</p>
            </div>
