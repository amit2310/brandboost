<template>
    <div class="p40">
        ...
        <div class="p10">
            ...
            <h3 style="float: right;">Exclude from Tags <span id="excludedContactTag">{{selected_tags.length}}</span></h3>
        </div>
                            ...
                            <tr v-for="tag in tags">
                                ...
                                <td>
                                    <label class="custmo_checkbox ">
                                        <input type="checkbox" name="checkRows[]" class="addToCampaign" @click="excludeToTags($event,tag.tagid)"
