        ...
        <div style="display: block;">
            <div class="row">
                <div class="col-12">
                    ...
                    <h3 style="float: right;display:none;">Exclude from Contacts <span>{{selected_contacts.length}}</span></h3>
                    <p class="htxt_regular_14 dark_200 m-0">Choose contacts do you want to exclude from the campaign</p>
                </div>
                <div class="col-12">
						...
						<span>
							<label class="custmo_checkbox pull-left">
								<input
                                    ...
                                    name="checkRows[]"
                                    class="addToCampaign"
                                    @click="excludeToContact($event, contact.subscriber_id)"
