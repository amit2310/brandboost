                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-heading">
                            <h6 class="panel-title">{{ totalResults }} Off Site Brand Boost Feedback</h6>
                        ...
                        <div class="table-responsive">
                            <feedback-list-table :oData="results" :canRead="canRead" :canWrite="canWrite"></feedback-list-table>
                        </div>
                    </div>
                </div>
            </div>
