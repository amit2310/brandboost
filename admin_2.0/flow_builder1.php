 ...
 **********************-->
	...
	**********************-->
    ...
    <div class="workflow_switch_div float-left">
        ...
        <a class="workflow_switch" href="#"><i class="ri-arrow-right-line"></i></a>
    </div>
    </div>
    <div class="col">
    <div class="workflow_switch_div float-right">
    	<a class="workflow_switch" href="#"><i class="ri-list-check-2"></i> List view</a>
        <a class="workflow_switch active" href="#"><i class="ri-drag-move-line"></i> Canvas</a>
    </div>
    </div>
    </div>
    ...
    <div class="row">
           	...
           	<div class="row">
           		<div class="col-md-12">
                    ...
                    <div class="wf_icons br12 bkg_dark_100 rotate_45 border"><img class="rotate_45_minus small" src="assets/images/play_white_small.svg"></div>
						...
						<p class="dark_200 fsize13 fw500 mb15 ls4">Entry Trigger </p>
        ...
        <a class="workflowadds" href="#"><i class="ri-add-fill"></i></a>
        </div>
