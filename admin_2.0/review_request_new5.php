  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<div class="col-md-6 col-6 text-right">
   		<button class="btn btn-md bkg_light_800 light_000" >Send Request <span><img src="assets/images/arrow-right-circle-fill-white.svg"></span></button>
   	</div>
   </div>
   </div>
    			...
    			<div class="row">
    				...
    				<div class="col-9">
    					...
    					<ul class="review_camapaign_list">
    						<li><span>Recipients</span><strong> <img src="assets/images/addcirclegreen.svg"> &nbsp; Core Subscribers List </strong></li>
    						<li><span>Exclude</span><strong><img src="assets/images/minus_red.svg"> &nbsp; Spam Tag</strong></li>
    					</ul>
    				</div>
    				<div class="col text-right">
