  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<div class="col-md-6 col-6 text-right">
   		<button class="btn btn-md bkg_reviews_400 light_000" >Save Campaign <span><img src="assets/images/arrow-right-circle-fill-white.svg"></span></button>
   	</div>
   </div>
   </div>
	...
	<div class="page_sidebar bkg_light_000 fixed">
 	<div style="width: 279px;">
      ...
      <div class="p30 pb10 text-center">
      	<img src="assets/images/review_setup_graph5.svg"/>
      </div>
    		...
    		<div class="card p35 br6 mb10">
    			<div class="row">
    				...
    				<div class="col-9">
    					<h3 class="htxt_medium_16 dark_700 mb-2">From</h3>
    					<ul class="review_camapaign_list">
    						<li><span>From name</span><strong>Makers</strong></li>
    						<li><span>From phone number</span><strong>+1 (262) 555-0131</strong></li>
    					</ul>
    				</div>
    				<div class="col text-right">
    					<button class="btn border br35 dark_200 fsize13 fw500 p10 pl30 pr30 shadow-none">Edit</button>
    			...
    			<div class="row">
    				...
    				<div class="col-9">
    					...
    					<ul class="review_camapaign_list">
    						...
    						<a href="#">Preview SMS Template “Review Request”</a><br>
							<a href="#">Send test SMS</a>
    						</strong></li>
    					</ul>
    				</div>
    				<div class="col text-right">
