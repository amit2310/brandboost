 ...
 **********************-->
    ...
    <div class="row">
    	<div class="col-md-12">
    		<ul class="email_config_list">
    			...
    			<li><a class="active" href="#"><span class="num_circle"><span class="num">3</span><span class="check_img"><img src="assets/images/email_check.svg"/></span></span>Recipients</a></li>
   ...
   <div class="table_head_action mt-2">
    <div class="row">
    	<div class="col-md-6">
    		<h3 class="htxt_medium_16 dark_400">1,389 subscribers</h3>
    	</div>
    	<div class="col-md-6">
