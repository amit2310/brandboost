    	...
    	<div class="col-md-12">
    		...
    		<div class="row mb65">
     		...
     		<div class="col-md-12 text-center">
     			<img class="mt40" style="max-width: 250px; " src="assets/images/sms_subscribers.svg">
     			<h3 class="htxt_bold_18 dark_700 mt30">Looks like you don’t have any subscribers</h3>
     			<h3 class="htxt_regular_14 dark_200 mt20 mb25">It’s very easy to create or import subscribers!</h3>
     			<button class="btn btn-sm bkg_sms_000 pr20 sms_400 slidebox">Add subscribers</button>
     		</div>
     		</div>
