   ...
   <div class="content-area">
    ...
    <div class="row">
        ...
        <div class="card p0 animate_top col">
          <div class="p20">
          	<p class="htxt_regular_12 dark_600 lh_19 m-0">
          		Hi, <span class="sms_400">{Name}</span> The Top Forex Brokers Review is a great website that provided me with insightful information about Forex Trading by incorporating a list of the top brokers in the world, it gave me an idea of where i should make trades. The use of Forex Education.
          	</p>
          </div>
          <div class="p20 btop mt-3 text-center">
            <p class="htxt_regular_14 dark_800 mb-1">Simple Template</p>
            <p class="dark_200 htxt_medium_12 m-0">SMS</p>
          </div>
        </div>
      </div>
