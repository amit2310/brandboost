 ...
 **********************-->
   ...
   <div class="table_head_action">
    ...
    <div class="row">
    	<div class="col-md-6">
    		<h3 class="htxt_medium_16 dark_400">Offline</h3>
    	</div>
    	<div class="col-md-6">
    	<div class="table_action">
			<div class="float-right">
    		...
    		<div class="table-responsive">
				...
				<tbody>
			     ...
			     <tr>
				  ...
				  <tr>
					<td><span class="table-img mr15"><span class="fl_name"><img src="assets/images/avatar/07.png"/></span></span> <span class="htxt_medium_14 dark_900">Bessie Mccoy</span></td>
					<td><span class="icons"><img src="assets/images/chrome-fill.svg"></span> <span class="icons"><img src="assets/images/android-fill.svg"></span> <span class="icons"><img src="assets/images/smartphone-fill.svg"></span> 
					</td>
					<td>Services</td>
					<td>3 min.</td>
				  ...
				  <tr>
					<td><span class="table-img mr15"><span class="fl_name"><img src="assets/images/avatar/08.png"/></span></span> <span class="htxt_medium_14 dark_900">Morris Mckinney</span></td>
					<td><span class="icons"><img src="assets/images/chrome-fill.svg"></span> <span class="icons"><img src="assets/images/android-fill.svg"></span> <span class="icons"><img src="assets/images/smartphone-fill.svg"></span> 
					</td>
					<td>Our new product</td>
					<td>47 min.</td>
