 ...
 **********************-->
   <div class="content-area">
    ...
    <div class="row">
    	<div class="col-md-6">
    		<h3 class="htxt_medium_16 dark_400">SMS</h3>
    	</div>
    	<div class="col-md-6">
    ...
    <div class="row">
    		...
    		<div class="table-responsive">
				...
				<tbody>
				  ...
				  <tr>
					...
					<td class="text-right">(252) 555-0126</td>
   	...
   	<div class="row">
    	<div class="col-md-3 d-flex">
    		<div class="card p0 pt30 min_h_275 text-center animate_top col">
				...
				<a href="#" class="circle-icon-64 bkg_sms_000 m0auto"><img src="assets/images/sms-chat-4-line.svg"/> </a>
   				<h3 class="htxt_bold_16 dark_700 mb-1 mt-4">User Onboarding</h3>
   				<p class="fsize11 fw500 dark_200 text-uppercase">WORKFLOW</p>
    	...
    	<div class="col-md-3 text-center d-flex slidebox">
    		<div class="card p30 min_h_275 animate_top col">
     		<img class="mt20 mb30" src="assets/images/plus_icon_circle_64.svg">
     		<p class="htxt_regular_16 dark_100 mb15">Create<br>new workflow</p>
     		</div>
    	</div>
    </div>
 ...
 **********************-->
 <?php include("sms_workflow_create_smart_popup.php"); ?>
...
<script>
  ...
  var options7 = {
    ...
    new ApexCharts(document.querySelector("#sparklinechart3"), options9).render();
  </script>
