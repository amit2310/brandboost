 ...
 **********************-->
  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<h3 class="htxt_medium_24 dark_700">People Segment 2</h3>
   	</div>
   	<div class="col-md-6 col-6 text-right">
   		<button class="circle-icon-40 mr15 back_btn"><img class="back_img_icon" src="assets/images/filter.svg"/></button>
   		<button class="btn btn-md bkg_blue_200 light_000 slidebox">New Segment <span><img src="assets/images/blue-plus.svg"/></span></button>
   	</div>
   </div>
   </div>
   ...
   <div class="content-area">
    ...
    <div class="row">
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_brand_000 m0auto"><img src="assets/images/filter-3-f.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">Male, USA, 25+</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">SEGMENT</p>
          <div class="p20 btop">
    ...
    <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_light_600 m0auto"><img src="assets/images/filter-3-f.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">Male, USA, 25+</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">SEGMENT</p>
          <div class="p20 btop">
            <ul class="workflow_list">
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_email_300 m0auto"><img src="assets/images/filter-3-f.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">Male, USA, 25+</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">SEGMENT</p>
          <div class="p20 btop">
            <ul class="workflow_list">
 ...
 **********************-->
 <?php include("people_segment_create_smart_popup.php"); ?>
