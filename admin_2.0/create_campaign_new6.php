 ...
 **********************-->
      					...
      					<div class="p30 pb15">
     						<div class="row">
      						...
      						<ul class="list_review mt-3">
     							...
     							<li><a class="active" href="#">Email Subject</a></li>
	...
	**********************-->
    ...
    <div class="row">
    	<div class="col-12">
    		...
    		<div class="card p35 br6 mb10">
    			<div class="row">
    				...
    				<div class="col">
    					...
    					<p class="htxt_regular_14 dark_400 m-0 ls4">This text will be displayed in the Subject field in your recipient's email client</p>
    				</div>
    				<div class="col text-right">
			...
			<div class="campaign_name_sec border br4 p10 pl20 pr20 fsize14 dark_200">
                	<div class="row">
                		<div class="col-8"><input type="text" class="textfield emoji2 fsize14 dark_200" id="fname" placeholder="Enter your email subject line" name="fname"></div>
                		<div class="col-4">
    					...
    					<div class="col-12">
    						<div class="form-group mb-0">
    							...
    							<input type="text" class="form-control h48 emoji2" placeholder="Email preview text appears in an inbox after subject line" />
    						</div>
    					</div>
    				</div>
    			</div>
    ...
    <div class="table_head_action pb0 mb15 mt15 disabled">
    <div class="row">
    	<div class="col">
