...
<div class="table_head_action">
    <div class="row">
    	<div class="col-md-6">
    		<h3 class="htxt_medium_16 dark_400">Forms</h3>
    	</div>
    	<div class="col-md-6">
   ...
   <div class="row">
      ...
      <div class="col-md-3 d-flex slidebox">
        <div class="card p0 pt30 text-center animate_top col">
         <img class="mt20 mb30" src="assets/images/plus_icon_circle_64.svg">
     		<p class="htxt_regular_16 dark_100 mb15">Create<br>new segment</p>
        </div>
      </div>
