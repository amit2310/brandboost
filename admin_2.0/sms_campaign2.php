 ...
 **********************-->
  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<h3 class="htxt_medium_24 dark_700">SMS Campaign 2</h3>
   	</div>
    ...
    <div class="row">
    	<div class="col-md-3">
    		<div class="card p0 pt30 min_h_275 text-center animate_top">
				...
				<a href="#" class="circle-icon-64 bkg_sms_000 m0auto"><img src="assets/images/sms-chat-4-line.svg"/> </a>
   				<h3 class="htxt_bold_16 dark_700 mb-1 mt-4">2nd Training SMS</h3>
    	...
    	<div class="col-md-3">
    		<div class="card p0 pt30 min_h_275 text-center animate_top">
				...
				<a href="#" class="circle-icon-64 bkg_dark_000 m0auto"><img src="assets/images/send-plane-fill-grey.svg"/> </a>
   				<h3 class="htxt_bold_16 dark_700 mb-1 mt-4">2nd Training SMS</h3>
   				<p class="fsize11 fw500 dark_200 text-uppercase">Campaign</p>
   				<div style="min-height: 40px; margin: 4px 0;" class="img_box">
   					<img src="assets/images/Rectangle-grey.svg"/>	
   				</div>
