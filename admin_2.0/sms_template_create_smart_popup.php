      ...
      <div class="p40">
        <div class="row">
          <div class="col-md-12"> <img src="assets/images/sms_temp_icon.svg"/>
            <h3 class="htxt_medium_24 dark_800 mt20">Create Sign-up Form </h3>
            <hr>
          </div>
          <div class="col-md-12">
        ...
        <div class="row bottom-position">
          ...
          <div class="col-md-12">
            <button class="btn btn-lg bkg_sms_400 light_000 pr20 min_w_160 fsize16 fw600">Create</button>
            <a class="sms_400 fsize16 fw400 ml20" href="#">Close</a> </div>
        </div>
      </div>
    </div>
  </div>
