    	...
    	<div class="card p0">
						<div class="p30 bbot pt20 pb20">
							<div class="bbot mb30">
								<div class="row">
									<div class="col-md-8">
								<p class="fsize16 fw500 dark_700 float-left mr-3"><img src="assets/images/RLogo_11.svg"> &nbsp; Gladys Russell</p>
								<p class="mt-1 review_rating_start"><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_grey_18.svg"></i></p>
									</div>
									<div class="col-md-4"><p class="float-right fsize14 dark_200 mt-2">Dec 9, 2019</p></div>
								</div>
							...
							<p class="fsize14 fw400 dark_600 lh_22 m-0">
								The Top Forex Brokers Review is a great website that provided me with insightful information about Forex Trading by incorporating a list of the top brokers in the world, it gave me an idea of where i should make trades. The use of Forex Education is fantastic as it helped me gain a better understanding of various aspects related to the Forex Trading, which allowed me to make my decision of which broker to trade with. I highly recommend using this website.
							</p>
						</div>
						<div class="p20 pl30 pr30" style="background: #fcfdff">
							<p class="float-left fsize14 light_700 mt-2 mb-0"><img src="assets/images/chat-3-fill.svg"> &nbsp; Respond as BrandBoost</p>
							<button class="btn btn-md bkg_light_700 light_000 float-right pl20 pr20"><img src="assets/images/send_white.svg"> &nbsp; Send </button>
						</div>
		...
		<div class="card p0">
						<div class="p30 bbot pt20 pb20">
							<div class="bbot mb30">
								<div class="row">
									<div class="col-md-8">
								<p class="fsize16 fw500 dark_700 float-left mr-3"><img src="assets/images/RLogo_06.svg"> &nbsp; Wade Murphy</p>
								<p class="mt-1 review_rating_start"><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_yellow_18.svg"></i><i class=""><img src="assets/images/star-fill_grey_18.svg"></i></p>
									</div>
									<div class="col-md-4"><p class="float-right fsize14 dark_200 mt-2">Dec 9, 2019</p></div>
								</div>
							...
							<p class="fsize14 fw400 dark_600 lh_22 m-0">
								The Forex Education section is fantastic for gain decent amount of knowledge about trading Forex.<br>
								 The website has a lots of useful information related to trading Forex.
							</p>
						</div>
						<div class="p20 pl30 pr30" style="background: #fcfdff">
							<p class="float-left fsize14 light_700 mt-2 mb-0"><img src="assets/images/chat-3-fill.svg"> &nbsp; Respond as BrandBoost</p>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
      <div class="panel-body">
    	...
    	<div class="card p0 pt0 pb30 text-center animate_top col">
						<div class="p20 bbot">
							<ul class="workflow_list">
								<li><a class="text-uppercase fw500 dark_200" href="#">OVERALL RATING</a></li>
							</ul>
						</div>
				
   				<h3 class="htxt_regular_28 dark_700 mt-4 mb-0">4.5</h3>
   				<p class="m-0 mb-3"><span class="green_400 mr-2"><i><img src="assets/images/arrow-right-up-line.svg"></i>33,87%</span>last week</p>
   				<div style="min-height: 40px; margin: 5px 0 0;" class="img_box">
   					<div class="ratingbox">
					<ul>
    	...
    	<div class="card p25 animate_top">
    		<img class="float-left mb-3" src="assets/images/plane_work.svg" width="70">
    	...
    	<div class="card p20 min_h_240 profile_form">
    		...
    		<div class="card p20">
						<ul class="review_sites_list">
							<li><span class="float-left">All Sites</span> 
							...
							<li><span class="float-left"><img src="assets/images/RLogo_10.svg"> Facebook</span> 
							<span class="float-right">
								<label class="custmo_checkbox pull-left">
									<input type="checkbox">
									<span class="custmo_checkmark blue"></span>
							...
							<li><span class="float-left"><img src="assets/images/RLogo_11.svg" width="20"> Google</span> 
							<span class="float-right">
								<label class="custmo_checkbox pull-left">
									<input type="checkbox">
									<span class="custmo_checkmark blue"></span>
							...
							<li><span class="float-left"><img src="assets/images/RLogo_09.svg" width="20"> Tripadvisor</span> 
							<span class="float-right">
								<label class="custmo_checkbox pull-left">
									<input type="checkbox">
									<span class="custmo_checkmark blue"></span>
							...
							<li><span class="float-left"><img src="assets/images/RLogo_07.svg" width="20"> Yelp</span> 
							<span class="float-right">
								<label class="custmo_checkbox pull-left">
									<input type="checkbox">
									<span class="custmo_checkmark blue"></span>
			...
			<div class="col-md-8">
				...
				<div class="activity_card email">
					<div class="row">
						<div class="col-md-10">
							<div class="icons bkg_blue_200"><i><img src="assets/images/message-3-line.svg"></i></div>
							<p class="htxt_bold_16 dark_800 mb-2">Quis vulputate tincidunt arcu eget.</p>
							<p class="htxt_regular_14 dark_400 mb0">Tortor nibh bibendum quis ultrices auctor facilisis condimentum eu.</p>
						</div>
						<div class="col-md-2 text-right"><p class="htxt_regular_14 dark_200">11:44AM</p></div>
					</div>
				  ...
				  <tr>
					...
					<td class="text-right"><span class=""><img src="assets/images/chevronbottom.svg"> </span></td>
     				...
     				<div class="col-md-12 text-right mt20">
     					<button class="btn btn-md bkg_blue_200 light_000 slidebox">Next <span><img src="assets/images/blue-plus.svg"></span></button>
     				</div>
					</div>
