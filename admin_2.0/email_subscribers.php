    	...
    	<div class="col-md-12">
    		...
    		<div class="row mb65">
     		...
     		<div class="col-md-12 text-center">
     			<img class="mt40" style="max-width: 225px; " src="assets/images/subscribers_image.png">
     			...
     			<button class="btn btn-sm bkg_email_000 pr20 email_400 slidebox">Add subscribers</button>
     		</div>
     		</div>
 ...
 **********************-->
 <?php include("email_subscribers_create_smart_popup.php"); ?>
