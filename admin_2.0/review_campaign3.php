    ...
    <div class="row">
      <div class="col-md-3 d-flex">
        <div class="card p0 pt30 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_reviews_000 m0auto"><img src="assets/images/star-fill-review-24.svg"> </a>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt30 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_dark_000 m0auto"><img src="assets/images/star-fill-grey.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-2 mt-4">Review Campaign</h3>
          <p class="fsize10 fw500 light_800 text-uppercase mb20">COMPLETED</p>
          <div class="p15 pt15 btop">
            <ul class="workflow_list">
								<li><a href="#"><span><img src="assets/images/send-plane-line.svg"></span> 3k</a></li>
								<li><a href="#"><span><img src="assets/images/mail-open-line.svg"></span> 28%</a></li>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt50 text-center animate_top col">
          ...
          <h3 class="htxt_bold_12 dark_200 mb-0 mt-4 text-uppercase">Create<br>new segment</h3>
