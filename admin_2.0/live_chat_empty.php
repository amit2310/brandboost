 ...
 **********************-->
  ...
  <div class="container-fluid">
   <div class="row">
   	<div class="col-md-6">
   	<h3 class="htxt_medium_24 dark_700">Live Chats </h3>
   	</div>
    	...
    	<div class="col-md-12">
    		<div class="card card_shadow min-h-280">
     		...
     		<div class="col-md-12 text-center">
     			<img class="mt40" style="max-width: 250px; " src="assets/images/livechat_image.svg">
     			<h3 class="htxt_bold_18 dark_700 mt30">Looks like you don’t have any chats</h3>
