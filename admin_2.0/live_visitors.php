 ...
 **********************-->
    		...
    		<div class="card p40 pt0 pb0">
     		<div class="row">
     							<div class="col-md-7">
     								...
     								<h3 class="htxt_bold_18 dark_800">Site visitors live feed</h3>
     								<p class="htxt_regular_14 dark_400 mt15 mb25 lh_20">Visitors tab you can see the list of all users currently visiting your<br>
						 website. Here you check their location, which browser they are using,<br>
						 and the URL of the page they are currently viewing.</p>
     								
     							</div>
     							<div class="col-md-5 text-center">
     								<img style="max-width: 272px;" src="assets/images/livevisitor_image.png">
     							</div>
     						</div>
     		</div>
    	</div>
   ...
   <div class="table_head_action">
    <div class="row">
    	<div class="col-md-6">
    		<h3 class="htxt_medium_16 dark_400">Live Visitors</h3>
    	</div>
    	<div class="col-md-6">
