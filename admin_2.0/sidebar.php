<div class="left-sidenav">
  <div class="main-icon-menu">
    ...
    <a href="#people" class="nav-link people active"> <img src="assets/images/01.svg"/> </a> 
    ...
    <a href="#BrandBoostEmailMarketing" class="nav-link email" > <img src="assets/images/10.svg"/> </a> 
    ...
    <div class="menu-body slimscroll"> 
     ...
     <span style="position: absolute; top: 17px; right: 20px; transform:rotate(180deg);" class="mobile-menu-control float-left"><img src="assets/images/close_menu_circle.svg"></span>
      ...
      <div id="people" class="main-icon-menu-pane people active">
        ...
        <ul class="nav">
          <li class="nav-item"><a class="nav-link active" href="people_dashboard.php"><i><img src="assets/images/home-con.svg"/></i>Dashboard</a></li>
          <li class="nav-item"><a class="nav-link" href="people_contact.php"><i><img src="assets/images/email_campaign-icon.svg"/></i>Contacts</a></li>
          <li class="nav-item"><a class="nav-link " href="template.php"><i><img src="assets/images/people.svg"/></i>Lists</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/email-temp-icon.svg"/></i>Segments</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/forms-icon.svg"/></i>Tags</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/workflow-icon.svg"/></i>Deals</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/analytics-icon.svg"/></i>Companies</a></li>
      ...
      <div id="BrandBoostEmailMarketing" class="main-icon-menu-pane email">
        ...
        <ul class="nav">
          <li class="nav-item"><a class="nav-link active" href="template.php"><i><img src="assets/images/Email_home08.svg"/></i>Dashboard</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/email_campaign-icon.svg"/></i>Email Campaigns</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/account-circle-line.svg"/></i>Subscribers</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/email-temp-icon.svg"/></i>Email Templates</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/forms-icon.svg"/></i>Forms</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/workflow-icon.svg"/></i>Workflows</a></li>
          <li class="nav-item"><a class="nav-link" href="template.php"><i><img src="assets/images/analytics-icon.svg"/></i>Analytics</a></li>
