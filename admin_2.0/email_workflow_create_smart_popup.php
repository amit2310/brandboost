<div class="box" style="width: 424px;">
  <div style="width: 424px;overflow: hidden; height: 100%;">
    <div style="height: 100%; overflow-y:auto; overflow-x: hidden;"> <a class="cross_icon slidebox"><i class=""><img src="assets/images/cross.svg"/></i></a>
      <div class="p40">
        <div class="row">
          <div class="col-md-12"> <img src="assets/images/email_workflow_icon.svg"/>
            <h3 class="htxt_medium_24 dark_800 mt20">Create Workflow</h3>
            <hr class="mt30 mb30">
          </div>
          <div class="col-md-12">
            <form action="/action_page.php">
              <div class="form-group">
                <label for="campaignname">Form name</label>
                <input type="text" class="form-control h56" id="campaignname" placeholder="Enter list name" name="campaignname">
              </div>
