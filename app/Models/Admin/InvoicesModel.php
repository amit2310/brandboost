...
class InvoicesModel extends Model {
    ...
    public static function getInvoiceDetails($invoiceID) {
        ...
        $oData = DB::table('tbl_cc_invoices')
            ->Join('tbl_cc_invoices_items', 'tbl_cc_invoices.id', '=' , 'tbl_cc_invoices_items.local_invoice_id')
            ->Join('tbl_users', 'tbl_cc_invoices.customer_id', '=' , 'tbl_users.cb_contact_id')
            ->Join('tbl_cc_subscriptions', 'tbl_cc_subscriptions.subscription_id', '=' , 'tbl_cc_invoices_items.local_invoice_id')
