           	...
           	<div class="row">
           		<div class="col-md-4">
                    ...
                    <div class="wf_icons br12 bkg_dark_100 rotate_45 border"><img class="rotate_45_minus small" src="assets/images/play_white_small.svg"></div>
						...
						<p class="dark_200 fsize13 fw500 mb15">Entry Trigger</p>
						<div class="p0 pt12 btop">
							<ul class="workflow_list">
                                <li style="border:none;"><a class="blue_300 fw500 fsize11" href="#"><span class="d-inline-block"><img src="assets/images/plus_blue_7.svg"></span> ADD TRIGGER</a></li>
							</ul>
						</div>
					</div>
                   </div>
                   ...
                   <div class="col-md-4">
                    ...
                    <div class="wf_icons br12 bkg_dark_100 rotate_45 border"><img class="rotate_45_minus small" src="assets/images/play_white_small.svg"></div>
                        <p class="dark_100 fsize11 fw500 mb-1 text-uppercase ls_4">TRIGGER </p>
						<p class="dark_600 fsize13 fw500 mb15">Submitted a form</p>
						<div class="p0 pt12 btop">
							<ul class="workflow_list">
        ...
        <div class="col-md-12 mb0">
           <div class="workflow_box mt-5">
           	<div class="row">
           		<div class="col-md-4">
					<div class="workflow_card">
                    <div class="wf_icons br12 bkg_blue_300"><img src="assets/images/flashlight-fill-white.svg" width="18"></div>
                   ...
                   <div class="col-md-4">
					<div class="workflow_card">
                    <div class="wf_icons br12 bkg_blue_300"><img src="assets/images/folder-fill.svg" width="18"></div>
                        <p class="dark_100 fsize11 fw500 mb-1 text-uppercase ls_4">LIST </p>
						<p class="dark_600 fsize13 fw500 mb15 ls4">People list </p>
						<div class="p0 pt12 btop">
							<ul class="workflow_list">
                                <li style="border:none;"><a class="dark_200 fsize12" href="#"><span class="d-inline-block"><i class="ri-account-circle-fill blue_300 fsize15"></i></span> 1356</a></li>
							</ul>
						</div>
					</div>
                   </div>
        ...
        <div class="col-md-12 mb0">
           <div class="workflow_box mt-5">
           	<div class="row">
           		<div class="col-md-4">
					<div class="workflow_card ">
                    <div class="wf_icons br100 bkg_blue_300 border"><img src="assets/images/time-fill-14.svg" width="18"></div>
                   ...
                   <div class="col-md-4">
                    ...
                    <div class="wf_icons br100 bkg_blue_300 border"><img src="assets/images/time-fill-14.svg" width="18"></div>
                        <p class="dark_100 fsize11 fw500 mb-1 text-uppercase ls_4">DELAY </p>
						<p class="dark_600 fsize13 fw500 mb15 ls4">Wait for 3 days </p>
						<div class="p0 pt12 btop">
							<ul class="workflow_list">
                                <li style="border:none;"><a class="dark_200 fsize12" href="#"><span class="d-inline-block"><i class="ri-time-fill blue_300 fsize15"></i></span> The same time</a></li>
							</ul>
						</div>
					</div>
                   </div>
