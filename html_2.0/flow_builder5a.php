	...
	**********************-->
	...
	<div class="page_sidebar bkg_light_000 fixed">
 	<div style="width: 279px;">
        ...
        <li><a href="#"><span class="circle-icon-20 bkg_blue_300 br35"><i class="ri-folder-fill"></i></span> Delay: 3 days </a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb0">
           <div class="workflow_box">
           	<div class="row">
           		<div class="col-md-12">
					<div class="workflow_card " style="border:2px solid #4F8AF4 ">
 ...
 **********************-->
 <?php include("wf_delay_smart_popup.php"); ?>
