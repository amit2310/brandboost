 ...
 **********************-->
  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<h3 class="htxt_medium_24 dark_700">Email Subscribers</h3>
   	</div>
 ...
 **********************-->
   <div class="content-area">
    ...
    <div class="row">
    	<div class="col-md-6">
    		<h3 class="htxt_medium_16 dark_400">Subscribers</h3>
    	</div>
    	<div class="col-md-6">
    	...
    	<div class="col-md-12">
    		<div class="table-responsive">
				...
				<tbody>
			     ...
			     <tr>
					<td colspan=""><span class="fsize12 fw300">Name </span></td>
					<td class="text-right" colspan=""><span class="fsize12 fw300">Email</span></td>
					<td colspan="3"><span class="fsize12 fw300">Tags</span></td>
					<td colspan="2"><span class="fsize12 fw300">Status</span></td>
					<td colspan=""><span class="fsize12 fw300">Action</span></td>
				  </tr>
				  
				  
				  
				  <tr>
					<td><span class="table-img mr15"><!--<img src="assets/images/table_user.png"/>--><span class="fl_name email_400">am</span></span> <span class="htxt_medium_14 dark_900">Courtney Black</span></td>
 ...
 **********************-->
 <?php include("email_list_create_smart_popup.php"); ?>
