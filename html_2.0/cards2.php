   ...
   <div class="content-area">
    ...
    <div class="row">
    	<div class="col-md-3 text-center">
    		<div class="card p30 animate_top">
     		...
     		<h3 class="htxt_bold_16 dark_700 mt25 mb15">Create new <br>contact</h3>
			<p class="htxt_regular_12 dark_300 mb10">Libero lacinia eu, nulla in<br> adipiscing maecenas<br> risus massa. </p>
     		</div>
    	</div>
    	<div class="col-md-4 text-center">
    		<div class="card p30 animate_top">
     		<img src="assets/images/create-contact.svg">
     		<h3 class="htxt_bold_16 dark_700 mt25 mb15">Create<br>contacts list</h3>
     		<p class="htxt_regular_12 dark_300 mb10">Libero lacinia eu, nulla in<br> adipiscing maecenas<br> risus massa. </p>
     		</div>
    	</div>
    	<div class="col-md-5 text-center">
    		<div class="card p30 animate_top">
     		<img src="assets/images/create-contact.svg">
     		<h3 class="htxt_bold_16 dark_700 mt25 mb15">Create new <br>deals</h3>
     		<p class="htxt_regular_12 dark_300 mb10">Libero lacinia eu, nulla in<br> adipiscing maecenas<br> risus massa. </p>
     		</div>
    	</div>
    </div>
    ...
    <div class="row">
     	<div class="col-md-6 d-flex">
     		<div class="card col animate_top">
     		<div class="row">
     		<div class="col-md-6">
...
in next 3 days.</p>
    		<a class="fsize15 blue_300" href="#"><img src="assets/images/editpen.svg">&nbsp; Create new email</a>     		</div>
     		<div class="col-md-6 text-center">
     			<img class="mt40" style="max-width: 225px; " src="assets/images/dashboard_image_01.png">     		</div>
     		</div>
     		</div>
     	</div>
     	<div class="col-md-6 d-flex">
...
in next 3 days.</p>
    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="card p30 pl40 pr50 user_profile animate_top" style="height: 145px;">
    		<div class="row">
    		<div class="col-md-2">
    			<div class="profile_icon">
    				<img src="assets/images/profile-icon-36.svg">    			</div>
    			</div>
    			<div class="col-md-4">
    			...
    			<div class="col-md-6 text-right">
    			<img style="max-width: 86px;" src="assets/images/lead_source.png">    			</div>
    			</div>
    		</div>
    	</div>
    	...
    	<div class="col-md-6">
    		...
    		<div class="col-md-2">
    			...
    			<div class="col-md-6 text-right">
    			<img style="max-width: 250px;" class="mt15" src="assets/images/profile_graph.svg">    			</div>
    			</div>
    		</div>
    	</div>
    </div>
    	...
    	<div class="col-md-3 d-flex">
    		<div class="card p0 animate_top col">
				...
				<div class="p30">
					...
					<div class="col-md-6"><div class="circle-icon-52 float-right"><img src="assets/images/circle_chart.png"/></div></div>
				</div>
				</div>
    		</div>
    	</div>
    	...
    	<div class="col-md-3 d-flex">
    		<div class="card p0 animate_top col">
				<div class="p15 pt15 bbot">
					...
					<div class="col-md-6"><div class="circle-icon-52 float-right"><img src="assets/images/circle_chart2.png"/></div></div>
				</div>
				</div>
    		</div>
    	</div>
    	...
    	<div class="col-md-3 d-flex">
    		<div class="card p0 animate_top col">
				...
				<div class="p30">
					...
					<div class="col-md-6"><div class="circle-icon-52 float-right"><img src="assets/images/circle_chart3.png"/></div></div>
				</div>
				</div>
    		</div>
    	</div>
    	...
    	<div class="col-md-4 d-flex">
    		<div class="card p0 animate_top col">
   			...
   			<div class="p30">
					...
					<div class="col-md-6">
						<div style="min-height: 40px; margin: 0px 0 0;" class="img_box">
						<div id="email_open_chart2" class=""></div>
					</div>
					</div>
				</div>
				</div>
    		...
    		<div class="card p0 animate_top col">
				<div class="p15 pt15 bbot text-center">
   				...
   				<div class="p30">
					...
					<div class="col-md-6">
						<div style="min-height: 40px; margin: 0px 0 0;" class="img_box">
						<div id="email_open_chart3" class=""></div>
					</div>
					</div>
				</div>
				</div>
    ...
    <div class="col-md-3">
    		<div class="card p0 pt30 min_h_275 text-center animate_top">
				...
				<a href="#" class="circle-icon-64 bkg_email_000 m0auto"><img src="assets/images/send-plane-fill-email_blue.svg"/> </a>
   				...
   				<div style="min-height: 40px; margin: 4px 0 25px;" class="img_box">
    		...
    		<div class="card p0 animate_top col max_h_330">
				<div class="p15 pt15 bbot">
   				...
   				<div class="p30">
					...
					<div class="col-md-6">
						<div id="chart_08">
					<apexchart type=radialBar height=160 :options="chartOptions" :series="series" />
				  </div>
					</div>
				</div>
				</div>
    ...
    <div class="row">
    	<div class="col-md-3 d-flex">
    		<div class="card p0 animate_top col" style="max-height: 230px;">
				<div class="p15 pt15 bbot">
					<ul class="workflow_list">
						<li><a class="text-uppercase fw500 dark_200" href="#">CLICK RATE</a></li>
					</ul>
   				...
   				<div class="p30">
					...
					<div class="col-md-6">
						<div id="chart_11" style="margin-top: -10px;">
							<apexchart type=radialBar height=180 :options="chartOptions" :series="series" />
						  </div>
					</div>
				</div>
				</div>
    	...
    	<div class="col-md-4 d-flex">
    		<div class="card p0 animate_top col" style="max-height: 230px;">
				...
				<div class="p30">
					...
					<div class="col-md-6">
						<div id="chart_12" style="margin-top: -10px;">
							<apexchart type=radialBar height=180 :options="chartOptions" :series="series" />
						  </div>
					</div>
				</div>
    	...
    	<div class="col-md-5 d-flex">
    		<div class="card p0 animate_top col" style="max-height: 230px;">
				...
				<div class="p30">
					...
					<div class="col-md-6">
						<div id="chart_13" style="margin-top: -10px;">
							<apexchart type=radialBar height=180 :options="chartOptions" :series="series" />
						  </div>
					</div>
				</div>
    ...
    <div class="row">
    	<div class="col-md-3 d-flex">
    		<div class="card p0 animate_top col" style="max-height: 200px;">
				<div class="p15 pt15 bbot">
					<ul class="workflow_list">
						<li><a class="text-uppercase fw500 dark_200" href="#">CLICK RATE</a></li>
					</ul>
   				...
   				<div class="p30">
					...
					<div class="col-md-6">
						<div id="chart_14" style="margin-top: -20px;">
    	...
    	<div class="col-md-4 d-flex">
   		...
   		<div class="p30">
					...
					<div class="col-md-6">
						<div id="chart_15" style="margin-top: -20px;">
							<apexchart type=radialBar height=250 :options="chartOptions" :series="series" />
						  </div>
					</div>
				</div>
    	...
    	<div class="col-md-5 d-flex">
    		<div class="card p0 animate_top col" style="max-height: 200px;">
				...
				<div class="p30">
					...
					<div class="col-md-6">
						<div id="chart_16" style="margin-top: -20px;">
							<apexchart type=radialBar height=250 :options="chartOptions" :series="series" />
						  </div>
					</div>
				</div>
...
<script>
  ...
  <script src="https://cdn.jsdelivr.net/npm/vue-apexcharts"></script>
    ...
    new ApexCharts(document.querySelector("#email_open_chart2"), options8).render();
    new ApexCharts(document.querySelector("#email_open_chart3"), options9).render();
		...
		************/
        ...
        var chart = new ApexCharts(document.querySelector("#openrate2"), options2).render();
        var chart = new ApexCharts(document.querySelector("#openrate3"), options2).render();
	 ...
	 var sparklineData = [47, 45, 54, 38, 56, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46];	
      ...
      yaxis: {
		...
		var spark = new ApexCharts(document.querySelector("#spark"), spark_small).render();
		var spark2 = new ApexCharts(document.querySelector("#spark2"), spark_mid).render();
		var spark3 = new ApexCharts(document.querySelector("#spark3"), spark_big).render();
    ...
    new ApexCharts(document.querySelector("#sparklinechart1"), options8).render();
    new ApexCharts(document.querySelector("#sparklinechart2"), options8).render();
    new ApexCharts(document.querySelector("#sparklinechart3"), options8).render();
	
		
		
		/***************
		RADIAL Multi CIRCLE CHARTS VUE
		************/	
      ...
      data: {
		...
		/***************
		RADIAL SINGLE CIRCLE CHARTS VUE
		************/		
