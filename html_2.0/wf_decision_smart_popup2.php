<div class="box" style="width: 424px; border-color:#64B2CB!important; display:block; ">
          ...
          <div class="col-md-12"> <img width="40" src="assets/images/decision_arrow_45.png"/>
           ...
           <div class="col-md-12">
             <div class="form-group">
                <label for="campaignname" class="fsize11 fw500 dark_600 ls4">DECISION NODE NAME</label>
                <input class="form-control h50" type="text" placeholder="Enter decision node name" />
              </div>
              
              <div class="form-group">
                <label for="campaignname" class="fsize11 fw500 dark_600 ls4">DECISION BASED ON</label>
              ...
              <div class="form-group">
                <label for="campaignname" class="fsize11 fw500 dark_600 ls4">PATH 2</label>
                <label class="fsize11 fw500 dark_400 ls4 float-right">REMOVE  <img width="17" src="assets/images/cross.svg"/> </label>
                <select class="form-control h50 form-control-custom dark_800">
                	<option>Select segment </option>
                    <option>Submitted a form</option>
                    <option>Choose a trigger...</option>
