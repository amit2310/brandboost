        ...
        <div class="col-md-12 mb0">
           <div class="workflow_box" >
           	<div class="row">
           		<div class="col-md-12">
					<div class="workflow_card">
                    <div class="wf_icons br12 bkg_blue_300"><img width="18" src="assets/images/folde.svg"></div>
                        <p class="dark_100 fsize11 fw500 mb-1 text-uppercase ls_4">LIST </p>
						<p class="dark_200 fsize13 fw500 mb15 ls4">People list </p>
						<div class="p0 pt12 btop">
							<ul class="workflow_list">
                                <li style="border:none;"><a class=" fsize12" href="#"><span class="d-inline-block blue_400 fsize14"><i class="ri-account-circle-fill"></i></span> 1,356</a></li>
							</ul>
						</div>
					</div>
                   </div>
 ...
 **********************-->
 <?php //include("wf_add_action_smart_popup.php"); ?>
