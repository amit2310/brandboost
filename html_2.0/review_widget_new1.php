  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<div class="col-md-6 col-6 text-right">
   		...
   		<button class="btn btn-md bkg_reviews_400 light_000 slidebox">CREATE WIDGET <span><img src="assets/images/reviews_plus_icon.svg"></span></button>
   	</div>
   </div>
   </div>
    	...
    	<div class="col-md-12">
    		<div class="card card_shadow min-h-280 pt50 pb50">
     		...
     		<div class="col-md-12 text-center">
     			...
     			<button class="btn btn-sm bkg_reviews_000 pr20 reviews_400 slidebox">Create new widget</button>
     		</div>
     		</div>
