 ...
 **********************-->
  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<h3 class="htxt_medium_24 dark_700">People List 2</h3>
   	</div>
   ...
   <div class="content-area">
    ...
    <div class="row">
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_brand_000 m0auto"><img src="assets/images/folder-fill.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">Subscribers</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">LIST</p>
          <div class="p20 btop">
            <ul class="workflow_list">
              <li><a href="#"><span><img src="assets/images/account-circle-fill-grey.svg"></span> 1,356</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_light_600 m0auto"><img src="assets/images/folder-fill.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">McDonald's</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">LIST</p>
          <div class="p20 btop">
            <ul class="workflow_list">
              <li><a href="#"><span><img src="assets/images/account-circle-fill-grey.svg"></span> 1,356</a></li>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_brand_000 m0auto"><img src="assets/images/folder-fill.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">Facebook</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">LIST</p>
          <div class="p20 btop">
            <ul class="workflow_list">
              <li><a href="#"><span><img src="assets/images/account-circle-fill-grey.svg"></span> 1,356</a></li>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_reviews_100 m0auto"><img src="assets/images/folder-fill.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">MasterCard</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">LIST</p>
          <div class="p20 btop">
            <ul class="workflow_list">
              <li><a href="#"><span><img src="assets/images/account-circle-fill-grey.svg"></span> 1,356</a></li>
    ...
    <div class="row">
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_light_600 m0auto"><img src="assets/images/folder-fill.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">eBay</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">LIST</p>
          <div class="p20 btop">
            <ul class="workflow_list">
              <li><a href="#"><span><img src="assets/images/account-circle-fill-grey.svg"></span> 1,356</a></li>
    ...
    <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_brand_000 m0auto"><img src="assets/images/folder-fill.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-1 mt-4">Starbucks</h3>
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4">LIST</p>
          <div class="p20 btop">
            <ul class="workflow_list">
              <li><a href="#"><span><img src="assets/images/account-circle-fill-grey.svg"></span> 1,356</a></li>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
          ...
          <p class="fsize11 fw500 dark_200 text-uppercase mb30 ls_4 mt-4">Add<br>
new LIST</p>
