 ...
 **********************-->
  ...
  <div class="container-fluid">
   <div class="row">
   	...
   	<h3 class="htxt_medium_24 dark_700">Subscribers</h3>
   	</div>
   	<div class="col-md-6 text-right">
   		<button class="mr15 btn btn-md bkg_light_000 sms_400">Filters &nbsp; &nbsp; <img src="assets/images/sms_filter.svg"/></button>
   		<button class="btn btn-md light_000 bkg_sms_400 slidebox" >Add contact &nbsp; &nbsp; <span><img src="assets/images/sms_add.svg"/></span></button>
   	</div>
   </div>
   </div>
   ...
   <div class="content-area">
    ...
    <div class="row">
        ...
        <div class="card p0 pt30 text-center animate_top col">
          ...
          <a href="#" class="circle-icon-64 bkg_sms_000 m0auto"><img src="assets/images/sms-file-28.svg"> </a>
          <h3 class="htxt_bold_16 dark_700 mb-4 mt-4">Subscribers List</h3>
          <div class="p20 btop mt-3">
            <ul class="workflow_list">
              <li><a href="#"><span><img src="assets/images/user_grey.svg"></span> 1,356</a></li>
            </ul>
          </div>
        </div>
      </div>
				...
				<tbody>
				  <tr>
				   ...
				   <tr>
					...
					<td class="text-right">(603) 555-0123</td>
					<td># lead, subscriber</td>
					<td><span class="badge badge-dark">+4</span></td>
					<td>Ticket</td>
				  ...
				  <tr>
					...
					<td class="text-right">(907) 555-0101</td>
					<td># lead, subscriber</td>
					<td><span class="badge badge-dark">+4</span></td>
					<td>Customer</td>
					<td><span class="dot_6 bkg_blue_300">&nbsp;</span></td>
				  ...
				  <tr>
					...
					<td class="text-right">(205) 555-0100</td>
					<td># lead, subscriber</td>
					<td><span class="badge badge-dark">+4</span></td>
					<td>Ticket</td>
					<td><span class="dot_6 bkg_yellow_500">&nbsp;</span></td>
				  ...
				  <tr>
					...
					<td class="text-right">(704) 555-0127</td>
					<td># lead, subscriber</td>
					<td><span class="badge badge-dark">+4</span></td>
					<td>Ticket</td>
					<td><span class="dot_6 bkg_yellow_500">&nbsp;</span></td>
