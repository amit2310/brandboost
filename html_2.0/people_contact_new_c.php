 ...
 **********************-->
   <div class="content-area">
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
         <span class="status_icon bkg_light_800"></span>
          ...
          <a href="#" class="circle-icon-56 m0auto"><img src="assets/images/avatar/02.png"/></a>
          <h3 class="htxt_medium_14 dark_600 mb-1 mt-4 ">Ricardo Flores</h3>
          <p class="fsize14 fw400 dark_400 mb-1 ls_4">stanley.baker@example.com</p>
          <p class="fsize14 fw400 dark_400 mb30 ls_4">3 month ago</p>
          <div class="p20 btop">
            <button class="tags_btn blue">customer</button> <button class="tags_btn">+2 </button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
         <span class="status_icon bkg_light_800"></span>
          ...
          <a href="#" class="circle-icon-56 m0auto bkg_red_100"><span class="fsize14 fw500 text-uppercase light_000">ds</span></a>
          <h3 class="htxt_medium_14 dark_600 mb-1 mt-4">Debra Simmmons</h3>
          <p class="fsize14 fw400 dark_400 mb-1 ls_4">stanley.baker@example.com</p>
          <p class="fsize14 fw400 dark_400 mb30 ls_4">3 month ago</p>
          <div class="p20 btop">
             <button class="tags_btn">user</button> <button class="tags_btn blue">customer</button> <button class="tags_btn">+2 </button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
         <span class="status_icon bkg_light_800"></span>
          ...
          <a href="#" class="circle-icon-56 m0auto bkg_green_100"><span class="fsize14 fw500 text-uppercase light_000">mb</span></a>
          <h3 class="htxt_medium_14 dark_600 mb-1 mt-4">Mike Black</h3>
          <p class="fsize14 fw400 dark_400 mb-1 ls_4">stanley.baker@example.com</p>
          <p class="fsize14 fw400 dark_400 mb30 ls_4">3 month ago</p>
          <div class="p20 btop">
            <button class="tags_btn">+2 </button> <button class="tags_btn blue">customer</button> <button class="tags_btn">user</button> 
          </div>
        </div>
      </div>
    ...
    <div class="row">
        ...
        <div class="card p0 pt40 text-center animate_top col">
         <span class="status_icon bkg_light_800"></span>
          ...
          <a href="#" class="circle-icon-56 m0auto"><img src="assets/images/avatar/03.png"/></a>
          <h3 class="htxt_medium_14 dark_600 mb-1 mt-4 ">Calvin Simmmons</h3>
          <p class="fsize14 fw400 dark_400 mb-1 ls_4">stanley.baker@example.com</p>
          <p class="fsize14 fw400 dark_400 mb30 ls_4">3 month ago</p>
          <div class="p20 btop">
             <button class="tags_btn">user</button> <button class="tags_btn">+2 </button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
         <span class="status_icon bkg_light_800"></span>
          ...
          <a href="#" class="circle-icon-56 m0auto bkg_green_100"><span class="fsize14 fw500 text-uppercase light_000">tr</span></a>
          <h3 class="htxt_medium_14 dark_600 mb-1 mt-4">Tyrone Robertson</h3>
          <p class="fsize14 fw400 dark_400 mb-1 ls_4">stanley.baker@example.com</p>
          <p class="fsize14 fw400 dark_400 mb30 ls_4">3 month ago</p>
          <div class="p20 btop">
            <button class="tags_btn blue">customer</button>  <button class="tags_btn">+2 </button>
      ...
      <div class="col-md-3 d-flex">
        <div class="card p0 pt40 text-center animate_top col">
         <span class="status_icon bkg_light_800"></span>
          ...
          <a href="#" class="circle-icon-56 m0auto"><img src="assets/images/avatar/04.png"/></a>
          <h3 class="htxt_medium_14 dark_600 mb-1 mt-4 ">Diane Watson</h3>
          <p class="fsize14 fw400 dark_400 mb-1 ls_4">stanley.baker@example.com</p>
          <p class="fsize14 fw400 dark_400 mb30 ls_4">3 month ago</p>
          <div class="p20 btop">
            <button class="tags_btn blue">customer</button> <button class="tags_btn">user</button> 
          </div>
        </div>
      </div>
    ...
    <div class="row">
    	<div class="col">
    		<div class="custom_pagination grey">
			    	<div class="row">
			    		<div class="col-md-6">
