    ...
    <div class="row">
    	<div class="col-md-12">
           <div class="workflow_box">
           	<div class="row">
           		<div class="col-md-12">
					<div class="workflow_card" style="border:2px solid #97A4BD">
        ...
        <a class="workflowadds slidebox" href="#"><i class="ri-add-fill"></i></a>        </div>
 ...
 **********************-->
 <?php include("wf_trigger_smart_popup.php"); ?>
