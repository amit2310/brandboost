      	...
      	<img src="assets/images/review_setup_graph.svg"/>      </div>
      					...
      					<div class="p30 pb15">
     						<div class="row">
      						...
      						<ul class="list_review mt-3 d-none">
	...
	**********************-->
    ...
    <div class="row">
    	<div class="col-12">
    		...
    		<div class="card p35 br6 mb10">
    			<div class="row">
    				<div style="max-width: 64px" class="col mt-1"><span class="circle-icon-36 bkg_light_200 light_000 d-block dark_100 fsize16 fw500">5</span></div>
    				<div class="col">
