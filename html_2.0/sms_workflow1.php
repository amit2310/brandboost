    	...
    	<div class="col-md-12">
    		...
    		<div class="row mb65">
     		...
     		<div class="col-md-12 text-center">
     			<img class="mt40" style="max-width: 250px; " src="assets/images/sms_workflow.svg">
     			...
     			<button class="btn btn-sm bkg_sms_000 pr20 sms_400 slidebox">Create workflow</button>
     		</div>
     		</div>
